 ...
 */
const Q = globalThis, $ = Q.ShadowRoot && (Q.ShadyCSS === void 0 || Q.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ee = Symbol(), ce = /* @__PURE__ */ new WeakMap();
let Ie = class {
  constructor(e, t, i) {
...
}, ae = $ ? (n) => n : (n) => n instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: He, defineProperty: Ge, getOwnPropertyDescriptor: Re, getOwnPropertyNames: Oe, getOwnPropertySymbols: Ve, getPrototypeOf: Ke } = Object, v = globalThis, be = v.trustedTypes, Pe = be ? be.emptyScript : "", L = v.reactiveElementPolyfillSupport, R = (n, e) => n, F = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? Pe : null;
      break;
  ...
  return t;
} }, te = (n, e) => !He(n, e), me = { attribute: !0, type: String, converter: F, reflect: !1, useDefault: !1, hasChanged: te };
...
let S = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(R("properties"))) {
      const t = this.properties, i = [...Oe(t), ...Ve(t)];
  ...
  _$ET(e, t) {
    ...
    if (o !== void 0 && i.reflect === !0) {
      const s = (((r = i.converter) == null ? void 0 : r.toAttribute) !== void 0 ? i.converter : F).toAttribute(t, i.type);
  ...
  _$AK(e, t) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const c = i.getPropertyOptions(o), l = typeof c.converter == "function" ? { fromAttribute: c.converter } : ((r = c.converter) == null ? void 0 : r.fromAttribute) !== void 0 ? c.converter : F;
      this._$Em = o;
...
S.elementStyles = [], S.shadowRootOptions = { mode: "open" }, S[R("elementProperties")] = /* @__PURE__ */ new Map(), S[R("finalized")] = /* @__PURE__ */ new Map(), L == null || L({ ReactiveElement: S }), (v.reactiveElementVersions ?? (v.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const O = globalThis, Y = O.trustedTypes, de = Y ? Y.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, ze = "$lit$", A = `lit$${Math.random().toFixed(9).slice(2)}$`, ke = "?" + A, De = `<${ke}>`, q = document, V = () => q.createComment(""), K = (n) => n === null || typeof n != "object" && typeof n != "function", ie = Array.isArray, Te = (n) => ie(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", j = `[ 	
\f\r]`, H = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, fe = /-->/g, he = />/g, I = RegExp(`>|${j}(?:([^\\s"'>=/]+)(${j}*=${j}*(?:[^ 	
...
const Qe = (n, e) => {
  ...
  for (let c = 0; c < t; c++) {
    const l = n[c];
    let d, h, b = -1, p = 0;
    for (; p < l.length && (s.lastIndex = p, h = s.exec(l), h !== null); ) p = s.lastIndex, s === H ? h[1] === "!--" ? s = fe : h[1] !== void 0 ? s = he : h[2] !== void 0 ? (qe.test(h[2]) && (o = RegExp("</" + h[2], "g")), s = I) : h[3] !== void 0 && (s = I) : s === I ? h[0] === ">" ? (s = o ?? H, b = -1) : h[1] === void 0 ? b = -2 : (b = s.lastIndex - h[2].length, d = h[1], s = h[3] === void 0 ? I : h[3] === '"' ? ge : we) : s === ge || s === we ? s = I : s === fe || s === he ? s = H : (s = I, o = void 0);
    const y = s === I && n[c + 1].startsWith("/>") ? " " : "";
    r += s === H ? l + De : b >= 0 ? (i.push(d), l.slice(0, b) + ze + l.slice(b) + A + y) : l + A + (b === -2 ? c : y);
  }
...
class P {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let r = 0, s = 0;
    const c = e.length - 1, l = this.parts, [d, h] = Qe(e, t);
    if (this.el = P.createElement(d, i), z.currentNode = this.el.content, t === 2 || t === 3) {
      const b = this.el.content.firstChild;
      b.replaceWith(...b.childNodes);
    }
    for (; (o = z.nextNode()) !== null && l.length < c; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const b of o.getAttributeNames()) if (b.endsWith(ze)) {
          const p = h[s++], y = o.getAttribute(b).split(A), U = /([.?@])?(.*)/.exec(p);
          l.push({ type: 1, index: r, name: U[2], strings: y, ctor: U[1] === "." ? Ye : U[1] === "?" ? We : U[1] === "@" ? Ne : N }), o.removeAttribute(b);
        } else b.startsWith(A) && (l.push({ type: 6, index: r }), o.removeAttribute(b));
        if (qe.test(o.tagName)) {
          const b = o.textContent.split(A), p = b.length - 1;
          if (p > 0) {
            o.textContent = Y ? Y.emptyScript : "";
            for (let y = 0; y < p; y++) o.append(b[y], V()), z.nextNode(), l.push({ type: 2, index: ++r });
            o.append(b[p], V());
          }
        }
        ...
        let b = -1;
        for (; (b = o.data.indexOf(A, b + 1)) !== -1; ) l.push({ type: 7, index: r }), b += A.length - 1;
      }
      r++;
    }
  }
...
function J(n, e, t = n, i) {
  ...
  return (o == null ? void 0 : o.constructor) !== r && ((c = o == null ? void 0 : o._$AO) == null || c.call(o, !1), r === void 0 ? o = void 0 : (o = new r(n), o._$AT(n, t, i)), i !== void 0 ? (t._$Co ?? (t._$Co = []))[i] = o : t._$Cl = o), o !== void 0 && (e = J(n, o._$AS(n, e.values), o, i)), e;
}
class Fe {
  constructor(e, t) {
  ...
  u(e) {
    ...
    z.currentNode = o;
    let r = z.nextNode(), s = 0, c = 0, l = i[0];
    for (; l !== void 0; ) {
      if (s === l.index) {
        let d;
        l.type === 2 ? d = new D(r, r.nextSibling, this, e) : l.type === 1 ? d = new l.ctor(r, l.name, l.strings, this, e) : l.type === 6 && (d = new Ze(r, this, e)), this._$AV.push(d), l = i[++c];
      }
...
class D {
  ...
  constructor(e, t, i, o) {
    this.type = 2, this._$AH = a, this._$AN = void 0, this._$AA = e, this._$AB = t, this._$AM = i, this.options = o, this._$Cv = (o == null ? void 0 : o.isConnected) ?? !0;
  }
  get parentNode() {
  ...
  _$AI(e, t = this) {
    e = J(this, e, t), K(e) ? e === a || e == null || e === "" ? (this._$AH !== a && this._$AR(), this._$AH = a) : e !== this._$AH && e !== B && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Te(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== a && K(this._$AH) ? this._$AA.nextSibling.data = e : this.T(q.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var r;
    const { values: t, _$litType$: i } = e, o = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = P.createElement(Se(i.h, i.h[0]), this.options)), i);
    if (((r = this._$AH) == null ? void 0 : r._$AD) === o) this._$AH.p(t);
    else {
      const s = new Fe(o, this), c = s.u(this.options);
...
class N {
  ...
  constructor(e, t, i, o, r) {
    this.type = 1, this._$AH = a, this._$AN = void 0, this.element = e, this.name = t, this._$AM = o, this.options = r, i.length > 2 || i[0] !== "" || i[1] !== "" ? (this._$AH = Array(i.length - 1).fill(new String()), this.strings = i) : this._$AH = a;
  }
  _$AI(e, t = this, i, o) {
    ...
    if (r === void 0) e = J(this, e, t, 0), s = !K(e) || e !== this._$AH && e !== B, s && (this._$AH = e);
      ...
      const c = e;
      let l, d;
      for (e = r[0], l = 0; l < r.length - 1; l++) d = J(this, c[i + l], t, l), d === B && (d = this._$AH[l]), s || (s = !K(d) || d !== this._$AH[l]), d === a ? e = a : e !== a && (e += (d ?? "") + r[l + 1]), this._$AH[l] = d;
    }
    s && !o && this.j(e);
  }
  j(e) {
...
class Ne extends N {
  ...
  _$AI(e, t = this) {
    if ((e = J(this, e, t, 0) ?? a) === B) return;
    const i = this._$AH, o = e === a && i !== a || e.capture !== i.capture || e.once !== i.once || e.passive !== i.passive, r = e !== a && (i === a || o);
...
var Ee;
x._$litElement$ = !0, x.finalized = !0, (Ee = k.litElementHydrateSupport) == null || Ee.call(k, { LitElement: x });
const _ = k.litElementPolyfillSupport;
_ == null || _({ LitElement: x });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const je = { attribute: !0, type: String, converter: F, reflect: !1, hasChanged: te }, Xe = (n = je, e, t) => {
...
function m(n) {
  return (e, t) => typeof t == "object" ? Xe(n, e, t) : ((i, o, r) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const _e = (n, e, t) => (t.configurable = !0, t.enumerable = !0, Reflect.decorate && typeof e != "object" && Object.defineProperty(n, e, t), t);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
var G = /* @__PURE__ */ ((n) => (n.Regular = "regular", n.Medium = "medium", n.Large = "large", n))(G || {});
function ue(n) {
...
@font-face {
  font-family: '${ct}';
  src: url('data:font/woff2;base64,${lt}') format('woff2');
  font-weight: normal;
  font-style: normal;
  font-display: block;
}
`, document.head.appendChild(n), ye = !0;
}
var bt = Object.defineProperty, T = (n, e, t, i) => {
  for (var o = void 0, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (o = s(e, t, o) || o);
  return o && bt(e, t, o), o;
};
const Ae = "swim-icon", ne = class ne extends x {
  constructor() {
    super(...arguments), this.fontIcon = "", this.alt = "", this.fontSet = "lit", this.iconClass = "", this._cssClasses = [], this._iconClassTokensOnHost = [];
  }
  connectedCallback() {
    super.connectedCallback(), at(), this._updateFontIcon();
  }
  updated(e) {
  ...
  render() {
    ...
    return !e || e.length === 0 ? w`
      ...
      >
        ${e.map(
      (s, c) => w`<i part="icon icon-${c}" class="swim-icon__i swim-icon__i--${c} ${s}${o}"></i>`
    )}
      </span>
    `;
  }
...
var mt = Object.defineProperty, dt = Object.getOwnPropertyDescriptor, g = (n, e, t, i) => {
  for (var o = i > 1 ? void 0 : i ? dt(e, t) : e, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (o = (i ? s(e, t, o) : s(o)) || o);
  return i && o && mt(e, t, o), o;
};
const ve = "swim-dialog", re = class re extends x {
  constructor() {
  ...
  render() {
    ...
    const e = this.format === G.Regular || this.format === "regular", t = this.format === G.Large || this.format === "large", i = this.format === G.Medium || this.format === "medium", o = [
      "swim-dialog__content",
      this.cssClass,
    ...
    return w`
      <div class="${s}" style="--swim-dialog-z: ${this.zIndex}" role="presentation">
        ${this.showBackdrop ? w`<div class="swim-dialog__backdrop" aria-hidden="true"></div>` : a}
        <div
          part="content"
          class="${o}"
          ...
          role="dialog"
          aria-modal="true"
          aria-labelledby="${this.dialogTitle ? this._titleId : a}"
          id="${this._contentId}"
        >
          ${e ? w`
                ${this.closeButton ? w`
                ...
                <div class="swim-dialog__body swim-scroll">
                  <slot></slot>
                  ${this.content ? w`<div>${this.content}</div>` : a}
                </div>
              ` : w`
                <div class="swim-dialog__body swim-scroll">
                  <slot></slot>
...
var ht = Object.defineProperty, M = (n, e, t, i) => {
  for (var o = void 0, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (o = s(e, t, o) || o);
  return o && ht(e, t, o), o;
};
const xe = "swim-large-format-dialog-content", se = class se extends x {
  constructor() {
      ...
      <main class="format-dialog-container">
        <header class="format-dialog-container__header">
          <div class="format-dialog-container__header-title ${e}">
            ...
            ${this.dialogSubtitle ? w`<h4>${this.dialogSubtitle}</h4>` : a}
          </div>
...
var gt = Object.defineProperty, pt = (n, e, t, i) => {
  for (var o = void 0, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (o = s(e, t, o) || o);
  return o && gt(e, t, o), o;
};
const Ce = "swim-large-format-dialog-footer", le = class le extends x {
  constructor() {
