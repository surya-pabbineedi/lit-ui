...
const Ie = (n) => new Ee(typeof n == "string" ? n : n + "", void 0, ee), E = (n, ...e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Me, defineProperty: He, getOwnPropertyDescriptor: Ge, getOwnPropertyNames: Re, getOwnPropertySymbols: Oe, getPrototypeOf: Ve } = Object, v = globalThis, be = v.trustedTypes, Ke = be ? be.emptyScript : "", j = v.reactiveElementPolyfillSupport, R = (n, e) => n, F = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? Ke : null;
      break;
...
let S = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(R("properties"))) {
      const t = this.properties, i = [...Re(t), ...Oe(t)];
...
S.elementStyles = [], S.shadowRootOptions = { mode: "open" }, S[R("elementProperties")] = /* @__PURE__ */ new Map(), S[R("finalized")] = /* @__PURE__ */ new Map(), j == null || j({ ReactiveElement: S }), (v.reactiveElementVersions ?? (v.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
const Te = (n, e) => {
  ...
  for (let c = 0; c < t; c++) {
    ...
    r += s === H ? l + Pe : b >= 0 ? (i.push(d), l.slice(0, b) + ze + l.slice(b) + A + y) : l + A + (b === -2 ? c : y);
  }
    ...
    for (; (o = z.nextNode()) !== null && l.length < c; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const b of o.getAttributeNames()) if (b.endsWith(ze)) {
          const p = h[s++], y = o.getAttribute(b).split(A), T = /([.?@])?(.*)/.exec(p);
          l.push({ type: 1, index: r, name: T[2], strings: y, ctor: T[1] === "." ? Fe : T[1] === "?" ? Ye : T[1] === "@" ? We : N }), o.removeAttribute(b);
...
var Ce;
x._$litElement$ = !0, x.finalized = !0, (Ce = k.litElementHydrateSupport) == null || Ce.call(k, { LitElement: x });
...
const ye = "swim-icon", ne = class ne extends x {
  constructor() {
...
const Ae = "swim-dialog", re = class re extends x {
  constructor() {
...
const ve = "swim-large-format-dialog-content", se = class se extends x {
  constructor() {
...
const xe = "swim-large-format-dialog-footer", le = class le extends x {
  constructor() {
