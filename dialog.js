 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Me, defineProperty: He, getOwnPropertyDescriptor: Ge, getOwnPropertyNames: Re, getOwnPropertySymbols: Ke, getPrototypeOf: Ve } = Object, x = globalThis, be = x.trustedTypes, Oe = be ? be.emptyScript : "", j = x.reactiveElementPolyfillSupport, R = (n, e) => n, F = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? Oe : null;
      break;
  ...
  return t;
} }, te = (n, e) => !Me(n, e), me = { attribute: !0, type: String, converter: F, reflect: !1, useDefault: !1, hasChanged: te };
...
let S = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(R("properties"))) {
      const t = this.properties, i = [...Re(t), ...Ke(t)];
...
S.elementStyles = [], S.shadowRootOptions = { mode: "open" }, S[R("elementProperties")] = /* @__PURE__ */ new Map(), S[R("finalized")] = /* @__PURE__ */ new Map(), j == null || j({ ReactiveElement: S }), (x.reactiveElementVersions ?? (x.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const K = globalThis, Y = K.trustedTypes, de = Y ? Y.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, Ie = "$lit$", v = `lit$${Math.random().toFixed(9).slice(2)}$`, ze = "?" + v, Pe = `<${ze}>`, q = document, V = () => q.createComment(""), O = (n) => n === null || typeof n != "object" && typeof n != "function", ie = Array.isArray, De = (n) => ie(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", L = `[ 	
\f\r]`, H = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, fe = /-->/g, he = />/g, I = RegExp(`>|${L}(?:([^\\s"'>=/]+)(${L}*=${L}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), we = /'/g, ge = /"/g, ke = /^(?:script|style|textarea|title)$/i, Ue = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), w = Ue(1), B = Symbol.for("lit-noChange"), a = Symbol.for("lit-nothing"), pe = /* @__PURE__ */ new WeakMap(), z = q.createTreeWalker(q, 129);
function qe(n, e) {
...
const Te = (n, e) => {
  ...
  for (let c = 0; c < t; c++) {
    const l = n[c];
    let d, h, b = -1, p = 0;
    for (; p < l.length && (s.lastIndex = p, h = s.exec(l), h !== null); ) p = s.lastIndex, s === H ? h[1] === "!--" ? s = fe : h[1] !== void 0 ? s = he : h[2] !== void 0 ? (ke.test(h[2]) && (o = RegExp("</" + h[2], "g")), s = I) : h[3] !== void 0 && (s = I) : s === I ? h[0] === ">" ? (s = o ?? H, b = -1) : h[1] === void 0 ? b = -2 : (b = s.lastIndex - h[2].length, d = h[1], s = h[3] === void 0 ? I : h[3] === '"' ? ge : we) : s === ge || s === we ? s = I : s === fe || s === he ? s = H : (s = I, o = void 0);
    const A = s === I && n[c + 1].startsWith("/>") ? " " : "";
    r += s === H ? l + Pe : b >= 0 ? (i.push(d), l.slice(0, b) + Ie + l.slice(b) + v + A) : l + v + (b === -2 ? c : A);
  }
  return [qe(n, r + (n[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), i];
};
class P {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let r = 0, s = 0;
    const c = e.length - 1, l = this.parts, [d, h] = Te(e, t);
    ...
    for (; (o = z.nextNode()) !== null && l.length < c; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const b of o.getAttributeNames()) if (b.endsWith(Ie)) {
          const p = h[s++], A = o.getAttribute(b).split(v), T = /([.?@])?(.*)/.exec(p);
          l.push({ type: 1, index: r, name: T[2], strings: A, ctor: T[1] === "." ? Fe : T[1] === "?" ? Ye : T[1] === "@" ? We : Z }), o.removeAttribute(b);
        } else b.startsWith(v) && (l.push({ type: 6, index: r }), o.removeAttribute(b));
        if (ke.test(o.tagName)) {
          const b = o.textContent.split(v), p = b.length - 1;
          if (p > 0) {
            o.textContent = Y ? Y.emptyScript : "";
            for (let A = 0; A < p; A++) o.append(b[A], V()), z.nextNode(), l.push({ type: 2, index: ++r });
            o.append(b[p], V());
          }
        }
      } else if (o.nodeType === 8) if (o.data === ze) l.push({ type: 2, index: r });
      else {
        let b = -1;
        for (; (b = o.data.indexOf(v, b + 1)) !== -1; ) l.push({ type: 7, index: r }), b += v.length - 1;
      }
      r++;
    }
  }
...
class D {
  ...
  _$AI(e, t = this) {
    e = J(this, e, t), O(e) ? e === a || e == null || e === "" ? (this._$AH !== a && this._$AR(), this._$AH = a) : e !== this._$AH && e !== B && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : De(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== a && O(this._$AH) ? this._$AA.nextSibling.data = e : this.T(q.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var r;
    const { values: t, _$litType$: i } = e, o = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = P.createElement(qe(i.h, i.h[0]), this.options)), i);
    if (((r = this._$AH) == null ? void 0 : r._$AD) === o) this._$AH.p(t);
    else {
      const s = new Qe(o, this), c = s.u(this.options);
...
class Z {
  ...
  _$AI(e, t = this, i, o) {
    ...
    let s = !1;
    if (r === void 0) e = J(this, e, t, 0), s = !O(e) || e !== this._$AH && e !== B, s && (this._$AH = e);
    else {
      const c = e;
      let l, d;
      for (e = r[0], l = 0; l < r.length - 1; l++) d = J(this, c[i + l], t, l), d === B && (d = this._$AH[l]), s || (s = !O(d) || d !== this._$AH[l]), d === a ? e = a : e !== a && (e += (d ?? "") + r[l + 1]), this._$AH[l] = d;
    }
    s && !o && this.j(e);
  }
  j(e) {
...
X == null || X(P, D), (K.litHtmlVersions ?? (K.litHtmlVersions = [])).push("3.3.1");
const Ne = (n, e, t) => {
...
var Ce;
C._$litElement$ = !0, C.finalized = !0, (Ce = k.litElementHydrateSupport) == null || Ce.call(k, { LitElement: C });
const _ = k.litElementPolyfillSupport;
_ == null || _({ LitElement: C });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const je = { attribute: !0, type: String, converter: F, reflect: !1, hasChanged: te }, Le = (n = je, e, t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Xe = (n, e, t) => (t.configurable = !0, t.enumerable = !0, Reflect.decorate && typeof e != "object" && Object.defineProperty(n, e, t), t);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
const ye = "swim-icon", ne = class ne extends C {
  constructor() {
...
customElements.get(ye) || customElements.define(ye, E);
var ct = Object.defineProperty, at = Object.getOwnPropertyDescriptor, g = (n, e, t, i) => {
  for (var o = i > 1 ? void 0 : i ? at(e, t) : e, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (o = (i ? s(e, t, o) : s(o)) || o);
  return i && o && ct(e, t, o), o;
};
const Ae = "swim-dialog", re = class re extends C {
  constructor() {
  ...
  render() {
    ...
    return w`
      <div class="${s}" style="--swim-dialog-z: ${this.zIndex}" role="presentation">
        ${this.showBackdrop ? w`<div class="swim-dialog__backdrop" aria-hidden="true" @click="${this._onBackdropClick}"></div>` : a}
        <div
          part="content"
          class="${o}"
...
g([
  _e(".swim-dialog__content")
], f.prototype, "_contentEl", 2);
customElements.get(Ae) || customElements.define(Ae, f);
const bt = [
  N,
  y`
    :host {
...
var mt = Object.defineProperty, M = (n, e, t, i) => {
  for (var o = void 0, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (o = s(e, t, o) || o);
  return o && mt(e, t, o), o;
};
const ve = "swim-large-format-dialog-content", se = class se extends C {
  constructor() {
...
var ft = Object.defineProperty, ht = (n, e, t, i) => {
  for (var o = void 0, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (o = s(e, t, o) || o);
  return o && ft(e, t, o), o;
};
const xe = "swim-large-format-dialog-footer", le = class le extends C {
  constructor() {
...
customElements.get(xe) || customElements.define(xe, W);
export {
  G as DialogFormat,
  f as SwimDialog,
