 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const I = globalThis, G = I.trustedTypes, de = G ? G.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, ke = "$lit$", y = `lit$${Math.random().toFixed(9).slice(2)}$`, Ee = "?" + y, Be = `<${Ee}>`, C = document, N = () => C.createComment(""), H = (n) => n === null || typeof n != "object" && typeof n != "function", ie = Array.isArray, je = (n) => ie(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", Z = `[ 	
\f\r]`, M = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, fe = /-->/g, he = />/g, k = RegExp(`>|${Z}(?:([^\\s"'>=/]+)(${Z}*=${Z}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), we = /'/g, ue = /"/g, Se = /^(?:script|style|textarea|title)$/i, Le = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), w = Le(1), T = Symbol.for("lit-noChange"), c = Symbol.for("lit-nothing"), ge = /* @__PURE__ */ new WeakMap(), E = C.createTreeWalker(C, 129);
function Ce(n, e) {
...
const De = (n, e) => {
  ...
  for (let a = 0; a < t; a++) {
    ...
    r += s === M ? l + Be : b >= 0 ? (i.push(d), l.slice(0, b) + ke + l.slice(b) + y + _) : l + y + (b === -2 ? a : _);
  }
      ...
      if (o.nodeType === 1) {
        ...
        if (Se.test(o.tagName)) {
          ...
          if (g > 0) {
            ...
            for (let _ = 0; _ < g; _++) o.append(b[_], N()), E.nextNode(), l.push({ type: 2, index: ++r });
            o.append(b[g], N());
          }
        }
...
class Fe {
  ...
  u(e) {
    ...
    E.currentNode = o;
    let r = E.nextNode(), s = 0, a = 0, l = i[0];
    for (; l !== void 0; ) {
      if (s === l.index) {
        let d;
        l.type === 2 ? d = new j(r, r.nextSibling, this, e) : l.type === 1 ? d = new l.ctor(r, l.name, l.strings, this, e) : l.type === 6 && (d = new Ve(r, this, e)), this._$AV.push(d), l = i[++a];
      }
      s !== (l == null ? void 0 : l.index) && (r = E.nextNode(), s++);
    }
...
class j {
  ...
  _$AI(e, t = this) {
    e = O(this, e, t), H(e) ? e === c || e == null || e === "" ? (this._$AH !== c && this._$AR(), this._$AH = c) : e !== this._$AH && e !== T && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : je(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== c && H(this._$AH) ? this._$AA.nextSibling.data = e : this.T(C.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var r;
    const { values: t, _$litType$: i } = e, o = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = B.createElement(Ce(i.h, i.h[0]), this.options)), i);
  ...
  k(e) {
    ...
    const t = this._$AH;
    let i, o = 0;
    for (const r of e) o === t.length ? t.push(i = new j(this.O(N()), this.O(N()), this, this.options)) : i = t[o], i._$AI(r), o++;
...
Q == null || Q(B, j), (I.litHtmlVersions ?? (I.litHtmlVersions = [])).push("3.3.1");
const Ke = (n, e, t) => {
  const i = (t == null ? void 0 : t.renderBefore) ?? e;
  let o = i._$litPart$;
  if (o === void 0) {
    const r = (t == null ? void 0 : t.renderBefore) ?? null;
    i._$litPart$ = o = new j(e.insertBefore(N(), r), r, void 0, t ?? {});
  }
  return o._$AI(n), o;
};
/**
