 ...
 */
const Q = globalThis, $ = Q.ShadowRoot && (Q.ShadyCSS === void 0 || Q.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ee = Symbol(), ae = /* @__PURE__ */ new WeakMap();
let Ie = class {
  constructor(e, n, t) {
  ...
  get styleSheet() {
    ...
    if ($ && e === void 0) {
      ...
      t && (e = ae.get(n)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), t && ae.set(n, e));
    }
    return e;
  }
  toString() {
...
const Je = (i) => new Ie(typeof i == "string" ? i : i + "", void 0, ee), E = (i, ...e) => {
  const n = i.length === 1 ? i[0] : e.reduce((t, o, r) => t + ((s) => {
    if (s._$cssResult$ === !0) return s.cssText;
    if (typeof s == "number") return s;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + s + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(o) + i[r + 1], i[0]);
  return new Ie(n, i, ee);
}, Me = (i, e) => {
  if ($) i.adoptedStyleSheets = e.map((n) => n instanceof CSSStyleSheet ? n : n.styleSheet);
  else for (const n of e) {
    const t = document.createElement("style"), o = Q.litNonce;
    o !== void 0 && t.setAttribute("nonce", o), t.textContent = n.cssText, i.appendChild(t);
  }
}, le = $ ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((e) => {
  let n = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: He, defineProperty: Ge, getOwnPropertyDescriptor: Re, getOwnPropertyNames: Oe, getOwnPropertySymbols: Ve, getPrototypeOf: Ke } = Object, A = globalThis, ge = A.trustedTypes, Pe = ge ? ge.emptyScript : "", L = A.reactiveElementPolyfillSupport, R = (i, e) => i, F = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Pe : null;
      break;
  ...
  return n;
} }, ne = (i, e) => !He(i, e), be = { attribute: !0, type: String, converter: F, reflect: !1, useDefault: !1, hasChanged: ne };
...
let S = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, n, t) {
    ...
    return { get: o, set(s) {
      ...
      r == null || r.call(this, s), this.requestUpdate(e, a, t);
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(R("properties"))) {
      const n = this.properties, t = [...Oe(n), ...Ve(n)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const o of t) n.unshift(le(o));
    } else e !== void 0 && n.push(le(e));
    return n;
  }
  static _$Eu(e, n) {
    const t = n.attribute;
  ...
  _$ET(e, n) {
    ...
    if (o !== void 0 && t.reflect === !0) {
      const s = (((r = t.converter) == null ? void 0 : r.toAttribute) !== void 0 ? t.converter : F).toAttribute(n, t.type);
  ...
  _$AK(e, n) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const a = t.getPropertyOptions(o), c = typeof a.converter == "function" ? { fromAttribute: a.converter } : ((r = a.converter) == null ? void 0 : r.fromAttribute) !== void 0 ? a.converter : F;
      this._$Em = o;
  ...
  requestUpdate(e, n, t) {
    ...
    if (e !== void 0) {
      ...
      if (t ?? (t = r.getPropertyOptions(e)), !((t.hasChanged ?? ne)(s, n) || t.useDefault && t.reflect && s === ((o = this._$Ej) == null ? void 0 : o.get(e)) && !this.hasAttribute(r._$Eu(e, t)))) return;
      this.C(e, n, t);
    }
    this.isUpdatePending === !1 && (this._$ES = this._$EP());
  }
  C(e, n, { useDefault: t, reflect: o, wrapped: r }, s) {
    t && !(this._$Ej ?? (this._$Ej = /* @__PURE__ */ new Map())).has(e) && (this._$Ej.set(e, s ?? n ?? this[e]), r !== !0 || s !== void 0) || (this._$AL.has(e) || (this.hasUpdated || t || (n = void 0), this._$AL.set(e, n)), o === !0 && this._$Em !== e && (this._$Eq ?? (this._$Eq = /* @__PURE__ */ new Set())).add(e));
  }
  async _$EP() {
...
S.elementStyles = [], S.shadowRootOptions = { mode: "open" }, S[R("elementProperties")] = /* @__PURE__ */ new Map(), S[R("finalized")] = /* @__PURE__ */ new Map(), L == null || L({ ReactiveElement: S }), (A.reactiveElementVersions ?? (A.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const O = globalThis, Y = O.trustedTypes, de = Y ? Y.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, ze = "$lit$", y = `lit$${Math.random().toFixed(9).slice(2)}$`, ke = "?" + y, De = `<${ke}>`, q = document, V = () => q.createComment(""), K = (i) => i === null || typeof i != "object" && typeof i != "function", te = Array.isArray, Ue = (i) => te(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", j = `[ 	
\f\r]`, H = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, xe = /-->/g, fe = />/g, I = RegExp(`>|${j}(?:([^\\s"'>=/]+)(${j}*=${j}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), he = /'/g, pe = /"/g, qe = /^(?:script|style|textarea|title)$/i, Te = (i) => (e, ...n) => ({ _$litType$: i, strings: e, values: n }), h = Te(1), B = Symbol.for("lit-noChange"), l = Symbol.for("lit-nothing"), ue = /* @__PURE__ */ new WeakMap(), z = q.createTreeWalker(q, 129);
function Se(i, e) {
...
const Qe = (i, e) => {
  ...
  let o, r = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", s = H;
  for (let a = 0; a < n; a++) {
    const c = i[a];
    let d, f, g = -1, u = 0;
    for (; u < c.length && (s.lastIndex = u, f = s.exec(c), f !== null); ) u = s.lastIndex, s === H ? f[1] === "!--" ? s = xe : f[1] !== void 0 ? s = fe : f[2] !== void 0 ? (qe.test(f[2]) && (o = RegExp("</" + f[2], "g")), s = I) : f[3] !== void 0 && (s = I) : s === I ? f[0] === ">" ? (s = o ?? H, g = -1) : f[1] === void 0 ? g = -2 : (g = s.lastIndex - f[2].length, d = f[1], s = f[3] === void 0 ? I : f[3] === '"' ? pe : he) : s === pe || s === he ? s = I : s === xe || s === fe ? s = H : (s = I, o = void 0);
    const w = s === I && i[a + 1].startsWith("/>") ? " " : "";
    r += s === H ? c + De : g >= 0 ? (t.push(d), c.slice(0, g) + ze + c.slice(g) + y + w) : c + y + (g === -2 ? a : w);
  }
  return [Se(i, r + (i[n] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), t];
};
class P {
  constructor({ strings: e, _$litType$: n }, t) {
    ...
    this.parts = [];
    let r = 0, s = 0;
    const a = e.length - 1, c = this.parts, [d, f] = Qe(e, n);
    if (this.el = P.createElement(d, t), z.currentNode = this.el.content, n === 2 || n === 3) {
      const g = this.el.content.firstChild;
      g.replaceWith(...g.childNodes);
    }
    for (; (o = z.nextNode()) !== null && c.length < a; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const g of o.getAttributeNames()) if (g.endsWith(ze)) {
          const u = f[s++], w = o.getAttribute(g).split(y), T = /([.?@])?(.*)/.exec(u);
          c.push({ type: 1, index: r, name: T[2], strings: w, ctor: T[1] === "." ? Ye : T[1] === "?" ? We : T[1] === "@" ? Ne : N }), o.removeAttribute(g);
        } else g.startsWith(y) && (c.push({ type: 6, index: r }), o.removeAttribute(g));
        if (qe.test(o.tagName)) {
          const g = o.textContent.split(y), u = g.length - 1;
          if (u > 0) {
            o.textContent = Y ? Y.emptyScript : "";
            for (let w = 0; w < u; w++) o.append(g[w], V()), z.nextNode(), c.push({ type: 2, index: ++r });
            o.append(g[u], V());
          }
        }
        ...
        let g = -1;
        for (; (g = o.data.indexOf(y, g + 1)) !== -1; ) c.push({ type: 7, index: r }), g += y.length - 1;
      }
      r++;
    }
  }
  static createElement(e, n) {
    const t = q.createElement("template");
    return t.innerHTML = e, t;
  }
}
function J(i, e, n = i, t) {
  var s, a;
  if (e === B) return e;
  let o = t !== void 0 ? (s = n._$Co) == null ? void 0 : s[t] : n._$Cl;
  const r = K(e) ? void 0 : e._$litDirective$;
  return (o == null ? void 0 : o.constructor) !== r && ((a = o == null ? void 0 : o._$AO) == null || a.call(o, !1), r === void 0 ? o = void 0 : (o = new r(i), o._$AT(i, n, t)), t !== void 0 ? (n._$Co ?? (n._$Co = []))[t] = o : n._$Cl = o), o !== void 0 && (e = J(i, o._$AS(i, e.values), o, t)), e;
}
class Fe {
  constructor(e, n) {
  ...
  u(e) {
    const { el: { content: n }, parts: t } = this._$AD, o = ((e == null ? void 0 : e.creationScope) ?? q).importNode(n, !0);
    z.currentNode = o;
    let r = z.nextNode(), s = 0, a = 0, c = t[0];
    for (; c !== void 0; ) {
      if (s === c.index) {
        let d;
        c.type === 2 ? d = new D(r, r.nextSibling, this, e) : c.type === 1 ? d = new c.ctor(r, c.name, c.strings, this, e) : c.type === 6 && (d = new Ze(r, this, e)), this._$AV.push(d), c = t[++a];
      }
...
class D {
  ...
  _$AI(e, n = this) {
    e = J(this, e, n), K(e) ? e === l || e == null || e === "" ? (this._$AH !== l && this._$AR(), this._$AH = l) : e !== this._$AH && e !== B && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Ue(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== l && K(this._$AH) ? this._$AA.nextSibling.data = e : this.T(q.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var r;
    const { values: n, _$litType$: t } = e, o = typeof t == "number" ? this._$AC(e) : (t.el === void 0 && (t.el = P.createElement(Se(t.h, t.h[0]), this.options)), t);
  ...
  _$AC(e) {
    let n = ue.get(e.strings);
    return n === void 0 && ue.set(e.strings, n = new P(e)), n;
  }
  k(e) {
    te(this._$AH) || (this._$AH = [], this._$AR());
    const n = this._$AH;
    let t, o = 0;
    for (const r of e) o === n.length ? n.push(t = new D(this.O(V()), this.O(V()), this, this.options)) : t = n[o], t._$AI(r), o++;
...
class N {
  ...
  _$AI(e, n = this, t, o) {
    ...
    let s = !1;
    if (r === void 0) e = J(this, e, n, 0), s = !K(e) || e !== this._$AH && e !== B, s && (this._$AH = e);
    else {
      const a = e;
      let c, d;
      for (e = r[0], c = 0; c < r.length - 1; c++) d = J(this, a[t + c], n, c), d === B && (d = this._$AH[c]), s || (s = !K(d) || d !== this._$AH[c]), d === l ? e = l : e !== l && (e += (d ?? "") + r[c + 1]), this._$AH[c] = d;
    }
    s && !o && this.j(e);
  }
  j(e) {
...
const Le = (i, e, n) => {
  ...
  if (o === void 0) {
    ...
    t._$litPart$ = o = new D(e.insertBefore(V(), r), r, void 0, n ?? {});
  }
  return o._$AI(i), o;
};
/**
...
class v extends S {
  ...
  update(e) {
    const n = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = Le(n, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var e;
...
var Ee;
v._$litElement$ = !0, v.finalized = !0, (Ee = k.litElementHydrateSupport) == null || Ee.call(k, { LitElement: v });
const _ = k.litElementPolyfillSupport;
_ == null || _({ LitElement: v });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const je = { attribute: !0, type: String, converter: F, reflect: !1, hasChanged: ne }, Xe = (i = je, e, n) => {
...
function b(i) {
  return (e, n) => typeof n == "object" ? Xe(i, e, n) : ((t, o, r) => {
    const s = o.hasOwnProperty(r);
    return o.constructor.createProperty(r, t), s ? Object.getOwnPropertyDescriptor(o, r) : void 0;
  })(i, e, n);
}
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const _e = (i, e, n) => (n.configurable = !0, n.enumerable = !0, Reflect.decorate && typeof e != "object" && Object.defineProperty(i, e, n), n);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
var G = /* @__PURE__ */ ((i) => (i.Regular = "regular", i.Medium = "medium", i.Large = "large", i))(G || {});
function me(i) {
  return i != null && `${i}` != "false";
}
function nn(i, e = null) {
...
`, on = E`
  ...
  ${tn}
`, rn = (i) => `ngx-icon ${i.trim().split(" ").map((n) => {
  const [t, o] = n.split(":");
...
@font-face {
  font-family: '${ln}';
  src: url('data:font/woff2;base64,${an}') format('woff2');
  font-weight: normal;
  font-style: normal;
  font-display: block;
}
`, document.head.appendChild(i), we = !0;
}
var bn = Object.defineProperty, U = (i, e, n, t) => {
  for (var o = void 0, r = i.length - 1, s; r >= 0; r--)
    (s = i[r]) && (o = s(e, n, o) || o);
  return o && bn(e, n, o), o;
};
const ye = "swim-icon", ie = class ie extends v {
  constructor() {
    super(...arguments), this.fontIcon = "", this.alt = "", this.fontSet = "ngx", this.iconClass = "", this._cssClasses = [], this._iconClassTokensOnHost = [];
  }
  connectedCallback() {
    super.connectedCallback(), gn(), this._updateFontIcon();
  }
  updated(e) {
  ...
  _updateFontIcon() {
    ...
    this._cssClasses = cn.get(e, this.fontSet);
  }
  render() {
    var r;
    ...
    return !e || e.length === 0 ? h`
      ...
      >
        ${e.map(
      (s, a) => h`<i part="icon icon-${a}" class="swim-icon__i swim-icon__i--${a} ${s}${o}"></i>`
    )}
      </span>
    `;
  }
...
let C = ie;
U([
  b({ type: String, attribute: "font-icon" })
], C.prototype, "fontIcon");
U([
  b({ type: String })
], C.prototype, "alt");
U([
  b({ type: String, attribute: "font-set" })
], C.prototype, "fontSet");
U([
  b({ type: String, attribute: "icon-class" })
], C.prototype, "iconClass");
U([
  oe()
], C.prototype, "_cssClasses");
customElements.get(ye) || customElements.define(ye, C);
var dn = Object.defineProperty, xn = Object.getOwnPropertyDescriptor, p = (i, e, n, t) => {
  for (var o = t > 1 ? void 0 : t ? xn(e, n) : e, r = i.length - 1, s; r >= 0; r--)
    (s = i[r]) && (o = (t ? s(e, n, o) : s(o)) || o);
  return t && o && dn(e, n, o), o;
};
const Ae = "swim-dialog", re = class re extends v {
  constructor() {
  ...
  set visible(e) {
    const n = me(e);
    this._visible !== n && (this._visible = n, n ? (this._previousActiveElement = typeof document < "u" ? document.activeElement : null, this.dispatchEvent(new CustomEvent("open", { bubbles: !0 }))) : (this._restoreFocus(), this.dispatchEvent(new CustomEvent("close", { detail: void 0, bubbles: !0 }))));
  }
  get zIndex() {
    return this._zIndex;
  }
  set zIndex(e) {
    this._zIndex = nn(e, 991);
  }
  get _contentzIndex() {
  ...
  updated(e) {
    e.has("visible") && this.visible && this._contentEl && requestAnimationFrame(() => {
      var n;
      (n = this._contentEl) == null || n.focus({ preventScroll: !0 });
    });
  }
  render() {
    if (!this.visible) return l;
    const e = this.format === G.Regular || this.format === "regular", n = this.format === G.Large || this.format === "large", t = this.format === G.Medium || this.format === "medium", o = [
      "swim-dialog__content",
      this.cssClass,
      n ? "swim-dialog__content--large" : "",
      t ? "swim-dialog__content--medium" : ""
    ...
    return h`
      <div class="${s}" style="--swim-dialog-z: ${this.zIndex}" role="presentation">
        ${this.showBackdrop ? h`<div class="swim-dialog__backdrop" aria-hidden="true"></div>` : l}
        <div
          part="content"
          class="${o}"
          ...
          role="dialog"
          aria-modal="true"
          aria-labelledby="${this.dialogTitle ? this._titleId : l}"
          id="${this._contentId}"
        >
          ${e ? h`
                ${this.closeButton ? h`
                ...
                <div class="swim-dialog__body swim-scroll">
                  <slot></slot>
                  ${this.content ? h`<div>${this.content}</div>` : l}
                </div>
              ` : h`
                <div class="swim-dialog__body swim-scroll">
                  <slot></slot>
...
let x = re;
p([
  b({ type: String, attribute: "dialog-title" })
], x.prototype, "dialogTitle", 2);
p([
  b({ type: String })
], x.prototype, "title", 1);
p([
...
p([
  b({ type: String, attribute: "css-class" })
], x.prototype, "cssClass", 2);
p([
...
], x.prototype, "showBackdrop", 2);
p([
  b({ type: Boolean, attribute: "close-button" })
], x.prototype, "closeButton", 1);
p([
  b({ type: Boolean, reflect: !0 })
], x.prototype, "visible", 1);
p([
  b({ type: Number })
], x.prototype, "zIndex", 1);
p([
  b({ attribute: !1 })
], x.prototype, "beforeClose", 2);
p([
  oe()
], x.prototype, "_contentId", 2);
p([
  oe()
], x.prototype, "_titleId", 2);
p([
  $e(".swim-dialog__content")
], x.prototype, "_contentEl", 2);
customElements.get(Ae) || customElements.define(Ae, x);
const fn = [
  Z,
  E`
    :host {
...
var hn = Object.defineProperty, M = (i, e, n, t) => {
  for (var o = void 0, r = i.length - 1, s; r >= 0; r--)
    (s = i[r]) && (o = s(e, n, o) || o);
  return o && hn(e, n, o), o;
};
const ve = "swim-large-format-dialog-content", se = class se extends v {
  constructor() {
      ...
      <main class="format-dialog-container">
        <header class="format-dialog-container__header">
          <div class="format-dialog-container__header-title ${e}">
            ...
            ${this.dialogSubtitle ? h`<h4>${this.dialogSubtitle}</h4>` : l}
          </div>
...
M([
  b({ type: String, attribute: "dialog-title" })
], m.prototype, "dialogTitle");
M([
  b({ type: String, attribute: "dialog-subtitle" })
], m.prototype, "dialogSubtitle");
M([
  b({ type: String, attribute: "dialog-action-title" })
], m.prototype, "dialogActionTitle");
M([
  b({ type: String, attribute: "dialog-dirty-action-title" })
], m.prototype, "dialogDirtyActionTitle");
M([
  b({ type: Boolean, reflect: !0 })
], m.prototype, "dirty");
...
var un = Object.defineProperty, mn = (i, e, n, t) => {
  for (var o = void 0, r = i.length - 1, s; r >= 0; r--)
    (s = i[r]) && (o = s(e, n, o) || o);
  return o && un(e, n, o), o;
};
const Ce = "swim-large-format-dialog-footer", ce = class ce extends v {
  constructor() {
    super(...arguments), this.format = "large";
  }
  render() {
    return h` <div class="format-dialog-footer"><slot></slot></div> `;
  }
};
ce.styles = pn;
let W = ce;
...
customElements.get(Ce) || customElements.define(Ce, W);
export {
  G as DialogFormat,
  x as SwimDialog,
  m as SwimLargeFormatDialogContent,
