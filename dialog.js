 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: He, defineProperty: Ge, getOwnPropertyDescriptor: Re, getOwnPropertyNames: Oe, getOwnPropertySymbols: Ve, getPrototypeOf: Ke } = Object, A = globalThis, be = A.trustedTypes, Pe = be ? be.emptyScript : "", L = A.reactiveElementPolyfillSupport, R = (i, e) => i, F = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Pe : null;
      break;
  ...
  return t;
} }, te = (i, e) => !He(i, e), ge = { attribute: !0, type: String, converter: F, reflect: !1, useDefault: !1, hasChanged: te };
...
let S = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, t, o) {
    const { get: n, set: r } = Re(this.prototype, e) ?? { get() {
      return this[t];
    }, set(s) {
      this[t] = s;
    } };
    return { get: n, set(s) {
      ...
      r == null || r.call(this, s), this.requestUpdate(e, a, o);
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(R("properties"))) {
      const t = this.properties, o = [...Oe(t), ...Ve(t)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const n of o) t.unshift(le(n));
  ...
  _$ET(e, t) {
    ...
    if (n !== void 0 && o.reflect === !0) {
      const s = (((r = o.converter) == null ? void 0 : r.toAttribute) !== void 0 ? o.converter : F).toAttribute(t, o.type);
  ...
  _$AK(e, t) {
    ...
    if (n !== void 0 && this._$Em !== n) {
      const a = o.getPropertyOptions(n), c = typeof a.converter == "function" ? { fromAttribute: a.converter } : ((r = a.converter) == null ? void 0 : r.fromAttribute) !== void 0 ? a.converter : F;
      this._$Em = n;
      const m = c.fromAttribute(t, a.type);
      this[n] = m ?? ((s = this._$Ej) == null ? void 0 : s.get(n)) ?? m, this._$Em = null;
    }
  }
  requestUpdate(e, t, o) {
    var n;
    if (e !== void 0) {
      ...
      if (o ?? (o = r.getPropertyOptions(e)), !((o.hasChanged ?? te)(s, t) || o.useDefault && o.reflect && s === ((n = this._$Ej) == null ? void 0 : n.get(e)) && !this.hasAttribute(r._$Eu(e, o)))) return;
      this.C(e, t, o);
    }
    this.isUpdatePending === !1 && (this._$ES = this._$EP());
  }
  C(e, t, { useDefault: o, reflect: n, wrapped: r }, s) {
    o && !(this._$Ej ?? (this._$Ej = /* @__PURE__ */ new Map())).has(e) && (this._$Ej.set(e, s ?? t ?? this[e]), r !== !0 || s !== void 0) || (this._$AL.has(e) || (this.hasUpdated || o || (t = void 0), this._$AL.set(e, t)), n === !0 && this._$Em !== e && (this._$Eq ?? (this._$Eq = /* @__PURE__ */ new Set())).add(e));
  }
  async _$EP() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const O = globalThis, Y = O.trustedTypes, me = Y ? Y.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, ze = "$lit$", y = `lit$${Math.random().toFixed(9).slice(2)}$`, ke = "?" + y, De = `<${ke}>`, q = document, V = () => q.createComment(""), K = (i) => i === null || typeof i != "object" && typeof i != "function", oe = Array.isArray, Ue = (i) => oe(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", j = `[ 	
\f\r]`, H = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, de = /-->/g, fe = />/g, I = RegExp(`>|${j}(?:([^\\s"'>=/]+)(${j}*=${j}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), he = /'/g, we = /"/g, qe = /^(?:script|style|textarea|title)$/i, Te = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), h = Te(1), B = Symbol.for("lit-noChange"), l = Symbol.for("lit-nothing"), pe = /* @__PURE__ */ new WeakMap(), z = q.createTreeWalker(q, 129);
function Se(i, e) {
...
const Qe = (i, e) => {
  ...
  let n, r = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", s = H;
  for (let a = 0; a < t; a++) {
    const c = i[a];
    let m, f, b = -1, p = 0;
    for (; p < c.length && (s.lastIndex = p, f = s.exec(c), f !== null); ) p = s.lastIndex, s === H ? f[1] === "!--" ? s = de : f[1] !== void 0 ? s = fe : f[2] !== void 0 ? (qe.test(f[2]) && (n = RegExp("</" + f[2], "g")), s = I) : f[3] !== void 0 && (s = I) : s === I ? f[0] === ">" ? (s = n ?? H, b = -1) : f[1] === void 0 ? b = -2 : (b = s.lastIndex - f[2].length, m = f[1], s = f[3] === void 0 ? I : f[3] === '"' ? we : he) : s === we || s === he ? s = I : s === de || s === fe ? s = H : (s = I, n = void 0);
    const x = s === I && i[a + 1].startsWith("/>") ? " " : "";
    r += s === H ? c + De : b >= 0 ? (o.push(m), c.slice(0, b) + ze + c.slice(b) + y + x) : c + y + (b === -2 ? a : x);
  }
  return [Se(i, r + (i[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), o];
};
class P {
  constructor({ strings: e, _$litType$: t }, o) {
    ...
    this.parts = [];
    let r = 0, s = 0;
    const a = e.length - 1, c = this.parts, [m, f] = Qe(e, t);
    if (this.el = P.createElement(m, o), z.currentNode = this.el.content, t === 2 || t === 3) {
      const b = this.el.content.firstChild;
      b.replaceWith(...b.childNodes);
    }
    for (; (n = z.nextNode()) !== null && c.length < a; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) for (const b of n.getAttributeNames()) if (b.endsWith(ze)) {
          const p = f[s++], x = n.getAttribute(b).split(y), T = /([.?@])?(.*)/.exec(p);
          c.push({ type: 1, index: r, name: T[2], strings: x, ctor: T[1] === "." ? Ye : T[1] === "?" ? We : T[1] === "@" ? Ne : N }), n.removeAttribute(b);
        } else b.startsWith(y) && (c.push({ type: 6, index: r }), n.removeAttribute(b));
        if (qe.test(n.tagName)) {
          const b = n.textContent.split(y), p = b.length - 1;
          if (p > 0) {
            n.textContent = Y ? Y.emptyScript : "";
            for (let x = 0; x < p; x++) n.append(b[x], V()), z.nextNode(), c.push({ type: 2, index: ++r });
            n.append(b[p], V());
          }
        }
      } else if (n.nodeType === 8) if (n.data === ke) c.push({ type: 2, index: r });
      else {
        let b = -1;
        for (; (b = n.data.indexOf(y, b + 1)) !== -1; ) c.push({ type: 7, index: r }), b += y.length - 1;
      }
      r++;
    }
  }
...
function J(i, e, t = i, o) {
  var s, a;
  if (e === B) return e;
  let n = o !== void 0 ? (s = t._$Co) == null ? void 0 : s[o] : t._$Cl;
  const r = K(e) ? void 0 : e._$litDirective$;
  return (n == null ? void 0 : n.constructor) !== r && ((a = n == null ? void 0 : n._$AO) == null || a.call(n, !1), r === void 0 ? n = void 0 : (n = new r(i), n._$AT(i, t, o)), o !== void 0 ? (t._$Co ?? (t._$Co = []))[o] = n : t._$Cl = n), n !== void 0 && (e = J(i, n._$AS(i, e.values), n, o)), e;
}
class Fe {
  constructor(e, t) {
  ...
  u(e) {
    const { el: { content: t }, parts: o } = this._$AD, n = ((e == null ? void 0 : e.creationScope) ?? q).importNode(t, !0);
    z.currentNode = n;
    let r = z.nextNode(), s = 0, a = 0, c = o[0];
    for (; c !== void 0; ) {
      if (s === c.index) {
        let m;
        c.type === 2 ? m = new D(r, r.nextSibling, this, e) : c.type === 1 ? m = new c.ctor(r, c.name, c.strings, this, e) : c.type === 6 && (m = new Ze(r, this, e)), this._$AV.push(m), c = o[++a];
      }
...
class D {
  ...
  constructor(e, t, o, n) {
    this.type = 2, this._$AH = l, this._$AN = void 0, this._$AA = e, this._$AB = t, this._$AM = o, this.options = n, this._$Cv = (n == null ? void 0 : n.isConnected) ?? !0;
  }
  get parentNode() {
  ...
  _$AI(e, t = this) {
    e = J(this, e, t), K(e) ? e === l || e == null || e === "" ? (this._$AH !== l && this._$AR(), this._$AH = l) : e !== this._$AH && e !== B && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Ue(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    var r;
    const { values: t, _$litType$: o } = e, n = typeof o == "number" ? this._$AC(e) : (o.el === void 0 && (o.el = P.createElement(Se(o.h, o.h[0]), this.options)), o);
    if (((r = this._$AH) == null ? void 0 : r._$AD) === n) this._$AH.p(t);
    else {
      const s = new Fe(n, this), a = s.u(this.options);
      s.p(t), this.T(a), this._$AH = s;
    }
  }
  _$AC(e) {
    let t = pe.get(e.strings);
    return t === void 0 && pe.set(e.strings, t = new P(e)), t;
  }
  k(e) {
    oe(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let o, n = 0;
    for (const r of e) n === t.length ? t.push(o = new D(this.O(V()), this.O(V()), this, this.options)) : o = t[n], o._$AI(r), n++;
...
class N {
  ...
  constructor(e, t, o, n, r) {
    this.type = 1, this._$AH = l, this._$AN = void 0, this.element = e, this.name = t, this._$AM = n, this.options = r, o.length > 2 || o[0] !== "" || o[1] !== "" ? (this._$AH = Array(o.length - 1).fill(new String()), this.strings = o) : this._$AH = l;
  }
  _$AI(e, t = this, o, n) {
    const r = this.strings;
    let s = !1;
    if (r === void 0) e = J(this, e, t, 0), s = !K(e) || e !== this._$AH && e !== B, s && (this._$AH = e);
    else {
      const a = e;
      let c, m;
      for (e = r[0], c = 0; c < r.length - 1; c++) m = J(this, a[o + c], t, c), m === B && (m = this._$AH[c]), s || (s = !K(m) || m !== this._$AH[c]), m === l ? e = l : e !== l && (e += (m ?? "") + r[c + 1]), this._$AH[c] = m;
    }
    s && !n && this.j(e);
  }
  j(e) {
...
class Ne extends N {
  ...
  _$AI(e, t = this) {
    if ((e = J(this, e, t, 0) ?? l) === B) return;
    const o = this._$AH, n = e === l && o !== l || e.capture !== o.capture || e.once !== o.once || e.passive !== o.passive, r = e !== l && (o === l || n);
...
const Le = (i, e, t) => {
  ...
  if (n === void 0) {
    ...
    o._$litPart$ = n = new D(e.insertBefore(V(), r), r, void 0, t ?? {});
  }
  return n._$AI(i), n;
};
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const je = { attribute: !0, type: String, converter: F, reflect: !1, hasChanged: te }, Xe = (i = je, e, t) => {
  const { kind: o, metadata: n } = t;
  let r = globalThis.litPropertyMetadata.get(n);
  if (r === void 0 && globalThis.litPropertyMetadata.set(n, r = /* @__PURE__ */ new Map()), o === "setter" && ((i = Object.create(i)).wrapped = !0), r.set(t.name, i), o === "accessor") {
    const { name: s } = t;
    return { set(a) {
...
function g(i) {
  return (e, t) => typeof t == "object" ? Xe(i, e, t) : ((o, n, r) => {
    const s = n.hasOwnProperty(r);
    return n.constructor.createProperty(r, o), s ? Object.getOwnPropertyDescriptor(n, r) : void 0;
  })(i, e, t);
}
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const _e = (i, e, t) => (t.configurable = !0, t.enumerable = !0, Reflect.decorate && typeof e != "object" && Object.defineProperty(i, e, t), t);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
var bt = Object.defineProperty, U = (i, e, t, o) => {
...
const ye = "swim-icon", ie = class ie extends v {
  ...
  _updateFontIcon() {
    ...
    this._cssClasses = st.get(e, this.fontSet);
  }
  render() {
    var r;
    const e = this._cssClasses, t = !!this.alt, o = ((r = this.iconClass) == null ? void 0 : r.trim()) ?? "", n = o ? ` ${o}` : "";
    return !e || e.length === 0 ? h`
        <span
          part="icon"
          class="${o}"
          role="${t ? "img" : "presentation"}"
          aria-label="${t ? this.alt : l}"
      ...
      >
        ${e.map(
      (s, a) => h`<i part="icon icon-${a}" class="swim-icon__i swim-icon__i--${a} ${s}${n}"></i>`
    )}
      </span>
    `;
  }
...
var gt = Object.defineProperty, mt = Object.getOwnPropertyDescriptor, w = (i, e, t, o) => {
  for (var n = o > 1 ? void 0 : o ? mt(e, t) : e, r = i.length - 1, s; r >= 0; r--)
...
const Ae = "swim-dialog", re = class re extends v {
  ...
  render() {
    ...
    const e = this.format === G.Regular || this.format === "regular", t = this.format === G.Large || this.format === "large", o = this.format === G.Medium || this.format === "medium", n = [
      "swim-dialog__content",
      this.cssClass,
...
let d = re;
w([
  g({ type: String, attribute: "dialog-title" })
], d.prototype, "dialogTitle", 2);
w([
  g({ type: String })
], d.prototype, "title", 1);
w([
...
w([
  g({ type: String, attribute: "css-class" })
...
], d.prototype, "showBackdrop", 2);
w([
  g({ type: Boolean, attribute: "close-button" })
], d.prototype, "closeButton", 1);
w([
...
w([
  g({ attribute: !1 })
], d.prototype, "beforeClose", 2);
w([
  ne()
], d.prototype, "_contentId", 2);
w([
  ne()
], d.prototype, "_titleId", 2);
w([
...
var ft = Object.defineProperty, M = (i, e, t, o) => {
  for (var n = void 0, r = i.length - 1, s; r >= 0; r--)
    (s = i[r]) && (n = s(e, t, n) || n);
  return n && ft(e, t, n), n;
};
...
M([
  g({ type: String, attribute: "dialog-title" })
], u.prototype, "dialogTitle");
M([
  g({ type: String, attribute: "dialog-subtitle" })
], u.prototype, "dialogSubtitle");
M([
  g({ type: String, attribute: "dialog-action-title" })
], u.prototype, "dialogActionTitle");
M([
  g({ type: String, attribute: "dialog-dirty-action-title" })
], u.prototype, "dialogDirtyActionTitle");
M([
  g({ type: Boolean, reflect: !0 })
], u.prototype, "dirty");
...
var wt = Object.defineProperty, pt = (i, e, t, o) => {
  for (var n = void 0, r = i.length - 1, s; r >= 0; r--)
    (s = i[r]) && (n = s(e, t, n) || n);
  return n && wt(e, t, n), n;
};
...
export {
  G as DialogFormat,
  d as SwimDialog,
  u as SwimLargeFormatDialogContent,
