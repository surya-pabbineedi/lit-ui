 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Pe, defineProperty: Ge, getOwnPropertyDescriptor: Ke, getOwnPropertyNames: Re, getOwnPropertySymbols: Ue, getPrototypeOf: Fe } = Object, C = globalThis, he = C.trustedTypes, Qe = he ? he.emptyScript : "", $ = C.reactiveElementPolyfillSupport, K = (n, e) => n, Z = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? Qe : null;
      break;
  ...
  return t;
} }, re = (n, e) => !Pe(n, e), fe = { attribute: !0, type: String, converter: Z, reflect: !1, useDefault: !1, hasChanged: re };
...
let M = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, t, i) {
    const { get: o, set: s } = Ke(this.prototype, e) ?? { get() {
      return this[t];
    }, set(r) {
      this[t] = r;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(K("properties"))) {
      const t = this.properties, i = [...Re(t), ...Ue(t)];
  ...
  _$ET(e, t) {
    ...
    if (o !== void 0 && i.reflect === !0) {
      const r = (((s = i.converter) == null ? void 0 : s.toAttribute) !== void 0 ? i.converter : Z).toAttribute(t, i.type);
  ...
  _$AK(e, t) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const c = i.getPropertyOptions(o), l = typeof c.converter == "function" ? { fromAttribute: c.converter } : ((s = c.converter) == null ? void 0 : s.fromAttribute) !== void 0 ? c.converter : Z;
      this._$Em = o;
...
M.elementStyles = [], M.shadowRootOptions = { mode: "open" }, M[K("elementProperties")] = /* @__PURE__ */ new Map(), M[K("finalized")] = /* @__PURE__ */ new Map(), $ == null || $({ ReactiveElement: M }), (C.reactiveElementVersions ?? (C.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const R = globalThis, L = R.trustedTypes, pe = L ? L.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, ze = "$lit$", x = `lit$${Math.random().toFixed(9).slice(2)}$`, qe = "?" + x, Ye = `<${qe}>`, B = document, U = () => B.createComment(""), F = (n) => n === null || typeof n != "object" && typeof n != "function", le = Array.isArray, Te = (n) => le(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", ee = `[ 	
\f\r]`, P = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, me = /-->/g, ue = />/g, E = RegExp(`>|${ee}(?:([^\\s"'>=/]+)(${ee}*=${ee}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), we = /'/g, ge = /"/g, Se = /^(?:script|style|textarea|title)$/i, We = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), y = We(1), H = Symbol.for("lit-noChange"), m = Symbol.for("lit-nothing"), ye = /* @__PURE__ */ new WeakMap(), q = B.createTreeWalker(B, 129);
function Oe(n, e) {
...
const Ze = (n, e) => {
  ...
  for (let c = 0; c < t; c++) {
    const l = n[c];
    let b, w, a = -1, u = 0;
    for (; u < l.length && (r.lastIndex = u, w = r.exec(l), w !== null); ) u = r.lastIndex, r === P ? w[1] === "!--" ? r = me : w[1] !== void 0 ? r = ue : w[2] !== void 0 ? (Se.test(w[2]) && (o = RegExp("</" + w[2], "g")), r = E) : w[3] !== void 0 && (r = E) : r === E ? w[0] === ">" ? (r = o ?? P, a = -1) : w[1] === void 0 ? a = -2 : (a = r.lastIndex - w[2].length, b = w[1], r = w[3] === void 0 ? E : w[3] === '"' ? ge : we) : r === ge || r === we ? r = E : r === me || r === ue ? r = P : (r = E, o = void 0);
    const h = r === E && n[c + 1].startsWith("/>") ? " " : "";
    s += r === P ? l + Ye : a >= 0 ? (i.push(b), l.slice(0, a) + ze + l.slice(a) + x + h) : l + x + (a === -2 ? c : h);
  }
  return [Oe(n, s + (n[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), i];
};
class Q {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let s = 0, r = 0;
    const c = e.length - 1, l = this.parts, [b, w] = Ze(e, t);
    if (this.el = Q.createElement(b, i), q.currentNode = this.el.content, t === 2 || t === 3) {
      const a = this.el.content.firstChild;
      a.replaceWith(...a.childNodes);
    }
    for (; (o = q.nextNode()) !== null && l.length < c; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const a of o.getAttributeNames()) if (a.endsWith(ze)) {
          const u = w[r++], h = o.getAttribute(a).split(x), g = /([.?@])?(.*)/.exec(u);
          l.push({ type: 1, index: s, name: g[2], strings: h, ctor: g[1] === "." ? Ne : g[1] === "?" ? je : g[1] === "@" ? Xe : j }), o.removeAttribute(a);
        } else a.startsWith(x) && (l.push({ type: 6, index: s }), o.removeAttribute(a));
        if (Se.test(o.tagName)) {
          const a = o.textContent.split(x), u = a.length - 1;
          if (u > 0) {
            o.textContent = L ? L.emptyScript : "";
            for (let h = 0; h < u; h++) o.append(a[h], U()), q.nextNode(), l.push({ type: 2, index: ++s });
            o.append(a[u], U());
          }
        }
      } else if (o.nodeType === 8) if (o.data === qe) l.push({ type: 2, index: s });
      else {
        let a = -1;
        for (; (a = o.data.indexOf(x, a + 1)) !== -1; ) l.push({ type: 7, index: s }), a += x.length - 1;
      }
      s++;
    }
  }
...
let Le = class {
  ...
  u(e) {
    const { el: { content: t }, parts: i } = this._$AD, o = ((e == null ? void 0 : e.creationScope) ?? B).importNode(t, !0);
    q.currentNode = o;
    let s = q.nextNode(), r = 0, c = 0, l = i[0];
    for (; l !== void 0; ) {
      if (r === l.index) {
        let b;
        l.type === 2 ? b = new V(s, s.nextSibling, this, e) : l.type === 1 ? b = new l.ctor(s, l.name, l.strings, this, e) : l.type === 6 && (b = new _e(s, this, e)), this._$AV.push(b), l = i[++c];
      }
      r !== (l == null ? void 0 : l.index) && (s = q.nextNode(), r++);
    }
    return q.currentNode = B, o;
  }
  p(e) {
    let t = 0;
...
class V {
  ...
  _$AI(e, t = this) {
    e = D(this, e, t), F(e) ? e === m || e == null || e === "" ? (this._$AH !== m && this._$AR(), this._$AH = m) : e !== this._$AH && e !== H && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Te(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== m && F(this._$AH) ? this._$AA.nextSibling.data = e : this.T(B.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var s;
    const { values: t, _$litType$: i } = e, o = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = Q.createElement(Oe(i.h, i.h[0]), this.options)), i);
  ...
  _$AC(e) {
    ...
    return t === void 0 && ye.set(e.strings, t = new Q(e)), t;
  }
  k(e) {
...
class j {
  ...
  _$AI(e, t = this, i, o) {
    ...
    let r = !1;
    if (s === void 0) e = D(this, e, t, 0), r = !F(e) || e !== this._$AH && e !== H, r && (this._$AH = e);
    else {
      const c = e;
      let l, b;
      for (e = s[0], l = 0; l < s.length - 1; l++) b = D(this, c[i + l], t, l), b === H && (b = this._$AH[l]), r || (r = !F(b) || b !== this._$AH[l]), b === m ? e = m : e !== m && (e += (b ?? "") + s[l + 1]), this._$AH[l] = b;
    }
    r && !o && this.j(e);
  }
  j(e) {
...
const $e = { I: V }, te = R.litHtmlPolyfillSupport;
te == null || te(Q, V), (R.litHtmlVersions ?? (R.litHtmlVersions = [])).push("3.3.1");
const et = (n, e, t) => {
...
var ke;
O._$litElement$ = !0, O.finalized = !0, (ke = S.litElementHydrateSupport) == null || ke.call(S, { LitElement: O });
const ie = S.litElementPolyfillSupport;
ie == null || ie({ LitElement: O });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const tt = { attribute: !0, type: String, converter: Z, reflect: !1, hasChanged: re }, it = (n = tt, e, t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: lt } = $e, ve = () => document.createComment(""), G = (n, e, t) => {
  var s;
  ...
  return t;
}, z = (n, e, t = n) => (n._$AI(e, t), n), ct = {}, at = (n, e = ct) => n._$AH = e, bt = (n) => n._$AH, oe = (n) => {
...
const Ae = (n, e, t) => {
  ...
  update(n, [e, t, i]) {
    ...
    else if (c[a] === r[h]) l[h] = z(o[a], s[h]), a++, h++;
    else if (c[u] === r[g]) l[g] = z(o[u], s[g]), u--, g--;
    else if (c[a] === r[g]) l[g] = z(o[a], s[g]), G(n, l[g + 1], o[a]), a++, g--;
    else if (c[u] === r[h]) l[h] = z(o[u], s[h]), G(n, o[a], o[u]), u--, h++;
    else if (b === void 0 && (b = Ae(r, h, g), w = Ae(c, a, u)), b.has(c[a])) if (b.has(c[u])) {
      const v = w.get(r[h]), _ = v !== void 0 ? o[v] : null;
      if (_ === null) {
        const ae = G(n, o[a]);
        z(ae, s[h]), l[h] = ae;
      } else l[h] = z(_, s[h]), G(n, o[a], _), o[v] = null;
      h++;
    } else oe(o[u]), u--;
    else oe(o[a]), a++;
    for (; h <= g; ) {
...
`;
var Je = /* @__PURE__ */ ((n) => (n.legacy = "legacy", n.fill = "fill", n))(Je || {}), Me = /* @__PURE__ */ ((n) => (n.sm = "sm", n.md = "md", n.lg = "lg", n))(Me || {});
function A(n) {
...
`, ut = J`
  ...
  ${mt}
`, wt = (n) => `swim-icon ${n.trim().split(" ").map((t) => {
  const [i, o] = t.split(":");
...
class gt {
  ...
  get(e, t) {
    return this.lookup(e, t).map((i) => wt(i));
  }
  lookup(e, t) {
...
const xe = "swim-icon", ce = class ce extends O {
  constructor() {
  ...
  _updateFontIcon() {
    ...
    this._cssClasses = yt.get(e, this.fontSet);
  }
  render() {
    var s;
...
], I.prototype, "iconClass");
Y([
  k()
], I.prototype, "_cssClasses");
customElements.get(xe) || customElements.define(xe, I);
var At = Object.defineProperty, xt = Object.getOwnPropertyDescriptor, X = (n, e, t, i) => {
  for (var o = i > 1 ? void 0 : i ? xt(e, t) : e, s = n.length - 1, r; s >= 0; s--)
    (r = n[s]) && (o = (i ? r(e, t, o) : r(o)) || o);
  return i && o && At(e, t, o), o;
};
const Ce = "swim-option";
class T extends O {
  constructor() {
...
customElements.get(Ce) || customElements.define(Ce, T);
var Ct = Object.defineProperty, It = Object.getOwnPropertyDescriptor, p = (n, e, t, i) => {
  for (var o = i > 1 ? void 0 : i ? It(e, t) : e, s = n.length - 1, r; s >= 0; s--)
    (r = n[s]) && (o = (i ? r(e, t, o) : r(o)) || o);
  return i && o && Ct(e, t, o), o;
};
const Ie = "swim-select", N = class N extends O {
  constructor() {
    super(), this.label = "", this.placeholder = "Select...", this.hint = "", this.emptyPlaceholder = "No options available", this.filterPlaceholder = "Filter options...", this.options = [], this._value = [], this.name = "", this.id = `swim-select-${Math.random().toString(36).substr(2, 9)}`, this._disabled = !1, this._required = !1, this.appearance = Je.legacy, this.size = Me.sm, this._withMargin = !0, this._withHint = !0, this._filterable = !0, this._multiple = !1, this._allowClear = !0, this.requiredIndicator = "*", this._slottedOptions = [], this._open = !1, this._focused = !1, this._touched = !1, this._invalid = !1, this._filterQuery = "", this._focusedIndex = -1, this._internals = this.attachInternals();
  }
  get value() {
          ...
          <div class="select-flex-wrap-inner">
            <div class="select-input-wrap">
              ...
              <label class="select-label" for="${this.id}">
                ${this.label} ${this.required ? y`<span>${this.requiredIndicator}</span>` : m}
              </label>
            </div>
          </div>
        </div>
...
N.styles = [He, ht, ft], N.formAssociated = !0;
let d = N;
p([
  Be(".select-input")
], d.prototype, "selectInput", 2);
p([
  Be(".select-filter-input")
...
customElements.get(Ie) || customElements.define(Ie, d);
export {
  T as SwimOption,
  d as SwimSelect
};
