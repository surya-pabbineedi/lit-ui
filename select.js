 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Oe, defineProperty: Ve, getOwnPropertyDescriptor: Ge, getOwnPropertyNames: Pe, getOwnPropertySymbols: Ke, getPrototypeOf: Re } = Object, A = globalThis, ge = A.trustedTypes, Ue = ge ? ge.emptyScript : "", X = A.reactiveElementPolyfillSupport, K = (i, e) => i, T = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Ue : null;
      break;
  ...
  return t;
} }, ie = (i, e) => !Oe(i, e), be = { attribute: !0, type: String, converter: T, reflect: !1, useDefault: !1, hasChanged: ie };
...
let J = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, t, n) {
    ...
    return { get: o, set(s) {
      ...
      r == null || r.call(this, s), this.requestUpdate(e, l, n);
  ...
  _$ET(e, t) {
    ...
    if (o !== void 0 && n.reflect === !0) {
      const s = (((r = n.converter) == null ? void 0 : r.toAttribute) !== void 0 ? n.converter : T).toAttribute(t, n.type);
  ...
  _$AK(e, t) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const l = n.getPropertyOptions(o), c = typeof l.converter == "function" ? { fromAttribute: l.converter } : ((r = l.converter) == null ? void 0 : r.fromAttribute) !== void 0 ? l.converter : T;
      this._$Em = o;
      const g = c.fromAttribute(t, l.type);
      this[o] = g ?? ((s = this._$Ej) == null ? void 0 : s.get(o)) ?? g, this._$Em = null;
    }
  }
  requestUpdate(e, t, n) {
    var o;
    if (e !== void 0) {
      ...
      if (n ?? (n = r.getPropertyOptions(e)), !((n.hasChanged ?? ie)(s, t) || n.useDefault && n.reflect && s === ((o = this._$Ej) == null ? void 0 : o.get(e)) && !this.hasAttribute(r._$Eu(e, n)))) return;
      this.C(e, t, n);
    }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const R = globalThis, Z = R.trustedTypes, de = Z ? Z.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, ke = "$lit$", v = `lit$${Math.random().toFixed(9).slice(2)}$`, Ee = "?" + v, Fe = `<${Ee}>`, S = document, U = () => S.createComment(""), F = (i) => i === null || typeof i != "object" && typeof i != "function", re = Array.isArray, Qe = (i) => re(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", _ = `[ 	
\f\r]`, G = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, he = /-->/g, xe = />/g, I = RegExp(`>|${_}(?:([^\\s"'>=/]+)(${_}*=${_}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), fe = /'/g, pe = /"/g, ze = /^(?:script|style|textarea|title)$/i, Ye = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), y = Ye(1), B = Symbol.for("lit-noChange"), x = Symbol.for("lit-nothing"), ue = /* @__PURE__ */ new WeakMap(), z = S.createTreeWalker(S, 129);
function qe(i, e) {
...
const We = (i, e) => {
  ...
  for (let l = 0; l < t; l++) {
    const c = i[l];
    let g, u, a = -1, f = 0;
    for (; f < c.length && (s.lastIndex = f, u = s.exec(c), u !== null); ) f = s.lastIndex, s === G ? u[1] === "!--" ? s = he : u[1] !== void 0 ? s = xe : u[2] !== void 0 ? (ze.test(u[2]) && (o = RegExp("</" + u[2], "g")), s = I) : u[3] !== void 0 && (s = I) : s === I ? u[0] === ">" ? (s = o ?? G, a = -1) : u[1] === void 0 ? a = -2 : (a = s.lastIndex - u[2].length, g = u[1], s = u[3] === void 0 ? I : u[3] === '"' ? pe : fe) : s === pe || s === fe ? s = I : s === he || s === xe ? s = G : (s = I, o = void 0);
    const d = s === I && i[l + 1].startsWith("/>") ? " " : "";
    r += s === G ? c + Fe : a >= 0 ? (n.push(g), c.slice(0, a) + ke + c.slice(a) + v + d) : c + v + (a === -2 ? l : d);
  }
  return [qe(i, r + (i[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), n];
};
class Q {
  constructor({ strings: e, _$litType$: t }, n) {
    ...
    this.parts = [];
    let r = 0, s = 0;
    const l = e.length - 1, c = this.parts, [g, u] = We(e, t);
    if (this.el = Q.createElement(g, n), z.currentNode = this.el.content, t === 2 || t === 3) {
    ...
    for (; (o = z.nextNode()) !== null && c.length < l; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const a of o.getAttributeNames()) if (a.endsWith(ke)) {
          const f = u[s++], d = o.getAttribute(a).split(v), m = /([.?@])?(.*)/.exec(f);
          c.push({ type: 1, index: r, name: m[2], strings: d, ctor: m[1] === "." ? Ze : m[1] === "?" ? Ne : m[1] === "@" ? Le : L }), o.removeAttribute(a);
        } else a.startsWith(v) && (c.push({ type: 6, index: r }), o.removeAttribute(a));
        if (ze.test(o.tagName)) {
          const a = o.textContent.split(v), f = a.length - 1;
          if (f > 0) {
            o.textContent = Z ? Z.emptyScript : "";
            for (let d = 0; d < f; d++) o.append(a[d], U()), z.nextNode(), c.push({ type: 2, index: ++r });
            o.append(a[f], U());
          }
        }
      } else if (o.nodeType === 8) if (o.data === Ee) c.push({ type: 2, index: r });
      else {
        let a = -1;
        for (; (a = o.data.indexOf(v, a + 1)) !== -1; ) c.push({ type: 7, index: r }), a += v.length - 1;
      }
      r++;
    }
  }
...
function D(i, e, t = i, n) {
  ...
  return (o == null ? void 0 : o.constructor) !== r && ((l = o == null ? void 0 : o._$AO) == null || l.call(o, !1), r === void 0 ? o = void 0 : (o = new r(i), o._$AT(i, t, n)), n !== void 0 ? (t._$Co ?? (t._$Co = []))[n] = o : t._$Cl = o), o !== void 0 && (e = D(i, o._$AS(i, e.values), o, n)), e;
}
let Te = class {
  constructor(e, t) {
  ...
  u(e) {
    ...
    z.currentNode = o;
    let r = z.nextNode(), s = 0, l = 0, c = n[0];
    for (; c !== void 0; ) {
      if (s === c.index) {
        let g;
        c.type === 2 ? g = new V(r, r.nextSibling, this, e) : c.type === 1 ? g = new c.ctor(r, c.name, c.strings, this, e) : c.type === 6 && (g = new je(r, this, e)), this._$AV.push(g), c = n[++l];
      }
...
class V {
  ...
  _$AI(e, t = this) {
    e = D(this, e, t), F(e) ? e === x || e == null || e === "" ? (this._$AH !== x && this._$AR(), this._$AH = x) : e !== this._$AH && e !== B && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Qe(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== x && F(this._$AH) ? this._$AA.nextSibling.data = e : this.T(S.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var r;
    ...
    if (((r = this._$AH) == null ? void 0 : r._$AD) === o) this._$AH.p(t);
      ...
      const s = new Te(o, this), l = s.u(this.options);
  ...
  k(e) {
    ...
    const t = this._$AH;
    let n, o = 0;
    for (const r of e) o === t.length ? t.push(n = new V(this.O(U()), this.O(U()), this, this.options)) : n = t[o], n._$AI(r), o++;
...
class L {
  ...
  constructor(e, t, n, o, r) {
    this.type = 1, this._$AH = x, this._$AN = void 0, this.element = e, this.name = t, this._$AM = o, this.options = r, n.length > 2 || n[0] !== "" || n[1] !== "" ? (this._$AH = Array(n.length - 1).fill(new String()), this.strings = n) : this._$AH = x;
  }
  _$AI(e, t = this, n, o) {
    const r = this.strings;
    let s = !1;
    if (r === void 0) e = D(this, e, t, 0), s = !F(e) || e !== this._$AH && e !== B, s && (this._$AH = e);
    else {
      const l = e;
      let c, g;
      for (e = r[0], c = 0; c < r.length - 1; c++) g = D(this, l[n + c], t, c), g === B && (g = this._$AH[c]), s || (s = !F(g) || g !== this._$AH[c]), g === x ? e = x : e !== x && (e += (g ?? "") + r[c + 1]), this._$AH[c] = g;
    }
    s && !o && this.j(e);
  }
  j(e) {
...
class Le extends L {
  ...
  _$AI(e, t = this) {
    if ((e = D(this, e, t, 0) ?? x) === B) return;
    const n = this._$AH, o = e === x && n !== x || e.capture !== n.capture || e.once !== n.once || e.passive !== n.passive, r = e !== x && (n === x || o);
...
const _e = (i, e, t) => {
  ...
  if (o === void 0) {
    ...
    n._$litPart$ = o = new V(e.insertBefore(U(), r), r, void 0, t ?? {});
  }
  return o._$AI(i), o;
};
/**
...
const $e = { attribute: !0, type: String, converter: T, reflect: !1, hasChanged: ie }, et = (i = $e, e, t) => {
  ...
  if (r === void 0 && globalThis.litPropertyMetadata.set(o, r = /* @__PURE__ */ new Map()), n === "setter" && ((i = Object.create(i)).wrapped = !0), r.set(t.name, i), n === "accessor") {
    ...
    return { set(l) {
      ...
      e.set.call(this, l), this.requestUpdate(s, c, i);
    }, init(l) {
      return l !== void 0 && this.C(s, void 0, i, l), l;
    } };
  }
  if (n === "setter") {
    const { name: s } = t;
    return function(l) {
      const c = this[s];
      e.call(this, l), this.requestUpdate(s, c, i);
    };
  }
  throw Error("Unsupported decorator location: " + n);
};
function p(i) {
  return (e, t) => typeof t == "object" ? et(i, e, t) : ((n, o, r) => {
...
function Se(i, e) {
  return (t, n, o) => {
    const r = (s) => {
      var l;
      return ((l = s.renderRoot) == null ? void 0 : l.querySelector(i)) ?? null;
    };
    return tt(t, n, { get() {
      return r(this);
    } });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: rt } = Xe, me = () => document.createComment(""), P = (i, e, t) => {
  var r;
  const n = i._$AA.parentNode, o = e === void 0 ? i._$AB : e._$AA;
  if (t === void 0) {
    const s = n.insertBefore(me(), o), l = n.insertBefore(me(), o);
    t = new rt(s, l, i, i.options);
  } else {
    const s = t._$AB.nextSibling, l = t._$AM, c = l !== i;
    if (c) {
      let g;
      (r = t._$AQ) == null || r.call(t, i), t._$AM = i, t._$AP !== void 0 && (g = i._$AU) !== l._$AU && t._$AP(g);
    }
    if (s !== o || c) {
      let g = t._$AA;
      for (; g !== s; ) {
        const u = g.nextSibling;
        n.insertBefore(g, o), g = u;
      }
    }
  }
  return t;
}, k = (i, e, t = i) => (i._$AI(e, t), i), st = {}, ct = (i, e = st) => i._$AH = e, lt = (i) => i._$AH, te = (i) => {
...
const ye = (i, e, t) => {
  ...
  dt(i, e, t) {
    ...
    const o = [], r = [];
    let s = 0;
    for (const l of i) o[s] = n ? n(l, s) : s, r[s] = t(l, s), s++;
  ...
  update(i, [e, t, n]) {
    const o = lt(i), { values: r, keys: s } = this.dt(e, t, n);
    if (!Array.isArray(o)) return this.ut = s, r;
    const l = this.ut ?? (this.ut = []), c = [];
    let g, u, a = 0, f = o.length - 1, d = 0, m = r.length - 1;
    for (; a <= f && d <= m; ) if (o[a] === null) a++;
    else if (o[f] === null) f--;
    else if (l[a] === s[d]) c[d] = k(o[a], r[d]), a++, d++;
    else if (l[f] === s[m]) c[m] = k(o[f], r[m]), f--, m--;
    else if (l[a] === s[m]) c[m] = k(o[a], r[m]), P(i, c[m + 1], o[a]), a++, m--;
    else if (l[f] === s[d]) c[d] = k(o[f], r[d]), P(i, o[a], o[f]), f--, d++;
    else if (g === void 0 && (g = ye(s, d, m), u = ye(l, a, f)), g.has(l[a])) if (g.has(l[f])) {
      const w = u.get(s[d]), j = w !== void 0 ? o[w] : null;
      if (j === null) {
        const ce = P(i, o[a]);
        k(ce, r[d]), c[d] = ce;
      } else c[d] = k(j, r[d]), P(i, o[a], j), o[w] = null;
      d++;
    } else te(o[f]), f--;
    else te(o[a]), a++;
    for (; d <= m; ) {
...
`, ht = O`
  ...
  ${dt}
`, xt = (i) => `ngx-icon ${i.trim().split(" ").map((t) => {
  const [n, o] = t.split(":");
...
const ve = "swim-icon", se = class se extends M {
  ...
  render() {
    ...
    return !e || e.length === 0 ? y`
      ...
      >
        ${e.map(
      (s, l) => y`<i part="icon icon-${l}" class="swim-icon__i swim-icon__i--${l} ${s}${o}"></i>`
    )}
      </span>
    `;
  }
...
let C = se;
Y([
  p({ type: String, attribute: "font-icon" })
], C.prototype, "fontIcon");
Y([
  p({ type: String })
], C.prototype, "alt");
Y([
  p({ type: String, attribute: "font-set" })
], C.prototype, "fontSet");
Y([
  p({ type: String, attribute: "icon-class" })
...
var vt = Object.defineProperty, At = Object.getOwnPropertyDescriptor, h = (i, e, t, n) => {
  for (var o = n > 1 ? void 0 : n ? At(e, t) : e, r = i.length - 1, s; r >= 0; r--)
...
const Ae = "swim-select", N = class N extends M {
  ...
  render() {
    ...
    return y`
          ...
          <div class="select-flex-wrap-inner">
            <div class="select-input-wrap">
              ...
              <label class="select-label" for="${this.id}">
                ${this.label} ${this.required ? y`<span>${this.requiredIndicator}</span>` : x}
              </label>
            </div>
          </div>
        </div>
      ...
      (o, r) => this._renderOption(o, r)
    )}
                      </ul>
                    ` : y` <div class="select-empty">${this.emptyPlaceholder}</div> `}
              </div>
            ` : x}
      </div>
    `;
  ...
  _renderValue() {
    if (this._value.length === 0)
      return y`<span class="select-placeholder">${this.placeholder}</span>`;
    if (this.multiple)
      return y`
        ${this._value.map((e) => {
      ...
      `;
    {
      ...
      return y`${(e == null ? void 0 : e.name) || this._value[0]}`;
    }
  }
  _renderChip(e) {
    return y`
  ...
  _renderOption(e, t) {
    const n = this._getOptionValue(e), o = this._isSelected(n), r = t === this._focusedIndex;
    return y`
      <li
        class="select-option"
        role="option"
  ...
  _removeChip(e, t) {
    e.stopPropagation();
    const n = this._getOptionValue(t), o = this._value.filter((r) => r !== n);
...
N.styles = [Be, gt, bt], N.formAssociated = !0;
let b = N;
h([
  Se(".select-input")
], b.prototype, "selectInput", 2);
h([
  Se(".select-filter-input")
], b.prototype, "filterInput", 2);
h([
  p({ type: String })
], b.prototype, "label", 2);
h([
...
h([
  p({ type: String, attribute: "empty-placeholder" })
], b.prototype, "emptyPlaceholder", 2);
h([
  p({ type: String, attribute: "filter-placeholder" })
], b.prototype, "filterPlaceholder", 2);
h([
  p({ type: Array })
...
h([
  p({ type: Boolean, reflect: !0, attribute: "marginless" })
...
h([
  p({ type: Boolean })
], b.prototype, "filterable", 1);
h([
  p({ type: Boolean, reflect: !0 })
], b.prototype, "multiple", 1);
h([
  p({ type: Boolean, attribute: "allow-clear" })
], b.prototype, "allowClear", 1);
h([
  p({ type: String, attribute: "required-indicator" })
...
h([
  H()
], b.prototype, "_filterQuery", 2);
h([
  H()
], b.prototype, "_focusedIndex", 2);
customElements.get(Ae) || customElements.define(Ae, b);
export {
  b as SwimSelect
};
