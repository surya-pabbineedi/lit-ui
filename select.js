 ...
 */
const T = globalThis, ie = T.ShadowRoot && (T.ShadyCSS === void 0 || T.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, oe = Symbol(), ce = /* @__PURE__ */ new WeakMap();
let Ie = class {
  constructor(e, t, i) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Oe, defineProperty: Ve, getOwnPropertyDescriptor: Ge, getOwnPropertyNames: Pe, getOwnPropertySymbols: Ke, getPrototypeOf: Re } = Object, x = globalThis, be = x.trustedTypes, Ue = be ? be.emptyScript : "", X = x.reactiveElementPolyfillSupport, K = (n, e) => n, W = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? Ue : null;
      break;
  ...
  return t;
} }, ne = (n, e) => !Oe(n, e), de = { attribute: !0, type: String, converter: W, reflect: !1, useDefault: !1, hasChanged: ne };
...
let J = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(K("properties"))) {
      const t = this.properties, i = [...Pe(t), ...Ke(t)];
...
J.elementStyles = [], J.shadowRootOptions = { mode: "open" }, J[K("elementProperties")] = /* @__PURE__ */ new Map(), J[K("finalized")] = /* @__PURE__ */ new Map(), X == null || X({ ReactiveElement: J }), (x.reactiveElementVersions ?? (x.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const R = globalThis, Z = R.trustedTypes, he = Z ? Z.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, ke = "$lit$", A = `lit$${Math.random().toFixed(9).slice(2)}$`, Ee = "?" + A, Fe = `<${Ee}>`, S = document, U = () => S.createComment(""), F = (n) => n === null || typeof n != "object" && typeof n != "function", se = Array.isArray, Qe = (n) => se(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", _ = `[ 	
\f\r]`, G = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, fe = /-->/g, pe = />/g, I = RegExp(`>|${_}(?:([^\\s"'>=/]+)(${_}*=${_}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), me = /'/g, ue = /"/g, ze = /^(?:script|style|textarea|title)$/i, Ye = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), y = Ye(1), B = Symbol.for("lit-noChange"), p = Symbol.for("lit-nothing"), we = /* @__PURE__ */ new WeakMap(), z = S.createTreeWalker(S, 129);
function qe(n, e) {
...
const Te = (n, e) => {
  ...
  for (let c = 0; c < t; c++) {
    const l = n[c];
    let b, w, a = -1, m = 0;
    for (; m < l.length && (r.lastIndex = m, w = r.exec(l), w !== null); ) m = r.lastIndex, r === G ? w[1] === "!--" ? r = fe : w[1] !== void 0 ? r = pe : w[2] !== void 0 ? (ze.test(w[2]) && (o = RegExp("</" + w[2], "g")), r = I) : w[3] !== void 0 && (r = I) : r === I ? w[0] === ">" ? (r = o ?? G, a = -1) : w[1] === void 0 ? a = -2 : (a = r.lastIndex - w[2].length, b = w[1], r = w[3] === void 0 ? I : w[3] === '"' ? ue : me) : r === ue || r === me ? r = I : r === fe || r === pe ? r = G : (r = I, o = void 0);
    const h = r === I && n[c + 1].startsWith("/>") ? " " : "";
    s += r === G ? l + Fe : a >= 0 ? (i.push(b), l.slice(0, a) + ke + l.slice(a) + A + h) : l + A + (a === -2 ? c : h);
  }
...
class Q {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let s = 0, r = 0;
    const c = e.length - 1, l = this.parts, [b, w] = Te(e, t);
    if (this.el = Q.createElement(b, i), z.currentNode = this.el.content, t === 2 || t === 3) {
      const a = this.el.content.firstChild;
      a.replaceWith(...a.childNodes);
    }
    for (; (o = z.nextNode()) !== null && l.length < c; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const a of o.getAttributeNames()) if (a.endsWith(ke)) {
          const m = w[r++], h = o.getAttribute(a).split(A), g = /([.?@])?(.*)/.exec(m);
          l.push({ type: 1, index: s, name: g[2], strings: h, ctor: g[1] === "." ? Ze : g[1] === "?" ? Le : g[1] === "@" ? Ne : N }), o.removeAttribute(a);
        } else a.startsWith(A) && (l.push({ type: 6, index: s }), o.removeAttribute(a));
        if (ze.test(o.tagName)) {
          const a = o.textContent.split(A), m = a.length - 1;
          if (m > 0) {
            o.textContent = Z ? Z.emptyScript : "";
            for (let h = 0; h < m; h++) o.append(a[h], U()), z.nextNode(), l.push({ type: 2, index: ++s });
            o.append(a[m], U());
          }
        }
      } else if (o.nodeType === 8) if (o.data === Ee) l.push({ type: 2, index: s });
      else {
        let a = -1;
        for (; (a = o.data.indexOf(A, a + 1)) !== -1; ) l.push({ type: 7, index: s }), a += A.length - 1;
      }
      s++;
    }
  }
...
function D(n, e, t = n, i) {
  ...
  return (o == null ? void 0 : o.constructor) !== s && ((c = o == null ? void 0 : o._$AO) == null || c.call(o, !1), s === void 0 ? o = void 0 : (o = new s(n), o._$AT(n, t, i)), i !== void 0 ? (t._$Co ?? (t._$Co = []))[i] = o : t._$Cl = o), o !== void 0 && (e = D(n, o._$AS(n, e.values), o, i)), e;
}
let We = class {
  constructor(e, t) {
  ...
  u(e) {
    ...
    z.currentNode = o;
    let s = z.nextNode(), r = 0, c = 0, l = i[0];
    for (; l !== void 0; ) {
      if (r === l.index) {
        let b;
        l.type === 2 ? b = new V(s, s.nextSibling, this, e) : l.type === 1 ? b = new l.ctor(s, l.name, l.strings, this, e) : l.type === 6 && (b = new je(s, this, e)), this._$AV.push(b), l = i[++c];
      }
      r !== (l == null ? void 0 : l.index) && (s = z.nextNode(), r++);
    }
...
class V {
  ...
  _$AI(e, t = this) {
    e = D(this, e, t), F(e) ? e === p || e == null || e === "" ? (this._$AH !== p && this._$AR(), this._$AH = p) : e !== this._$AH && e !== B && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Qe(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    var s;
    const { values: t, _$litType$: i } = e, o = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = Q.createElement(qe(i.h, i.h[0]), this.options)), i);
    if (((s = this._$AH) == null ? void 0 : s._$AD) === o) this._$AH.p(t);
    else {
      const r = new We(o, this), c = r.u(this.options);
  ...
  k(e) {
    ...
    const t = this._$AH;
    let i, o = 0;
    for (const s of e) o === t.length ? t.push(i = new V(this.O(U()), this.O(U()), this, this.options)) : i = t[o], i._$AI(s), o++;
...
class N {
  ...
  _$AI(e, t = this, i, o) {
    ...
    if (s === void 0) e = D(this, e, t, 0), r = !F(e) || e !== this._$AH && e !== B, r && (this._$AH = e);
      ...
      const c = e;
      let l, b;
      for (e = s[0], l = 0; l < s.length - 1; l++) b = D(this, c[i + l], t, l), b === B && (b = this._$AH[l]), r || (r = !F(b) || b !== this._$AH[l]), b === p ? e = p : e !== p && (e += (b ?? "") + s[l + 1]), this._$AH[l] = b;
    }
    r && !o && this.j(e);
  }
  j(e) {
...
const _e = (n, e, t) => {
  ...
  if (o === void 0) {
    ...
    i._$litPart$ = o = new V(e.insertBefore(U(), s), s, void 0, t ?? {});
  }
  return o._$AI(n), o;
};
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const $e = { attribute: !0, type: String, converter: W, reflect: !1, hasChanged: ne }, et = (n = $e, e, t) => {
...
function u(n) {
  return (e, t) => typeof t == "object" ? et(n, e, t) : ((i, o, s) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const it = { CHILD: 2 }, ot = (n) => (...e) => ({ _$litDirective$: n, values: e });
class nt {
  constructor(e) {
  }
  get _$AU() {
...
const { I: st } = Xe, ge = () => document.createComment(""), P = (n, e, t) => {
  ...
  return t;
}, k = (n, e, t = n) => (n._$AI(e, t), n), rt = {}, lt = (n, e = rt) => n._$AH = e, ct = (n) => n._$AH, te = (n) => {
...
const ye = (n, e, t) => {
  ...
  return i;
}, at = ot(class extends nt {
  constructor(n) {
    if (super(n), n.type !== it.CHILD) throw Error("repeat() can only be used in text expressions");
  }
  dt(n, e, t) {
    let i;
  ...
  update(n, [e, t, i]) {
    const o = ct(n), { values: s, keys: r } = this.dt(e, t, i);
    if (!Array.isArray(o)) return this.ut = r, s;
    const c = this.ut ?? (this.ut = []), l = [];
    let b, w, a = 0, m = o.length - 1, h = 0, g = s.length - 1;
    for (; a <= m && h <= g; ) if (o[a] === null) a++;
    else if (o[m] === null) m--;
    else if (c[a] === r[h]) l[h] = k(o[a], s[h]), a++, h++;
    else if (c[m] === r[g]) l[g] = k(o[m], s[g]), m--, g--;
    else if (c[a] === r[g]) l[g] = k(o[a], s[g]), P(n, l[g + 1], o[a]), a++, g--;
    else if (c[m] === r[h]) l[h] = k(o[m], s[h]), P(n, o[a], o[m]), m--, h++;
    else if (b === void 0 && (b = ye(r, h, g), w = ye(c, a, m)), b.has(c[a])) if (b.has(c[m])) {
      const v = w.get(r[h]), j = v !== void 0 ? o[v] : null;
      if (j === null) {
        const le = P(n, o[a]);
        k(le, s[h]), l[h] = le;
      } else l[h] = k(j, s[h]), P(n, o[a], j), o[v] = null;
      h++;
    } else te(o[m]), m--;
    else te(o[a]), a++;
    for (; h <= g; ) {
...
`;
var He = /* @__PURE__ */ ((n) => (n.legacy = "legacy", n.fill = "fill", n))(He || {}), Je = /* @__PURE__ */ ((n) => (n.sm = "sm", n.md = "md", n.lg = "lg", n))(Je || {});
function E(n) {
...
@font-face {
  font-family: '${gt}';
  src: url('data:font/woff2;base64,${wt}') format('woff2');
  font-weight: normal;
  font-style: normal;
  font-display: block;
}
`, document.head.appendChild(n), ve = !0;
}
var vt = Object.defineProperty, Y = (n, e, t, i) => {
  for (var o = void 0, s = n.length - 1, r; s >= 0; s--)
    (r = n[s]) && (o = r(e, t, o) || o);
  return o && vt(e, t, o), o;
};
const Ae = "swim-icon", re = class re extends M {
  constructor() {
  ...
  render() {
    ...
    return !e || e.length === 0 ? y`
      ...
      >
        ${e.map(
      (r, c) => y`<i part="icon icon-${c}" class="swim-icon__i swim-icon__i--${c} ${r}${o}"></i>`
    )}
      </span>
    `;
  }
...
customElements.get(Ae) || customElements.define(Ae, C);
var At = Object.defineProperty, xt = Object.getOwnPropertyDescriptor, f = (n, e, t, i) => {
  for (var o = i > 1 ? void 0 : i ? xt(e, t) : e, s = n.length - 1, r; s >= 0; s--)
    (r = n[s]) && (o = (i ? r(e, t, o) : r(o)) || o);
  return i && o && At(e, t, o), o;
};
const xe = "swim-select", L = class L extends M {
  constructor() {
          ...
          <div class="select-flex-wrap-inner">
            <div class="select-input-wrap">
              ...
              <label class="select-label" for="${this.id}">
                ${this.label} ${this.required ? y`<span>${this.requiredIndicator}</span>` : p}
              </label>
            </div>
          </div>
        </div>
...
L.styles = [Be, bt, dt], L.formAssociated = !0;
let d = L;
f([
  Se(".select-input")
...
customElements.get(xe) || customElements.define(xe, d);
export {
  d as SwimSelect
};
