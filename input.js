...
const ke = (n) => new ve(typeof n == "string" ? n : n + "", void 0, te), M = (n, ...e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Be, defineProperty: He, getOwnPropertyDescriptor: Je, getOwnPropertyNames: Ve, getOwnPropertySymbols: Me, getPrototypeOf: Re } = Object, E = globalThis, le = E.trustedTypes, Ge = le ? le.emptyScript : "", j = E.reactiveElementPolyfillSupport, T = (n, e) => n, W = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? Ge : null;
      break;
  ...
  return t;
} }, ie = (n, e) => !Be(n, e), ce = { attribute: !0, type: String, converter: W, reflect: !1, useDefault: !1, hasChanged: ie };
...
let H = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(T("properties"))) {
      const t = this.properties, i = [...Ve(t), ...Me(t)];
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const U = globalThis, N = U.trustedTypes, ae = N ? N.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, Ae = "$lit$", x = `lit$${Math.random().toFixed(9).slice(2)}$`, xe = "?" + x, Te = `<${xe}>`, S = document, O = () => S.createComment(""), P = (n) => n === null || typeof n != "object" && typeof n != "function", oe = Array.isArray, Ue = (n) => oe(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", X = `[ 	
\f\r]`, G = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, be = /-->/g, de = />/g, I = RegExp(`>|${X}(?:([^\\s"'>=/]+)(${X}*=${X}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), he = /'/g, me = /"/g, Ee = /^(?:script|style|textarea|title)$/i, Oe = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), u = Oe(1), w = Symbol.for("lit-noChange"), h = Symbol.for("lit-nothing"), fe = /* @__PURE__ */ new WeakMap(), q = S.createTreeWalker(S, 129);
function Ce(n, e) {
...
const Pe = (n, e) => {
  ...
  for (let c = 0; c < t; c++) {
    const l = n[c];
    let f, p, m = -1, g = 0;
    for (; g < l.length && (s.lastIndex = g, p = s.exec(l), p !== null); ) g = s.lastIndex, s === G ? p[1] === "!--" ? s = be : p[1] !== void 0 ? s = de : p[2] !== void 0 ? (Ee.test(p[2]) && (o = RegExp("</" + p[2], "g")), s = I) : p[3] !== void 0 && (s = I) : s === I ? p[0] === ">" ? (s = o ?? G, m = -1) : p[1] === void 0 ? m = -2 : (m = s.lastIndex - p[2].length, f = p[1], s = p[3] === void 0 ? I : p[3] === '"' ? me : he) : s === me || s === he ? s = I : s === be || s === de ? s = G : (s = I, o = void 0);
    const v = s === I && n[c + 1].startsWith("/>") ? " " : "";
    r += s === G ? l + Te : m >= 0 ? (i.push(f), l.slice(0, m) + Ae + l.slice(m) + x + v) : l + x + (m === -2 ? c : v);
  }
...
class K {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    if (this.el = K.createElement(f, i), q.currentNode = this.el.content, t === 2 || t === 3) {
    ...
    for (; (o = q.nextNode()) !== null && l.length < c; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const m of o.getAttributeNames()) if (m.endsWith(Ae)) {
          const g = p[s++], v = o.getAttribute(m).split(x), Q = /([.?@])?(.*)/.exec(g);
          l.push({ type: 1, index: r, name: Q[2], strings: v, ctor: Q[1] === "." ? De : Q[1] === "?" ? Fe : Q[1] === "@" ? Qe : L }), o.removeAttribute(m);
        ...
        if (Ee.test(o.tagName)) {
          ...
          if (g > 0) {
            ...
            for (let v = 0; v < g; v++) o.append(m[v], O()), q.nextNode(), l.push({ type: 2, index: ++r });
            o.append(m[g], O());
          }
        }
...
class Ke {
  ...
  u(e) {
    ...
    for (; l !== void 0; ) {
      if (s === l.index) {
        let f;
        l.type === 2 ? f = new D(r, r.nextSibling, this, e) : l.type === 1 ? f = new l.ctor(r, l.name, l.strings, this, e) : l.type === 6 && (f = new Ye(r, this, e)), this._$AV.push(f), l = i[++c];
      }
...
class D {
  ...
  _$AI(e, t = this) {
    e = V(this, e, t), P(e) ? e === h || e == null || e === "" ? (this._$AH !== h && this._$AR(), this._$AH = h) : e !== this._$AH && e !== w && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Ue(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== h && P(this._$AH) ? this._$AA.nextSibling.data = e : this.T(S.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var r;
    const { values: t, _$litType$: i } = e, o = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = K.createElement(Ce(i.h, i.h[0]), this.options)), i);
  ...
  k(e) {
    ...
    const t = this._$AH;
    let i, o = 0;
    for (const r of e) o === t.length ? t.push(i = new D(this.O(O()), this.O(O()), this, this.options)) : i = t[o], i._$AI(r), o++;
...
class L {
  ...
  _$AI(e, t = this, i, o) {
    ...
    let s = !1;
    if (r === void 0) e = V(this, e, t, 0), s = !P(e) || e !== this._$AH && e !== w, s && (this._$AH = e);
    else {
      const c = e;
      let l, f;
      for (e = r[0], l = 0; l < r.length - 1; l++) f = V(this, c[i + l], t, l), f === w && (f = this._$AH[l]), s || (s = !P(f) || f !== this._$AH[l]), f === h ? e = h : e !== h && (e += (f ?? "") + r[l + 1]), this._$AH[l] = f;
    }
    s && !o && this.j(e);
  }
  j(e) {
...
const We = (n, e, t) => {
  ...
  if (o === void 0) {
    ...
    i._$litPart$ = o = new D(e.insertBefore(O(), r), r, void 0, t ?? {});
  }
  return o._$AI(n), o;
};
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ne = { attribute: !0, type: String, converter: W, reflect: !1, hasChanged: ie }, Ze = (n = Ne, e, t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const B = { ATTRIBUTE: 1, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4 }, Xe = (n) => (...e) => ({ _$litDirective$: n, values: e });
class _e {
  constructor(e) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const $e = (n) => n.strings === void 0, et = {}, tt = (n, e = et) => n._$AH = e;
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const pe = Xe(class extends _e {
  constructor(n) {
    ...
    if (!$e(n)) throw Error("`live` bindings can only contain a single expression");
  }
  render(n) {
    return n;
  }
  update(n, [e]) {
    ...
    } else if (n.type === B.ATTRIBUTE && t.getAttribute(i) === e + "") return w;
    return tt(n), e;
  }
});
/**
...
`, document.head.appendChild(n), ue = !0;
}
var bt = Object.defineProperty, F = (n, e, t, i) => {
  for (var o = void 0, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (o = s(e, t, o) || o);
  return o && bt(e, t, o), o;
};
const we = "swim-icon", ne = class ne extends J {
  constructor() {
...
`;
var y = /* @__PURE__ */ ((n) => (n.text = "text", n.password = "password", n.email = "email", n.number = "number", n.tel = "tel", n.url = "url", n.textarea = "textarea", n))(y || {}), ze = /* @__PURE__ */ ((n) => (n.legacy = "legacy", n.fill = "fill", n))(ze || {}), qe = /* @__PURE__ */ ((n) => (n.sm = "sm", n.md = "md", n.lg = "lg", n))(qe || {});
function z(n) {
  return n != null && `${n}` != "false";
}
var mt = Object.defineProperty, ft = Object.getOwnPropertyDescriptor, b = (n, e, t, i) => {
  for (var o = i > 1 ? void 0 : i ? ft(e, t) : e, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (o = (i ? s(e, t, o) : s(o)) || o);
  return i && o && mt(e, t, o), o;
};
const ge = "swim-input", Z = class Z extends J {
  constructor() {
...
Z.styles = [Ie, dt, ht], Z.formAssociated = !0;
let a = Z;
b([
...
customElements.get(ge) || customElements.define(ge, a);
export {
