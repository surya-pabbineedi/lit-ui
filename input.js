 ...
 */
const Y = globalThis, ee = Y.ShadowRoot && (Y.ShadyCSS === void 0 || Y.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ne = Symbol(), re = /* @__PURE__ */ new WeakMap();
let we = class {
  constructor(e, n, t) {
    if (this._$cssResult$ = !0, t !== ne) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
  ...
  get styleSheet() {
    ...
    if (ee && e === void 0) {
      ...
      t && (e = re.get(n)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), t && re.set(n, e));
    }
    return e;
  }
  toString() {
...
const ke = (i) => new we(typeof i == "string" ? i : i + "", void 0, ne), M = (i, ...e) => {
  const n = i.length === 1 ? i[0] : e.reduce((t, o, s) => t + ((r) => {
    if (r._$cssResult$ === !0) return r.cssText;
    if (typeof r == "number") return r;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + r + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(o) + i[s + 1], i[0]);
  return new we(n, i, ne);
}, Se = (i, e) => {
  if (ee) i.adoptedStyleSheets = e.map((n) => n instanceof CSSStyleSheet ? n : n.styleSheet);
  else for (const n of e) {
    const t = document.createElement("style"), o = Y.litNonce;
    o !== void 0 && t.setAttribute("nonce", o), t.textContent = n.cssText, i.appendChild(t);
  }
}, se = ee ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((e) => {
  let n = "";
...
const { is: Be, defineProperty: He, getOwnPropertyDescriptor: Je, getOwnPropertyNames: Ve, getOwnPropertySymbols: Me, getPrototypeOf: Re } = Object, E = globalThis, ce = E.trustedTypes, Ge = ce ? ce.emptyScript : "", j = E.reactiveElementPolyfillSupport, T = (i, e) => i, W = { toAttribute(i, e) {
  ...
  return n;
} }, te = (i, e) => !Be(i, e), ae = { attribute: !0, type: String, converter: W, reflect: !1, useDefault: !1, hasChanged: te };
...
let H = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, n, t) {
    ...
    return { get: o, set(r) {
      ...
      s == null || s.call(this, r), this.requestUpdate(e, a, t);
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(T("properties"))) {
      const n = this.properties, t = [...Ve(n), ...Me(n)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const o of t) n.unshift(se(o));
    } else e !== void 0 && n.push(se(e));
    return n;
  }
  static _$Eu(e, n) {
    const t = n.attribute;
  ...
  _$ET(e, n) {
    ...
    if (o !== void 0 && t.reflect === !0) {
      const r = (((s = t.converter) == null ? void 0 : s.toAttribute) !== void 0 ? t.converter : W).toAttribute(n, t.type);
  ...
  _$AK(e, n) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const a = t.getPropertyOptions(o), c = typeof a.converter == "function" ? { fromAttribute: a.converter } : ((s = a.converter) == null ? void 0 : s.fromAttribute) !== void 0 ? a.converter : W;
      this._$Em = o;
      const h = c.fromAttribute(n, a.type);
  ...
  requestUpdate(e, n, t) {
    ...
    if (e !== void 0) {
      ...
      if (t ?? (t = s.getPropertyOptions(e)), !((t.hasChanged ?? te)(r, n) || t.useDefault && t.reflect && r === ((o = this._$Ej) == null ? void 0 : o.get(e)) && !this.hasAttribute(s._$Eu(e, t)))) return;
      this.C(e, n, t);
    }
    this.isUpdatePending === !1 && (this._$ES = this._$EP());
  }
  C(e, n, { useDefault: t, reflect: o, wrapped: s }, r) {
    t && !(this._$Ej ?? (this._$Ej = /* @__PURE__ */ new Map())).has(e) && (this._$Ej.set(e, r ?? n ?? this[e]), s !== !0 || r !== void 0) || (this._$AL.has(e) || (this.hasUpdated || t || (n = void 0), this._$AL.set(e, n)), o === !0 && this._$Em !== e && (this._$Eq ?? (this._$Eq = /* @__PURE__ */ new Set())).add(e));
  }
  async _$EP() {
...
\f\r]`, G = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ge = /-->/g, be = />/g, I = RegExp(`>|${X}(?:([^\\s"'>=/]+)(${X}*=${X}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), xe = /'/g, de = /"/g, Ee = /^(?:script|style|textarea|title)$/i, Oe = (i) => (e, ...n) => ({ _$litType$: i, strings: e, values: n }), p = Oe(1), u = Symbol.for("lit-noChange"), x = Symbol.for("lit-nothing"), he = /* @__PURE__ */ new WeakMap(), q = S.createTreeWalker(S, 129);
function Ce(i, e) {
...
const Pe = (i, e) => {
  ...
  let o, s = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", r = G;
  for (let a = 0; a < n; a++) {
    const c = i[a];
    let h, f, d = -1, m = 0;
    for (; m < c.length && (r.lastIndex = m, f = r.exec(c), f !== null); ) m = r.lastIndex, r === G ? f[1] === "!--" ? r = ge : f[1] !== void 0 ? r = be : f[2] !== void 0 ? (Ee.test(f[2]) && (o = RegExp("</" + f[2], "g")), r = I) : f[3] !== void 0 && (r = I) : r === I ? f[0] === ">" ? (r = o ?? G, d = -1) : f[1] === void 0 ? d = -2 : (d = r.lastIndex - f[2].length, h = f[1], r = f[3] === void 0 ? I : f[3] === '"' ? de : xe) : r === de || r === xe ? r = I : r === ge || r === be ? r = G : (r = I, o = void 0);
    const w = r === I && i[a + 1].startsWith("/>") ? " " : "";
    s += r === G ? c + Te : d >= 0 ? (t.push(h), c.slice(0, d) + ve + c.slice(d) + A + w) : c + A + (d === -2 ? a : w);
  }
  return [Ce(i, s + (i[n] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), t];
};
class K {
  constructor({ strings: e, _$litType$: n }, t) {
    ...
    this.parts = [];
    let s = 0, r = 0;
    const a = e.length - 1, c = this.parts, [h, f] = Pe(e, n);
    if (this.el = K.createElement(h, t), q.currentNode = this.el.content, n === 2 || n === 3) {
      const d = this.el.content.firstChild;
      d.replaceWith(...d.childNodes);
    }
    for (; (o = q.nextNode()) !== null && c.length < a; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const d of o.getAttributeNames()) if (d.endsWith(ve)) {
          const m = f[r++], w = o.getAttribute(d).split(A), Q = /([.?@])?(.*)/.exec(m);
          c.push({ type: 1, index: s, name: Q[2], strings: w, ctor: Q[1] === "." ? De : Q[1] === "?" ? Fe : Q[1] === "@" ? Qe : L }), o.removeAttribute(d);
        } else d.startsWith(A) && (c.push({ type: 6, index: s }), o.removeAttribute(d));
        if (Ee.test(o.tagName)) {
          const d = o.textContent.split(A), m = d.length - 1;
          if (m > 0) {
            o.textContent = N ? N.emptyScript : "";
            for (let w = 0; w < m; w++) o.append(d[w], O()), q.nextNode(), c.push({ type: 2, index: ++s });
            o.append(d[m], O());
          }
        }
      } else if (o.nodeType === 8) if (o.data === Ae) c.push({ type: 2, index: s });
      else {
        let d = -1;
        for (; (d = o.data.indexOf(A, d + 1)) !== -1; ) c.push({ type: 7, index: s }), d += A.length - 1;
      }
      s++;
    }
  }
...
function V(i, e, n = i, t) {
  var r, a;
  if (e === u) return e;
  let o = t !== void 0 ? (r = n._$Co) == null ? void 0 : r[t] : n._$Cl;
  const s = P(e) ? void 0 : e._$litDirective$;
  return (o == null ? void 0 : o.constructor) !== s && ((a = o == null ? void 0 : o._$AO) == null || a.call(o, !1), s === void 0 ? o = void 0 : (o = new s(i), o._$AT(i, n, t)), t !== void 0 ? (n._$Co ?? (n._$Co = []))[t] = o : n._$Cl = o), o !== void 0 && (e = V(i, o._$AS(i, e.values), o, t)), e;
}
class Ke {
  constructor(e, n) {
  ...
  u(e) {
    const { el: { content: n }, parts: t } = this._$AD, o = ((e == null ? void 0 : e.creationScope) ?? S).importNode(n, !0);
    q.currentNode = o;
    let s = q.nextNode(), r = 0, a = 0, c = t[0];
    for (; c !== void 0; ) {
      if (r === c.index) {
        let h;
        c.type === 2 ? h = new D(s, s.nextSibling, this, e) : c.type === 1 ? h = new c.ctor(s, c.name, c.strings, this, e) : c.type === 6 && (h = new Ye(s, this, e)), this._$AV.push(h), c = t[++a];
      }
      r !== (c == null ? void 0 : c.index) && (s = q.nextNode(), r++);
    }
...
class D {
  ...
  constructor(e, n, t, o) {
    this.type = 2, this._$AH = x, this._$AN = void 0, this._$AA = e, this._$AB = n, this._$AM = t, this.options = o, this._$Cv = (o == null ? void 0 : o.isConnected) ?? !0;
  }
  get parentNode() {
  ...
  _$AI(e, n = this) {
    e = V(this, e, n), P(e) ? e === x || e == null || e === "" ? (this._$AH !== x && this._$AR(), this._$AH = x) : e !== this._$AH && e !== u && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Ue(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== x && P(this._$AH) ? this._$AA.nextSibling.data = e : this.T(S.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var s;
    const { values: n, _$litType$: t } = e, o = typeof t == "number" ? this._$AC(e) : (t.el === void 0 && (t.el = K.createElement(Ce(t.h, t.h[0]), this.options)), t);
  ...
  _$AC(e) {
    let n = he.get(e.strings);
    return n === void 0 && he.set(e.strings, n = new K(e)), n;
  }
  k(e) {
    oe(this._$AH) || (this._$AH = [], this._$AR());
    const n = this._$AH;
    let t, o = 0;
    for (const s of e) o === n.length ? n.push(t = new D(this.O(O()), this.O(O()), this, this.options)) : t = n[o], t._$AI(s), o++;
...
class L {
  ...
  constructor(e, n, t, o, s) {
    this.type = 1, this._$AH = x, this._$AN = void 0, this.element = e, this.name = n, this._$AM = o, this.options = s, t.length > 2 || t[0] !== "" || t[1] !== "" ? (this._$AH = Array(t.length - 1).fill(new String()), this.strings = t) : this._$AH = x;
  }
  _$AI(e, n = this, t, o) {
    const s = this.strings;
    let r = !1;
    if (s === void 0) e = V(this, e, n, 0), r = !P(e) || e !== this._$AH && e !== u, r && (this._$AH = e);
    else {
      const a = e;
      let c, h;
      for (e = s[0], c = 0; c < s.length - 1; c++) h = V(this, a[t + c], n, c), h === u && (h = this._$AH[c]), r || (r = !P(h) || h !== this._$AH[c]), h === x ? e = x : e !== x && (e += (h ?? "") + s[c + 1]), this._$AH[c] = h;
    }
    r && !o && this.j(e);
  }
  j(e) {
...
class Qe extends L {
  constructor(e, n, t, o, s) {
    super(e, n, t, o, s), this.type = 5;
  }
  _$AI(e, n = this) {
    if ((e = V(this, e, n, 0) ?? x) === u) return;
    const t = this._$AH, o = e === x && t !== x || e.capture !== t.capture || e.once !== t.once || e.passive !== t.passive, s = e !== x && (t === x || o);
    o && this.element.removeEventListener(this.name, this, t), s && this.element.addEventListener(this.name, this, e), this._$AH = e;
  }
  handleEvent(e) {
    var n;
...
const We = (i, e, n) => {
  ...
  if (o === void 0) {
    ...
    t._$litPart$ = o = new D(e.insertBefore(O(), s), s, void 0, n ?? {});
  }
  return o._$AI(i), o;
};
/**
...
let J = class extends H {
  ...
  update(e) {
    const n = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = We(n, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var e;
...
var ye;
J._$litElement$ = !0, J.finalized = !0, (ye = k.litElementHydrateSupport) == null || ye.call(k, { LitElement: J });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ne = { attribute: !0, type: String, converter: W, reflect: !1, hasChanged: te }, Ze = (i = Ne, e, n) => {
  const { kind: t, metadata: o } = n;
  let s = globalThis.litPropertyMetadata.get(o);
  if (s === void 0 && globalThis.litPropertyMetadata.set(o, s = /* @__PURE__ */ new Map()), t === "setter" && ((i = Object.create(i)).wrapped = !0), s.set(n.name, i), t === "accessor") {
    const { name: r } = n;
    return { set(a) {
      const c = e.get.call(this);
      e.set.call(this, a), this.requestUpdate(r, c, i);
    }, init(a) {
  ...
  if (t === "setter") {
    ...
    return function(a) {
      const c = this[r];
      e.call(this, a), this.requestUpdate(r, c, i);
    };
  }
  throw Error("Unsupported decorator location: " + t);
};
function b(i) {
  return (e, n) => typeof n == "object" ? Ze(i, e, n) : ((t, o, s) => {
    const r = o.hasOwnProperty(s);
    return o.constructor.createProperty(s, t), r ? Object.getOwnPropertyDescriptor(o, s) : void 0;
  })(i, e, n);
}
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Le = (i, e, n) => (n.configurable = !0, n.enumerable = !0, Reflect.decorate && typeof e != "object" && Object.defineProperty(i, e, n), n);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
class _e {
  ...
  _$AT(e, n, t) {
    this._$Ct = e, this._$AM = n, this._$Ci = t;
  }
  _$AS(e, n) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const $e = (i) => i.strings === void 0, en = {}, nn = (i, e = en) => i._$AH = e;
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
const fe = Xe(class extends _e {
  ...
  update(i, [e]) {
    if (e === u || e === x) return e;
    const n = i.element, t = i.name;
    if (i.type === B.PROPERTY) {
      if (e === n[t]) return u;
    } else if (i.type === B.BOOLEAN_ATTRIBUTE) {
      if (!!e === n.hasAttribute(t)) return u;
    } else if (i.type === B.ATTRIBUTE && n.getAttribute(t) === e + "") return u;
    return nn(i), e;
  }
});
/**
...
class sn {
  ...
  lookup(e, n) {
    ...
    return (Array.isArray(e) ? e : [e]).reduce((o, s) => {
      const r = this._expandKeys(s, t).map((a) => {
...
var bn = Object.defineProperty, F = (i, e, n, t) => {
...
const ue = "swim-icon", ie = class ie extends J {
  ...
  render() {
    var s;
    const e = this._cssClasses, n = !!this.alt, t = ((s = this.iconClass) == null ? void 0 : s.trim()) ?? "", o = t ? ` ${t}` : "";
    return !e || e.length === 0 ? p`
        <span
          part="icon"
          class="${t}"
          role="${n ? "img" : "presentation"}"
          aria-label="${n ? this.alt : x}"
...
`;
var y = /* @__PURE__ */ ((i) => (i.text = "text", i.password = "password", i.email = "email", i.number = "number", i.tel = "tel", i.url = "url", i.textarea = "textarea", i))(y || {}), ze = /* @__PURE__ */ ((i) => (i.legacy = "legacy", i.fill = "fill", i))(ze || {}), qe = /* @__PURE__ */ ((i) => (i.sm = "sm", i.md = "md", i.lg = "lg", i))(qe || {});
function z(i) {
  return i != null && `${i}` != "false";
}
var hn = Object.defineProperty, fn = Object.getOwnPropertyDescriptor, g = (i, e, n, t) => {
  for (var o = t > 1 ? void 0 : t ? fn(e, n) : e, s = i.length - 1, r; s >= 0; s--)
    (r = i[s]) && (o = (t ? r(e, n, o) : r(o)) || o);
  return t && o && hn(e, n, o), o;
};
const me = "swim-input", Z = class Z extends J {
  constructor() {
  ...
  set value(e) {
    const n = this._value;
    this._value = e, this._internals.setFormValue(e), this.requestUpdate("value", n), this._updateActiveState();
  }
  get disabled() {
  ...
  focus(e) {
    var n;
    (n = this.inputElement) == null || n.focus(e);
  }
  updated(e) {
    super.updated(e), e.has("value") && this._updateActiveState(), (e.has("required") || e.has("min") || e.has("max")) && this._validate();
  }
  render() {
    const e = this.type === y.textarea, n = this.type === y.password && this.passwordToggleEnabled && !this.disabled, t = this.type === y.number && !this.disabled, o = this._passwordVisible ? y.text : this.type;
    return p`
        ...
        <div class="input-flex-wrap">
          ...
          <div class="input-flex-wrap-inner">
            ...
            <label class="input-label" part="label" for="${this.id}">
              ${this.label} ${this.required ? p`<span>${this.requiredIndicator}</span>` : x}
            </label>
          </div>
  ...
  _handleInput(e) {
    const n = e.target;
    this.value = n.value, this._dirty || (this._dirty = !0, this.setAttribute("dirty", "")), this.dispatchEvent(new Event("input", { bubbles: !0, composed: !0 }));
  }
  _handleChange(e) {
  ...
  _increment() {
    if (this.inputElement && this.type === y.number) {
      const e = this.inputElement, n = parseFloat(e.value) || 0;
      if (this.max !== void 0 && n >= this.max) return;
      const t = n + 1;
      this.value = t.toString(), this.dispatchEvent(new Event("change", { bubbles: !0, composed: !0 }));
    }
  }
  _decrement() {
    if (this.inputElement && this.type === y.number) {
      const e = this.inputElement, n = parseFloat(e.value) || 0;
      if (this.min !== void 0 && n <= this.min) return;
      const t = n - 1;
      this.value = t.toString(), this.dispatchEvent(new Event("change", { bubbles: !0, composed: !0 }));
    }
  }
  _validate() {
    ...
    if (this.required && !this.value && (e = !1), this.type === y.number && this.value) {
      ...
      this.min !== void 0 && n < this.min && (e = !1), this.max !== void 0 && n > this.max && (e = !1);
    }
  ...
  _updateActiveState() {
    const e = this.value && this.value.length > 0, n = !!this.placeholder;
    this._focused || e ? this.setAttribute("active", "") : this.removeAttribute("active"), n ? this.setAttribute("has-placeholder", "") : this.removeAttribute("has-placeholder"), this.label ? this.removeAttribute("no-label") : this.setAttribute("no-label", "");
  }
  // Form API
  formResetCallback() {
...
Z.styles = [Ie, xn, dn], Z.formAssociated = !0;
let l = Z;
g([
...
g([
  b({ type: Boolean, reflect: !0, attribute: "marginless" })
], l.prototype, "marginless", 1);
g([
  b({ type: Boolean })
], l.prototype, "withHint", 1);
g([
  b({ type: Boolean, attribute: "password-toggle-enabled" })
...
g([
  b({ type: Number, attribute: "textarea-rows" })
], l.prototype, "textareaRows", 2);
g([
  b({ type: String, attribute: "required-indicator" })
...
customElements.get(me) || customElements.define(me, l);
export {
