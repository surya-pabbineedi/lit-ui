...
`;var sr=Object.defineProperty,rr=Object.getOwnPropertyDescriptor,tt=(n,e,t,o)=>{for(var i=o>1?void 0:o?rr(e,t):e,s=n.length-1,r;s>=0;s--)(r=n[s])&&(i=(o?r(e,t,i):r(i))||i);return o&&i&&sr(e,t,i),i};let ar=0;const Wo="swim-tab",Fi=class Fi extends _{constructor(){super(...arguments),this._instanceId=++ar,this._generatedPanelId=`tab-panel-${this._instanceId}`,this._generatedTabId=`tab-${this._instanceId}`,this.tabId=this._generatedTabId,this.label="",this._active=!1,this._disabled=!1}get id(){return this._id??this._generatedPanelId}set id(e){this._id=e||this._generatedPanelId}get title(){return this.label}set title(e){this.label=e}get active(){return this._active}set active(e){const t=g(e);if(this._active!==t){const o=this._active;this._active=t,this.requestUpdate("active",o),this.dispatchEvent(new CustomEvent("swim-tab-active-change",{bubbles:!0,composed:!0}))}}get disabled(){return this._disabled}set disabled(e){this._disabled=g(e)}connectedCallback(){super.connectedCallback(),this.hasAttribute("tab-id")||(this.tabId=this._generatedTabId)}render(){return c`
    ...
    `}};Fi.styles=[y,nr];let re=Fi;tt([a({type:String})],re.prototype,"id",1);tt([a({type:String,attribute:"tab-id"})],re.prototype,"tabId",2);tt([a({type:String})],re.prototype,"label",2);tt([a({type:String})],re.prototype,"title",1);tt([a({type:Boolean,reflect:!0})],re.prototype,"active",1);tt([a({type:Boolean,reflect:!0})],re.prototype,"disabled",1);customElements.get(Wo)||customElements.define(Wo,re);const lr=f`
  :host {
    display: block;
    margin-bottom: 2em;
  }
...
`;var ur=Object.defineProperty,pr=Object.getOwnPropertyDescriptor,it=(n,e,t,o)=>{for(var i=o>1?void 0:o?pr(e,t):e,s=n.length-1,r;s>=0;s--)(r=n[s])&&(i=(o?r(e,t,i):r(i))||i);return o&&i&&ur(e,t,i),i};let gr=0;const Qo="swim-button-toggle",Mi=class Mi extends _{constructor(){super(...arguments),this._uniqueId=`swim-button-toggle-${++gr}`,this.name=this._uniqueId,this.value=!1,this._checked=!1,this._disabled=!1}get id(){return this._id??this._uniqueId}set id(e){this._id=e}get checked(){return this._checked}set checked(e){const t=g(e);this._checked!==t&&(this._checked=t,this.requestUpdate("checked"))}get disabled(){return this._disabled}set disabled(e){this._disabled=g(e)}render(){return c`
    ...
    `}_handleClick(e){e.preventDefault(),e.stopPropagation(),!(this.disabled||this.checked)&&(this._checked=!0,this.dispatchEvent(new CustomEvent("value-change",{detail:this.value,bubbles:!0,composed:!0})))}};Mi.styles=[y,hr];let _e=Mi;it([a({type:String})],_e.prototype,"id",1);it([a({type:String})],_e.prototype,"name",2);it([a()],_e.prototype,"value",2);it([a({type:Boolean,reflect:!0})],_e.prototype,"checked",1);it([x()],_e.prototype,"_checked",2);it([a({type:Boolean,reflect:!0})],_e.prototype,"disabled",1);customElements.get(Qo)||customElements.define(Qo,_e);const br=f`
  :host {
    display: inline-flex;
...
`,Cr=[y,wr,yr,kr];var vt=(n=>(n.Success="success",n.Error="error",n.Disabled="disabled",n))(vt||{}),Qn=(n=>(n.Horizontal="horizontal",n.Vertical="vertical",n))(Qn||{}),Yn=(n=>(n.Normal="normal",n.Flat="flat",n))(Yn||{});const Er=f`
  :host {
    display: inline-flex;
  }
...
`,Or=[y,Tr];var Lr=Object.defineProperty,Zn=(n,e,t,o)=>{for(var i=void 0,s=n.length-1,r;s>=0;s--)(r=n[s])&&(i=r(e,t,i)||i);return i&&Lr(e,t,i),i};const nn="swim-card-header",Hi=class Hi extends _{constructor(){super(...arguments),this.label="",this.orientation="horizontal"}render(){return c`
    ...
    `}};Hi.styles=Or;let _t=Hi;Zn([a({type:String})],_t.prototype,"label");Zn([a({type:String,reflect:!0})],_t.prototype,"orientation");customElements.get(nn)||customElements.define(nn,_t);const Pr=f`
  :host {
    position: relative;
    display: flex;
    align-items: center;
...
`,wa=[y,xa];function is(n){const[e,t,o]=n;return`${e} ${t} ${o}`}function je(n,e,t){const o=t.split(" ");return o.length===3?o:[n,e,t]}var ya=Object.defineProperty,ka=Object.getOwnPropertyDescriptor,oi=(n,e,t,o)=>{for(var i=o>1?void 0:o?ka(e,t):e,s=n.length-1,r;s>=0;s--)(r=n[s])&&(i=(o?r(e,t,i):r(i))||i);return o&&i&&ya(e,t,i),i};const lt="1 1 1e-9px",vn="swim-split-area",Wi=class Wi extends _{constructor(){super(...arguments),this._areaBasis=lt,this.shouldAdjustMaxMin=!1,this.initialFlexParts=je("1","1",lt),this.currentFlexParts=je("1","1",lt)}get areaBasis(){return this._areaBasis}set areaBasis(e){this._areaBasis!==e&&(this._areaBasis=e||lt,this._applyBasis())}connectedCallback(){super.connectedCallback(),this._applyBasis()}updated(){this.style.flex=is(this.currentFlexParts),this.shouldAdjustMaxMin&&this.currentFlexParts[2]?(this.style.minWidth=this.currentFlexParts[2],this.style.maxWidth=this.currentFlexParts[2]):(this.style.minWidth="",this.style.maxWidth="")}updateBasis(e){this.currentFlexParts[2]=e,this.requestUpdate()}_applyBasis(){const e=this._areaBasis||lt,[t,o,i]=je("1","1",e);this.currentFlexParts=[t,o,i],this.initialFlexParts=[t,o,i],!this.minBasis&&o==="0"&&(this.minBasis=i),!this.maxBasis&&t==="0"&&(this.maxBasis=i),this.requestUpdate()}render(){return c`<slot></slot>`}};Wi.styles=wa;let qe=Wi;oi([a({type:String,attribute:"area-basis"})],qe.prototype,"areaBasis",1);oi([a({type:String,attribute:"min-basis"})],qe.prototype,"minBasis",2);oi([a({type:String,attribute:"max-basis"})],qe.prototype,"maxBasis",2);oi([a({type:Boolean,attribute:"should-adjust-max-min"})],qe.prototype,"shouldAdjustMaxMin",2);customElements.get(vn)||customElements.define(vn,qe);const Ca=f`
  :host {
    position: relative;
    box-sizing: border-box;
    flex-shrink: 0;
...
`,Ea=[y,Ca];var We=(n=>(n.Row="row",n.Column="column",n))(We||{}),Aa=Object.defineProperty,Sa=Object.getOwnPropertyDescriptor,os=(n,e,t,o)=>{for(var i=o>1?void 0:o?Sa(e,t):e,s=n.length-1,r;s>=0;s--)(r=n[s])&&(i=(o?r(e,t,i):r(i))||i);return o&&i&&Aa(e,t,i),i};const Ft="0 0 15px",_n="swim-split-handle",ji=class ji extends _{constructor(){super(...arguments),this._handleBasis=Ft,this.direction=We.Row,this.currentFlexParts=je("0","0",Ft),this._boundMouseUp=this._onMouseUp.bind(this),this._boundMouseMove=this._onMouseMove.bind(this)}get handleBasis(){return this._handleBasis}set handleBasis(e){this._handleBasis!==e&&(this._handleBasis=e||Ft,this.currentFlexParts=je("0","0",this._handleBasis),this.requestUpdate())}connectedCallback(){super.connectedCallback(),this.currentFlexParts=je("0","0",this._handleBasis||Ft)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mouseup",this._boundMouseUp,!0),document.removeEventListener("mousemove",this._boundMouseMove,!0)}updated(){this.style.flex=is(this.currentFlexParts)}_onMouseDown(e){e.preventDefault(),document.addEventListener("mouseup",this._boundMouseUp,!0),document.addEventListener("mousemove",this._boundMouseMove,!0),this.dispatchEvent(new CustomEvent("dragstart",{detail:e,bubbles:!0,composed:!0}))}_onMouseMove(e){this.dispatchEvent(new CustomEvent("drag",{detail:e,bubbles:!0,composed:!0}))}_onMouseUp(e){document.removeEventListener("mouseup",this._boundMouseUp,!0),document.removeEventListener("mousemove",this._boundMouseMove,!0),this.dispatchEvent(new CustomEvent("dragend",{detail:e,bubbles:!0,composed:!0}))}_onDblClick(e){this.dispatchEvent(new CustomEvent("dblclick",{detail:e,bubbles:!0,composed:!0}))}render(){return c`
      <button
        type="button"
    ...
    `}};ji.styles=Ea;let xt=ji;os([a({type:String,attribute:"handle-basis"})],xt.prototype,"handleBasis",1);os([a({type:String,reflect:!0})],xt.prototype,"direction",2);customElements.get(_n)||customElements.define(_n,xt);const Ia=f`
  :host {
    display: flex;
    height: 100%;
    width: 100%;
...
`;var Xa=Object.defineProperty,el=Object.getOwnPropertyDescriptor,Oi=(n,e,t,o)=>{for(var i=el(e,t),s=n.length-1,r;s>=0;s--)(r=n[s])&&(i=r(e,t,i)||i);return i&&Xa(e,t,i),i};const In="swim-navbar-item",Xi=class Xi extends _{constructor(){super(...arguments),this._active=0,this._total=0,this._index=0,this._clickBound=()=>this._handleClick()}get active(){return this._active}set active(e){const t=S(e,0);if(this._active!==t){const o=this._active;this._active=t,this.requestUpdate("active",o)}}get total(){return this._total}set total(e){this._total=S(e,0)}get index(){return this._index}set index(e){const t=S(e,0);if(this._index!==t){const o=this._index;this._index=t,this.requestUpdate("index",o)}}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this._clickBound)}disconnectedCallback(){this.removeEventListener("click",this._clickBound),super.disconnectedCallback()}render(){const e=this._active===this._index;return c`
  ...
  `];var ut=(n=>(n.Regular="regular",n.Medium="medium",n.Large="large",n))(ut||{}),ll=Object.defineProperty,cl=Object.getOwnPropertyDescriptor,$=(n,e,t,o)=>{for(var i=o>1?void 0:o?cl(e,t):e,s=n.length-1,r;s>=0;s--)(r=n[s])&&(i=(o?r(e,t,i):r(i))||i);return o&&i&&ll(e,t,i),i};const On="swim-dialog",io=class io extends _{constructor(){super(...arguments),this.dialogTitle="",this.content="",this.class="",this.cssClass="",this.format=ut.Regular,this.showBackdrop=!0,this._closeButton=!0,this._visible=!1,this._zIndex=991,this._contentId=`swim-dialog-content-${Math.random().toString(36).slice(2,11)}`,this._titleId=`swim-dialog-title-${Math.random().toString(36).slice(2,11)}`,this._previousActiveElement=null}get title(){return this.dialogTitle}set title(e){e&&(this.dialogTitle=e)}get closeButton(){return this._closeButton}set closeButton(e){this._closeButton=g(e)}get visible(){return this._visible}set visible(e){const t=g(e);this._visible!==t&&(this._visible=t,t?(this._previousActiveElement=typeof document<"u"?document.activeElement:null,this.dispatchEvent(new CustomEvent("open",{bubbles:!0}))):(this._restoreFocus(),this.dispatchEvent(new CustomEvent("close",{detail:void 0,bubbles:!0}))))}get zIndex(){return this._zIndex}set zIndex(e){this._zIndex=S(e,991)}get _contentzIndex(){return this.zIndex+1}get _canClose(){return this.beforeClose?this.beforeClose():!0}_restoreFocus(){this._previousActiveElement&&typeof this._previousActiveElement.focus=="function"&&this._previousActiveElement.focus(),this._previousActiveElement=null}show(){this.visible=!0}hide(){this._canClose&&(this.visible=!1)}firstUpdated(){this.visible&&this._contentEl&&this._contentEl.focus({preventScroll:!0})}updated(e){e.has("visible")&&this.visible&&this._contentEl&&requestAnimationFrame(()=>{var t;(t=this._contentEl)==null||t.focus({preventScroll:!0})})}render(){if(!this.visible)return h;const e=this.format===ut.Regular||this.format==="regular",t=this.format===ut.Large||this.format==="large",o=this.format===ut.Medium||this.format==="medium",i=["swim-dialog__content",this.cssClass,t?"swim-dialog__content--large":"",o?"swim-dialog__content--medium":""].filter(Boolean).join(" "),s=this.class.includes("swim-dialog--full-screen"),r=["swim-dialog","swim-dialog--open",this.class,s?"swim-scroll":""].filter(Boolean).join(" ");return c`
  ...
  `];var hl=Object.defineProperty,ot=(n,e,t,o)=>{for(var i=void 0,s=n.length-1,r;s>=0;s--)(r=n[s])&&(i=r(e,t,i)||i);return i&&hl(e,t,i),i};const Ln="swim-large-format-dialog-content",oo=class oo extends _{constructor(){super(...arguments),this.format="large",this.dialogTitle="",this.dialogSubtitle="",this.dialogActionTitle="Close",this.dialogDirtyActionTitle="Cancel",this.dirty=!1}_onCloseOrCancel(){this.dispatchEvent(new CustomEvent("close-or-cancel",{detail:this.dirty,bubbles:!0,composed:!0}))}render(){const e=["format-dialog-container__header-title","format-dialog-container__header-title--with-subtitle"].join(" ");return c`
    ...
    `}};oo.styles=[kt,dl];let xe=oo;ot([a({type:String,reflect:!0})],xe.prototype,"format");ot([a({type:String,attribute:"dialog-title"})],xe.prototype,"dialogTitle");ot([a({type:String,attribute:"dialog-subtitle"})],xe.prototype,"dialogSubtitle");ot([a({type:String,attribute:"dialog-action-title"})],xe.prototype,"dialogActionTitle");ot([a({type:String,attribute:"dialog-dirty-action-title"})],xe.prototype,"dialogDirtyActionTitle");ot([a({type:Boolean,reflect:!0})],xe.prototype,"dirty");customElements.get(Ln)||customElements.define(Ln,xe);const ul=[y,f`
    :host {
...
Age: ${Pt}`)})}Cl();const i=document.getElementById("selectableCardDemo"),s=document.getElementById("cardSelectedValue");i&&s&&i.addEventListener("select",z=>{s.textContent=String(z.detail??!1)});const r=document.getElementById("outlineCardDemo");r&&r.addEventListener("outline-click",()=>console.log("Outline clicked"));const l=document.getElementById("checkboxDemoEvent"),d=document.getElementById("checkboxDemoChecked"),u=document.getElementById("checkboxDemoEventName");l&&d&&u&&(l.addEventListener("checked-change",z=>{d.textContent=String(z.detail),u.textContent="checked-change"}),l.addEventListener("change",()=>{u.textContent="change"}),l.addEventListener("focus",()=>{u.textContent="focus"}),l.addEventListener("blur",()=>{u.textContent="blur"}),d.textContent=String(l.checked));const v=document.getElementById("radioSingleValue"),p=["radioSeasonSpring","radioSeasonSummer","radioSeasonFall","radioSeasonWinter"];p.forEach(z=>{const T=document.getElementById(z);T&&v&&T.addEventListener("change",q=>{const M=q.detail;p.forEach(be=>{const ie=document.getElementById(be);ie&&(ie.checked=ie.value===M)}),v.textContent=String(M??"")})});const b=document.getElementById("radioGroupDemo"),m=document.getElementById("radioGroupValue");b&&m&&(m.textContent=String(b.value??"—"),b.addEventListener("change",z=>{m.textContent=String(z.detail??"—")}));const E=document.getElementById("progressSpinnerWithLabel");E&&(E.spinnerLabel={inProgressLabel:"Loading...",completeLabel:"Complete!",failLabel:"Failed"});const A=document.getElementById("progressSpinnerConfigurable"),j=document.getElementById("progressSpinnerConfigurableCode"),ne=["progressSpinnerValue","progressSpinnerTotal","progressSpinnerDiameter","progressSpinnerStrokeWidth","progressSpinnerColor","progressSpinnerMode","progressSpinnerCompleteStatus","progressSpinnerShowIcon"];function te(){var Io;if(!A)return;const z=document.getElementById("progressSpinnerValue"),T=document.getElementById("progressSpinnerTotal"),q=document.getElementById("progressSpinnerDiameter"),M=document.getElementById("progressSpinnerStrokeWidth"),be=document.getElementById("progressSpinnerColor"),ie=document.getElementById("progressSpinnerMode"),Ge=document.getElementById("progressSpinnerCompleteStatus"),Ue=document.getElementById("progressSpinnerShowIcon"),Pt=(z==null?void 0:z.value)??"35",li=(T==null?void 0:T.value)??"100",yo=(q==null?void 0:q.value)??"100",ko=(M==null?void 0:M.value)??"5",Co=(be==null?void 0:be.value)??"lime",Eo=(ie==null?void 0:ie.value)??"indeterminate",Dt=(Ge==null?void 0:Ge.value)??"success",Ao=(Ue==null?void 0:Ue.checked)!==!1,So=Dt==="fail"||Dt==="success"?li:Pt;if(A.value=Number(So),A.total=Number(li),A.diameter=Number(yo),A.strokeWidth=Number(ko),A.color=Co,A.setAttribute("mode",Eo),A.isFailure=Dt==="fail",A.appearance=Ao?"icon":"default",(Io=A.requestUpdate)==null||Io.call(A),j){const cs=Dt==="fail"?`
  ...
  aria-label="...">
</swim-progress-spinner>`}}if(A){const z=document.getElementById("progressSpinnerMode");z&&z.addEventListener("change",()=>setTimeout(te,0)),ne.forEach(q=>{const M=document.getElementById(q);M&&M!==z&&(M.addEventListener("input",te),M.addEventListener("change",te))}),z&&z.addEventListener("input",te);const T=document.getElementById("progressSpinnerShowIcon");T&&T.addEventListener("change",te),te()}const $e=document.getElementById("sliderDemoEvent"),Ve=document.getElementById("sliderDemoValue"),nt=document.getElementById("sliderDemoPercent");$e&&Ve&&nt&&$e.addEventListener("change",z=>{const T=z.detail;Ve.textContent=String((T==null?void 0:T.value)??""),nt.textContent=String((T==null?void 0:T.percent)??"")});const Ne=document.getElementById("toggleDemoEvent"),si=document.getElementById("toggleDemoChecked"),Ct=document.getElementById("toggleDemoEventName");Ne&&si&&Ct&&(Ne.addEventListener("change",()=>{si.textContent=String(Ne.checked),Ct.textContent="change"}),Ne.addEventListener("focus",()=>{Ct.textContent="focus"}),Ne.addEventListener("blur",()=>{Ct.textContent="blur"}),si.textContent=String(Ne.checked));const ro=document.getElementById("seasonToggleGroup"),ao=document.getElementById("seasonValue");ro&&ao&&ro.addEventListener("value-change",z=>{ao.textContent=String(z.detail??"")});const Et=document.getElementById("disabledGroupDemo"),ri=document.getElementById("toggleGroupDisabledBtn");Et&&ri&&ri.addEventListener("click",()=>{Et.disabled=!Et.disabled,ri.textContent=Et.disabled?"Enable group":"Disable group"}),kl(),El();const lo=document.getElementById("dialogContentOpen"),At=document.getElementById("dialogContentDemo");lo&&At&&(lo.addEventListener("click",()=>{At.visible=!0}),At.addEventListener("close",()=>{At.visible=!1}));const co=document.getElementById("dialogComponentToggle"),st=document.getElementById("dialogComponentDemo");co&&st&&(co.addEventListener("click",()=>{st.visible=!st.visible}),st.addEventListener("close",()=>{st.visible=!1}));const ho=document.getElementById("dialogWizardOpen"),St=document.getElementById("dialogWizardDemo");ho&&St&&(ho.addEventListener("click",()=>{St.visible=!0}),St.addEventListener("close",()=>{St.visible=!1}));const Ce=document.getElementById("dialogWizardTabs"),uo=document.getElementById("dialogWizardPrev"),po=document.getElementById("dialogWizardNext");uo&&(Ce!=null&&Ce.prev)&&uo.addEventListener("click",()=>Ce.prev()),po&&(Ce!=null&&Ce.next)&&po.addEventListener("click",()=>Ce.next());const go=document.getElementById("dialogFullScreenOpen"),It=document.getElementById("dialogFullScreenDemo");go&&It&&(go.addEventListener("click",()=>{It.visible=!0}),It.addEventListener("close",()=>{It.visible=!1}));const bo=document.getElementById("dialogLargeFormatOpen"),zt=document.getElementById("dialogLargeFormatDemo");bo&&zt&&(bo.addEventListener("click",()=>{zt.visible=!0}),zt.addEventListener("close-or-cancel",()=>{zt.visible=!1}));const mo=document.getElementById("dialogMediumFormatOpen"),Bt=document.getElementById("dialogMediumFormatDemo");mo&&Bt&&(mo.addEventListener("click",()=>{Bt.visible=!0}),Bt.addEventListener("close-or-cancel",()=>{Bt.visible=!1}));const fo=document.getElementById("dialogMediumContentOpen"),Tt=document.getElementById("dialogMediumContentDemo");fo&&Tt&&(fo.addEventListener("click",()=>{Tt.visible=!0}),Tt.addEventListener("close-or-cancel",()=>{Tt.visible=!1}));const vo=document.getElementById("dialogMediumFooterOpen"),Ot=document.getElementById("dialogMediumFooterDemo");vo&&Ot&&(vo.addEventListener("click",()=>{Ot.visible=!0}),Ot.addEventListener("close-or-cancel",()=>{Ot.visible=!1}));const _o=document.getElementById("dialogMediumFooterContentOpen"),Lt=document.getElementById("dialogMediumFooterContentDemo");_o&&Lt&&(_o.addEventListener("click",()=>{Lt.visible=!0}),Lt.addEventListener("close-or-cancel",()=>{Lt.visible=!1}));const xo=document.getElementById("navbarGoToFourthBtn"),ai=document.getElementById("navbarTopDemo");xo&&ai&&"goTo"in ai&&xo.addEventListener("click",()=>ai.goTo(3));const wo=document.getElementById("selectForm");wo&&wo.addEventListener("submit",z=>{z.preventDefault();const T=document.getElementById("formSelect1"),q=document.getElementById("formSelect2");console.log("Select Form submitted!"),alert(`Form submitted!
Category: ${T.value}
Tags: ${JSON.stringify(q.value)}`)})}async function Sl(){document.querySelectorAll('.sub-nav-item[href^="#"]').forEach(r=>{r.addEventListener("click",l=>{const d=r.getAttribute("href");if(!d||d==="#")return;const u=d.slice(1).toLowerCase();ls.has(u)&&(l.preventDefault(),window.location.hash!==d?window.location.hash=u:mi(u))})}),window.addEventListener("hashchange",()=>{const r=bi();n(r),mi(r)});function n(r){const l=r??bi();document.querySelectorAll(".sub-nav-item.active, .nav-item.active").forEach(d=>d.classList.remove("active")),document.querySelectorAll(`.sub-nav-item[href="#${l}"], .nav-item[href="#${l}"]`).forEach(d=>d.classList.add("active"))}const e=bi();window.location.hash.slice(1).toLowerCase()!==e&&history.replaceState(null,"",`#${e}`),n(e),await mi(e);const t=document.getElementById("navSearch"),o=document.querySelectorAll(".nav-item-container"),i=document.querySelectorAll(".sub-nav-item");function s(){if(!t)return;const r=t.value.trim().toLowerCase();i.forEach(l=>{var u;const d=((u=l.textContent)==null?void 0:u.trim().toLowerCase())??"";l.classList.toggle("nav-search-hidden",r.length>0&&!d.includes(r))}),o.forEach(l=>{var m;const d=l.querySelector(".nav-item-label"),u=((m=d==null?void 0:d.textContent)==null?void 0:m.trim().toLowerCase())??"",v=l.querySelectorAll(".sub-nav-item:not(.nav-search-hidden)").length,p=r.length===0||u.includes(r),b=v>0;l.classList.toggle("nav-search-hidden",r.length>0&&!p&&!b)})}t&&(t.addEventListener("input",s),t.addEventListener("keydown",r=>{r.key==="Escape"&&(t.value="",s(),t.blur())})),console.log("✨ @swimlane/lit-ui demo loaded successfully!")}document.addEventListener("DOMContentLoaded",()=>{const n=kt.styleSheet;n&&(document.adoptedStyleSheets=[...document.adoptedStyleSheets,n]),Sl()});
