 ...
 */const Ht=globalThis,_i=Ht.ShadowRoot&&(Ht.ShadyCSS===void 0||Ht.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,vi=Symbol(),Zi=new WeakMap;let Io=class{constructor(t,i,n){if(this._$cssResult$=!0,n!==vi)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=i}get styleSheet(){let t=this.o;const i=this.t;if(_i&&t===void 0){const n=i!==void 0&&i.length===1;n&&(t=Zi.get(i)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),n&&Zi.set(i,t))}return t}toString(){return this.cssText}};const Zo=e=>new Io(typeof e=="string"?e:e+"",void 0,vi),f=(e,...t)=>{const i=e.length===1?e[0]:t.reduce((n,o,s)=>n+(r=>{if(r._$cssResult$===!0)return r.cssText;if(typeof r=="number")return r;throw Error("Value passed to 'css' function must be a 'css' function result: "+r+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+e[s+1],e[0]);return new Io(i,e,vi)},Jo=(e,t)=>{if(_i)e.adoptedStyleSheets=t.map(i=>i instanceof CSSStyleSheet?i:i.styleSheet);else for(const i of t){const n=document.createElement("style"),o=Ht.litNonce;o!==void 0&&n.setAttribute("nonce",o),n.textContent=i.cssText,e.appendChild(n)}},Ji=_i?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let i="";for(const n of t.cssRules)i+=n.cssText;return Zo(i)})(e):e;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:en,defineProperty:tn,getOwnPropertyDescriptor:on,getOwnPropertyNames:nn,getOwnPropertySymbols:sn,getPrototypeOf:rn}=Object,ze=globalThis,eo=ze.trustedTypes,an=eo?eo.emptyScript:"",ri=ze.reactiveElementPolyfillSupport,gt=(e,t)=>e,jt={toAttribute(e,t){switch(t){case Boolean:e=e?an:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let i=e;switch(t){case Boolean:i=e!==null;break;case Number:i=e===null?null:Number(e);break;case Object:case Array:try{i=JSON.parse(e)}catch{i=null}}return i}},wi=(e,t)=>!en(e,t),to={attribute:!0,type:String,converter:jt,reflect:!1,useDefault:!1,hasChanged:wi};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),ze.litPropertyMetadata??(ze.litPropertyMetadata=new WeakMap);let Xe=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,i=to){if(i.state&&(i.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((i=Object.create(i)).wrapped=!0),this.elementProperties.set(t,i),!i.noAccessor){const n=Symbol(),o=this.getPropertyDescriptor(t,n,i);o!==void 0&&tn(this.prototype,t,o)}}static getPropertyDescriptor(t,i,n){const{get:o,set:s}=on(this.prototype,t)??{get(){return this[i]},set(r){this[i]=r}};return{get:o,set(r){const c=o==null?void 0:o.call(this);s==null||s.call(this,r),this.requestUpdate(t,c,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??to}static _$Ei(){if(this.hasOwnProperty(gt("elementProperties")))return;const t=rn(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(gt("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(gt("properties"))){const i=this.properties,n=[...nn(i),...sn(i)];for(const o of n)this.createProperty(o,i[o])}const t=this[Symbol.metadata];if(t!==null){const i=litPropertyMetadata.get(t);if(i!==void 0)for(const[n,o]of i)this.elementProperties.set(n,o)}this._$Eh=new Map;for(const[i,n]of this.elementProperties){const o=this._$Eu(i,n);o!==void 0&&this._$Eh.set(o,i)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const i=[];if(Array.isArray(t)){const n=new Set(t.flat(1/0).reverse());for(const o of n)i.unshift(Ji(o))}else t!==void 0&&i.push(Ji(t));return i}static _$Eu(t,i){const n=i.attribute;return n===!1?void 0:typeof n=="string"?n:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var t;this._$ES=new Promise(i=>this.enableUpdating=i),this._$AL=new Map,this._$E_(),this.requestUpdate(),(t=this.constructor.l)==null||t.forEach(i=>i(this))}addController(t){var i;(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&((i=t.hostConnected)==null||i.call(t))}removeController(t){var i;(i=this._$EO)==null||i.delete(t)}_$E_(){const t=new Map,i=this.constructor.elementProperties;for(const n of i.keys())this.hasOwnProperty(n)&&(t.set(n,this[n]),delete this[n]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Jo(t,this.constructor.elementStyles),t}connectedCallback(){var t;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$EO)==null||t.forEach(i=>{var n;return(n=i.hostConnected)==null?void 0:n.call(i)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$EO)==null||t.forEach(i=>{var n;return(n=i.hostDisconnected)==null?void 0:n.call(i)})}attributeChangedCallback(t,i,n){this._$AK(t,n)}_$ET(t,i){var s;const n=this.constructor.elementProperties.get(t),o=this.constructor._$Eu(t,n);if(o!==void 0&&n.reflect===!0){const r=(((s=n.converter)==null?void 0:s.toAttribute)!==void 0?n.converter:jt).toAttribute(i,n.type);this._$Em=t,r==null?this.removeAttribute(o):this.setAttribute(o,r),this._$Em=null}}_$AK(t,i){var s,r;const n=this.constructor,o=n._$Eh.get(t);if(o!==void 0&&this._$Em!==o){const c=n.getPropertyOptions(o),d=typeof c.converter=="function"?{fromAttribute:c.converter}:((s=c.converter)==null?void 0:s.fromAttribute)!==void 0?c.converter:jt;this._$Em=o;const p=d.fromAttribute(i,c.type);this[o]=p??((r=this._$Ej)==null?void 0:r.get(o))??p,this._$Em=null}}requestUpdate(t,i,n){var o;if(t!==void 0){const s=this.constructor,r=this[t];if(n??(n=s.getPropertyOptions(t)),!((n.hasChanged??wi)(r,i)||n.useDefault&&n.reflect&&r===((o=this._$Ej)==null?void 0:o.get(t))&&!this.hasAttribute(s._$Eu(t,n))))return;this.C(t,i,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,i,{useDefault:n,reflect:o,wrapped:s},r){n&&!(this._$Ej??(this._$Ej=new Map)).has(t)&&(this._$Ej.set(t,r??i??this[t]),s!==!0||r!==void 0)||(this._$AL.has(t)||(this.hasUpdated||n||(i=void 0),this._$AL.set(t,i)),o===!0&&this._$Em!==t&&(this._$Eq??(this._$Eq=new Set)).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(i){Promise.reject(i)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var n;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[s,r]of this._$Ep)this[s]=r;this._$Ep=void 0}const o=this.constructor.elementProperties;if(o.size>0)for(const[s,r]of o){const{wrapped:c}=r,d=this[s];c!==!0||this._$AL.has(s)||d===void 0||this.C(s,void 0,r,d)}}let t=!1;const i=this._$AL;try{t=this.shouldUpdate(i),t?(this.willUpdate(i),(n=this._$EO)==null||n.forEach(o=>{var s;return(s=o.hostUpdate)==null?void 0:s.call(o)}),this.update(i)):this._$EM()}catch(o){throw t=!1,this._$EM(),o}t&&this._$AE(i)}willUpdate(t){}_$AE(t){var i;(i=this._$EO)==null||i.forEach(n=>{var o;return(o=n.hostUpdated)==null?void 0:o.call(n)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&(this._$Eq=this._$Eq.forEach(i=>this._$ET(i,this[i]))),this._$EM()}updated(t){}firstUpdated(t){}};Xe.elementStyles=[],Xe.shadowRootOptions={mode:"open"},Xe[gt("elementProperties")]=new Map,Xe[gt("finalized")]=new Map,ri==null||ri({ReactiveElement:Xe}),(ze.reactiveElementVersions??(ze.reactiveElementVersions=[])).push("2.1.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const bt=globalThis,Ut=bt.trustedTypes,io=Ut?Ut.createPolicy("lit-html",{createHTML:e=>e}):void 0,Ao="$lit$",Ae=`lit$${Math.random().toFixed(9).slice(2)}$`,zo="?"+Ae,ln=`<${zo}>`,Me=document,mt=()=>Me.createComment(""),ft=e=>e===null||typeof e!="object"&&typeof e!="function",xi=Array.isArray,cn=e=>xi(e)||typeof(e==null?void 0:e[Symbol.iterator])=="function",ai=`[ 	
\f\r]`,at=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,oo=/-->/g,no=/>/g,Le=RegExp(`>|${ai}(?:([^\\s"'>=/]+)(${ai}*=${ai}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),so=/'/g,ro=/"/g,Bo=/^(?:script|style|textarea|title)$/i,dn=e=>(t,...i)=>({_$litType$:e,strings:t,values:i}),l=dn(1),ee=Symbol.for("lit-noChange"),h=Symbol.for("lit-nothing"),ao=new WeakMap,De=Me.createTreeWalker(Me,129);function To(e,t){if(!xi(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return io!==void 0?io.createHTML(t):t}const hn=(e,t)=>{const i=e.length-1,n=[];let o,s=t===2?"<svg>":t===3?"<math>":"",r=at;for(let c=0;c<i;c++){const d=e[c];let p,w,u=-1,b=0;for(;b<d.length&&(r.lastIndex=b,w=r.exec(d),w!==null);)b=r.lastIndex,r===at?w[1]==="!--"?r=oo:w[1]!==void 0?r=no:w[2]!==void 0?(Bo.test(w[2])&&(o=RegExp("</"+w[2],"g")),r=Le):w[3]!==void 0&&(r=Le):r===Le?w[0]===">"?(r=o??at,u=-1):w[1]===void 0?u=-2:(u=r.lastIndex-w[2].length,p=w[1],r=w[3]===void 0?Le:w[3]==='"'?ro:so):r===ro||r===so?r=Le:r===oo||r===no?r=at:(r=Le,o=void 0);const m=r===Le&&e[c+1].startsWith("/>")?" ":"";s+=r===at?d+ln:u>=0?(n.push(p),d.slice(0,u)+Ao+d.slice(u)+Ae+m):d+Ae+(u===-2?c:m)}return[To(e,s+(e[i]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),n]};class _t{constructor({strings:t,_$litType$:i},n){let o;this.parts=[];let s=0,r=0;const c=t.length-1,d=this.parts,[p,w]=hn(t,i);if(this.el=_t.createElement(p,n),De.currentNode=this.el.content,i===2||i===3){const u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(o=De.nextNode())!==null&&d.length<c;){if(o.nodeType===1){if(o.hasAttributes())for(const u of o.getAttributeNames())if(u.endsWith(Ao)){const b=w[r++],m=o.getAttribute(u).split(Ae),C=/([.?@])?(.*)/.exec(b);d.push({type:1,index:s,name:C[2],strings:m,ctor:C[1]==="."?pn:C[1]==="?"?gn:C[1]==="@"?bn:Qt}),o.removeAttribute(u)}else u.startsWith(Ae)&&(d.push({type:6,index:s}),o.removeAttribute(u));if(Bo.test(o.tagName)){const u=o.textContent.split(Ae),b=u.length-1;if(b>0){o.textContent=Ut?Ut.emptyScript:"";for(let m=0;m<b;m++)o.append(u[m],mt()),De.nextNode(),d.push({type:2,index:++s});o.append(u[b],mt())}}}else if(o.nodeType===8)if(o.data===zo)d.push({type:2,index:s});else{let u=-1;for(;(u=o.data.indexOf(Ae,u+1))!==-1;)d.push({type:7,index:s}),u+=Ae.length-1}s++}}static createElement(t,i){const n=Me.createElement("template");return n.innerHTML=t,n}}function Je(e,t,i=e,n){var r,c;if(t===ee)return t;let o=n!==void 0?(r=i._$Co)==null?void 0:r[n]:i._$Cl;const s=ft(t)?void 0:t._$litDirective$;return(o==null?void 0:o.constructor)!==s&&((c=o==null?void 0:o._$AO)==null||c.call(o,!1),s===void 0?o=void 0:(o=new s(e),o._$AT(e,i,n)),n!==void 0?(i._$Co??(i._$Co=[]))[n]=o:i._$Cl=o),o!==void 0&&(t=Je(e,o._$AS(e,t.values),o,n)),t}let un=class{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:i},parts:n}=this._$AD,o=((t==null?void 0:t.creationScope)??Me).importNode(i,!0);De.currentNode=o;let s=De.nextNode(),r=0,c=0,d=n[0];for(;d!==void 0;){if(r===d.index){let p;d.type===2?p=new ot(s,s.nextSibling,this,t):d.type===1?p=new d.ctor(s,d.name,d.strings,this,t):d.type===6&&(p=new mn(s,this,t)),this._$AV.push(p),d=n[++c]}r!==(d==null?void 0:d.index)&&(s=De.nextNode(),r++)}return De.currentNode=Me,o}p(t){let i=0;for(const n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(t,n,i),i+=n.strings.length-2):n._$AI(t[i])),i++}};class ot{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,i,n,o){this.type=2,this._$AH=h,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=n,this.options=o,this._$Cv=(o==null?void 0:o.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=Je(this,t,i),ft(t)?t===h||t==null||t===""?(this._$AH!==h&&this._$AR(),this._$AH=h):t!==this._$AH&&t!==ee&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):cn(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==h&&ft(this._$AH)?this._$AA.nextSibling.data=t:this.T(Me.createTextNode(t)),this._$AH=t}$(t){var s;const{values:i,_$litType$:n}=t,o=typeof n=="number"?this._$AC(t):(n.el===void 0&&(n.el=_t.createElement(To(n.h,n.h[0]),this.options)),n);if(((s=this._$AH)==null?void 0:s._$AD)===o)this._$AH.p(i);else{const r=new un(o,this),c=r.u(this.options);r.p(i),this.T(c),this._$AH=r}}_$AC(t){let i=ao.get(t.strings);return i===void 0&&ao.set(t.strings,i=new _t(t)),i}k(t){xi(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let n,o=0;for(const s of t)o===i.length?i.push(n=new ot(this.O(mt()),this.O(mt()),this,this.options)):n=i[o],n._$AI(s),o++;o<i.length&&(this._$AR(n&&n._$AB.nextSibling,o),i.length=o)}_$AR(t=this._$AA.nextSibling,i){var n;for((n=this._$AP)==null?void 0:n.call(this,!1,!0,i);t!==this._$AB;){const o=t.nextSibling;t.remove(),t=o}}setConnected(t){var i;this._$AM===void 0&&(this._$Cv=t,(i=this._$AP)==null||i.call(this,t))}}class Qt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,i,n,o,s){this.type=1,this._$AH=h,this._$AN=void 0,this.element=t,this.name=i,this._$AM=o,this.options=s,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=h}_$AI(t,i=this,n,o){const s=this.strings;let r=!1;if(s===void 0)t=Je(this,t,i,0),r=!ft(t)||t!==this._$AH&&t!==ee,r&&(this._$AH=t);else{const c=t;let d,p;for(t=s[0],d=0;d<s.length-1;d++)p=Je(this,c[n+d],i,d),p===ee&&(p=this._$AH[d]),r||(r=!ft(p)||p!==this._$AH[d]),p===h?t=h:t!==h&&(t+=(p??"")+s[d+1]),this._$AH[d]=p}r&&!o&&this.j(t)}j(t){t===h?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class pn extends Qt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===h?void 0:t}}class gn extends Qt{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==h)}}class bn extends Qt{constructor(t,i,n,o,s){super(t,i,n,o,s),this.type=5}_$AI(t,i=this){if((t=Je(this,t,i,0)??h)===ee)return;const n=this._$AH,o=t===h&&n!==h||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,s=t!==h&&(n===h||o);o&&this.element.removeEventListener(this.name,this,n),s&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var i;typeof this._$AH=="function"?this._$AH.call(((i=this.options)==null?void 0:i.host)??this.element,t):this._$AH.handleEvent(t)}}class mn{constructor(t,i,n){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(t){Je(this,t)}}const fn={I:ot},li=bt.litHtmlPolyfillSupport;li==null||li(_t,ot),(bt.litHtmlVersions??(bt.litHtmlVersions=[])).push("3.3.1");const _n=(e,t,i)=>{const n=(i==null?void 0:i.renderBefore)??t;let o=n._$litPart$;if(o===void 0){const s=(i==null?void 0:i.renderBefore)??null;n._$litPart$=o=new ot(t.insertBefore(mt(),s),s,void 0,i??{})}return o._$AI(e),o};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Fe=globalThis;let _=class extends Xe{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var i;const t=super.createRenderRoot();return(i=this.renderOptions).renderBefore??(i.renderBefore=t.firstChild),t}update(t){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=_n(i,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)==null||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)==null||t.setConnected(!1)}render(){return ee}};var Eo;_._$litElement$=!0,_.finalized=!0,(Eo=Fe.litElementHydrateSupport)==null||Eo.call(Fe,{LitElement:_});const ci=Fe.litElementPolyfillSupport;ci==null||ci({LitElement:_});(Fe.litElementVersions??(Fe.litElementVersions=[])).push("4.2.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const vn={attribute:!0,type:String,converter:jt,reflect:!1,hasChanged:wi},wn=(e=vn,t,i)=>{const{kind:n,metadata:o}=i;let s=globalThis.litPropertyMetadata.get(o);if(s===void 0&&globalThis.litPropertyMetadata.set(o,s=new Map),n==="setter"&&((e=Object.create(e)).wrapped=!0),s.set(i.name,e),n==="accessor"){const{name:r}=i;return{set(c){const d=t.get.call(this);t.set.call(this,c),this.requestUpdate(r,d,e)},init(c){return c!==void 0&&this.C(r,void 0,e,c),c}}}if(n==="setter"){const{name:r}=i;return function(c){const d=this[r];t.call(this,c),this.requestUpdate(r,d,e)}}throw Error("Unsupported decorator location: "+n)};function a(e){return(t,i)=>typeof i=="object"?wn(e,t,i):((n,o,s)=>{const r=o.hasOwnProperty(s);return o.constructor.createProperty(s,n),r?Object.getOwnPropertyDescriptor(o,s):void 0})(e,t,i)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function v(e){return a({...e,state:!0,attribute:!1})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const xn=(e,t,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&typeof t!="object"&&Object.defineProperty(e,t,i),i);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function H(e,t){return(i,n,o)=>{const s=r=>{var c;return((c=r.renderRoot)==null?void 0:c.querySelector(e))??null};return xn(i,n,{get(){return s(this)}})}}const $=f`
  :host {
    /* Colors - Blue */
...
`;var U=(e=>(e.Active="active",e.InProgress="in-progress",e.Success="success",e.Fail="fail",e))(U||{});function g(e){return e!=null&&`${e}`!="false"}function I(e,t=null){return isNaN(parseFloat(e))||isNaN(Number(e))?t:Number(e)}const $n=f`
...
`,kn=f`
  ...
  ${$n}
`,Sn=e=>`ngx-icon ${e.trim().split(" ").map(i=>{const[n,o]=i.split(":");return n.length?`${n} ${n}-${o}`:o}).join(" ")}`;class Cn{constructor(){this._defaultFontSetClass="ngx",this._iconMap=new Map}setDefaultFontSetClass(t){return this._defaultFontSetClass=t,this._defaultFontSetClass}get(t,i){return this.lookup(t,i).map(n=>Sn(n))}lookup(t,i){const n=i??this._defaultFontSetClass;return(Array.isArray(t)?t:[t]).reduce((o,s)=>{const r=this._expandKeys(s,n).map(c=>{const d=this._iconMap.get(c);return d&&d.length===1?d[0]:c}).join(" ");return o.concat(this._iconMap.get(r)||[r])},[])}add(t,i){const n=this._expandKeys(t,this._defaultFontSetClass).join(" "),o=this.lookup(i);this._iconMap.set(n,o)}_expandKeys(t,i){return t.split(" ").map(n=>n.includes(":")?n:`${i}:${n}`)}}const En=new Cn;var In=Object.defineProperty,An=Object.getOwnPropertyDescriptor,nt=(e,t,i,n)=>{for(var o=n>1?void 0:n?An(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&In(t,i,o),o};let Be=class extends _{constructor(){super(...arguments),this.fontIcon="",this.alt="",this.fontSet="ngx",this.iconClass="",this._cssClasses=[],this._iconClassTokensOnHost=[]}connectedCallback(){super.connectedCallback(),this._updateFontIcon()}updated(e){super.updated(e),(e.has("fontIcon")||e.has("fontSet"))&&this._updateFontIcon(),e.has("iconClass")&&this._syncIconClassToHost()}_syncIconClassToHost(){var t;const e=(((t=this.iconClass)==null?void 0:t.trim())??"").split(/\s+/).filter(Boolean);this._iconClassTokensOnHost.forEach(i=>this.classList.remove(i)),e.forEach(i=>this.classList.add(i)),this._iconClassTokensOnHost=e}_parseFontIcon(e){if(Array.isArray(e))return e.filter(Boolean);if(typeof e!="string"||!e)return[];const t=e.trim();if(t.startsWith("["))try{const i=JSON.parse(t);return Array.isArray(i)?i:[t]}catch{return[t]}return[t]}_updateFontIcon(){const e=this._parseFontIcon(this.fontIcon);if(e.length===0){this._cssClasses=[];return}this._cssClasses=En.get(e,this.fontSet)}render(){var o;const e=this._cssClasses,t=!!this.alt,i=((o=this.iconClass)==null?void 0:o.trim())??"",n=i?` ${i}`:"";return!e||e.length===0?l`
        <span
          part="icon"
          class="${i}"
    ...
    `}};Be.styles=[$,kn];nt([a({type:String,attribute:"font-icon"})],Be.prototype,"fontIcon",2);nt([a({type:String})],Be.prototype,"alt",2);nt([a({type:String,attribute:"font-set"})],Be.prototype,"fontSet",2);nt([a({type:String,attribute:"icon-class"})],Be.prototype,"iconClass",2);nt([v()],Be.prototype,"_cssClasses",2);Be=nt([y("swim-icon")],Be);var zn=Object.defineProperty,Bn=Object.getOwnPropertyDescriptor,se=(e,t,i,n)=>{for(var o=n>1?void 0:n?Bn(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&zn(t,i,o),o};let W=class extends _{constructor(){super(...arguments),this.variant="default",this.size="medium",this._disabled=!1,this._state=U.Active,this.type="button",this._inProgress=!1,this._success=!1,this._fail=!1}get disabled(){return this._disabled}set disabled(e){this._disabled=g(e)}get state(){return this._state}set state(e){this._state=e,this._updateStateFlags()}get timeout(){return this._timeout===void 0?3e3:this._timeout}set timeout(e){this._timeout=I(e)}get promise(){return this._promise}set promise(e){this._promise=e,this._handlePromise()}connectedCallback(){super.connectedCallback(),this._updateState()}disconnectedCallback(){super.disconnectedCallback(),this._clearTimer()}render(){return l`
    ...
    `}_renderStateIcon(){return this._inProgress?l`<swim-icon class="state-icon" font-icon="loading"></swim-icon>`:this._success?l`<swim-icon class="state-icon" font-icon="check"></swim-icon>`:this._fail?l`<swim-icon class="state-icon" font-icon="x"></swim-icon>`:h}_handleClick(e){if(this.disabled){e.stopPropagation(),e.preventDefault();return}}_updateStateFlags(){this._inProgress=this._state===U.InProgress,this._success=this._state===U.Success,this._fail=this._state===U.Fail}_updateState(){this._state||(this.state=U.Active),this.timeout&&(this._state===U.Success||this._state===U.Fail||this._state===U.InProgress)&&(this._clearTimer(),this._timer=window.setTimeout(()=>{this.state=U.Active,this._updateState()},this.timeout))}_handlePromise(){this._promise&&(this.state=U.InProgress,this._promise.then(()=>{this.state=U.Success,this._updateState()}).catch(()=>{this.state=U.Fail,this._updateState()}))}_clearTimer(){this._timer!==void 0&&(clearTimeout(this._timer),this._timer=void 0)}};W.styles=[$,yn];se([a({type:String,reflect:!0})],W.prototype,"variant",2);se([a({type:String,reflect:!0})],W.prototype,"size",2);se([a({type:Boolean,reflect:!0})],W.prototype,"disabled",1);se([a({type:String,reflect:!0})],W.prototype,"state",1);se([a({type:String})],W.prototype,"type",2);se([a({type:Number})],W.prototype,"timeout",1);se([a({attribute:!1})],W.prototype,"promise",1);se([v()],W.prototype,"_inProgress",2);se([v()],W.prototype,"_success",2);se([v()],W.prototype,"_fail",2);W=se([y("swim-button")],W);const Tn=f`
  :host {
    display: inline-flex;
    position: relative;
    box-sizing: border-box;
...
`;var Oo=(e=>(e.Horizontal="horizontal",e.Vertical="vertical",e))(Oo||{}),Lo=(e=>(e.Contained="contained",e.Text="text",e))(Lo||{}),Po=(e=>(e.Default="default",e.Primary="primary",e))(Po||{}),On=Object.defineProperty,Ln=Object.getOwnPropertyDescriptor,Zt=(e,t,i,n)=>{for(var o=n>1?void 0:n?Ln(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&On(t,i,o),o};let et=class extends _{constructor(){super(...arguments),this.orientation=Oo.Horizontal,this.variant=Lo.Contained,this.buttonGroupStyle=Po.Default}render(){return l`<slot></slot>`}};et.styles=[$,Tn];Zt([a({type:String,reflect:!0})],et.prototype,"orientation",2);Zt([a({type:String,reflect:!0})],et.prototype,"variant",2);Zt([a({attribute:"button-group-style",type:String,reflect:!0})],et.prototype,"buttonGroupStyle",2);et=Zt([y("swim-button-group")],et);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ie={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},yi=e=>(...t)=>({_$litDirective$:e,values:t});class $i{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,i,n){this._$Ct=t,this._$AM=i,this._$Ci=n}_$AS(t,i){return this.update(t,i)}update(t,i){return this.render(...i)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:Pn}=fn,Dn=e=>e.strings===void 0,lo=()=>document.createComment(""),lt=(e,t,i)=>{var s;const n=e._$AA.parentNode,o=t===void 0?e._$AB:t._$AA;if(i===void 0){const r=n.insertBefore(lo(),o),c=n.insertBefore(lo(),o);i=new Pn(r,c,e,e.options)}else{const r=i._$AB.nextSibling,c=i._$AM,d=c!==e;if(d){let p;(s=i._$AQ)==null||s.call(i,e),i._$AM=e,i._$AP!==void 0&&(p=e._$AU)!==c._$AU&&i._$AP(p)}if(r!==o||d){let p=i._$AA;for(;p!==r;){const w=p.nextSibling;n.insertBefore(p,o),p=w}}}return i},Pe=(e,t,i=e)=>(e._$AI(t,i),e),Fn={},Do=(e,t=Fn)=>e._$AH=t,Mn=e=>e._$AH,di=e=>{e._$AR(),e._$AA.remove()};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const co=yi(class extends $i{constructor(e){if(super(e),e.type!==Ie.PROPERTY&&e.type!==Ie.ATTRIBUTE&&e.type!==Ie.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Dn(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===ee||t===h)return t;const i=e.element,n=e.name;if(e.type===Ie.PROPERTY){if(t===i[n])return ee}else if(e.type===Ie.BOOLEAN_ATTRIBUTE){if(!!t===i.hasAttribute(n))return ee}else if(e.type===Ie.ATTRIBUTE&&i.getAttribute(n)===t+"")return ee;return Do(e),t}});/**
 * @license
              ...
              <div class="select-dropdown" part="dropdown" role="listbox" id="${this.id}-listbox">
                ...
                ${t.length>0?l`
                      <ul class="select-options">
                        ${Vn(t,n=>this._getOptionValue(n),(n,o)=>this._renderOption(n,o))}
                      </ul>
...
`;var Gn=Object.defineProperty,Kn=Object.getOwnPropertyDescriptor,qe=(e,t,i,n)=>{for(var o=n>1?void 0:n?Kn(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&Gn(t,i,o),o};let Xn=0,ue=class extends _{constructor(){super(...arguments),this._instanceId=++Xn,this._generatedPanelId=`tab-panel-${this._instanceId}`,this._generatedTabId=`tab-${this._instanceId}`,this.tabId=this._generatedTabId,this.label="",this._active=!1,this._disabled=!1}get id(){return this._id??this._generatedPanelId}set id(e){this._id=e||this._generatedPanelId}get title(){return this.label}set title(e){this.label=e}get active(){return this._active}set active(e){const t=g(e);if(this._active!==t){const i=this._active;this._active=t,this.requestUpdate("active",i),this.dispatchEvent(new CustomEvent("swim-tab-active-change",{bubbles:!0,composed:!0}))}}get disabled(){return this._disabled}set disabled(e){this._disabled=g(e)}connectedCallback(){super.connectedCallback(),this.hasAttribute("tab-id")||(this.tabId=this._generatedTabId)}render(){return l`
    ...
    `}};ue.styles=[$,Wn];qe([a({type:String})],ue.prototype,"id",1);qe([a({type:String,attribute:"tab-id"})],ue.prototype,"tabId",2);qe([a({type:String})],ue.prototype,"label",2);qe([a({type:String})],ue.prototype,"title",1);qe([a({type:Boolean,reflect:!0})],ue.prototype,"active",1);qe([a({type:Boolean,reflect:!0})],ue.prototype,"disabled",1);ue=qe([y("swim-tab")],ue);const Yn=f`
  :host {
    display: block;
    margin-bottom: 2em;
  }
...
`;var Fo=(e=>(e.Legacy="legacy",e.Light="light",e))(Fo||{}),Qn=Object.defineProperty,Zn=Object.getOwnPropertyDescriptor,$t=(e,t,i,n)=>{for(var o=n>1?void 0:n?Zn(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&Qn(t,i,o),o};let Re=class extends _{constructor(){super(...arguments),this._vertical=!1,this.appearance=Fo.Legacy,this._tabs=[],this._slotChangeBound=()=>this._syncTabs(),this._tabActiveChangeBound=()=>this.requestUpdate()}get vertical(){return this._vertical}set vertical(e){this._vertical=g(e)}connectedCallback(){super.connectedCallback()}firstUpdated(){this._syncTabs(),this._listenToTabChanges();const e=this.slotEl;e&&e.addEventListener("slotchange",this._slotChangeBound)}disconnectedCallback(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector("slot");e&&e.removeEventListener("slotchange",this._slotChangeBound),this._tabs.forEach(i=>i.removeEventListener("swim-tab-active-change",this._tabActiveChangeBound)),super.disconnectedCallback()}_listenToTabChanges(){this._tabs.forEach(e=>e.addEventListener("swim-tab-active-change",this._tabActiveChangeBound))}_syncTabs(){var o;const e=(o=this.shadowRoot)==null?void 0:o.querySelector("slot"),i=((e==null?void 0:e.assignedElements({flatten:!0}))??[]).filter(s=>s instanceof ue);this._tabs.forEach(s=>s.removeEventListener("swim-tab-active-change",this._tabActiveChangeBound)),this._tabs=i,this._listenToTabChanges();const n=i.filter(s=>s.active);n.length>1?console.error('swim-tabs: Multiple active tabs set "active".'):n.length===0&&i.length>0&&(i[0].active=!0)}_tabClicked(e){e.disabled||(this._tabs.forEach(t=>t.active=t===e),e.active=!0,this.dispatchEvent(new CustomEvent("select-tab",{detail:{tab:e},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("select",{detail:{tab:e},bubbles:!0,composed:!0})))}_move(e){const t=this._tabs,i=t.findIndex(n=>n.active);for(let n=i+e;n>=0&&n<t.length;n+=e){const o=t[n];if(o&&!o.disabled){this._tabClicked(o);return}}}prev(){this._move(-1)}next(){this._move(1)}_handleKeyDown(e){const t=this.vertical,i=e.key;t&&(i==="ArrowUp"||i==="ArrowDown")?(e.preventDefault(),this._move(i==="ArrowDown"?1:-1)):!t&&(i==="ArrowLeft"||i==="ArrowRight")&&(e.preventDefault(),this._move(i==="ArrowRight"?1:-1))}render(){const e=this._tabs;return l`
    ...
    `}};Re.styles=[$,Yn];$t([H("slot")],Re.prototype,"slotEl",2);$t([a({type:Boolean,reflect:!0})],Re.prototype,"vertical",1);$t([a({type:String,reflect:!0})],Re.prototype,"appearance",2);$t([v()],Re.prototype,"_tabs",2);Re=$t([y("swim-tabs")],Re);const Jn=f`
  :host {
    display: inline-block;
    cursor: pointer;
  }
...
`;var es=Object.defineProperty,ts=Object.getOwnPropertyDescriptor,je=(e,t,i,n)=>{for(var o=n>1?void 0:n?ts(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&es(t,i,o),o};let is=0,$e=class extends _{constructor(){super(...arguments),this._uniqueId=`swim-button-toggle-${++is}`,this.name=this._uniqueId,this.value=!1,this._checked=!1,this._disabled=!1}get id(){return this._id??this._uniqueId}set id(e){this._id=e}get checked(){return this._checked}set checked(e){const t=g(e);this._checked!==t&&(this._checked=t,this.requestUpdate("checked"))}get disabled(){return this._disabled}set disabled(e){this._disabled=g(e)}render(){return l`
      <button
        type="button"
    ...
    `}_handleClick(e){e.preventDefault(),e.stopPropagation(),!(this.disabled||this.checked)&&(this._checked=!0,this.dispatchEvent(new CustomEvent("value-change",{detail:this.value,bubbles:!0,composed:!0})))}};$e.styles=[$,Jn];je([a({type:String})],$e.prototype,"id",1);je([a({type:String})],$e.prototype,"name",2);je([a()],$e.prototype,"value",2);je([a({type:Boolean,reflect:!0})],$e.prototype,"checked",1);je([v()],$e.prototype,"_checked",2);je([a({type:Boolean,reflect:!0})],$e.prototype,"disabled",1);$e=je([y("swim-button-toggle")],$e);const os=f`
  :host {
    display: inline-flex;
...
`;var ns=Object.defineProperty,ss=Object.getOwnPropertyDescriptor,Te=(e,t,i,n)=>{for(var o=n>1?void 0:n?ss(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&ns(t,i,o),o};let rs=0,ne=class extends _{constructor(){var e;super(),this._uniqueId=`swim-button-toggle-group-${++rs}`,this._animationHolderLeft=0,this._animationHolderWidth=0,this.label="",this._value=void 0,this._disabled=!1,this._slotChangeBound=()=>this._onSlotChange(),this._slotForCleanup=null,this._internals=((e=this.attachInternals)==null?void 0:e.call(this))??{},this.setAttribute("role","group"),this._boundValueChange=this._onValueChangeEvent.bind(this)}get id(){return this._id??this._uniqueId}set id(e){this._id=e}get value(){return this._value}set value(e){this._value!==e&&(this._value=e,this._internals.setFormValue(e!=null?String(e):""),this._syncSelection())}get disabled(){return this._disabled}set disabled(e){this._disabled=g(e),this._syncDisabled()}connectedCallback(){super.connectedCallback(),this.addEventListener("value-change",this._boundValueChange),this._internals.setFormValue&&this._internals.setFormValue(this._value!=null?String(this._value):"")}disconnectedCallback(){this._slotForCleanup&&(this._slotForCleanup.removeEventListener("slotchange",this._slotChangeBound),this._slotForCleanup=null),this.removeEventListener("value-change",this._boundValueChange),super.disconnectedCallback()}firstUpdated(e){super.firstUpdated(e);const t=this._slot;t&&(this._slotForCleanup=t,t.addEventListener("slotchange",this._slotChangeBound)),this._onSlotChange()}updated(e){super.updated(e),(e.has("value")||e.has("disabled"))&&(this._syncSelection(),this._syncDisabled())}_getToggles(){const e=this._slot;return e?e.assignedElements({flatten:!0}).filter(i=>i instanceof HTMLElement&&i.tagName==="SWIM-BUTTON-TOGGLE"):[]}_onSlotChange(){this._syncSelection(),this._syncDisabled(),requestAnimationFrame(()=>this._calcAnimationDimensions())}_syncSelection(){const e=this._getToggles(),t=this._value;e.forEach(i=>{i.checked=i.value!==void 0&&i.value===t}),requestAnimationFrame(()=>this._calcAnimationDimensions())}_syncDisabled(){this._getToggles().forEach(t=>{t.disabled=this._disabled})}_calcAnimationDimensions(){const e=this._getToggles();if(!e.length||this._disabled){this._animationHolderLeft=0,this._animationHolderWidth=0;return}const t=e.findIndex(r=>r.value!==void 0&&r.value===this._value);if(t<0){this._animationHolderLeft=0,this._animationHolderWidth=0;return}let i=0;for(let r=0;r<t;r++)i+=e[r].offsetWidth??0;i+=t*2+2;const o=e[t],s=Math.max(0,((o==null?void 0:o.offsetWidth)??0)-4);this._animationHolderLeft=i,this._animationHolderWidth=s}_onValueChangeEvent(e){const i=e.detail;this._value!==i&&(this._value=i,this._internals.setFormValue(i!=null?String(i):""),this._syncSelection(),this.dispatchEvent(new CustomEvent("value-change",{detail:i,bubbles:!0,composed:!0})))}render(){return l`
    ...
    `}};ne.styles=[$,os];ne.formAssociated=!0;Te([H("slot")],ne.prototype,"_slot",2);Te([v()],ne.prototype,"_animationHolderLeft",2);Te([v()],ne.prototype,"_animationHolderWidth",2);Te([a({type:String})],ne.prototype,"id",1);Te([a({type:String})],ne.prototype,"label",2);Te([a()],ne.prototype,"value",1);Te([a({type:Boolean,reflect:!0})],ne.prototype,"disabled",1);ne=Te([y("swim-button-toggle-group")],ne);const Wt=4,hi=3,uo=25,as=30,ls=15,po=27,cs=f`
  ...
  .swim-card__outline {
    ...
    left: -5px;
    bottom: -5px;
    border: ${hi}px solid var(--blue-400);
    border-radius: var(--radius-6);
  }
...
`,hs=f`
  ...
  :host([orientation='vertical']) .swim-card__status {
    margin: ${ls}px auto var(--spacing-0) auto;
  }
...
`,us=[$,cs,ds,hs];var vt=(e=>(e.Success="success",e.Error="error",e.Disabled="disabled",e))(vt||{}),Mo=(e=>(e.Horizontal="horizontal",e.Vertical="vertical",e))(Mo||{}),Ro=(e=>(e.Normal="normal",e.Flat="flat",e))(Ro||{}),ps=Object.defineProperty,gs=Object.getOwnPropertyDescriptor,re=(e,t,i,n)=>{for(var o=n>1?void 0:n?gs(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&ps(t,i,o),o};let G=class extends _{constructor(){super(...arguments),this._disabled=!1,this.orientation=Mo.Horizontal,this.statusTooltip="",this._selectable=!1,this._selected=!1,this._error=!1,this.outlineText="",this.appearance=Ro.Normal,this._hideAccent=!1}get disabled(){return this._disabled}set disabled(e){this._disabled=g(e)}get selectable(){return this._selectable}set selectable(e){this._selectable=g(e)}get selected(){return this._selected}set selected(e){this._selected=g(e)}get error(){return this._error}set error(e){this._error=g(e)}get hideAccent(){return this._hideAccent}set hideAccent(e){this._hideAccent=g(e)}_onOutlineClick(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent("outline-click",{bubbles:!0,composed:!0}))}_onSelectChange(e){e.stopPropagation();const t=e.target;this.selected=t.checked,this.dispatchEvent(new CustomEvent("select",{detail:this.selected,bubbles:!0,composed:!0}))}_onCheckboxClick(e){e.stopPropagation()}render(){const e=this.selected&&!this.outlineText&&!this.error,t=this.error&&!this.outlineText,i=!!this.outlineText,n=!!this.status,o=this.status===vt.Success?"swim-card__status--success":this.status===vt.Error?"swim-card__status--error":"";return l`
    ...
    `}};G.styles=us;re([a({type:Boolean,reflect:!0})],G.prototype,"disabled",1);re([a({type:String,reflect:!0})],G.prototype,"orientation",2);re([a({type:String,reflect:!0})],G.prototype,"status",2);re([a({type:String,attribute:"status-tooltip"})],G.prototype,"statusTooltip",2);re([a({type:Boolean,reflect:!0})],G.prototype,"selectable",1);re([a({type:Boolean,reflect:!0})],G.prototype,"selected",1);re([a({type:Boolean,reflect:!0})],G.prototype,"error",1);re([a({type:String,attribute:"outline-text"})],G.prototype,"outlineText",2);re([a({type:String,reflect:!0})],G.prototype,"appearance",2);re([a({type:Boolean,attribute:"hide-accent"})],G.prototype,"hideAccent",1);G=re([y("swim-card")],G);const go=25,bs=f`
  :host {
    display: flex;
    align-items: center;
    padding: var(--spacing-0) ${go}px;
    flex-grow: 1;
    overflow: hidden;
    cursor: pointer;
    box-sizing: border-box;
...
`,ms=[$,bs];var fs=Object.defineProperty,_s=Object.getOwnPropertyDescriptor,Ci=(e,t,i,n)=>{for(var o=n>1?void 0:n?_s(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&fs(t,i,o),o};let wt=class extends _{constructor(){super(...arguments),this.label="",this.orientation="horizontal"}render(){return l`
    ...
    `}};wt.styles=ms;Ci([a({type:String})],wt.prototype,"label",2);Ci([a({type:String,reflect:!0})],wt.prototype,"orientation",2);wt=Ci([y("swim-card-header")],wt);const vs=4,ws=f`
  :host {
    position: relative;
    border-bottom: 2px solid var(--grey-700);
    height: 50px;
...
`,xs=[$,ws];var ys=Object.defineProperty,$s=Object.getOwnPropertyDescriptor,Ho=(e,t,i,n)=>{for(var o=n>1?void 0:n?$s(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&ys(t,i,o),o};let Gt=class extends _{constructor(){super(...arguments),this.label=""}render(){return l`
      ${this.label?l`<div class="swim-card-footer__label">${this.label}</div>`:h}
      <slot></slot>
    `}};Gt.styles=xs;Ho([a({type:String})],Gt.prototype,"label",2);Gt=Ho([y("swim-card-footer")],Gt);const bo=3,ks=f`
  :host {
    width: 54px;
    height: 54px;
    min-width: 54px;
  ...
  .swim-card-avatar__status {
    ...
    padding: var(--spacing-4);
    border-radius: 50%;
    border: ${bo}px solid var(--grey-750);
    background-color: var(--white);
    z-index: 1;
  }
...
`,Ss=[$,ks];var Cs=Object.defineProperty,Es=Object.getOwnPropertyDescriptor,Jt=(e,t,i,n)=>{for(var o=n>1?void 0:n?Es(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&Cs(t,i,o),o};let tt=class extends _{constructor(){super(...arguments),this.src="",this.removeImageBackground=!1}render(){const e=!!this.status,t=this.status===vt.Success?"swim-card-avatar__status--success":this.status===vt.Error?"swim-card-avatar__status--error":"";return l`
    ...
    `}};tt.styles=Ss;Jt([a({type:String})],tt.prototype,"src",2);Jt([a({type:String,reflect:!0})],tt.prototype,"status",2);Jt([a({type:Boolean,attribute:"remove-image-background"})],tt.prototype,"removeImageBackground",2);tt=Jt([y("swim-card-avatar")],tt);const Is=f`
  :host {
    display: inline-block;
    background-color: var(--grey-700);
    border-radius: 11px;
...
`,As=[$,Is];var No=(e=>(e.Small="small",e.Medium="medium",e.Large="large",e))(No||{}),zs=Object.defineProperty,Bs=Object.getOwnPropertyDescriptor,Vo=(e,t,i,n)=>{for(var o=n>1?void 0:n?Bs(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&zs(t,i,o),o};let Kt=class extends _{constructor(){super(...arguments),this.size=No.Medium}render(){return l``}};Kt.styles=As;Vo([a({type:String,reflect:!0})],Kt.prototype,"size",2);Kt=Vo([y("swim-card-placeholder")],Kt);const mo=27,Ts=f`
  :host {
    display: flex;
    flex-direction: column;
    align-items: center;
...
`,Os=[$,Ts];var Ls=Object.getOwnPropertyDescriptor,Ps=(e,t,i,n)=>{for(var o=n>1?void 0:n?Ls(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(o)||o);return o};let gi=class extends _{render(){return l`<slot></slot>`}};gi.styles=Os;gi=Ps([y("swim-card-body")],gi);const Ds=f`
  :host {
    display: inline-flex;
  }
...
`;var Fs=Object.defineProperty,Ms=Object.getOwnPropertyDescriptor,be=(e,t,i,n)=>{for(var o=n>1?void 0:n?Ms(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&Fs(t,i,o),o};let Rs=0,K=class extends _{constructor(){super(),this.id=`swim-checkbox-${++Rs}`,this.name="",this.diameter="18px",this._checked=!1,this._indeterminate=!1,this._tabindex=0,this._disabled=!1,this._round=!1,this._internals=this.attachInternals()}get checked(){return this._checked}set checked(e){const t=g(e);this._checked!==t&&(this._checked=t,this._syncFormValue(),this.dispatchEvent(new CustomEvent("checked-change",{detail:this._checked,bubbles:!0,composed:!0})))}get indeterminate(){return this._indeterminate}set indeterminate(e){const t=g(e);this._indeterminate!==t&&(this._indeterminate=t,this.dispatchEvent(new CustomEvent("indeterminate-change",{detail:this._indeterminate,bubbles:!0,composed:!0})))}get tabindex(){return this._tabindex}set tabindex(e){this._tabindex=I(e,0)}get disabled(){return this._disabled}set disabled(e){this._disabled=g(e)}get round(){return this._round}set round(e){this._round=g(e)}connectedCallback(){super.connectedCallback(),this._syncFormValue()}updated(e){super.updated(e),(e.has("checked")||e.has("_checked"))&&this._syncFormValue()}focus(e){var t;(t=this._roving)==null||t.focus(e)}_syncFormValue(){this._internals.setFormValue(this._checked?"on":"")}_onClick(e){e.preventDefault(),!this.disabled&&this._toggle()}_onKeydown(e){e.key!==" "||this.disabled||(e.stopPropagation(),e.preventDefault(),this._toggle())}_toggle(){this.checked=!this.checked,this._emitChange()}_emitChange(){this.dispatchEvent(new CustomEvent("change",{detail:{stopPropagation:()=>{},timeStamp:Date.now(),target:{checked:this._checked}},bubbles:!0,composed:!0}))}_onFocus(e){this.dispatchEvent(new FocusEvent("focus",{...e,bubbles:!0,composed:!0}))}_onBlur(e){this.dispatchEvent(new FocusEvent("blur",{...e,bubbles:!0,composed:!0}))}render(){const e=`${this.id}-content`;return l`
    ...
    `}};K.styles=[$,Ds];K.formAssociated=!0;be([H(".swim-checkbox__roving")],K.prototype,"_roving",2);be([a({type:String})],K.prototype,"id",2);be([a({type:String})],K.prototype,"name",2);be([a({type:String})],K.prototype,"diameter",2);be([a({type:Boolean,reflect:!0,attribute:"checked"})],K.prototype,"checked",1);be([a({type:Boolean,reflect:!0})],K.prototype,"indeterminate",1);be([a({type:Number})],K.prototype,"tabindex",1);be([a({type:Boolean,reflect:!0})],K.prototype,"disabled",1);be([a({type:Boolean,reflect:!0})],K.prototype,"round",1);K=be([y("swim-checkbox")],K);const Hs=f`
  :host {
    display: block;
  }
...
`;var Vs=Object.defineProperty,qs=Object.getOwnPropertyDescriptor,ae=(e,t,i,n)=>{for(var o=n>1?void 0:n?qs(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&Vs(t,i,o),o};let js=0,X=class extends _{constructor(){super(...arguments),this.id=`swim-radio-${++js}`,this.name="",this.radioId="",this._tabindex=0,this._checked=!1,this.value="",this._disabled=!1,this.groupDisabled=!1,this.isInGroup=!1}get tabindex(){return this._tabindex}set tabindex(e){this._tabindex=I(e,0)}get checked(){return this._checked}set checked(e){const t=g(e);this._checked!==t&&(this._checked=t)}get disabled(){return this._disabled||this.groupDisabled}set disabled(e){this._disabled=g(e)}get _effectiveTabindex(){return this.disabled||this.isInGroup?-1:this._tabindex}get _inputId(){return this.radioId||`${this.id}-radio`}focus(e){var t;(t=this._roving)==null||t.focus(e)}_onClick(e){e.preventDefault(),!this.disabled&&this._select()}_onKeydown(e){e.key!==" "||this.disabled||(e.stopPropagation(),e.preventDefault(),this._select())}_select(){if(this.isInGroup){if(this._checked)return;this.checked=!0}else this.checked=!this._checked;this._checked&&this.dispatchEvent(new CustomEvent("change",{detail:this.value,bubbles:!0,composed:!0}))}_onInputChange(e){this.checked=!0,this.dispatchEvent(new CustomEvent("change",{detail:this.value,bubbles:!0,composed:!0}))}_onFocus(e){this.dispatchEvent(new FocusEvent("focus",{...e,bubbles:!0,composed:!0}))}_onBlur(e){this.dispatchEvent(new FocusEvent("blur",{...e,bubbles:!0,composed:!0}))}render(){const e=`${this.id}-content`;return l`
      <label
    ...
    `}};te.styles=[$,Ns];te.formAssociated=!0;Se([H("slot")],te.prototype,"_slot",2);Se([H(".swim-radio-group__slot")],te.prototype,"_slotWrapper",2);Se([a({type:String})],te.prototype,"id",2);Se([a({type:Boolean,reflect:!0})],te.prototype,"disabled",1);Se([a({type:String})],te.prototype,"value",1);Se([a({type:String})],te.prototype,"name",2);Se([a({type:Number})],te.prototype,"focusIndex",1);Se([a({type:Number})],te.prototype,"tabindex",1);te=Se([y("swim-radio-group")],te);const Xs=f`
  :host {
    display: inline-block;
  }
...
`;var Ys=Object.defineProperty,Qs=Object.getOwnPropertyDescriptor,me=(e,t,i,n)=>{for(var o=n>1?void 0:n?Qs(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&Ys(t,i,o),o};const Zs={fromAttribute:e=>e!=="false"&&e!=="",toAttribute:e=>e?"true":"false"};let Js=0,Y=class extends _{constructor(){super(),this.id=`swim-toggle-${++Js}`,this.name="",this.label="",this._checked=!1,this._disabled=!1,this._required=!1,this._showIcons=!0,this._tabindex=0,this._internals=this.attachInternals()}get checked(){return this._checked}set checked(e){const t=g(e);this._checked!==t&&(this._checked=t,this._syncFormValue())}get disabled(){return this._disabled}set disabled(e){this._disabled=g(e)}get required(){return this._required}set required(e){this._required=g(e)}get showIcons(){return this._showIcons}set showIcons(e){this._showIcons=e!=null?g(e):!0}get tabindex(){return this._tabindex}set tabindex(e){this._tabindex=I(e,0)}connectedCallback(){super.connectedCallback(),this._syncFormValue()}updated(e){super.updated(e),(e.has("checked")||e.has("_checked"))&&this._syncFormValue()}focus(e){var t;(t=this._roving)==null||t.focus(e)}_syncFormValue(){var t;this._internals.setFormValue(this._checked?"on":""),this.required&&!this._checked?this._internals.setValidity({valueMissing:!0},"This field is required"):this._internals.setValidity({});const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".swim-toggle__input");e&&(e.checked=this._checked,e.required=this.required)}_onClick(e){e.preventDefault(),!this.disabled&&this._toggle()}_onKeydown(e){e.key!==" "&&e.key!=="Enter"||(e.preventDefault(),!this.disabled&&this._toggle())}_toggle(){this.checked=!this.checked,this._emitChange()}_emitChange(){this.dispatchEvent(new CustomEvent("change",{detail:{stopPropagation:()=>{},timeStamp:Date.now(),target:{checked:this._checked}},bubbles:!0,composed:!0}))}_onFocus(e){this.dispatchEvent(new FocusEvent("focus",{...e,bubbles:!0,composed:!0}))}_onBlur(e){this.dispatchEvent(new FocusEvent("blur",{...e,bubbles:!0,composed:!0}))}_onInputChange(e){const t=e.target;this._checked!==t.checked&&(this._checked=t.checked,this.requestUpdate(),this._syncFormValue(),this._emitChange())}render(){const e=`${this.id}-text`;return l`
    ...
    `}};Y.styles=[$,Xs];Y.formAssociated=!0;me([H(".swim-toggle__roving")],Y.prototype,"_roving",2);me([a({type:String})],Y.prototype,"id",2);me([a({type:String})],Y.prototype,"name",2);me([a({type:String})],Y.prototype,"label",2);me([a({type:Boolean,reflect:!0,attribute:"checked"})],Y.prototype,"checked",1);me([a({type:Boolean,reflect:!0})],Y.prototype,"disabled",1);me([a({type:Boolean,reflect:!0})],Y.prototype,"required",1);me([a({type:Boolean,attribute:"show-icons",converter:Zs})],Y.prototype,"showIcons",1);me([a({type:Number})],Y.prototype,"tabindex",1);Y=me([y("swim-toggle")],Y);const er=f`
  :host {
    display: block;
    width: 100%;
    margin-bottom: 2em;
...
`,tr=[$,er];var qo=(e=>(e.Legacy="legacy",e.Outline="outline",e.Light="light",e.Minimal="minimal",e))(qo||{}),Nt=(e=>(e.Left="left",e.Right="right",e.None="none",e))(Nt||{}),ir=Object.defineProperty,or=Object.getOwnPropertyDescriptor,le=(e,t,i,n)=>{for(var o=n>1?void 0:n?or(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&ir(t,i,o),o};const nr={fromAttribute:e=>e!=="false"&&e!=="",toAttribute:e=>e?"true":"false"},jo={fromAttribute:e=>e!==null&&e!=="false",toAttribute:e=>e?"true":"false"};let fo=0,Q=class extends _{constructor(){super(...arguments),this._id=`section-${++fo}`,this._sectionCollapsed=!1,this._sectionCollapsible=!0,this._headerToggle=!1,this.sectionTitle="",this.padding="1.8em",this.appearance=qo.Legacy,this.togglePosition=Nt.Left,this._hasHeaderSlot=!1,this._headerSlotChangeBound=()=>this._checkHeaderSlot()}get id(){return this._id}set id(e){this._id=e||`section-${++fo}`}get sectionCollapsed(){return this._sectionCollapsed}set sectionCollapsed(e){const t=e!=null?g(e):!1;this._sectionCollapsed!==t&&(this._sectionCollapsed=t)}get sectionCollapsible(){return this._sectionCollapsible}set sectionCollapsible(e){const t=e!=null?g(e):!0;this._sectionCollapsible!==t&&(this._sectionCollapsible=t)}get headerToggle(){return this._headerToggle}set headerToggle(e){const t=e!=null?g(e):!1;this._headerToggle!==t&&(this._headerToggle=t)}get _contentId(){return`${this.id}-content`}firstUpdated(){var t,i;this._checkHeaderSlot();const e=((i=(t=this.renderRoot)==null?void 0:t.querySelector)==null?void 0:i.call(t,'slot[name="header"]'))??this._headerSlot;e&&(this._headerSlotForCleanup=e,e.addEventListener("slotchange",this._headerSlotChangeBound))}disconnectedCallback(){this._headerSlotForCleanup&&(this._headerSlotForCleanup.removeEventListener("slotchange",this._headerSlotChangeBound),this._headerSlotForCleanup=void 0),super.disconnectedCallback()}_checkHeaderSlot(){var t,i;const e=((i=(t=this.renderRoot)==null?void 0:t.querySelector)==null?void 0:i.call(t,'slot[name="header"]'))??this._headerSlot;if(e){const o=e.assignedNodes({flatten:!0}).some(s=>{var r;return s.nodeType===Node.ELEMENT_NODE||s.nodeType===Node.TEXT_NODE&&(((r=s.textContent)==null?void 0:r.trim())??"").length>0});this._hasHeaderSlot!==o&&(this._hasHeaderSlot=o)}}_headerIsEmpty(){var e;return!((e=this.sectionTitle)!=null&&e.trim())&&!this._hasHeaderSlot}_onToggle(e){if(e==null||e.stopPropagation(),!this.sectionCollapsible)return;const t=!this.sectionCollapsed;this.sectionCollapsed=t,this.dispatchEvent(new CustomEvent("toggle",{detail:t,bubbles:!0,composed:!0}))}_onHeaderKeydown(e){e.key!==" "&&e.key!=="Enter"||!this.headerToggle||!this.sectionCollapsible||(e.preventDefault(),this._onToggle(e))}_onHeaderClick(){this.headerToggle&&this.sectionCollapsible&&this._onToggle()}render(){var s;const e=this.sectionCollapsible,t=e&&this.togglePosition!==Nt.None,i=this.togglePosition===Nt.Right,n=["swim-section__header",this.sectionCollapsed?"swim-section__header--collapsed":"",e?"swim-section__header--collapsible":"",this.headerToggle?"swim-section__header--header-toggle":"",i?"swim-section__header--toggle-right":""].filter(Boolean).join(" "),o=this._headerIsEmpty();return l`
      <div class="swim-section__inner">
        ...
        >
          ...
          <div class="swim-section__header-content">
            ${(s=this.sectionTitle)!=null&&s.trim()?l`<h1 class="swim-section__header-title">${this.sectionTitle}</h1>`:h}
    ...
    `}};Q.styles=tr;le([a({type:String,reflect:!0})],Q.prototype,"id",1);le([a({reflect:!0,attribute:"section-collapsed",converter:jo})],Q.prototype,"sectionCollapsed",1);le([a({reflect:!0,attribute:"section-collapsible",converter:nr})],Q.prototype,"sectionCollapsible",1);le([a({reflect:!0,attribute:"header-toggle",converter:jo})],Q.prototype,"headerToggle",1);le([a({type:String,reflect:!0,attribute:"section-title"})],Q.prototype,"sectionTitle",2);le([a({type:String})],Q.prototype,"padding",2);le([a({type:String,reflect:!0})],Q.prototype,"appearance",2);le([a({type:String,reflect:!0,attribute:"toggle-position"})],Q.prototype,"togglePosition",2);le([v()],Q.prototype,"_hasHeaderSlot",2);le([H('slot[name="header"]')],Q.prototype,"_headerSlot",2);Q=le([y("swim-section")],Q);const sr=f`
  :host {
    display: contents;
  }
`;var rr=Object.getOwnPropertyDescriptor,ar=(e,t,i,n)=>{for(var o=n>1?void 0:n?rr(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(o)||o);return o};let bi=class extends _{render(){return l`<slot></slot>`}};bi.styles=sr;bi=ar([y("swim-section-header")],bi);const lr=2,cr=4,dr=16,hr=f`
  :host {
    --slider-track-height: ${lr}px;
    --slider-fill-height: ${cr}px;
    --slider-thumb-size: ${dr}px;
    display: inline-block;
  }
...
`;var ur=Object.defineProperty,pr=Object.getOwnPropertyDescriptor,N=(e,t,i,n)=>{for(var o=n>1?void 0:n?pr(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&ur(t,i,o),o};let gr=0,P=class extends _{constructor(){super(),this.id=`swim-slider-${++gr}`,this._min=0,this._max=100,this._step=1,this.orientation="horizontal",this._filled=!1,this._multiple=!1,this._disabled=!1,this._showTicks=!1,this.ariaLabel="",this._values=[0],this._active=[],this._internals=this.attachInternals()}get min(){return this._min}set min(e){this._min=I(e,0)}get max(){return this._max}set max(e){this._max=I(e,100)}get step(){return this._step}set step(e){this._step=I(e,1)}get filled(){return this._filled}set filled(e){this._filled=g(e)}get multiple(){return this._multiple}set multiple(e){this._multiple=g(e)}get disabled(){return this._disabled}set disabled(e){this._disabled=g(e)}get showTicks(){return this._showTicks}set showTicks(e){this._showTicks=g(e)}get tickStep(){return this._tickStep??this._step}set tickStep(e){this._tickStep=e!=null?I(e,this._step):void 0}get value(){return this._values.length?this.multiple?[...this._values].sort((e,t)=>e-t).join(","):String(this._values[0]):String(this._min)}set value(e){const t=e!=null?String(e):"",n=(t?t.split(",").map(s=>I(s.trim(),this._min)):[this._min]).map(s=>Math.max(this._min,Math.min(this._max,s)));let o;this.multiple?o=n.length>=2?n:n.length===1?[n[0],this._max]:[this._min,this._max]:o=n.slice(0,1),(o.length!==this._values.length||o.some((s,r)=>s!==this._values[r]))&&(this._values=o,this._syncFormValue())}connectedCallback(){super.connectedCallback(),(this._values.length===0||this._values.length===1&&this._values[0]===0&&this._min!==0)&&(this._values=this.multiple?[this._min,this._max]:[this._min],this._syncFormValue())}updated(e){super.updated(e),(e.has("value")||e.has("min")||e.has("max"))&&this._syncFormValue()}_syncFormValue(){this._internals.setFormValue(this.value)}get _percents(){const e=this._max-this._min||1;return this._values.map(t=>Math.round(100*(Math.max(this._min,Math.min(this._max,t))-this._min)/e))}get _thumbs(){return this._percents.map(e=>({left:`calc(${e}% - ${e/100}em)`}))}get _fill(){if(!this.filled)return null;const e=this._percents,t=this.multiple?Math.min(...e):0,n=(this.multiple?Math.max(...e):e[0])-t;return{left:`${t}%`,width:`${n}%`}}get _tickStepValue(){return this._tickStep??this._step}get _ticks(){if(!this.showTicks)return[];const e=this._tickStepValue,t=[];let i=this._min;for(;i<=this._max;)t.push(i),i+=e;const n=this._max-this._min||1;return t.map(o=>{const s=100*(o-this._min)/n;return{left:`calc(${s}% - ${s/100-.5}em)`}})}_setValue(e,t){const i=I(e,this._min),n=Math.max(this._min,Math.min(this._max,i));if(this._values[t]!==n){const o=[...this._values];o[t]=n,this._values=o,this._syncFormValue(),this._emitChange()}}_onChange(e){this._emitChange()}_emitChange(){const e=this.value,t=this.multiple?this._percents.join(","):String(this._percents[0]);this.dispatchEvent(new CustomEvent("change",{detail:{value:this.multiple?e:Number(e),percent:t},bubbles:!0,composed:!0}))}_setActive(e,t){const i=[...this._active];i[e]=t,this._active=i}_ensureValuesLength(){this.multiple&&this._values.length<2?this._values=[this._min,this._max]:!this.multiple&&this._values.length>1&&(this._values=[this._values[0]])}willUpdate(e){this._ensureValuesLength()}firstUpdated(){this._ensureValuesLength()}_onRangeInput(e,t){const i=e.target.value;this._setValue(Number(i),t)}render(){const e=this.orientation==="vertical";return l`
    ...
    `}};P.styles=[$,hr];P.formAssociated=!0;N([a({type:String})],P.prototype,"id",2);N([a({type:Number})],P.prototype,"min",1);N([a({type:Number})],P.prototype,"max",1);N([a({type:Number})],P.prototype,"step",1);N([a({type:String,reflect:!0})],P.prototype,"orientation",2);N([a({type:Boolean,reflect:!0})],P.prototype,"filled",1);N([a({type:Boolean,reflect:!0})],P.prototype,"multiple",1);N([a({type:Boolean,reflect:!0})],P.prototype,"disabled",1);N([a({type:Boolean,attribute:"show-ticks"})],P.prototype,"showTicks",1);N([a({type:Number,attribute:"tick-step"})],P.prototype,"tickStep",1);N([a({type:String,attribute:"aria-label"})],P.prototype,"ariaLabel",2);N([a({type:String})],P.prototype,"value",1);N([v()],P.prototype,"_values",2);N([v()],P.prototype,"_active",2);P=N([y("swim-slider")],P);const br=f`
  :host {
    overflow: hidden;
    box-sizing: border-box;
    min-height: 0;
  }
`,mr=[$,br];function Uo(e){const[t,i,n]=e;return`${t} ${i} ${n}`}function Ze(e,t,i){const n=i.split(" ");return n.length===3?n:[e,t,i]}var fr=Object.defineProperty,_r=Object.getOwnPropertyDescriptor,kt=(e,t,i,n)=>{for(var o=n>1?void 0:n?_r(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&fr(t,i,o),o};const ct="1 1 1e-9px";let He=class extends _{constructor(){super(...arguments),this._areaBasis=ct,this.shouldAdjustMaxMin=!1,this.initialFlexParts=Ze("1","1",ct),this.currentFlexParts=Ze("1","1",ct)}get areaBasis(){return this._areaBasis}set areaBasis(e){this._areaBasis!==e&&(this._areaBasis=e||ct,this._applyBasis())}connectedCallback(){super.connectedCallback(),this._applyBasis()}updated(){this.style.flex=Uo(this.currentFlexParts),this.shouldAdjustMaxMin&&this.currentFlexParts[2]?(this.style.minWidth=this.currentFlexParts[2],this.style.maxWidth=this.currentFlexParts[2]):(this.style.minWidth="",this.style.maxWidth="")}updateBasis(e){this.currentFlexParts[2]=e,this.requestUpdate()}_applyBasis(){const e=this._areaBasis||ct,[t,i,n]=Ze("1","1",e);this.currentFlexParts=[t,i,n],this.initialFlexParts=[t,i,n],!this.minBasis&&i==="0"&&(this.minBasis=n),!this.maxBasis&&t==="0"&&(this.maxBasis=n),this.requestUpdate()}render(){return l`<slot></slot>`}};He.styles=mr;kt([a({type:String,attribute:"area-basis"})],He.prototype,"areaBasis",1);kt([a({type:String,attribute:"min-basis"})],He.prototype,"minBasis",2);kt([a({type:String,attribute:"max-basis"})],He.prototype,"maxBasis",2);kt([a({type:Boolean,attribute:"should-adjust-max-min"})],He.prototype,"shouldAdjustMaxMin",2);He=kt([y("swim-split-area")],He);const vr=f`
  :host {
    position: relative;
    box-sizing: border-box;
    flex-shrink: 0;
...
`,wr=[$,vr];var Qe=(e=>(e.Row="row",e.Column="column",e))(Qe||{}),xr=Object.defineProperty,yr=Object.getOwnPropertyDescriptor,Ei=(e,t,i,n)=>{for(var o=n>1?void 0:n?yr(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&xr(t,i,o),o};const Rt="0 0 15px";let xt=class extends _{constructor(){super(...arguments),this._handleBasis=Rt,this.direction=Qe.Row,this.currentFlexParts=Ze("0","0",Rt),this._boundMouseUp=this._onMouseUp.bind(this),this._boundMouseMove=this._onMouseMove.bind(this)}get handleBasis(){return this._handleBasis}set handleBasis(e){this._handleBasis!==e&&(this._handleBasis=e||Rt,this.currentFlexParts=Ze("0","0",this._handleBasis),this.requestUpdate())}connectedCallback(){super.connectedCallback(),this.currentFlexParts=Ze("0","0",this._handleBasis||Rt)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mouseup",this._boundMouseUp,!0),document.removeEventListener("mousemove",this._boundMouseMove,!0)}updated(){this.style.flex=Uo(this.currentFlexParts)}_onMouseDown(e){e.preventDefault(),document.addEventListener("mouseup",this._boundMouseUp,!0),document.addEventListener("mousemove",this._boundMouseMove,!0),this.dispatchEvent(new CustomEvent("dragstart",{detail:e,bubbles:!0,composed:!0}))}_onMouseMove(e){this.dispatchEvent(new CustomEvent("drag",{detail:e,bubbles:!0,composed:!0}))}_onMouseUp(e){document.removeEventListener("mouseup",this._boundMouseUp,!0),document.removeEventListener("mousemove",this._boundMouseMove,!0),this.dispatchEvent(new CustomEvent("dragend",{detail:e,bubbles:!0,composed:!0}))}_onDblClick(e){this.dispatchEvent(new CustomEvent("dblclick",{detail:e,bubbles:!0,composed:!0}))}render(){return l`
      <button
        type="button"
    ...
    `}};xt.styles=wr;Ei([a({type:String,attribute:"handle-basis"})],xt.prototype,"handleBasis",1);Ei([a({type:String,reflect:!0})],xt.prototype,"direction",2);xt=Ei([y("swim-split-handle")],xt);const $r=f`
  :host {
    display: flex;
    height: 100%;
    width: 100%;
...
`,kr=[$,$r];function it(e){const t=String(e).indexOf("calc")>-1;return String(e).indexOf("%")>-1&&!t}function he(e){return typeof e=="string"?Number(e.replace(/%/g,"").replace(/px/g,"").trim()):e}function Wo(e,t,i,n,o,s){let r=e?it(e)?he(e):he(e)/s:0,c=t?it(t)?he(t):he(t)/s:100;return r=Math.max(r,n==="0"?o:0),c=Math.min(c,i==="0"?o:100),[r,c]}function _o(e,t,i){const[n,o,s]=e.currentFlexParts,r=it(s),c=he(s),d=e.initialFlexParts[2],p=it(d)?he(d):he(d)/i,w=r?c*i:c;let u=w+t,b=u/i;const[m,C]=Wo(e.minBasis,e.maxBasis,n,o,p,i);return b=Math.max(b,m),b=Math.min(b,C),u=b*i,e.updateBasis(r?b+"%":u+"px"),u-w}var Sr=Object.defineProperty,Cr=Object.getOwnPropertyDescriptor,Ii=(e,t,i,n)=>{for(var o=n>1?void 0:n?Cr(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&Sr(t,i,o),o};let yt=class extends _{constructor(){super(...arguments),this.direction=Qe.Row,this._areas=[],this._handles=[],this._handleListeners=new Map,this._onSlotChange=()=>{this._collectAreasAndHandles(),this._removeHandleListeners(),this._attachHandleListeners()}}connectedCallback(){super.connectedCallback(),this.addEventListener("slotchange",this._onSlotChange)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("slotchange",this._onSlotChange),this._removeHandleListeners()}updated(e){e.has("direction")&&this._handles.forEach(t=>{t.direction=this.direction})}firstUpdated(){requestAnimationFrame(()=>{this._collectAreasAndHandles(),this._attachHandleListeners()})}_collectAreasAndHandles(){if(!this.slotEl)return;const e=this.slotEl.assignedElements({flatten:!0});this._areas=e.filter(t=>{var i;return((i=t.tagName)==null?void 0:i.toLowerCase())==="swim-split-area"}),this._handles=e.filter(t=>{var i;return((i=t.tagName)==null?void 0:i.toLowerCase())==="swim-split-handle"}),this._handles.forEach(t=>{t.direction=this.direction})}_attachHandleListeners(){this._handles.forEach(e=>{const t=n=>{const o=n.detail;o&&this._onDrag(o)},i=()=>this._onDblClick();this._handleListeners.set(e,{drag:t,dblclick:i}),e.addEventListener("drag",t),e.addEventListener("dblclick",i)})}_removeHandleListeners(){this._handles.forEach(e=>{const t=this._handleListeners.get(e);t&&(e.removeEventListener("drag",t.drag),e.removeEventListener("dblclick",t.dblclick),this._handleListeners.delete(e))})}_resize(e){const n=(this.direction===Qe.Row?this.clientWidth:this.clientHeight)/100,o=this._areas;if(o.length===0)return;const[s,...r]=o;let c=e;c=_o(s,c,n),r.forEach(d=>{c+=_o(d,-c,n)})}_onDrag(e){const t=this.direction===Qe.Row?e.movementX:e.movementY;this._resize(t)}_onDblClick(){const i=(this.direction===Qe.Row?this.clientWidth:this.clientHeight)/100,o=this._areas[0];if(!o)return;const[s,r,c]=o.currentFlexParts,d=it(c),p=he(c),u=(d?p*i:p)/i,b=o.initialFlexParts[2],m=it(b)?he(b):he(b)/i,[C,E]=Wo(o.minBasis,o.maxBasis,s,r,m,i),j=u-C,de=E-u,Oe=(j<de?de:-j)*i;this._resize(Oe)}render(){return l`<slot></slot>`}};yt.styles=kr;Ii([a({type:String,reflect:!0})],yt.prototype,"direction",2);Ii([H("slot")],yt.prototype,"slotEl",2);yt=Ii([y("swim-split")],yt);const Er=f`
  ${$}
...
`;var Ye=(e=>(e.Indeterminate="indeterminate",e.Determinate="determinate",e))(Ye||{}),xe=(e=>(e.Default="default",e.Icon="icon",e))(xe||{}),Ir=Object.defineProperty,Ar=Object.getOwnPropertyDescriptor,q=(e,t,i,n)=>{for(var o=n>1?void 0:n?Ar(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&Ir(t,i,o),o};const zr=50,Br=100,mi=100,Vt=mi/2,Tr=Vt*2*Math.PI,Or="cloud-upload",Lr="check",Pr="x";let F=class extends _{constructor(){super(...arguments),this.mode=Ye.Indeterminate,this.color="var(--blue-500)",this.failStatusColor="var(--red-500)",this.appearance=xe.Default,this.inProgressIconName="",this.completeIconName="",this.failIconName="",this._isFailure=!1,this._value=0,this._total=100,this._diameter=100,this._strokeWidth=3,this._boundSlotChange=()=>this.requestUpdate()}get isFailure(){return this._isFailure}set isFailure(e){this._isFailure=g(e)}get value(){return this._value}set value(e){const t=I(e,0);this._value!==t&&(this._value=t)}get total(){return this._total}set total(e){const t=I(e,100);this._total!==t&&(this._total=t)}get diameter(){return this._diameter}set diameter(e){const t=I(e,100);this._diameter!==t&&(this._diameter=t)}get strokeWidth(){return this._strokeWidth}set strokeWidth(e){const t=I(e,3);this._strokeWidth!==t&&(this._strokeWidth=t)}get circumference(){return Tr}get modeValue(){return this.mode===Ye.Determinate||this.isComplete?this.value:zr}get modeTotal(){return this.mode===Ye.Determinate||this.isComplete?this.total:Br}get percentage(){return 100/this.modeTotal*this.modeValue}get isComplete(){return this.value>=this.total&&this.total>0}get spinnerColor(){return this.isComplete&&this.isFailure?this.failStatusColor:this.color}get strokeDasharray(){return`${this.circumference} ${this.circumference}`}get strokeDashoffset(){return this.circumference-this.percentage/100*this.circumference}hasSlotContent(e){var i;const t=(i=this.shadowRoot)==null?void 0:i.querySelector(`slot[name="${e}"]`);return!!(t!=null&&t.assignedNodes().length)}connectedCallback(){super.connectedCallback(),this.addEventListener("slotchange",this._boundSlotChange)}disconnectedCallback(){this.removeEventListener("slotchange",this._boundSlotChange),super.disconnectedCallback()}get effectiveInProgressIcon(){return this.hasSlotContent("in-progress-icon")?"":this.inProgressIconName||(this.appearance===xe.Icon?Or:"")}get effectiveCompleteIcon(){return this.hasSlotContent("complete-icon")?"":this.completeIconName||(this.appearance===xe.Icon?Lr:"")}get effectiveFailIcon(){return this.hasSlotContent("fail-icon")?"":this.failIconName||(this.appearance===xe.Icon?Pr:"")}render(){const e=this.appearance===xe.Icon&&!this.isComplete&&(this.effectiveInProgressIcon||this.hasSlotContent("in-progress-icon")),t=this.appearance===xe.Icon&&this.isComplete&&!this.isFailure&&(this.effectiveCompleteIcon||this.hasSlotContent("complete-icon")),i=this.appearance===xe.Icon&&this.isComplete&&this.isFailure&&(this.effectiveFailIcon||this.hasSlotContent("fail-icon"));return l`
      <div
        class="swim-progress-spinner__container ${this.appearance===xe.Icon?"swim-progress-spinner__container--icon":""}"
        part="container"
        style="--spinner-color: ${this.spinnerColor}"
        role="progressbar"
        aria-valuenow="${this.mode===Ye.Determinate?this.value:h}"
        aria-valuemin="0"
        aria-valuemax="${this.mode===Ye.Determinate?this.total:h}"
        aria-label="Progress"
      >
        <svg
...
`,Mr=[$,Fr];var L=(e=>(e.top="top",e.bottom="bottom",e.left="left",e.right="right",e))(L||{}),pe=(e=>(e.top="top",e.bottom="bottom",e.left="left",e.right="right",e.center="center",e))(pe||{}),Go=(e=>(e.popover="popover",e.tooltip="tooltip",e))(Go||{}),ye=(e=>(e.all="all",e.focus="focus",e.click="click",e.mouseover="mouseover",e))(ye||{});const ge=7;function Xt(e,t,i){return i===pe.left?(e.left??0)-ge:i===pe.right?(e.left??0)+(e.width??0)-(t.width??0)+ge:(e.left??0)+(e.width??0)/2-(t.width??0)/2}function Ai(e,t,i){return i===pe.top?(e.top??0)-ge:i===pe.bottom?(e.top??0)+(e.height??0)-(t.height??0)+ge:(e.top??0)+(e.height??0)/2-(t.height??0)/2}function vo(e,t,i){let n=Xt(e,t,i);return n+(t.width??0)>window.innerWidth&&(n=window.innerWidth-(t.width??0)),n}function wo(e,t,i){let n=Ai(e,t,i);return n+(t.height??0)>window.innerHeight&&(n=window.innerHeight-(t.height??0)),n}function Rr(e,t,i,n,o){return i===L.right?Xt(e,t,n)+(t.width??0)+o>window.innerWidth:i===L.left?Xt(e,t,n)-o<0:i===L.top?(e.top??0)-(t.height??0)-o<0:i===L.bottom?Ai(e,t,n)+(t.height??0)+o>window.innerHeight:!1}function Hr(e,t,i,n,o){return Rr(i,t,e,o,n)?e===L.right?L.left:e===L.left?L.right:e===L.top?L.bottom:L.top:e}function Nr(e,t,i,n,o){let s=0,r=0;return e===L.right?(r=(i.left??0)+(i.width??0)+n,s=wo(i,t,o)):e===L.left?(r=(i.left??0)-(t.width??0)-n,s=wo(i,t,o)):e===L.top?(s=(i.top??0)-(t.height??0)-n,r=vo(i,t,o)):(s=(i.top??0)+(i.height??0)+n,r=vo(i,t,o)),{top:s,left:r}}function xo(e,t,i,n){let o;n===pe.left?o=(e.width??0)/2-(i.width??0)/2+ge:n===pe.right?o=(t.width??0)-(e.width??0)/2-(i.width??0)/2-ge:o=(t.width??0)/2-(i.width??0)/2;const s=Xt(e,t,n);return s+(t.width??0)>window.innerWidth&&(o+=s+(t.width??0)-window.innerWidth),o}function yo(e,t,i,n){let o;n===pe.top?o=(e.height??0)/2-(i.height??0)/2+ge:n===pe.bottom?o=(t.height??0)-(e.height??0)/2-(i.height??0)/2-ge:o=(t.height??0)/2-(i.height??0)/2;const s=Ai(e,t,n);return s+(t.height??0)>window.innerHeight&&(o+=s+(t.height??0)-window.innerHeight),o}function Vr(e,t,i,n,o){let s=0,r=0;return e===L.right?(r=-ge,s=yo(i,t,n,o)):e===L.left?(r=t.width??0,s=yo(i,t,n,o)):e===L.top?(s=t.height??0,r=xo(i,t,n,o)):(s=-ge,r=xo(i,t,n,o)),{top:s,left:r}}var qr=Object.defineProperty,jr=Object.getOwnPropertyDescriptor,O=(e,t,i,n)=>{for(var o=n>1?void 0:n?jr(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&qr(t,i,o),o};let B=class extends _{constructor(){super(...arguments),this.content="",this.placement=L.top,this.alignment=pe.center,this.type=Go.popover,this.showEvent=ye.all,this._spacing=10,this._showCaret=!0,this._disabled=!1,this._closeOnClickOutside=!0,this._closeOnMouseLeave=!0,this._hideTimeout=300,this._showTimeout=100,this.cssClass="",this._open=!1,this._panelTop=0,this._panelLeft=0,this._effectivePlacement=L.top,this._caretTop=0,this._caretLeft=0,this._animate=!1,this._triggerRef=null,this._panelRef=null,this._caretRef=null,this._boundDocumentClick=null,this._openFromClick=!1,this._tooltipId=`swim-tooltip-${Math.random().toString(36).slice(2,11)}`,this._throttledPosition=()=>{this._throttleTimeout==null&&(this._throttleTimeout=window.setTimeout(()=>{this._throttleTimeout=void 0,this._open&&this._position()},100))},this._panelForHideListeners=null,this._panelMouseEnterBound=()=>this._clearHideTimer(),this._panelMouseLeaveBound=e=>{var i;const t=e.relatedTarget;t&&((i=this._triggerRef)!=null&&i.contains(t))||this.hide()},this._onTriggerFocus=()=>{this._listensFocus&&this.show()},this._onTriggerBlur=()=>{this._listensFocus&&this.hide(!0)},this._onTriggerMouseEnter=()=>{this._listensHover&&this.show()},this._onTriggerMouseLeave=e=>{var n;const t=e.relatedTarget,i=this._panelRef??((n=this.shadowRoot)==null?void 0:n.querySelector(".swim-tooltip__panel"));i!=null&&i.contains(t)||(this._listensHover&&this.closeOnMouseLeave&&this.hide(),this._listensClick&&this.hide())},this._onPanelMouseLeave=()=>{this.closeOnMouseLeave&&this.hide()},this._onTriggerClick=()=>{if(this.showEvent===ye.mouseover){this.hide(!0);return}this._listensClick&&(this._openFromClick?this.hide(!0):(this._openFromClick=!0,this.show(!0)))}}get spacing(){return this._spacing}set spacing(e){this._spacing=I(e,10)}get showCaret(){return this._showCaret}set showCaret(e){this._showCaret=g(e)}get disabled(){return this._disabled}set disabled(e){this._disabled=g(e)}get closeOnClickOutside(){return this._closeOnClickOutside}set closeOnClickOutside(e){this._closeOnClickOutside=g(e)}get closeOnMouseLeave(){return this._closeOnMouseLeave}set closeOnMouseLeave(e){this._closeOnMouseLeave=g(e)}get hideTimeout(){return this._hideTimeout}set hideTimeout(e){this._hideTimeout=I(e,300)}get showTimeout(){return this._showTimeout}set showTimeout(e){this._showTimeout=I(e,100)}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",this._throttledPosition)}disconnectedCallback(){window.removeEventListener("resize",this._throttledPosition),this._throttleTimeout!=null&&(window.clearTimeout(this._throttleTimeout),this._throttleTimeout=void 0),this._clearShowTimer(),this._clearHideTimer(),this._removeDocumentClick(),this._removePanelHideListeners(),super.disconnectedCallback()}_hasContentSlot(){return!!this.querySelector('[slot="content"]')}get _listensFocus(){return this.showEvent===ye.all||this.showEvent===ye.focus}get _listensHover(){return this.showEvent===ye.all||this.showEvent===ye.mouseover}get _listensClick(){return this.showEvent===ye.all||this.showEvent===ye.click}show(e=!1){if(this._open||this.disabled)return;this._clearShowTimer(),this._clearHideTimer();const t=()=>{this._open||this.disabled||!(this._hasContentSlot||this.content!=null&&this.content!=="")||(this._open=!0,this._effectivePlacement=this.placement,requestAnimationFrame(()=>{this._position(),requestAnimationFrame(()=>{this._animate=!0,this._addHideListeners()})}),this.dispatchEvent(new CustomEvent("show",{detail:!0,bubbles:!0})))};e?t():this._showTimer=window.setTimeout(t,this.showTimeout)}hide(e=!1){if(!this._open)return;this._clearShowTimer(),this._clearHideTimer();const t=()=>{this._open&&(this._open=!1,this._animate=!1,this._openFromClick=!1,this._removeDocumentClick(),this._removePanelHideListeners(),this.dispatchEvent(new CustomEvent("hide",{detail:!0,bubbles:!0})))};e?t():this._hideTimer=window.setTimeout(t,this.hideTimeout)}_clearShowTimer(){this._showTimer!=null&&(window.clearTimeout(this._showTimer),this._showTimer=void 0)}_clearHideTimer(){this._hideTimer!=null&&(window.clearTimeout(this._hideTimer),this._hideTimer=void 0)}_removeDocumentClick(){this._boundDocumentClick&&(document.removeEventListener("click",this._boundDocumentClick,!0),this._boundDocumentClick=null)}_position(){var c,d,p;const e=this._triggerRef??((c=this.shadowRoot)==null?void 0:c.querySelector(".swim-tooltip__trigger")),t=this._panelRef??((d=this.shadowRoot)==null?void 0:d.querySelector(".swim-tooltip__panel")),i=this._caretRef??((p=this.shadowRoot)==null?void 0:p.querySelector(".swim-tooltip__caret"));if(!e||!t)return;const n=e.getBoundingClientRect();if(!n.height&&!n.width)return;const o=t.getBoundingClientRect();this._effectivePlacement=Hr(this.placement,o,n,this.spacing,this.alignment);const{top:s,left:r}=Nr(this._effectivePlacement,o,n,this.spacing,this.alignment);if(this._panelTop=s,this._panelLeft=r,this.showCaret&&i){const w=i.getBoundingClientRect(),u=Vr(this._effectivePlacement,o,n,w,this.alignment);this._caretTop=u.top,this._caretLeft=u.left}}_removePanelHideListeners(){this._panelForHideListeners&&(this._panelForHideListeners.removeEventListener("mouseenter",this._panelMouseEnterBound),this._panelForHideListeners.removeEventListener("mouseleave",this._panelMouseLeaveBound),this._panelForHideListeners=null)}_addHideListeners(){var t;const e=this._panelRef??((t=this.shadowRoot)==null?void 0:t.querySelector(".swim-tooltip__panel"));e&&(this._removePanelHideListeners(),this._panelForHideListeners=e,e.addEventListener("mouseenter",this._panelMouseEnterBound),this.closeOnMouseLeave&&e.addEventListener("mouseleave",this._panelMouseLeaveBound),this.closeOnClickOutside&&(this._boundDocumentClick=i=>{var o;const n=i.target;e.contains(n)||(o=this._triggerRef)!=null&&o.contains(n)||this.hide(!0)},setTimeout(()=>document.addEventListener("click",this._boundDocumentClick,!0),0)))}firstUpdated(){var e,t,i;this._triggerRef=(e=this.shadowRoot)==null?void 0:e.querySelector(".swim-tooltip__trigger"),this._panelRef=(t=this.shadowRoot)==null?void 0:t.querySelector(".swim-tooltip__panel"),this._caretRef=(i=this.shadowRoot)==null?void 0:i.querySelector(".swim-tooltip__caret")}updated(e){this._open&&(e.has("placement")||e.has("alignment")||e.has("spacing"))&&this._position()}render(){const e=this._hasContentSlot(),t=e||this.content!=null&&this.content!=="",i=["swim-tooltip__panel",`swim-tooltip__panel--type-${this.type}`,`swim-tooltip__panel--position-${this._effectivePlacement}`,this._animate?"swim-tooltip__panel--animate":"",this.cssClass.includes("narrow")?"swim-tooltip__panel--narrow":""].filter(Boolean).join(" ");return l`
      <div
        part="trigger"
      ...
      ${this._open&&t?l`
          ...
          `:""}
    `}};B.styles=Mr;O([a({type:String})],B.prototype,"content",2);O([a({type:String,reflect:!0,attribute:"placement"})],B.prototype,"placement",2);O([a({type:String,reflect:!0,attribute:"alignment"})],B.prototype,"alignment",2);O([a({type:String,reflect:!0,attribute:"type"})],B.prototype,"type",2);O([a({type:String,attribute:"show-event"})],B.prototype,"showEvent",2);O([a({type:Number,attribute:"spacing"})],B.prototype,"spacing",1);O([a({type:Boolean,attribute:"show-caret",converter:{fromAttribute:e=>e!=="false",toAttribute:e=>e?"":"false"}})],B.prototype,"showCaret",1);O([a({type:Boolean,reflect:!0})],B.prototype,"disabled",1);O([a({type:Boolean,attribute:"close-on-click-outside"})],B.prototype,"closeOnClickOutside",1);O([a({type:Boolean,attribute:"close-on-mouse-leave"})],B.prototype,"closeOnMouseLeave",1);O([a({type:Number,attribute:"hide-timeout"})],B.prototype,"hideTimeout",1);O([a({type:Number,attribute:"show-timeout"})],B.prototype,"showTimeout",1);O([a({type:String,attribute:"css-class"})],B.prototype,"cssClass",2);O([v()],B.prototype,"_open",2);O([v()],B.prototype,"_panelTop",2);O([v()],B.prototype,"_panelLeft",2);O([v()],B.prototype,"_effectivePlacement",2);O([v()],B.prototype,"_caretTop",2);O([v()],B.prototype,"_caretLeft",2);O([v()],B.prototype,"_animate",2);B=O([y("swim-tooltip")],B);const Ur=40,Wr=2,Gr=f`
  :host {
    --swim-navbar-bar-size: ${Ur}px;
    --swim-navbar-bar-thickness: ${Wr}px;
    display: inline-flex;
    align-items: center;
    min-height: 50px;
    position: relative;
...
`;var Xr=Object.defineProperty,Yr=Object.getOwnPropertyDescriptor,ei=(e,t,i,n)=>{for(var o=n>1?void 0:n?Yr(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&Xr(t,i,o),o};let Ne=class extends _{constructor(){super(...arguments),this._active=0,this._total=0,this._index=0,this._clickBound=()=>this._handleClick()}get active(){return this._active}set active(e){const t=I(e,0);if(this._active!==t){const i=this._active;this._active=t,this.requestUpdate("active",i)}}get total(){return this._total}set total(e){this._total=I(e,0)}get index(){return this._index}set index(e){const t=I(e,0);if(this._index!==t){const i=this._index;this._index=t,this.requestUpdate("index",i)}}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this._clickBound)}disconnectedCallback(){this.removeEventListener("click",this._clickBound),super.disconnectedCallback()}render(){const e=this._active===this._index;return l`
      <div
    ...
    `}setActive(){this._active!==this._index&&(this._active=this._index,this.requestUpdate(),this.dispatchEvent(new CustomEvent("active-change",{detail:this._index,bubbles:!0,composed:!0})))}_handleClick(){this.setActive()}_handleKeyDown(e){(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.setActive())}};Ne.styles=[$,Kr];ei([a({type:Number})],Ne.prototype,"active",1);ei([a({type:Number})],Ne.prototype,"total",1);ei([a({type:Number})],Ne.prototype,"index",1);Ne=ei([y("swim-navbar-item")],Ne);var Qr=Object.defineProperty,Zr=Object.getOwnPropertyDescriptor,St=(e,t,i,n)=>{for(var o=n>1?void 0:n?Zr(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&Qr(t,i,o),o};const Jr=40;let Ve=class extends _{constructor(){super(...arguments),this._barAtTop=!1,this._active=0,this._navItems=[],this._slotChangeBound=()=>this._syncFromSlot(),this._activeChangeBound=e=>this._onItemActiveChange(e)}get barAtTop(){return this._barAtTop}set barAtTop(e){this._barAtTop=g(e)}get active(){return this._active}set active(e){const t=I(e,0);t!==this._active&&!isNaN(t)&&t>=0&&(!this._navItems.length||t<this._navItems.length)&&(this._active=t,this._syncItems(),this.dispatchEvent(new CustomEvent("active-change",{detail:this._active,bubbles:!0,composed:!0})))}connectedCallback(){super.connectedCallback(),requestAnimationFrame(()=>this._syncFromSlot())}firstUpdated(){var t;this._syncFromSlot();const e=this._slotEl??((t=this.shadowRoot)==null?void 0:t.querySelector("slot"));e&&e.addEventListener("slotchange",this._slotChangeBound)}disconnectedCallback(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector("slot");e&&e.removeEventListener("slotchange",this._slotChangeBound),this._navItems.forEach(i=>{i.removeEventListener("active-change",this._activeChangeBound)}),super.disconnectedCallback()}goTo(e){const t=I(e,-1);if(t>=0&&t<this._navItems.length&&t!==this._active){const i=this._navItems[t];i&&i.setActive()}}_syncFromSlot(){var n;const e=this._slotEl??((n=this.shadowRoot)==null?void 0:n.querySelector("slot"));let t=(e==null?void 0:e.assignedElements({flatten:!0}))??[];t.length===0&&(t=Array.from(this.children));const i=t.filter(o=>o instanceof Ne);this._navItems.forEach(o=>{o.removeEventListener("active-change",this._activeChangeBound)}),this._navItems=i,i.forEach(o=>{o.addEventListener("active-change",this._activeChangeBound)}),this._syncItems()}_syncItems(){const e=this._active,t=this._navItems.length;this._navItems.forEach((i,n)=>{i.index=n,i.total=t,i.active=e})}_onItemActiveChange(e){const t=e.detail;typeof t!="number"||t===this._active||t>=0&&t<this._navItems.length&&(this._active=t,this._syncItems(),this.requestUpdate(),this.dispatchEvent(new CustomEvent("active-change",{detail:this._active,bubbles:!0,composed:!0})))}_getBarTransform(){const e=this._navItems.filter((t,i)=>i<this._active).length;return`translateX(${Jr*e}px)`}render(){const e=this._barAtTop;return l`
    ...
    `}};Ve.styles=[$,Gr];St([H("slot")],Ve.prototype,"_slotEl",2);St([a({type:Boolean,reflect:!0,attribute:"bar-at-top"})],Ve.prototype,"barAtTop",1);St([a({type:Number})],Ve.prototype,"active",1);St([v()],Ve.prototype,"_navItems",2);Ve=St([y("swim-navbar")],Ve);const ea=[$,f`
    :host {
      display: block;
    }
  ...
  `];var ut=(e=>(e.Error="error",e.Success="success",e.Warning="warning",e))(ut||{}),ta=Object.defineProperty,ia=Object.getOwnPropertyDescriptor,fe=(e,t,i,n)=>{for(var o=n>1?void 0:n?ia(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&ta(t,i,o),o};const $o=44;let ie=class extends _{constructor(){super(...arguments),this.columnLayout="",this.dataSource=[],this.defaultRowStatus=ut.Error,this.headerLabels=[],this.columns=[],this._hasScrollbar=!1,this._page=1,this._rowsContainer=null,this._scrollBound=e=>this._emitScrollChanges(e)}get height(){return this._height}set height(e){this._height=e===void 0?void 0:I(e)}connectedCallback(){super.connectedCallback()}firstUpdated(){var e;this._rowsContainer=((e=this.renderRoot)==null?void 0:e.querySelector(".swim-list__rows-container"))??null,this._rowsContainer&&(this._rowsContainer.addEventListener("scroll",this._scrollBound),requestAnimationFrame(()=>{var t;if(this._updateScrollbarState(),(t=this.paginationConfig)!=null&&t.index&&this.paginationConfig.index>1&&this.paginationConfig.pageSize>0){this._page=this.paginationConfig.index;const i=$o*(this.paginationConfig.pageSize*(this._page-1));this._rowsContainer.scrollTo({top:i})}}))}disconnectedCallback(){this._rowsContainer&&(this._rowsContainer.removeEventListener("scroll",this._scrollBound),this._rowsContainer=null),super.disconnectedCallback()}updated(e){(e.has("dataSource")||e.has("height"))&&this._updateScrollbarState()}_updateScrollbarState(){this._rowsContainer&&(this._hasScrollbar=this._rowsContainer.scrollHeight>this._rowsContainer.clientHeight)}_emitScrollChanges(e){var o;const i=e.target.scrollTop;this.dispatchEvent(new CustomEvent("scroll",{detail:i,bubbles:!0}));const n=(o=this.paginationConfig)==null?void 0:o.pageSize;if(n){const s=Math.floor(i/$o),r=Math.floor(s/n)+1;r!==this._page&&(this._page=r,this.dispatchEvent(new CustomEvent("page-change",{detail:r,bubbles:!0})))}}_getGridStyle(){const e=Math.max(this.headerLabels.length,this.columns.length,1);return this.columnLayout&&this.columnLayout.trim()?this.columnLayout.trim():`repeat(${e}, 1fr)`}_getRowStatus(e){const t=e.status;return t===ut.Error||t===ut.Success||t===ut.Warning?t:this.defaultRowStatus}_getCellValue(e,t,i){if(t==="$index")return`${i+1}.`;const n=e[t];return n==null?"":String(n)}render(){const e=this._getGridStyle(),t=Math.max(this.headerLabels.length,this.columns.length,1),i=this.headerLabels.length>=t?this.headerLabels.slice(0,t):[...this.headerLabels,...Array(t-this.headerLabels.length).fill("")];return l`
      <div
    ...
    `}};ie.styles=ea;fe([a({type:String,attribute:"column-layout"})],ie.prototype,"columnLayout",2);fe([a({type:Array,attribute:!1})],ie.prototype,"dataSource",2);fe([a({type:Number})],ie.prototype,"height",1);fe([a({attribute:!1})],ie.prototype,"paginationConfig",2);fe([a({type:String,attribute:"default-row-status",reflect:!0})],ie.prototype,"defaultRowStatus",2);fe([a({type:Array,attribute:!1})],ie.prototype,"headerLabels",2);fe([a({type:Array,attribute:!1})],ie.prototype,"columns",2);fe([v()],ie.prototype,"_hasScrollbar",2);fe([v()],ie.prototype,"_page",2);ie=fe([y("swim-list")],ie);const ti=f`
...
`,oa=[$,ti,f`
  ...
  `];var pt=(e=>(e.Regular="regular",e.Medium="medium",e.Large="large",e))(pt||{}),na=Object.defineProperty,sa=Object.getOwnPropertyDescriptor,V=(e,t,i,n)=>{for(var o=n>1?void 0:n?sa(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&na(t,i,o),o};let D=class extends _{constructor(){super(...arguments),this.dialogTitle="",this.content="",this.class="",this.cssClass="",this.format=pt.Regular,this.showBackdrop=!0,this._closeButton=!0,this._visible=!1,this._zIndex=991,this._contentId=`swim-dialog-content-${Math.random().toString(36).slice(2,11)}`,this._titleId=`swim-dialog-title-${Math.random().toString(36).slice(2,11)}`,this._previousActiveElement=null}get title(){return this.dialogTitle}set title(e){e&&(this.dialogTitle=e)}get closeButton(){return this._closeButton}set closeButton(e){this._closeButton=g(e)}get visible(){return this._visible}set visible(e){const t=g(e);this._visible!==t&&(this._visible=t,t?(this._previousActiveElement=typeof document<"u"?document.activeElement:null,this.dispatchEvent(new CustomEvent("open",{bubbles:!0}))):(this._restoreFocus(),this.dispatchEvent(new CustomEvent("close",{detail:void 0,bubbles:!0}))))}get zIndex(){return this._zIndex}set zIndex(e){this._zIndex=I(e,991)}get _contentzIndex(){return this.zIndex+1}get _canClose(){return this.beforeClose?this.beforeClose():!0}_restoreFocus(){this._previousActiveElement&&typeof this._previousActiveElement.focus=="function"&&this._previousActiveElement.focus(),this._previousActiveElement=null}show(){this.visible=!0}hide(){this._canClose&&(this.visible=!1)}firstUpdated(){this.visible&&this._contentEl&&this._contentEl.focus({preventScroll:!0})}updated(e){e.has("visible")&&this.visible&&this._contentEl&&requestAnimationFrame(()=>{var t;(t=this._contentEl)==null||t.focus({preventScroll:!0})})}render(){if(!this.visible)return h;const e=this.format===pt.Regular||this.format==="regular",t=this.format===pt.Large||this.format==="large",i=this.format===pt.Medium||this.format==="medium",n=["swim-dialog__content",this.cssClass,t?"swim-dialog__content--large":"",i?"swim-dialog__content--medium":""].filter(Boolean).join(" "),o=this.class.includes("swim-dialog--full-screen"),s=["swim-dialog","swim-dialog--open",this.class,o?"swim-scroll":""].filter(Boolean).join(" ");return l`
    ...
    `}};D.styles=oa;V([a({type:String,attribute:"dialog-title"})],D.prototype,"dialogTitle",2);V([a({type:String})],D.prototype,"title",1);V([a({type:String})],D.prototype,"content",2);V([a({type:String})],D.prototype,"class",2);V([a({type:String,attribute:"css-class"})],D.prototype,"cssClass",2);V([a({type:String,reflect:!0})],D.prototype,"format",2);V([a({type:Boolean,attribute:"show-backdrop",reflect:!0,converter:{fromAttribute:e=>e===null?!0:e!=="false"&&e!=="0",toAttribute:e=>e?"":"false"}})],D.prototype,"showBackdrop",2);V([a({type:Boolean,attribute:"close-button"})],D.prototype,"closeButton",1);V([a({type:Boolean,reflect:!0})],D.prototype,"visible",1);V([a({type:Number})],D.prototype,"zIndex",1);V([a({attribute:!1})],D.prototype,"beforeClose",2);V([v()],D.prototype,"_contentId",2);V([v()],D.prototype,"_titleId",2);V([H(".swim-dialog__content")],D.prototype,"_contentEl",2);D=V([y("swim-dialog")],D);const ra=[$,f`
    :host {
      display: block;
      width: 100%;
      height: 100%;
  ...
  `];var aa=Object.defineProperty,la=Object.getOwnPropertyDescriptor,Ue=(e,t,i,n)=>{for(var o=n>1?void 0:n?la(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&aa(t,i,o),o};let ke=class extends _{constructor(){super(...arguments),this.format="large",this.dialogTitle="",this.dialogSubtitle="",this.dialogActionTitle="Close",this.dialogDirtyActionTitle="Cancel",this.dirty=!1}_onCloseOrCancel(){this.dispatchEvent(new CustomEvent("close-or-cancel",{detail:this.dirty,bubbles:!0,composed:!0}))}render(){const e=["format-dialog-container__header-title","format-dialog-container__header-title--with-subtitle"].join(" ");return l`
    ...
    `}};ke.styles=[ti,ra];Ue([a({type:String,reflect:!0})],ke.prototype,"format",2);Ue([a({type:String,attribute:"dialog-title"})],ke.prototype,"dialogTitle",2);Ue([a({type:String,attribute:"dialog-subtitle"})],ke.prototype,"dialogSubtitle",2);Ue([a({type:String,attribute:"dialog-action-title"})],ke.prototype,"dialogActionTitle",2);Ue([a({type:String,attribute:"dialog-dirty-action-title"})],ke.prototype,"dialogDirtyActionTitle",2);Ue([a({type:Boolean,reflect:!0})],ke.prototype,"dirty",2);ke=Ue([y("swim-large-format-dialog-content")],ke);const ca=[$,f`
    :host {
  ...
  `];var da=Object.defineProperty,ha=Object.getOwnPropertyDescriptor,Ko=(e,t,i,n)=>{for(var o=n>1?void 0:n?ha(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&da(t,i,o),o};let Yt=class extends _{constructor(){super(...arguments),this.format="large"}render(){return l` <div class="format-dialog-footer"><slot></slot></div> `}};Yt.styles=ca;Ko([a({type:String,reflect:!0})],Yt.prototype,"format",2);Yt=Ko([y("swim-large-format-dialog-footer")],Yt);const ua=[$,ti,f`
    :host {
...
Age: ${Ft}`)})}xa();const o=document.getElementById("selectableCardDemo"),s=document.getElementById("cardSelectedValue");o&&s&&o.addEventListener("select",z=>{s.textContent=String(z.detail??!1)});const r=document.getElementById("outlineCardDemo");r&&r.addEventListener("outline-click",()=>console.log("Outline clicked"));const c=document.getElementById("checkboxDemoEvent"),d=document.getElementById("checkboxDemoChecked"),p=document.getElementById("checkboxDemoEventName");c&&d&&p&&(c.addEventListener("checked-change",z=>{d.textContent=String(z.detail),p.textContent="checked-change"}),c.addEventListener("change",()=>{p.textContent="change"}),c.addEventListener("focus",()=>{p.textContent="focus"}),c.addEventListener("blur",()=>{p.textContent="blur"}),d.textContent=String(c.checked));const w=document.getElementById("radioSingleValue"),u=["radioSeasonSpring","radioSeasonSummer","radioSeasonFall","radioSeasonWinter"];u.forEach(z=>{const T=document.getElementById(z);T&&w&&T.addEventListener("change",M=>{const R=M.detail;u.forEach(ve=>{const oe=document.getElementById(ve);oe&&(oe.checked=oe.value===R)}),w.textContent=String(R??"")})});const b=document.getElementById("radioGroupDemo"),m=document.getElementById("radioGroupValue");b&&m&&(m.textContent=String(b.value??"—"),b.addEventListener("change",z=>{m.textContent=String(z.detail??"—")}));const C=document.getElementById("progressSpinnerWithLabel");C&&(C.spinnerLabel={inProgressLabel:"Loading...",completeLabel:"Complete!",failLabel:"Failed"});const E=document.getElementById("progressSpinnerConfigurable"),j=document.getElementById("progressSpinnerConfigurableCode"),de=["progressSpinnerValue","progressSpinnerTotal","progressSpinnerDiameter","progressSpinnerStrokeWidth","progressSpinnerColor","progressSpinnerMode","progressSpinnerCompleteStatus","progressSpinnerShowIcon"];function _e(){var Qi;if(!E)return;const z=document.getElementById("progressSpinnerValue"),T=document.getElementById("progressSpinnerTotal"),M=document.getElementById("progressSpinnerDiameter"),R=document.getElementById("progressSpinnerStrokeWidth"),ve=document.getElementById("progressSpinnerColor"),oe=document.getElementById("progressSpinnerMode"),Ge=document.getElementById("progressSpinnerCompleteStatus"),Ke=document.getElementById("progressSpinnerShowIcon"),Ft=(z==null?void 0:z.value)??"35",si=(T==null?void 0:T.value)??"100",Ui=(M==null?void 0:M.value)??"100",Wi=(R==null?void 0:R.value)??"5",Gi=(ve==null?void 0:ve.value)??"lime",Ki=(oe==null?void 0:oe.value)??"indeterminate",Mt=(Ge==null?void 0:Ge.value)??"success",Xi=(Ke==null?void 0:Ke.checked)!==!1,Yi=Mt==="fail"||Mt==="success"?si:Ft;if(E.value=Number(Yi),E.total=Number(si),E.diameter=Number(Ui),E.strokeWidth=Number(Wi),E.color=Gi,E.setAttribute("mode",Ki),E.isFailure=Mt==="fail",E.appearance=Xi?"icon":"default",(Qi=E.requestUpdate)==null||Qi.call(E),j){const Qo=Mt==="fail"?`
  ...
  stroke-width="${Wi}"
  color="${Gi}"
  appearance="${Xi?"icon":"default"}"${Qo}
  aria-label="...">
</swim-progress-spinner>`}}if(E){const z=document.getElementById("progressSpinnerMode");z&&z.addEventListener("change",()=>setTimeout(_e,0)),de.forEach(M=>{const R=document.getElementById(M);R&&R!==z&&(R.addEventListener("input",_e),R.addEventListener("change",_e))}),z&&z.addEventListener("input",_e);const T=document.getElementById("progressSpinnerShowIcon");T&&T.addEventListener("change",_e),_e()}const Oe=document.getElementById("sliderDemoEvent"),Ct=document.getElementById("sliderDemoValue"),st=document.getElementById("sliderDemoPercent");Oe&&Ct&&st&&Oe.addEventListener("change",z=>{const T=z.detail;Ct.textContent=String((T==null?void 0:T.value)??""),st.textContent=String((T==null?void 0:T.percent)??"")});const We=document.getElementById("toggleDemoEvent"),ii=document.getElementById("toggleDemoChecked"),Et=document.getElementById("toggleDemoEventName");We&&ii&&Et&&(We.addEventListener("change",()=>{ii.textContent=String(We.checked),Et.textContent="change"}),We.addEventListener("focus",()=>{Et.textContent="focus"}),We.addEventListener("blur",()=>{Et.textContent="blur"}),ii.textContent=String(We.checked));const zi=document.getElementById("seasonToggleGroup"),Bi=document.getElementById("seasonValue");zi&&Bi&&zi.addEventListener("value-change",z=>{Bi.textContent=String(z.detail??"")});const It=document.getElementById("disabledGroupDemo"),oi=document.getElementById("toggleGroupDisabledBtn");It&&oi&&oi.addEventListener("click",()=>{It.disabled=!It.disabled,oi.textContent=It.disabled?"Enable group":"Disable group"}),wa(),ya();const Ti=document.getElementById("dialogContentOpen"),At=document.getElementById("dialogContentDemo");Ti&&At&&(Ti.addEventListener("click",()=>{At.visible=!0}),At.addEventListener("close",()=>{At.visible=!1}));const Oi=document.getElementById("dialogComponentToggle"),rt=document.getElementById("dialogComponentDemo");Oi&&rt&&(Oi.addEventListener("click",()=>{rt.visible=!rt.visible}),rt.addEventListener("close",()=>{rt.visible=!1}));const Li=document.getElementById("dialogWizardOpen"),zt=document.getElementById("dialogWizardDemo");Li&&zt&&(Li.addEventListener("click",()=>{zt.visible=!0}),zt.addEventListener("close",()=>{zt.visible=!1}));const Ce=document.getElementById("dialogWizardTabs"),Pi=document.getElementById("dialogWizardPrev"),Di=document.getElementById("dialogWizardNext");Pi&&(Ce!=null&&Ce.prev)&&Pi.addEventListener("click",()=>Ce.prev()),Di&&(Ce!=null&&Ce.next)&&Di.addEventListener("click",()=>Ce.next());const Fi=document.getElementById("dialogFullScreenOpen"),Bt=document.getElementById("dialogFullScreenDemo");Fi&&Bt&&(Fi.addEventListener("click",()=>{Bt.visible=!0}),Bt.addEventListener("close",()=>{Bt.visible=!1}));const Mi=document.getElementById("dialogLargeFormatOpen"),Tt=document.getElementById("dialogLargeFormatDemo");Mi&&Tt&&(Mi.addEventListener("click",()=>{Tt.visible=!0}),Tt.addEventListener("close-or-cancel",()=>{Tt.visible=!1}));const Ri=document.getElementById("dialogMediumFormatOpen"),Ot=document.getElementById("dialogMediumFormatDemo");Ri&&Ot&&(Ri.addEventListener("click",()=>{Ot.visible=!0}),Ot.addEventListener("close-or-cancel",()=>{Ot.visible=!1}));const Hi=document.getElementById("dialogMediumContentOpen"),Lt=document.getElementById("dialogMediumContentDemo");Hi&&Lt&&(Hi.addEventListener("click",()=>{Lt.visible=!0}),Lt.addEventListener("close-or-cancel",()=>{Lt.visible=!1}));const Ni=document.getElementById("dialogMediumFooterOpen"),Pt=document.getElementById("dialogMediumFooterDemo");Ni&&Pt&&(Ni.addEventListener("click",()=>{Pt.visible=!0}),Pt.addEventListener("close-or-cancel",()=>{Pt.visible=!1}));const Vi=document.getElementById("dialogMediumFooterContentOpen"),Dt=document.getElementById("dialogMediumFooterContentDemo");Vi&&Dt&&(Vi.addEventListener("click",()=>{Dt.visible=!0}),Dt.addEventListener("close-or-cancel",()=>{Dt.visible=!1}));const qi=document.getElementById("navbarGoToFourthBtn"),ni=document.getElementById("navbarTopDemo");qi&&ni&&"goTo"in ni&&qi.addEventListener("click",()=>ni.goTo(3));const ji=document.getElementById("selectForm");ji&&ji.addEventListener("submit",z=>{z.preventDefault();const T=document.getElementById("formSelect1"),M=document.getElementById("formSelect2");console.log("Select Form submitted!"),alert(`Form submitted!
Category: ${T.value}
Tags: ${JSON.stringify(M.value)}`)})}async function ka(){document.querySelectorAll('.sub-nav-item[href^="#"]').forEach(r=>{r.addEventListener("click",c=>{const d=r.getAttribute("href");if(!d||d==="#")return;const p=d.slice(1).toLowerCase();Yo.has(p)&&(c.preventDefault(),window.location.hash!==d?window.location.hash=p:pi(p))})}),window.addEventListener("hashchange",()=>{const r=ui();e(r),pi(r)});function e(r){const c=r??ui();document.querySelectorAll(".sub-nav-item.active, .nav-item.active").forEach(d=>d.classList.remove("active")),document.querySelectorAll(`.sub-nav-item[href="#${c}"], .nav-item[href="#${c}"]`).forEach(d=>d.classList.add("active"))}const t=ui();window.location.hash.slice(1).toLowerCase()!==t&&history.replaceState(null,"",`#${t}`),e(t),await pi(t);const i=document.getElementById("navSearch"),n=document.querySelectorAll(".nav-item-container"),o=document.querySelectorAll(".sub-nav-item");function s(){if(!i)return;const r=i.value.trim().toLowerCase();o.forEach(c=>{var p;const d=((p=c.textContent)==null?void 0:p.trim().toLowerCase())??"";c.classList.toggle("nav-search-hidden",r.length>0&&!d.includes(r))}),n.forEach(c=>{var m;const d=c.querySelector(".nav-item-label"),p=((m=d==null?void 0:d.textContent)==null?void 0:m.trim().toLowerCase())??"",w=c.querySelectorAll(".sub-nav-item:not(.nav-search-hidden)").length,u=r.length===0||p.includes(r),b=w>0;c.classList.toggle("nav-search-hidden",r.length>0&&!u&&!b)})}i&&(i.addEventListener("input",s),i.addEventListener("keydown",r=>{r.key==="Escape"&&(i.value="",s(),i.blur())})),console.log("✨ @swimlane/lit-ui demo loaded successfully!")}document.addEventListener("DOMContentLoaded",()=>{const e=ti.styleSheet;e&&(document.adoptedStyleSheets=[...document.adoptedStyleSheets,e]),ka()});
