 ...
 */
const O = globalThis, j = O.ShadowRoot && (O.ShadyCSS === void 0 || O.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, X = Symbol(), ne = /* @__PURE__ */ new WeakMap();
let pe = class {
  constructor(e, t, n) {
...
const ve = (i) => new pe(typeof i == "string" ? i : i + "", void 0, X), K = (i, ...e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ie, defineProperty: Ee, getOwnPropertyDescriptor: ze, getOwnPropertyNames: Se, getOwnPropertySymbols: qe, getPrototypeOf: Je } = Object, A = globalThis, ie = A.trustedTypes, ke = ie ? ie.emptyScript : "", T = A.reactiveElementPolyfillSupport, B = (i, e) => i, F = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? ke : null;
      break;
...
let S = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(B("properties"))) {
      const t = this.properties, n = [...Se(t), ...qe(t)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const o of n) t.unshift(oe(o));
  ...
  _$ET(e, t) {
    ...
    if (o !== void 0 && n.reflect === !0) {
      const r = (((s = n.converter) == null ? void 0 : s.toAttribute) !== void 0 ? n.converter : F).toAttribute(t, n.type);
  ...
  _$AK(e, t) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const a = n.getPropertyOptions(o), c = typeof a.converter == "function" ? { fromAttribute: a.converter } : ((s = a.converter) == null ? void 0 : s.fromAttribute) !== void 0 ? a.converter : F;
      this._$Em = o;
      const g = c.fromAttribute(t, a.type);
  ...
  requestUpdate(e, t, n) {
    ...
    if (e !== void 0) {
      ...
      if (n ?? (n = s.getPropertyOptions(e)), !((n.hasChanged ?? _)(r, t) || n.useDefault && n.reflect && r === ((o = this._$Ej) == null ? void 0 : o.get(e)) && !this.hasAttribute(s._$Eu(e, n)))) return;
      this.C(e, t, n);
    }
...
S.elementStyles = [], S.shadowRootOptions = { mode: "open" }, S[B("elementProperties")] = /* @__PURE__ */ new Map(), S[B("finalized")] = /* @__PURE__ */ new Map(), T == null || T({ ReactiveElement: S }), (A.reactiveElementVersions ?? (A.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const M = globalThis, Q = M.trustedTypes, se = Q ? Q.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, ue = "$lit$", x = `lit$${Math.random().toFixed(9).slice(2)}$`, we = "?" + x, He = `<${we}>`, z = document, G = () => z.createComment(""), P = (i) => i === null || typeof i != "object" && typeof i != "function", $ = Array.isArray, Be = (i) => $(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", N = `[ 	
\f\r]`, H = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ce = /-->/g, ae = />/g, C = RegExp(`>|${N}(?:([^\\s"'>=/]+)(${N}*=${N}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), le = /'/g, be = /"/g, xe = /^(?:script|style|textarea|title)$/i, Me = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), y = Me(1), J = Symbol.for("lit-noChange"), b = Symbol.for("lit-nothing"), ge = /* @__PURE__ */ new WeakMap(), I = z.createTreeWalker(z, 129);
function ye(i, e) {
...
const Ge = (i, e) => {
  ...
  for (let a = 0; a < t; a++) {
    const c = i[a];
    let g, f, l = -1, u = 0;
    for (; u < c.length && (r.lastIndex = u, f = r.exec(c), f !== null); ) u = r.lastIndex, r === H ? f[1] === "!--" ? r = ce : f[1] !== void 0 ? r = ae : f[2] !== void 0 ? (xe.test(f[2]) && (o = RegExp("</" + f[2], "g")), r = C) : f[3] !== void 0 && (r = C) : r === C ? f[0] === ">" ? (r = o ?? H, l = -1) : f[1] === void 0 ? l = -2 : (l = r.lastIndex - f[2].length, g = f[1], r = f[3] === void 0 ? C : f[3] === '"' ? be : le) : r === be || r === le ? r = C : r === ce || r === ae ? r = H : (r = C, o = void 0);
    const w = r === C && i[a + 1].startsWith("/>") ? " " : "";
    s += r === H ? c + He : l >= 0 ? (n.push(g), c.slice(0, l) + ue + c.slice(l) + x + w) : c + x + (l === -2 ? a : w);
  }
  return [ye(i, s + (i[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), n];
};
class V {
  constructor({ strings: e, _$litType$: t }, n) {
    ...
    this.parts = [];
    let s = 0, r = 0;
    const a = e.length - 1, c = this.parts, [g, f] = Ge(e, t);
    if (this.el = V.createElement(g, n), I.currentNode = this.el.content, t === 2 || t === 3) {
      const l = this.el.content.firstChild;
      l.replaceWith(...l.childNodes);
    }
    for (; (o = I.nextNode()) !== null && c.length < a; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const l of o.getAttributeNames()) if (l.endsWith(ue)) {
          const u = f[r++], w = o.getAttribute(l).split(x), U = /([.?@])?(.*)/.exec(u);
          c.push({ type: 1, index: s, name: U[2], strings: w, ctor: U[1] === "." ? Ve : U[1] === "?" ? Ke : U[1] === "@" ? Re : Y }), o.removeAttribute(l);
        } else l.startsWith(x) && (c.push({ type: 6, index: s }), o.removeAttribute(l));
        if (xe.test(o.tagName)) {
          const l = o.textContent.split(x), u = l.length - 1;
          if (u > 0) {
            o.textContent = Q ? Q.emptyScript : "";
            for (let w = 0; w < u; w++) o.append(l[w], G()), I.nextNode(), c.push({ type: 2, index: ++s });
            o.append(l[u], G());
          }
        }
        ...
        let l = -1;
        for (; (l = o.data.indexOf(x, l + 1)) !== -1; ) c.push({ type: 7, index: s }), l += x.length - 1;
      }
      s++;
    }
  }
...
function k(i, e, t = i, n) {
  var r, a;
  if (e === J) return e;
  let o = n !== void 0 ? (r = t._$Co) == null ? void 0 : r[n] : t._$Cl;
  const s = P(e) ? void 0 : e._$litDirective$;
  return (o == null ? void 0 : o.constructor) !== s && ((a = o == null ? void 0 : o._$AO) == null || a.call(o, !1), s === void 0 ? o = void 0 : (o = new s(i), o._$AT(i, t, n)), n !== void 0 ? (t._$Co ?? (t._$Co = []))[n] = o : t._$Cl = o), o !== void 0 && (e = k(i, o._$AS(i, e.values), o, n)), e;
}
class Pe {
  constructor(e, t) {
  ...
  u(e) {
    ...
    I.currentNode = o;
    let s = I.nextNode(), r = 0, a = 0, c = n[0];
    for (; c !== void 0; ) {
      if (r === c.index) {
        let g;
        c.type === 2 ? g = new R(s, s.nextSibling, this, e) : c.type === 1 ? g = new c.ctor(s, c.name, c.strings, this, e) : c.type === 6 && (g = new De(s, this, e)), this._$AV.push(g), c = n[++a];
      }
      r !== (c == null ? void 0 : c.index) && (s = I.nextNode(), r++);
    }
...
class R {
  ...
  constructor(e, t, n, o) {
    this.type = 2, this._$AH = b, this._$AN = void 0, this._$AA = e, this._$AB = t, this._$AM = n, this.options = o, this._$Cv = (o == null ? void 0 : o.isConnected) ?? !0;
  }
  get parentNode() {
  ...
  _$AI(e, t = this) {
    e = k(this, e, t), P(e) ? e === b || e == null || e === "" ? (this._$AH !== b && this._$AR(), this._$AH = b) : e !== this._$AH && e !== J && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Be(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== b && P(this._$AH) ? this._$AA.nextSibling.data = e : this.T(z.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var s;
    const { values: t, _$litType$: n } = e, o = typeof n == "number" ? this._$AC(e) : (n.el === void 0 && (n.el = V.createElement(ye(n.h, n.h[0]), this.options)), n);
...
class Y {
  ...
  constructor(e, t, n, o, s) {
    this.type = 1, this._$AH = b, this._$AN = void 0, this.element = e, this.name = t, this._$AM = o, this.options = s, n.length > 2 || n[0] !== "" || n[1] !== "" ? (this._$AH = Array(n.length - 1).fill(new String()), this.strings = n) : this._$AH = b;
  }
  _$AI(e, t = this, n, o) {
    const s = this.strings;
    let r = !1;
    if (s === void 0) e = k(this, e, t, 0), r = !P(e) || e !== this._$AH && e !== J, r && (this._$AH = e);
    else {
      const a = e;
      let c, g;
      for (e = s[0], c = 0; c < s.length - 1; c++) g = k(this, a[n + c], t, c), g === J && (g = this._$AH[c]), r || (r = !P(g) || g !== this._$AH[c]), g === b ? e = b : e !== b && (e += (g ?? "") + s[c + 1]), this._$AH[c] = g;
    }
    r && !o && this.j(e);
  }
  j(e) {
...
class Re extends Y {
  ...
  _$AI(e, t = this) {
    if ((e = k(this, e, t, 0) ?? b) === J) return;
    const n = this._$AH, o = e === b && n !== b || e.capture !== n.capture || e.once !== n.once || e.passive !== n.passive, s = e !== b && (n === b || o);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Oe = { attribute: !0, type: String, converter: F, reflect: !1, hasChanged: _ }, Fe = (i = Oe, e, t) => {
...
function h(i) {
  return (e, t) => typeof t == "object" ? Fe(i, e, t) : ((n, o, s) => {
...
`;
var m = /* @__PURE__ */ ((i) => (i.Active = "active", i.InProgress = "in-progress", i.Success = "success", i.Fail = "fail", i))(m || {});
function Ye(i) {
...
`, Ne = K`
  ...
  ${Te}
`, Ze = (i) => `swim-icon ${i.trim().split(" ").map((t) => {
  const [n, o] = t.split(":");
...
var et = Object.defineProperty, D = (i, e, t, n) => {
  for (var o = void 0, s = i.length - 1, r; s >= 0; s--)
    (r = i[s]) && (o = r(e, t, o) || o);
  return o && et(e, t, o), o;
};
const me = "swim-icon", ee = class ee extends q {
  constructor() {
  ...
  render() {
    ...
    return !e || e.length === 0 ? y`
      ...
      >
        ${e.map(
      (r, a) => y`<i part="icon icon-${a}" class="swim-icon__i swim-icon__i--${a} ${r}${o}"></i>`
    )}
      </span>
    `;
  }
...
var tt = Object.defineProperty, nt = Object.getOwnPropertyDescriptor, p = (i, e, t, n) => {
  for (var o = n > 1 ? void 0 : n ? nt(e, t) : e, s = i.length - 1, r; s >= 0; s--)
    (r = i[s]) && (o = (n ? r(e, t, o) : r(o)) || o);
  return n && o && tt(e, t, o), o;
};
const de = "swim-button", te = class te extends q {
  constructor() {
    super(...arguments), this.variant = "default", this.size = "medium", this._disabled = !1, this._state = m.Active, this.type = "button", this._inProgress = !1, this._success = !1, this._fail = !1;
  }
  get disabled() {
  ...
  _updateStateFlags() {
    this._inProgress = this._state === m.InProgress, this._success = this._state === m.Success, this._fail = this._state === m.Fail;
  }
  _updateState() {
    this._state || (this.state = m.Active), this.timeout && (this._state === m.Success || this._state === m.Fail || this._state === m.InProgress) && (this._clearTimer(), this._timer = window.setTimeout(() => {
      this.state = m.Active, this._updateState();
    }, this.timeout));
  }
  _handlePromise() {
    this._promise && (this.state = m.InProgress, this._promise.then(() => {
      this.state = m.Success, this._updateState();
    }).catch(() => {
      this.state = m.Fail, this._updateState();
    }));
  }
  _clearTimer() {
