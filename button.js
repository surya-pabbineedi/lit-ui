 ...
 */
const O = globalThis, j = O.ShadowRoot && (O.ShadyCSS === void 0 || O.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, X = Symbol(), te = /* @__PURE__ */ new WeakMap();
let pe = class {
  constructor(e, n, t) {
  ...
  get styleSheet() {
    ...
    if (j && e === void 0) {
      ...
      t && (e = te.get(n)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), t && te.set(n, e));
    }
    return e;
  }
  toString() {
...
const we = (i) => new pe(typeof i == "string" ? i : i + "", void 0, X), K = (i, ...e) => {
  const n = i.length === 1 ? i[0] : e.reduce((t, o, c) => t + ((r) => {
  ...
  if (j) i.adoptedStyleSheets = e.map((n) => n instanceof CSSStyleSheet ? n : n.styleSheet);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ie, defineProperty: Ee, getOwnPropertyDescriptor: ze, getOwnPropertyNames: Se, getOwnPropertySymbols: qe, getPrototypeOf: Je } = Object, v = globalThis, ie = v.trustedTypes, ke = ie ? ie.emptyScript : "", T = v.reactiveElementPolyfillSupport, B = (i, e) => i, F = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? ke : null;
      break;
  ...
  return n;
} }, _ = (i, e) => !Ie(i, e), re = { attribute: !0, type: String, converter: F, reflect: !1, useDefault: !1, hasChanged: _ };
...
let S = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, n, t) {
    const { get: o, set: c } = ze(this.prototype, e) ?? { get() {
      return this[n];
    }, set(r) {
      this[n] = r;
    } };
    return { get: o, set(r) {
      ...
      c == null || c.call(this, r), this.requestUpdate(e, a, t);
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(B("properties"))) {
      const n = this.properties, t = [...Se(n), ...qe(n)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const o of t) n.unshift(oe(o));
    } else e !== void 0 && n.push(oe(e));
    return n;
  }
  static _$Eu(e, n) {
    const t = n.attribute;
  ...
  _$ET(e, n) {
    ...
    if (o !== void 0 && t.reflect === !0) {
      const r = (((c = t.converter) == null ? void 0 : c.toAttribute) !== void 0 ? t.converter : F).toAttribute(n, t.type);
  ...
  _$AK(e, n) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const a = t.getPropertyOptions(o), s = typeof a.converter == "function" ? { fromAttribute: a.converter } : ((c = a.converter) == null ? void 0 : c.fromAttribute) !== void 0 ? a.converter : F;
      this._$Em = o;
      const b = s.fromAttribute(n, a.type);
  ...
  requestUpdate(e, n, t) {
    var o;
    if (e !== void 0) {
      const c = this.constructor, r = this[e];
      if (t ?? (t = c.getPropertyOptions(e)), !((t.hasChanged ?? _)(r, n) || t.useDefault && t.reflect && r === ((o = this._$Ej) == null ? void 0 : o.get(e)) && !this.hasAttribute(c._$Eu(e, t)))) return;
      this.C(e, n, t);
    }
    this.isUpdatePending === !1 && (this._$ES = this._$EP());
  }
  C(e, n, { useDefault: t, reflect: o, wrapped: c }, r) {
    t && !(this._$Ej ?? (this._$Ej = /* @__PURE__ */ new Map())).has(e) && (this._$Ej.set(e, r ?? n ?? this[e]), c !== !0 || r !== void 0) || (this._$AL.has(e) || (this.hasUpdated || t || (n = void 0), this._$AL.set(e, n)), o === !0 && this._$Em !== e && (this._$Eq ?? (this._$Eq = /* @__PURE__ */ new Set())).add(e));
  }
  async _$EP() {
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (o.size > 0) for (const [c, r] of o) {
        const { wrapped: a } = r, s = this[c];
        a !== !0 || this._$AL.has(c) || s === void 0 || this.C(c, void 0, r, s);
      }
    }
    let e = !1;
    const n = this._$AL;
...
S.elementStyles = [], S.shadowRootOptions = { mode: "open" }, S[B("elementProperties")] = /* @__PURE__ */ new Map(), S[B("finalized")] = /* @__PURE__ */ new Map(), T == null || T({ ReactiveElement: S }), (v.reactiveElementVersions ?? (v.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const M = globalThis, Q = M.trustedTypes, ce = Q ? Q.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, ue = "$lit$", y = `lit$${Math.random().toFixed(9).slice(2)}$`, me = "?" + y, He = `<${me}>`, z = document, G = () => z.createComment(""), P = (i) => i === null || typeof i != "object" && typeof i != "function", $ = Array.isArray, Be = (i) => $(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", N = `[ 	
\f\r]`, H = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, se = /-->/g, ae = />/g, C = RegExp(`>|${N}(?:([^\\s"'>=/]+)(${N}*=${N}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ge = /'/g, le = /"/g, ye = /^(?:script|style|textarea|title)$/i, Me = (i) => (e, ...n) => ({ _$litType$: i, strings: e, values: n }), A = Me(1), J = Symbol.for("lit-noChange"), l = Symbol.for("lit-nothing"), be = /* @__PURE__ */ new WeakMap(), I = z.createTreeWalker(z, 129);
function Ae(i, e) {
  if (!$(i) || !i.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return ce !== void 0 ? ce.createHTML(e) : e;
}
const Ge = (i, e) => {
  const n = i.length - 1, t = [];
  let o, c = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", r = H;
  for (let a = 0; a < n; a++) {
    const s = i[a];
    let b, x, g = -1, u = 0;
    for (; u < s.length && (r.lastIndex = u, x = r.exec(s), x !== null); ) u = r.lastIndex, r === H ? x[1] === "!--" ? r = se : x[1] !== void 0 ? r = ae : x[2] !== void 0 ? (ye.test(x[2]) && (o = RegExp("</" + x[2], "g")), r = C) : x[3] !== void 0 && (r = C) : r === C ? x[0] === ">" ? (r = o ?? H, g = -1) : x[1] === void 0 ? g = -2 : (g = r.lastIndex - x[2].length, b = x[1], r = x[3] === void 0 ? C : x[3] === '"' ? le : ge) : r === le || r === ge ? r = C : r === se || r === ae ? r = H : (r = C, o = void 0);
    const m = r === C && i[a + 1].startsWith("/>") ? " " : "";
    c += r === H ? s + He : g >= 0 ? (t.push(b), s.slice(0, g) + ue + s.slice(g) + y + m) : s + y + (g === -2 ? a : m);
  }
  return [Ae(i, c + (i[n] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), t];
};
class V {
  constructor({ strings: e, _$litType$: n }, t) {
    ...
    this.parts = [];
    let c = 0, r = 0;
    const a = e.length - 1, s = this.parts, [b, x] = Ge(e, n);
    if (this.el = V.createElement(b, t), I.currentNode = this.el.content, n === 2 || n === 3) {
      const g = this.el.content.firstChild;
      g.replaceWith(...g.childNodes);
    }
    for (; (o = I.nextNode()) !== null && s.length < a; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const g of o.getAttributeNames()) if (g.endsWith(ue)) {
          const u = x[r++], m = o.getAttribute(g).split(y), U = /([.?@])?(.*)/.exec(u);
          s.push({ type: 1, index: c, name: U[2], strings: m, ctor: U[1] === "." ? Ve : U[1] === "?" ? Ke : U[1] === "@" ? Re : Y }), o.removeAttribute(g);
        } else g.startsWith(y) && (s.push({ type: 6, index: c }), o.removeAttribute(g));
        if (ye.test(o.tagName)) {
          const g = o.textContent.split(y), u = g.length - 1;
          if (u > 0) {
            o.textContent = Q ? Q.emptyScript : "";
            for (let m = 0; m < u; m++) o.append(g[m], G()), I.nextNode(), s.push({ type: 2, index: ++c });
            o.append(g[u], G());
          }
        }
      } else if (o.nodeType === 8) if (o.data === me) s.push({ type: 2, index: c });
      else {
        let g = -1;
        for (; (g = o.data.indexOf(y, g + 1)) !== -1; ) s.push({ type: 7, index: c }), g += y.length - 1;
      }
      c++;
    }
  }
...
function k(i, e, n = i, t) {
  var r, a;
  if (e === J) return e;
  let o = t !== void 0 ? (r = n._$Co) == null ? void 0 : r[t] : n._$Cl;
  const c = P(e) ? void 0 : e._$litDirective$;
  return (o == null ? void 0 : o.constructor) !== c && ((a = o == null ? void 0 : o._$AO) == null || a.call(o, !1), c === void 0 ? o = void 0 : (o = new c(i), o._$AT(i, n, t)), t !== void 0 ? (n._$Co ?? (n._$Co = []))[t] = o : n._$Cl = o), o !== void 0 && (e = k(i, o._$AS(i, e.values), o, t)), e;
}
class Pe {
  constructor(e, n) {
  ...
  u(e) {
    ...
    I.currentNode = o;
    let c = I.nextNode(), r = 0, a = 0, s = t[0];
    for (; s !== void 0; ) {
      if (r === s.index) {
        let b;
        s.type === 2 ? b = new R(c, c.nextSibling, this, e) : s.type === 1 ? b = new s.ctor(c, s.name, s.strings, this, e) : s.type === 6 && (b = new De(c, this, e)), this._$AV.push(b), s = t[++a];
      }
      r !== (s == null ? void 0 : s.index) && (c = I.nextNode(), r++);
    }
...
class R {
  ...
  _$AI(e, n = this) {
    e = k(this, e, n), P(e) ? e === l || e == null || e === "" ? (this._$AH !== l && this._$AR(), this._$AH = l) : e !== this._$AH && e !== J && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Be(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== l && P(this._$AH) ? this._$AA.nextSibling.data = e : this.T(z.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var c;
    const { values: n, _$litType$: t } = e, o = typeof t == "number" ? this._$AC(e) : (t.el === void 0 && (t.el = V.createElement(Ae(t.h, t.h[0]), this.options)), t);
    if (((c = this._$AH) == null ? void 0 : c._$AD) === o) this._$AH.p(n);
    else {
      const r = new Pe(o, this), a = r.u(this.options);
      r.p(n), this.T(a), this._$AH = r;
    }
  }
  _$AC(e) {
    let n = be.get(e.strings);
    return n === void 0 && be.set(e.strings, n = new V(e)), n;
  }
  k(e) {
    $(this._$AH) || (this._$AH = [], this._$AR());
    const n = this._$AH;
    let t, o = 0;
    for (const c of e) o === n.length ? n.push(t = new R(this.O(G()), this.O(G()), this, this.options)) : t = n[o], t._$AI(c), o++;
...
class Y {
  ...
  constructor(e, n, t, o, c) {
    this.type = 1, this._$AH = l, this._$AN = void 0, this.element = e, this.name = n, this._$AM = o, this.options = c, t.length > 2 || t[0] !== "" || t[1] !== "" ? (this._$AH = Array(t.length - 1).fill(new String()), this.strings = t) : this._$AH = l;
  }
  _$AI(e, n = this, t, o) {
    const c = this.strings;
    let r = !1;
    if (c === void 0) e = k(this, e, n, 0), r = !P(e) || e !== this._$AH && e !== J, r && (this._$AH = e);
    else {
      const a = e;
      let s, b;
      for (e = c[0], s = 0; s < c.length - 1; s++) b = k(this, a[t + s], n, s), b === J && (b = this._$AH[s]), r || (r = !P(b) || b !== this._$AH[s]), b === l ? e = l : e !== l && (e += (b ?? "") + c[s + 1]), this._$AH[s] = b;
    }
    r && !o && this.j(e);
  }
  j(e) {
...
class Re extends Y {
  constructor(e, n, t, o, c) {
    super(e, n, t, o, c), this.type = 5;
  }
  _$AI(e, n = this) {
    if ((e = k(this, e, n, 0) ?? l) === J) return;
    const t = this._$AH, o = e === l && t !== l || e.capture !== t.capture || e.once !== t.once || e.passive !== t.passive, c = e !== l && (t === l || o);
    o && this.element.removeEventListener(this.name, this, t), c && this.element.addEventListener(this.name, this, e), this._$AH = e;
  }
  handleEvent(e) {
    var n;
...
Z == null || Z(V, R), (M.litHtmlVersions ?? (M.litHtmlVersions = [])).push("3.3.1");
const Ue = (i, e, n) => {
  const t = (n == null ? void 0 : n.renderBefore) ?? e;
  let o = t._$litPart$;
  if (o === void 0) {
    const c = (n == null ? void 0 : n.renderBefore) ?? null;
    t._$litPart$ = o = new R(e.insertBefore(G(), c), c, void 0, n ?? {});
  }
  return o._$AI(i), o;
};
/**
...
class q extends S {
  ...
  update(e) {
    const n = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = Ue(n, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var e;
...
var he;
q._$litElement$ = !0, q.finalized = !0, (he = E.litElementHydrateSupport) == null || he.call(E, { LitElement: q });
const L = E.litElementPolyfillSupport;
L == null || L({ LitElement: q });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Oe = { attribute: !0, type: String, converter: F, reflect: !1, hasChanged: _ }, Fe = (i = Oe, e, n) => {
  const { kind: t, metadata: o } = n;
  let c = globalThis.litPropertyMetadata.get(o);
  if (c === void 0 && globalThis.litPropertyMetadata.set(o, c = /* @__PURE__ */ new Map()), t === "setter" && ((i = Object.create(i)).wrapped = !0), c.set(n.name, i), t === "accessor") {
    const { name: r } = n;
    return { set(a) {
      const s = e.get.call(this);
      e.set.call(this, a), this.requestUpdate(r, s, i);
    }, init(a) {
  ...
  if (t === "setter") {
    ...
    return function(a) {
      const s = this[r];
      e.call(this, a), this.requestUpdate(r, s, i);
    };
  }
  throw Error("Unsupported decorator location: " + t);
};
function h(i) {
  return (e, n) => typeof n == "object" ? Fe(i, e, n) : ((t, o, c) => {
    const r = o.hasOwnProperty(c);
    return o.constructor.createProperty(c, t), r ? Object.getOwnPropertyDescriptor(o, c) : void 0;
  })(i, e, n);
}
/**
 * @license
...
`;
var f = /* @__PURE__ */ ((i) => (i.Active = "active", i.InProgress = "in-progress", i.Success = "success", i.Fail = "fail", i))(f || {});
function Ye(i) {
  return i != null && `${i}` != "false";
}
function We(i, e = null) {
...
`, Ne = K`
  ...
  ${Te}
`, Ze = (i) => `ngx-icon ${i.trim().split(" ").map((n) => {
  const [t, o] = n.split(":");
...
class Le {
  ...
  get(e, n) {
    return this.lookup(e, n).map((t) => Ze(t));
  }
  lookup(e, n) {
    const t = n ?? this._defaultFontSetClass;
    return (Array.isArray(e) ? e : [e]).reduce((o, c) => {
      const r = this._expandKeys(c, t).map((a) => {
        const s = this._iconMap.get(a);
        return s && s.length === 1 ? s[0] : a;
      }).join(" ");
...
@font-face {
  font-family: '${_e}';
  src: url('data:font/woff2;base64,${Xe}') format('woff2');
  font-weight: normal;
  font-style: normal;
  font-display: block;
}
`, document.head.appendChild(i), xe = !0;
}
var en = Object.defineProperty, D = (i, e, n, t) => {
  for (var o = void 0, c = i.length - 1, r; c >= 0; c--)
    (r = i[c]) && (o = r(e, n, o) || o);
  return o && en(e, n, o), o;
};
const fe = "swim-icon", ee = class ee extends q {
  constructor() {
    super(...arguments), this.fontIcon = "", this.alt = "", this.fontSet = "ngx", this.iconClass = "", this._cssClasses = [], this._iconClassTokensOnHost = [];
  }
  connectedCallback() {
    super.connectedCallback(), $e(), this._updateFontIcon();
  }
  updated(e) {
  ...
  _updateFontIcon() {
    ...
    this._cssClasses = je.get(e, this.fontSet);
  }
  render() {
    var c;
    const e = this._cssClasses, n = !!this.alt, t = ((c = this.iconClass) == null ? void 0 : c.trim()) ?? "", o = t ? ` ${t}` : "";
    return !e || e.length === 0 ? A`
      ...
      >
        ${e.map(
      (r, a) => A`<i part="icon icon-${a}" class="swim-icon__i swim-icon__i--${a} ${r}${o}"></i>`
    )}
      </span>
    `;
  }
...
customElements.get(fe) || customElements.define(fe, w);
var nn = Object.defineProperty, tn = Object.getOwnPropertyDescriptor, p = (i, e, n, t) => {
  for (var o = t > 1 ? void 0 : t ? tn(e, n) : e, c = i.length - 1, r; c >= 0; c--)
    (r = i[c]) && (o = (t ? r(e, n, o) : r(o)) || o);
  return t && o && nn(e, n, o), o;
};
const de = "swim-button", ne = class ne extends q {
  constructor() {
    super(...arguments), this.variant = "default", this.size = "medium", this._disabled = !1, this._state = f.Active, this.type = "button", this._inProgress = !1, this._success = !1, this._fail = !1;
  }
  get disabled() {
  ...
  _renderStateIcon() {
    return this._inProgress ? A`<swim-icon class="state-icon" font-icon="loading"></swim-icon>` : this._success ? A`<swim-icon class="state-icon" font-icon="check"></swim-icon>` : this._fail ? A`<swim-icon class="state-icon" font-icon="x"></swim-icon>` : l;
  }
  _handleClick(e) {
    if (this.disabled) {
  ...
  _updateStateFlags() {
    this._inProgress = this._state === f.InProgress, this._success = this._state === f.Success, this._fail = this._state === f.Fail;
  }
  _updateState() {
    this._state || (this.state = f.Active), this.timeout && (this._state === f.Success || this._state === f.Fail || this._state === f.InProgress) && (this._clearTimer(), this._timer = window.setTimeout(() => {
      this.state = f.Active, this._updateState();
    }, this.timeout));
  }
  _handlePromise() {
    this._promise && (this.state = f.InProgress, this._promise.then(() => {
      this.state = f.Success, this._updateState();
    }).catch(() => {
      this.state = f.Fail, this._updateState();
    }));
  }
  _clearTimer() {
...
p([
  h({ type: Number })
], d.prototype, "timeout", 1);
p([
  h({ attribute: !1 })
], d.prototype, "promise", 1);
p([
  W()
], d.prototype, "_inProgress", 2);
p([
  W()
], d.prototype, "_success", 2);
p([
  W()
], d.prototype, "_fail", 2);
