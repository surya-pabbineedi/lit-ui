 ...
 */
const O = globalThis, j = O.ShadowRoot && (O.ShadyCSS === void 0 || O.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, X = Symbol(), ie = /* @__PURE__ */ new WeakMap();
let ue = class {
  constructor(e, t, i) {
...
const xe = (n) => new ue(typeof n == "string" ? n : n + "", void 0, X), K = (n, ...e) => {
...
}, oe = j ? (n) => n : (n) => n instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ie, defineProperty: Ee, getOwnPropertyDescriptor: ze, getOwnPropertyNames: Se, getOwnPropertySymbols: qe, getPrototypeOf: Je } = Object, v = globalThis, ne = v.trustedTypes, ke = ne ? ne.emptyScript : "", T = v.reactiveElementPolyfillSupport, B = (n, e) => n, F = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? ke : null;
      break;
  ...
  return t;
} }, _ = (n, e) => !Ie(n, e), re = { attribute: !0, type: String, converter: F, reflect: !1, useDefault: !1, hasChanged: _ };
...
let S = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, t, i) {
    ...
    return { get: o, set(r) {
      ...
      s == null || s.call(this, r), this.requestUpdate(e, l, i);
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(B("properties"))) {
      const t = this.properties, i = [...Se(t), ...qe(t)];
  ...
  _$ET(e, t) {
    ...
    if (o !== void 0 && i.reflect === !0) {
      const r = (((s = i.converter) == null ? void 0 : s.toAttribute) !== void 0 ? i.converter : F).toAttribute(t, i.type);
  ...
  _$AK(e, t) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const l = i.getPropertyOptions(o), c = typeof l.converter == "function" ? { fromAttribute: l.converter } : ((s = l.converter) == null ? void 0 : s.fromAttribute) !== void 0 ? l.converter : F;
      this._$Em = o;
      const f = c.fromAttribute(t, l.type);
  ...
  requestUpdate(e, t, i) {
    ...
    if (e !== void 0) {
      ...
      if (i ?? (i = s.getPropertyOptions(e)), !((i.hasChanged ?? _)(r, t) || i.useDefault && i.reflect && r === ((o = this._$Ej) == null ? void 0 : o.get(e)) && !this.hasAttribute(s._$Eu(e, i)))) return;
      this.C(e, t, i);
    }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const M = globalThis, Q = M.trustedTypes, se = Q ? Q.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, we = "$lit$", y = `lit$${Math.random().toFixed(9).slice(2)}$`, ge = "?" + y, He = `<${ge}>`, z = document, G = () => z.createComment(""), P = (n) => n === null || typeof n != "object" && typeof n != "function", $ = Array.isArray, Be = (n) => $(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", N = `[ 	
\f\r]`, H = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ce = /-->/g, le = />/g, C = RegExp(`>|${N}(?:([^\\s"'>=/]+)(${N}*=${N}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ae = /'/g, be = /"/g, ye = /^(?:script|style|textarea|title)$/i, Me = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), A = Me(1), J = Symbol.for("lit-noChange"), b = Symbol.for("lit-nothing"), fe = /* @__PURE__ */ new WeakMap(), I = z.createTreeWalker(z, 129);
function Ae(n, e) {
  if (!$(n) || !n.hasOwnProperty("raw")) throw Error("invalid template strings array");
...
const Ge = (n, e) => {
  ...
  for (let l = 0; l < t; l++) {
    const c = n[l];
    let f, m, a = -1, w = 0;
    for (; w < c.length && (r.lastIndex = w, m = r.exec(c), m !== null); ) w = r.lastIndex, r === H ? m[1] === "!--" ? r = ce : m[1] !== void 0 ? r = le : m[2] !== void 0 ? (ye.test(m[2]) && (o = RegExp("</" + m[2], "g")), r = C) : m[3] !== void 0 && (r = C) : r === C ? m[0] === ">" ? (r = o ?? H, a = -1) : m[1] === void 0 ? a = -2 : (a = r.lastIndex - m[2].length, f = m[1], r = m[3] === void 0 ? C : m[3] === '"' ? be : ae) : r === be || r === ae ? r = C : r === ce || r === le ? r = H : (r = C, o = void 0);
    const g = r === C && n[l + 1].startsWith("/>") ? " " : "";
    s += r === H ? c + He : a >= 0 ? (i.push(f), c.slice(0, a) + we + c.slice(a) + y + g) : c + y + (a === -2 ? l : g);
  }
  return [Ae(n, s + (n[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), i];
};
class V {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let s = 0, r = 0;
    const l = e.length - 1, c = this.parts, [f, m] = Ge(e, t);
    if (this.el = V.createElement(f, i), I.currentNode = this.el.content, t === 2 || t === 3) {
      const a = this.el.content.firstChild;
      a.replaceWith(...a.childNodes);
    }
    for (; (o = I.nextNode()) !== null && c.length < l; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const a of o.getAttributeNames()) if (a.endsWith(we)) {
          const w = m[r++], g = o.getAttribute(a).split(y), U = /([.?@])?(.*)/.exec(w);
          c.push({ type: 1, index: s, name: U[2], strings: g, ctor: U[1] === "." ? Ve : U[1] === "?" ? Ke : U[1] === "@" ? Re : Y }), o.removeAttribute(a);
        } else a.startsWith(y) && (c.push({ type: 6, index: s }), o.removeAttribute(a));
        if (ye.test(o.tagName)) {
          const a = o.textContent.split(y), w = a.length - 1;
          if (w > 0) {
            o.textContent = Q ? Q.emptyScript : "";
            for (let g = 0; g < w; g++) o.append(a[g], G()), I.nextNode(), c.push({ type: 2, index: ++s });
            o.append(a[w], G());
          }
        }
      } else if (o.nodeType === 8) if (o.data === ge) c.push({ type: 2, index: s });
      else {
        let a = -1;
        for (; (a = o.data.indexOf(y, a + 1)) !== -1; ) c.push({ type: 7, index: s }), a += y.length - 1;
      }
      s++;
    }
  }
...
function k(n, e, t = n, i) {
  ...
  return (o == null ? void 0 : o.constructor) !== s && ((l = o == null ? void 0 : o._$AO) == null || l.call(o, !1), s === void 0 ? o = void 0 : (o = new s(n), o._$AT(n, t, i)), i !== void 0 ? (t._$Co ?? (t._$Co = []))[i] = o : t._$Cl = o), o !== void 0 && (e = k(n, o._$AS(n, e.values), o, i)), e;
}
class Pe {
  constructor(e, t) {
  ...
  u(e) {
    ...
    I.currentNode = o;
    let s = I.nextNode(), r = 0, l = 0, c = i[0];
    for (; c !== void 0; ) {
      if (r === c.index) {
        let f;
        c.type === 2 ? f = new R(s, s.nextSibling, this, e) : c.type === 1 ? f = new c.ctor(s, c.name, c.strings, this, e) : c.type === 6 && (f = new De(s, this, e)), this._$AV.push(f), c = i[++l];
      }
...
class R {
  ...
  $(e) {
    var s;
    const { values: t, _$litType$: i } = e, o = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = V.createElement(Ae(i.h, i.h[0]), this.options)), i);
    if (((s = this._$AH) == null ? void 0 : s._$AD) === o) this._$AH.p(t);
    else {
      const r = new Pe(o, this), l = r.u(this.options);
  ...
  k(e) {
    ...
    const t = this._$AH;
    let i, o = 0;
    for (const s of e) o === t.length ? t.push(i = new R(this.O(G()), this.O(G()), this, this.options)) : i = t[o], i._$AI(s), o++;
...
class Y {
  ...
  _$AI(e, t = this, i, o) {
    ...
    if (s === void 0) e = k(this, e, t, 0), r = !P(e) || e !== this._$AH && e !== J, r && (this._$AH = e);
      ...
      const l = e;
      let c, f;
      for (e = s[0], c = 0; c < s.length - 1; c++) f = k(this, l[i + c], t, c), f === J && (f = this._$AH[c]), r || (r = !P(f) || f !== this._$AH[c]), f === b ? e = b : e !== b && (e += (f ?? "") + s[c + 1]), this._$AH[c] = f;
    }
    r && !o && this.j(e);
  }
  j(e) {
...
const Ue = (n, e, t) => {
  ...
  if (o === void 0) {
    ...
    i._$litPart$ = o = new R(e.insertBefore(G(), s), s, void 0, t ?? {});
  }
  return o._$AI(n), o;
};
/**
...
var pe;
q._$litElement$ = !0, q.finalized = !0, (pe = E.litElementHydrateSupport) == null || pe.call(E, { LitElement: q });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Oe = { attribute: !0, type: String, converter: F, reflect: !1, hasChanged: _ }, Fe = (n = Oe, e, t) => {
  ...
  if (s === void 0 && globalThis.litPropertyMetadata.set(o, s = /* @__PURE__ */ new Map()), i === "setter" && ((n = Object.create(n)).wrapped = !0), s.set(t.name, n), i === "accessor") {
    ...
    return { set(l) {
      ...
      e.set.call(this, l), this.requestUpdate(r, c, n);
    }, init(l) {
  ...
  if (i === "setter") {
    ...
    return function(l) {
      const c = this[r];
      e.call(this, l), this.requestUpdate(r, c, n);
    };
  }
  throw Error("Unsupported decorator location: " + i);
};
function p(n) {
  return (e, t) => typeof t == "object" ? Fe(n, e, t) : ((i, o, s) => {
...
`;
var d = /* @__PURE__ */ ((n) => (n.Active = "active", n.InProgress = "in-progress", n.Success = "success", n.Fail = "fail", n))(d || {});
function Ye(n) {
...
class Le {
  ...
  lookup(e, t) {
    ...
    return (Array.isArray(e) ? e : [e]).reduce((o, s) => {
      const r = this._expandKeys(s, i).map((l) => {
...
`, document.head.appendChild(n), me = !0;
}
var et = Object.defineProperty, D = (n, e, t, i) => {
  for (var o = void 0, s = n.length - 1, r; s >= 0; s--)
    (r = n[s]) && (o = r(e, t, o) || o);
  return o && et(e, t, o), o;
};
const de = "swim-icon", ee = class ee extends q {
  constructor() {
  ...
  render() {
    ...
    return !e || e.length === 0 ? A`
      ...
      >
        ${e.map(
      (r, l) => A`<i part="icon icon-${l}" class="swim-icon__i swim-icon__i--${l} ${r}${o}"></i>`
    )}
      </span>
    `;
  }
...
customElements.get(de) || customElements.define(de, x);
var tt = Object.defineProperty, it = Object.getOwnPropertyDescriptor, u = (n, e, t, i) => {
  for (var o = i > 1 ? void 0 : i ? it(e, t) : e, s = n.length - 1, r; s >= 0; s--)
    (r = n[s]) && (o = (i ? r(e, t, o) : r(o)) || o);
  return i && o && tt(e, t, o), o;
};
const he = "swim-button", te = class te extends q {
  constructor() {
  ...
  _renderStateIcon() {
    return this._inProgress ? A`<swim-icon class="state-icon" font-icon="loading"></swim-icon>` : this._success ? A`<swim-icon class="state-icon" font-icon="check"></swim-icon>` : this._fail ? A`<swim-icon class="state-icon" font-icon="x"></swim-icon>` : b;
  }
  _handleClick(e) {
    if (this.disabled) {
...
customElements.get(he) || customElements.define(he, h);
export {
  d as ButtonState,
  h as SwimButton
};
