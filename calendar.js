...
const Ce = (n) => new De(typeof n == "string" ? n : n + "", void 0, ie), K = (n, ...e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Se, defineProperty: Ye, getOwnPropertyDescriptor: Fe, getOwnPropertyNames: Ve, getOwnPropertySymbols: Je, getPrototypeOf: He } = Object, v = globalThis, le = v.trustedTypes, Be = le ? le.emptyScript : "", N = v.reactiveElementPolyfillSupport, F = (n, e) => n, Q = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? Be : null;
      break;
...
M.elementStyles = [], M.shadowRootOptions = { mode: "open" }, M[F("elementProperties")] = /* @__PURE__ */ new Map(), M[F("finalized")] = /* @__PURE__ */ new Map(), N == null || N({ ReactiveElement: M }), (v.reactiveElementVersions ?? (v.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
const Ue = (n, e) => {
  ...
  for (let c = 0; c < t; c++) {
    const a = n[c];
    let l, h, b = -1, g = 0;
    for (; g < a.length && (s.lastIndex = g, h = s.exec(a), h !== null); ) g = s.lastIndex, s === Y ? h[1] === "!--" ? s = fe : h[1] !== void 0 ? s = de : h[2] !== void 0 ? (Me.test(h[2]) && (o = RegExp("</" + h[2], "g")), s = D) : h[3] !== void 0 && (s = D) : s === D ? h[0] === ">" ? (s = o ?? Y, b = -1) : h[1] === void 0 ? b = -2 : (b = s.lastIndex - h[2].length, l = h[1], s = h[3] === void 0 ? D : h[3] === '"' ? ue : me) : s === ue || s === me ? s = D : s === fe || s === de ? s = Y : (s = D, o = void 0);
    const y = s === D && n[c + 1].startsWith("/>") ? " " : "";
    r += s === Y ? a + Ke : b >= 0 ? (i.push(l), a.slice(0, b) + Ee + a.slice(b) + A + y) : a + A + (b === -2 ? c : y);
  }
  return [ke(n, r + (n[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), i];
};
class B {
      ...
      if (o.nodeType === 1) {
        ...
        if (Me.test(o.tagName)) {
          ...
          if (g > 0) {
            ...
            for (let y = 0; y < g; y++) o.append(b[y], J()), C.nextNode(), a.push({ type: 2, index: ++r });
            o.append(b[g], J());
          }
        }
...
class G {
  ...
  _$AI(e, t = this) {
    e = S(this, e, t), H(e) ? e === f || e == null || e === "" ? (this._$AH !== f && this._$AR(), this._$AH = f) : e !== this._$AH && e !== q && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Ge(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== f && H(this._$AH) ? this._$AA.nextSibling.data = e : this.T(I.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var r;
    const { values: t, _$litType$: i } = e, o = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = B.createElement(ke(i.h, i.h[0]), this.options)), i);
  ...
  k(e) {
    ...
    const t = this._$AH;
    let i, o = 0;
    for (const r of e) o === t.length ? t.push(i = new G(this.O(J()), this.O(J()), this, this.options)) : i = t[o], i._$AI(r), o++;
...
class W {
  ...
  _$AI(e, t = this, i, o) {
    ...
    if (r === void 0) e = S(this, e, t, 0), s = !H(e) || e !== this._$AH && e !== q, s && (this._$AH = e);
      ...
      const c = e;
      let a, l;
      for (e = r[0], a = 0; a < r.length - 1; a++) l = S(this, c[i + a], t, a), l === q && (l = this._$AH[a]), s || (s = !H(l) || l !== this._$AH[a]), l === f ? e = f : e !== f && (e += (l ?? "") + r[a + 1]), this._$AH[a] = l;
    }
    s && !o && this.j(e);
  }
  j(e) {
...
const Ne = (n, e, t) => {
  ...
  if (o === void 0) {
    ...
    i._$litPart$ = o = new G(e.insertBefore(J(), r), r, void 0, t ?? {});
  }
  return o._$AI(n), o;
};
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ze = { attribute: !0, type: String, converter: Q, reflect: !1, hasChanged: oe }, Le = (n = Ze, e, t) => {
