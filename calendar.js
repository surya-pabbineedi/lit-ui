 ...
 */
const O = globalThis, te = O.ShadowRoot && (O.ShadyCSS === void 0 || O.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ne = Symbol(), ce = /* @__PURE__ */ new WeakMap();
let Ce = class {
  constructor(e, t, n) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ye, defineProperty: Fe, getOwnPropertyDescriptor: Ve, getOwnPropertyNames: Je, getOwnPropertySymbols: He, getPrototypeOf: Be } = Object, A = globalThis, ge = A.trustedTypes, Ke = ge ? ge.emptyScript : "", N = A.reactiveElementPolyfillSupport, F = (i, e) => i, Q = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Ke : null;
      break;
  ...
  return t;
} }, oe = (i, e) => !Ye(i, e), le = { attribute: !0, type: String, converter: Q, reflect: !1, useDefault: !1, hasChanged: oe };
...
let M = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(F("properties"))) {
      const t = this.properties, n = [...Je(t), ...He(t)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const o of n) t.unshift(ae(o));
  ...
  _$ET(e, t) {
    ...
    if (o !== void 0 && n.reflect === !0) {
      const r = (((s = n.converter) == null ? void 0 : s.toAttribute) !== void 0 ? n.converter : Q).toAttribute(t, n.type);
  ...
  _$AK(e, t) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const c = n.getPropertyOptions(o), a = typeof c.converter == "function" ? { fromAttribute: c.converter } : ((s = c.converter) == null ? void 0 : s.fromAttribute) !== void 0 ? c.converter : Q;
      this._$Em = o;
      const g = a.fromAttribute(t, c.type);
      this[o] = g ?? ((r = this._$Ej) == null ? void 0 : r.get(o)) ?? g, this._$Em = null;
    }
  }
  requestUpdate(e, t, n) {
    var o;
    if (e !== void 0) {
      ...
      if (n ?? (n = s.getPropertyOptions(e)), !((n.hasChanged ?? oe)(r, t) || n.useDefault && n.reflect && r === ((o = this._$Ej) == null ? void 0 : o.get(e)) && !this.hasAttribute(s._$Eu(e, n)))) return;
      this.C(e, t, n);
    }
...
M.elementStyles = [], M.shadowRootOptions = { mode: "open" }, M[F("elementProperties")] = /* @__PURE__ */ new Map(), M[F("finalized")] = /* @__PURE__ */ new Map(), N == null || N({ ReactiveElement: M }), (A.reactiveElementVersions ?? (A.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const V = globalThis, T = V.trustedTypes, be = T ? T.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, Ee = "$lit$", w = `lit$${Math.random().toFixed(9).slice(2)}$`, Ie = "?" + w, Ge = `<${Ie}>`, I = document, J = () => I.createComment(""), H = (i) => i === null || typeof i != "object" && typeof i != "function", ie = Array.isArray, Pe = (i) => ie(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Z = `[ 	
\f\r]`, Y = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, xe = /-->/g, he = />/g, D = RegExp(`>|${Z}(?:([^\\s"'>=/]+)(${Z}*=${Z}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), fe = /'/g, de = /"/g, Me = /^(?:script|style|textarea|title)$/i, Ue = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), h = Ue(1), q = Symbol.for("lit-noChange"), x = Symbol.for("lit-nothing"), ue = /* @__PURE__ */ new WeakMap(), C = I.createTreeWalker(I, 129);
function ke(i, e) {
...
const Re = (i, e) => {
  ...
  let o, s = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", r = Y;
  for (let c = 0; c < t; c++) {
    const a = i[c];
    let g, b, l = -1, m = 0;
    for (; m < a.length && (r.lastIndex = m, b = r.exec(a), b !== null); ) m = r.lastIndex, r === Y ? b[1] === "!--" ? r = xe : b[1] !== void 0 ? r = he : b[2] !== void 0 ? (Me.test(b[2]) && (o = RegExp("</" + b[2], "g")), r = D) : b[3] !== void 0 && (r = D) : r === D ? b[0] === ">" ? (r = o ?? Y, l = -1) : b[1] === void 0 ? l = -2 : (l = r.lastIndex - b[2].length, g = b[1], r = b[3] === void 0 ? D : b[3] === '"' ? de : fe) : r === de || r === fe ? r = D : r === xe || r === he ? r = Y : (r = D, o = void 0);
    const y = r === D && i[c + 1].startsWith("/>") ? " " : "";
    s += r === Y ? a + Ge : l >= 0 ? (n.push(g), a.slice(0, l) + Ee + a.slice(l) + w + y) : a + w + (l === -2 ? c : y);
  }
  return [ke(i, s + (i[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), n];
};
class B {
  constructor({ strings: e, _$litType$: t }, n) {
    ...
    this.parts = [];
    let s = 0, r = 0;
    const c = e.length - 1, a = this.parts, [g, b] = Re(e, t);
    if (this.el = B.createElement(g, n), C.currentNode = this.el.content, t === 2 || t === 3) {
      const l = this.el.content.firstChild;
      l.replaceWith(...l.childNodes);
    }
    for (; (o = C.nextNode()) !== null && a.length < c; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const l of o.getAttributeNames()) if (l.endsWith(Ee)) {
          const m = b[r++], y = o.getAttribute(l).split(w), R = /([.?@])?(.*)/.exec(m);
          a.push({ type: 1, index: s, name: R[2], strings: y, ctor: R[1] === "." ? Qe : R[1] === "?" ? Te : R[1] === "@" ? We : W }), o.removeAttribute(l);
        } else l.startsWith(w) && (a.push({ type: 6, index: s }), o.removeAttribute(l));
        if (Me.test(o.tagName)) {
          const l = o.textContent.split(w), m = l.length - 1;
          if (m > 0) {
            o.textContent = T ? T.emptyScript : "";
            for (let y = 0; y < m; y++) o.append(l[y], J()), C.nextNode(), a.push({ type: 2, index: ++s });
            o.append(l[m], J());
          }
        }
      } else if (o.nodeType === 8) if (o.data === Ie) a.push({ type: 2, index: s });
      else {
        let l = -1;
        for (; (l = o.data.indexOf(w, l + 1)) !== -1; ) a.push({ type: 7, index: s }), l += w.length - 1;
      }
      s++;
    }
  }
...
function S(i, e, t = i, n) {
  var r, c;
  if (e === q) return e;
  let o = n !== void 0 ? (r = t._$Co) == null ? void 0 : r[n] : t._$Cl;
  const s = H(e) ? void 0 : e._$litDirective$;
  return (o == null ? void 0 : o.constructor) !== s && ((c = o == null ? void 0 : o._$AO) == null || c.call(o, !1), s === void 0 ? o = void 0 : (o = new s(i), o._$AT(i, t, n)), n !== void 0 ? (t._$Co ?? (t._$Co = []))[n] = o : t._$Cl = o), o !== void 0 && (e = S(i, o._$AS(i, e.values), o, n)), e;
}
class Oe {
  constructor(e, t) {
  ...
  u(e) {
    ...
    C.currentNode = o;
    let s = C.nextNode(), r = 0, c = 0, a = n[0];
    for (; a !== void 0; ) {
      if (r === a.index) {
        let g;
        a.type === 2 ? g = new G(s, s.nextSibling, this, e) : a.type === 1 ? g = new a.ctor(s, a.name, a.strings, this, e) : a.type === 6 && (g = new Ne(s, this, e)), this._$AV.push(g), a = n[++c];
      }
      r !== (a == null ? void 0 : a.index) && (s = C.nextNode(), r++);
    }
    return C.currentNode = I, o;
  }
  p(e) {
    let t = 0;
...
class G {
  ...
  _$AI(e, t = this) {
    e = S(this, e, t), H(e) ? e === x || e == null || e === "" ? (this._$AH !== x && this._$AR(), this._$AH = x) : e !== this._$AH && e !== q && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Pe(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== x && H(this._$AH) ? this._$AA.nextSibling.data = e : this.T(I.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var s;
    const { values: t, _$litType$: n } = e, o = typeof n == "number" ? this._$AC(e) : (n.el === void 0 && (n.el = B.createElement(ke(n.h, n.h[0]), this.options)), n);
    if (((s = this._$AH) == null ? void 0 : s._$AD) === o) this._$AH.p(t);
    else {
      const r = new Oe(o, this), c = r.u(this.options);
  ...
  k(e) {
    ...
    const t = this._$AH;
    let n, o = 0;
    for (const s of e) o === t.length ? t.push(n = new G(this.O(J()), this.O(J()), this, this.options)) : n = t[o], n._$AI(s), o++;
...
class W {
  ...
  constructor(e, t, n, o, s) {
    this.type = 1, this._$AH = x, this._$AN = void 0, this.element = e, this.name = t, this._$AM = o, this.options = s, n.length > 2 || n[0] !== "" || n[1] !== "" ? (this._$AH = Array(n.length - 1).fill(new String()), this.strings = n) : this._$AH = x;
  }
  _$AI(e, t = this, n, o) {
    const s = this.strings;
    let r = !1;
    if (s === void 0) e = S(this, e, t, 0), r = !H(e) || e !== this._$AH && e !== q, r && (this._$AH = e);
    else {
      const c = e;
      let a, g;
      for (e = s[0], a = 0; a < s.length - 1; a++) g = S(this, c[n + a], t, a), g === q && (g = this._$AH[a]), r || (r = !H(g) || g !== this._$AH[a]), g === x ? e = x : e !== x && (e += (g ?? "") + s[a + 1]), this._$AH[a] = g;
    }
    r && !o && this.j(e);
  }
  j(e) {
...
class We extends W {
  ...
  _$AI(e, t = this) {
    if ((e = S(this, e, t, 0) ?? x) === q) return;
    const n = this._$AH, o = e === x && n !== x || e.capture !== n.capture || e.once !== n.once || e.passive !== n.passive, s = e !== x && (n === x || o);
...
const L = V.litHtmlPolyfillSupport;
L == null || L(B, G), (V.litHtmlVersions ?? (V.litHtmlVersions = [])).push("3.3.1");
const Ze = (i, e, t) => {
  const n = (t == null ? void 0 : t.renderBefore) ?? e;
  let o = n._$litPart$;
  if (o === void 0) {
    const s = (t == null ? void 0 : t.renderBefore) ?? null;
    n._$litPart$ = o = new G(e.insertBefore(J(), s), s, void 0, t ?? {});
  }
  return o._$AI(i), o;
};
/**
...
var De;
z._$litElement$ = !0, z.finalized = !0, (De = E.litElementHydrateSupport) == null || De.call(E, { LitElement: z });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Le = { attribute: !0, type: String, converter: Q, reflect: !1, hasChanged: oe }, je = (i = Le, e, t) => {
...
function u(i) {
  return (e, t) => typeof t == "object" ? je(i, e, t) : ((n, o, s) => {
...
`, _e = K`
  ...
  ${Xe}
`, $e = (i) => `ngx-icon ${i.trim().split(" ").map((t) => {
  const [n, o] = t.split(":");
...
class et {
  ...
  get(e, t) {
    return this.lookup(e, t).map((n) => $e(n));
  }
  lookup(e, t) {
...
@font-face {
  font-family: '${ot}';
  src: url('data:font/woff2;base64,${nt}') format('woff2');
  font-weight: normal;
  font-style: normal;
  font-display: block;
}
...
const me = "swim-icon", re = class re extends z {
  ...
  render() {
    ...
    return !e || e.length === 0 ? h`
      ...
      >
        ${e.map(
      (r, c) => h`<i part="icon icon-${c}" class="swim-icon__i swim-icon__i--${c} ${r}${o}"></i>`
    )}
      </span>
    `;
  }
...
`, ct = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], at = ["S", "M", "T", "W", "T", "F", "S"];
function ee(i, e) {
  return i.getFullYear() === e.getFullYear() && i.getMonth() === e.getMonth() && i.getDate() === e.getDate();
}
function ft(i, e) {
  return i.getFullYear() === e.getFullYear() && i.getMonth() === e.getMonth();
}
function gt(i, e) {
...
function d(i) {
  const e = /* @__PURE__ */ new Date(), t = i.getFullYear(), n = i.getMonth(), o = ye(t, n), s = new Date(t, n, 1).getDay(), r = [];
  if (s > 0) {
    const g = ye(t, n - 1);
    for (let b = s - 1; b >= 0; b--) {
      const l = new Date(t, n - 1, g - b);
      r.push(X(l, n, e));
    }
  }
  for (let g = 1; g <= o; g++)
    r.push(X(new Date(t, n, g), n, e));
  const c = r.length % 7;
  if (c > 0) {
    const g = 7 - c;
    for (let b = 1; b <= g; b++)
      r.push(X(new Date(t, n + 1, b), n, e));
  }
  const a = [];
  for (let g = 0; g < r.length; g += 7)
    a.push(r.slice(g, g + 7));
  return a;
}
function we(i) {
  return Math.floor(i / 20) * 20;
}
function _(i, e, t = "day") {
  if (!e) return !1;
  switch (t) {
    case "year":
      return i.getFullYear() < e.getFullYear();
...
function Ae(i) {
  if (i instanceof Date) return k(i) ? i : null;
...
var lt = Object.defineProperty, bt = Object.getOwnPropertyDescriptor, p = (i, e, t, n) => {
  for (var o = n > 1 ? void 0 : n ? bt(e, t) : e, s = i.length - 1, r; s >= 0; s--)
    (r = i[s]) && (o = (n ? r(e, t, o) : r(o)) || o);
  return n && o && lt(e, t, o), o;
};
const ve = "swim-calendar", se = class se extends z {
  constructor() {
    super(...arguments), this._value = null, this.disabled = !1, this._currentView = "date", this._focusDate = /* @__PURE__ */ new Date(), this._weeks = [], this._startYear = 0, this._currentDate = /* @__PURE__ */ new Date(), this._onDayKeyDown = (e) => {
      ...
      switch (e.code) {
        ...
        case "Home": {
          ...
          e.altKey ? n.setDate(1) : n.setDate(n.getDate() - n.getDay()), this._focusDate = n, this._weeks = d(this._focusDate), this.requestUpdate(), this.updateComplete.then(() => this.focusDay()), t = !0;
          break;
        }
        case "End": {
          const n = new Date(this._focusDate);
          e.altKey ? n.setMonth(n.getMonth() + 1, 0) : n.setDate(n.getDate() + (6 - n.getDay())), this._focusDate = n, this._weeks = d(this._focusDate), this.requestUpdate(), this.updateComplete.then(() => this.focusDay()), t = !0;
          break;
        }
        case "Enter":
          setTimeout(() => {
  ...
  set value(e) {
    const t = this._value;
    e && k(e) ? this._value = new Date(e) : this._value = null, this.requestUpdate("value", t);
  }
  set minView(e) {
  ...
  updated(e) {
    super.updated(e), e.has("value") && this._value && (this._focusDate = new Date(this._value), this._weeks = d(this._focusDate), this._startYear = we(this._focusDate.getFullYear()));
  }
  // ---------------------------------------------------------------------------
  // Public methods
  // ---------------------------------------------------------------------------
  ...
  _renderDateView() {
    ...
    return h`
      <div class="text-center">
        ...
        <div class="day-name-row">${at.map((t) => h`<div class="day-name text-center">${t}</div>`)}</div>
      ...
      (t) => h`
              <tr class="day-row" role="row">
                ${t.map((n) => {
        if (!n.num)
          return h`<td class="day-cell text-center" role="gridcell"></td>`;
        const o = this._value ? ee(n.date, this._value) : !1, s = ee(n.date, this._focusDate), r = this.disabled || this._isDayDisabled(n.date), c = ["day"];
        return n.prevMonth && c.push("prev-month"), n.nextMonth && c.push("next-month"), n.today && c.push("today"), o && c.push("active"), s && !r && c.push("focus"), h`
      ...
      <div class="text-center">
        ...
        <table class="months-container" role="grid">
          <tr class="months-row" role="row">
            ${ct.map((t, n) => {
      const o = this._isMonthActive(n), s = this._isCurrentMonth(n), r = this._focusDate.getMonth() === n && gt(this._focusDate, this._focusDate), c = this.disabled || this._isMonthDisabled(n), a = ["month"];
      return o && a.push("active"), s && a.push("current"), r && a.push("focus"), h`
      ...
      <div class="text-center">
        ...
        <table class="years-container" role="grid">
          <tr class="years-row" role="row">
            ${e.map((t) => {
      const n = this._isYearActive(t), o = t === this._currentDate.getFullYear(), s = t === this._focusDate.getFullYear(), r = this.disabled || this._isYearDisabled(t), c = ["year"];
      return n && c.push("active"), o && c.push("current"), s && c.push("focus"), h`
  ...
  // ---------------------------------------------------------------------------
  _init() {
    this._value && (this._focusDate = new Date(this._value)), this._weeks = d(this._focusDate), this._currentDate = /* @__PURE__ */ new Date(), this._startYear = we(this._focusDate.getFullYear()), this._validateView();
  }
  _validateView() {
    [
      "date",
  ...
  _resolveMin() {
    return this.minDate ? this.minDate instanceof Date ? this.minDate : Ae(this.minDate) : null;
  }
  _resolveMax() {
    return this.maxDate ? this.maxDate instanceof Date ? this.maxDate : Ae(this.maxDate) : null;
  }
  _isDayDisabled(e) {
    return _(e, this._resolveMin(), "day") || $(e, this._resolveMax(), "day");
  }
  _isMonthDisabled(e) {
    const t = new Date(this._focusDate.getFullYear(), e, 1);
    return _(t, this._resolveMin(), "month") || $(t, this._resolveMax(), "month");
  }
  _isYearDisabled(e) {
    const t = new Date(e, 0, 1);
    return _(t, this._resolveMin(), "year") || $(t, this._resolveMax(), "year");
  }
  _isMonthActive(e) {
  ...
  _prevMonth() {
    ...
    e.setMonth(e.getMonth() - 1), this._focusDate = e, this._weeks = d(this._focusDate);
  }
  _nextMonth() {
    const e = new Date(this._focusDate);
    e.setMonth(e.getMonth() + 1), this._focusDate = e, this._weeks = d(this._focusDate);
  ...
  _changeViews() {
    this._currentView === "date" ? this._currentView = "month" : this._currentView === "month" ? this._currentView = "year" : this._currentView = this._minView || "date", this._weeks = d(this._focusDate);
  }
  // ---------------------------------------------------------------------------
  // Day interaction
  // ---------------------------------------------------------------------------
  _onDayClick(e) {
    this._focusDate = new Date(e.date), this._value = new Date(e.date), (e.prevMonth || e.nextMonth) && (this._weeks = d(this._focusDate)), this.requestUpdate(), this.dispatchEvent(new CustomEvent("change", { detail: this._value, bubbles: !0, composed: !0 }));
  }
  _onMonthClick(e) {
    const t = new Date(this._focusDate);
    t.setMonth(e), this._focusDate = t, this._value = new Date(t), (this._minView || "date") !== "month" && (this._currentView = "date", this._weeks = d(this._focusDate)), this.requestUpdate(), this.dispatchEvent(new CustomEvent("change", { detail: this._value, bubbles: !0, composed: !0 }));
  }
  _onYearClick(e) {
    const t = new Date(this._focusDate);
    t.setFullYear(e), this._focusDate = t, this._value = new Date(t), (this._minView || "date") !== "year" && (this._currentView = "month", this._weeks = d(this._focusDate)), this.requestUpdate(), this.dispatchEvent(new CustomEvent("change", { detail: this._value, bubbles: !0, composed: !0 }));
  }
  // ---------------------------------------------------------------------------
  // Keyboard navigation
  // ---------------------------------------------------------------------------
  _moveFocus(e, t) {
    ...
    this._focusDate = n, this._weeks = d(this._focusDate), this._focusDate.getFullYear() < this._startYear ? this._prevTwoDecades() : this._focusDate.getFullYear() > this._startYear + 20 && this._nextTwoDecades(), this.requestUpdate(), this.updateComplete.then(() => this.focusDay());
  }
};
se.styles = [ze, st];
let f = se;
...
p([
  u({ attribute: "min-date" })
], f.prototype, "minDate", 2);
p([
  u({ attribute: "max-date" })
...
p([
  u({ type: String, attribute: "min-view" })
], f.prototype, "minView", 1);
p([
  P()
], f.prototype, "_currentView", 2);
p([
  P()
], f.prototype, "_focusDate", 2);
p([
  P()
], f.prototype, "_weeks", 2);
p([
  P()
], f.prototype, "_startYear", 2);
customElements.get(ve) || customElements.define(ve, f);
export {
  at as DAYS_OF_WEEK,
  ct as MONTHS_SHORT,
  f as SwimCalendar,
  we as getDecadeStartYear,
  d as getMonth,
  $ as isAfterDate,
  _ as isBeforeDate,
  ee as isSameDay,
