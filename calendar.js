 ...
 */
const O = globalThis, te = O.ShadowRoot && (O.ShadyCSS === void 0 || O.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ie = Symbol(), ce = /* @__PURE__ */ new WeakMap();
let De = class {
  constructor(e, t, i) {
...
const ze = (n) => new De(typeof n == "string" ? n : n + "", void 0, ie), Y = (n, ...e) => {
  ...
  if (te) n.adoptedStyleSheets = e.map((t) => t instanceof CSSStyleSheet ? t : t.styleSheet);
    ...
    const i = document.createElement("style"), o = O.litNonce;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Se, defineProperty: Ye, getOwnPropertyDescriptor: Fe, getOwnPropertyNames: Ve, getOwnPropertySymbols: Je, getPrototypeOf: He } = Object, v = globalThis, le = v.trustedTypes, Be = le ? le.emptyScript : "", Z = v.reactiveElementPolyfillSupport, V = (n, e) => n, Q = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? Be : null;
      break;
  ...
  return t;
} }, oe = (n, e) => !Se(n, e), be = { attribute: !0, type: String, converter: Q, reflect: !1, useDefault: !1, hasChanged: oe };
...
let M = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, t, i) {
    const { get: o, set: r } = Fe(this.prototype, e) ?? { get() {
      return this[t];
    }, set(s) {
      this[t] = s;
    } };
  ...
  _$AK(e, t) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const c = i.getPropertyOptions(o), a = typeof c.converter == "function" ? { fromAttribute: c.converter } : ((r = c.converter) == null ? void 0 : r.fromAttribute) !== void 0 ? c.converter : Q;
      this._$Em = o;
...
M.elementStyles = [], M.shadowRootOptions = { mode: "open" }, M[V("elementProperties")] = /* @__PURE__ */ new Map(), M[V("finalized")] = /* @__PURE__ */ new Map(), Z == null || Z({ ReactiveElement: M }), (v.reactiveElementVersions ?? (v.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const J = globalThis, T = J.trustedTypes, he = T ? T.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, Ce = "$lit$", A = `lit$${Math.random().toFixed(9).slice(2)}$`, Ee = "?" + A, Ke = `<${Ee}>`, I = document, H = () => I.createComment(""), B = (n) => n === null || typeof n != "object" && typeof n != "function", ne = Array.isArray, Ge = (n) => ne(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", N = `[ 	
\f\r]`, F = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, fe = /-->/g, de = />/g, D = RegExp(`>|${N}(?:([^\\s"'>=/]+)(${N}*=${N}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), me = /'/g, ue = /"/g, Ie = /^(?:script|style|textarea|title)$/i, Pe = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), d = Pe(1), q = Symbol.for("lit-noChange"), f = Symbol.for("lit-nothing"), we = /* @__PURE__ */ new WeakMap(), C = I.createTreeWalker(I, 129);
function Me(n, e) {
...
const Ue = (n, e) => {
  ...
  let o, r = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", s = F;
  for (let c = 0; c < t; c++) {
    const a = n[c];
    let l, h, b = -1, g = 0;
    for (; g < a.length && (s.lastIndex = g, h = s.exec(a), h !== null); ) g = s.lastIndex, s === F ? h[1] === "!--" ? s = fe : h[1] !== void 0 ? s = de : h[2] !== void 0 ? (Ie.test(h[2]) && (o = RegExp("</" + h[2], "g")), s = D) : h[3] !== void 0 && (s = D) : s === D ? h[0] === ">" ? (s = o ?? F, b = -1) : h[1] === void 0 ? b = -2 : (b = s.lastIndex - h[2].length, l = h[1], s = h[3] === void 0 ? D : h[3] === '"' ? ue : me) : s === ue || s === me ? s = D : s === fe || s === de ? s = F : (s = D, o = void 0);
    const y = s === D && n[c + 1].startsWith("/>") ? " " : "";
    r += s === F ? a + Ke : b >= 0 ? (i.push(l), a.slice(0, b) + Ce + a.slice(b) + A + y) : a + A + (b === -2 ? c : y);
  }
...
class K {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    if (this.el = K.createElement(l, i), C.currentNode = this.el.content, t === 2 || t === 3) {
      const b = this.el.content.firstChild;
      b.replaceWith(...b.childNodes);
    }
    for (; (o = C.nextNode()) !== null && a.length < c; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const b of o.getAttributeNames()) if (b.endsWith(Ce)) {
          const g = h[s++], y = o.getAttribute(b).split(A), R = /([.?@])?(.*)/.exec(g);
          a.push({ type: 1, index: r, name: R[2], strings: y, ctor: R[1] === "." ? Oe : R[1] === "?" ? Qe : R[1] === "@" ? Te : W }), o.removeAttribute(b);
        } else b.startsWith(A) && (a.push({ type: 6, index: r }), o.removeAttribute(b));
        if (Ie.test(o.tagName)) {
          const b = o.textContent.split(A), g = b.length - 1;
          if (g > 0) {
            o.textContent = T ? T.emptyScript : "";
            for (let y = 0; y < g; y++) o.append(b[y], H()), C.nextNode(), a.push({ type: 2, index: ++r });
            o.append(b[g], H());
          }
        }
      } else if (o.nodeType === 8) if (o.data === Ee) a.push({ type: 2, index: r });
      else {
        let b = -1;
        for (; (b = o.data.indexOf(A, b + 1)) !== -1; ) a.push({ type: 7, index: r }), b += A.length - 1;
      }
      r++;
    }
  }
...
function S(n, e, t = n, i) {
  ...
  return (o == null ? void 0 : o.constructor) !== r && ((c = o == null ? void 0 : o._$AO) == null || c.call(o, !1), r === void 0 ? o = void 0 : (o = new r(n), o._$AT(n, t, i)), i !== void 0 ? (t._$Co ?? (t._$Co = []))[i] = o : t._$Cl = o), o !== void 0 && (e = S(n, o._$AS(n, e.values), o, i)), e;
}
class Re {
  constructor(e, t) {
  ...
  u(e) {
    ...
    C.currentNode = o;
    let r = C.nextNode(), s = 0, c = 0, a = i[0];
    for (; a !== void 0; ) {
      if (s === a.index) {
        let l;
        a.type === 2 ? l = new G(r, r.nextSibling, this, e) : a.type === 1 ? l = new a.ctor(r, a.name, a.strings, this, e) : a.type === 6 && (l = new We(r, this, e)), this._$AV.push(l), a = i[++c];
      }
...
class G {
  ...
  _$AI(e, t = this) {
    e = S(this, e, t), B(e) ? e === f || e == null || e === "" ? (this._$AH !== f && this._$AR(), this._$AH = f) : e !== this._$AH && e !== q && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Ge(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== f && B(this._$AH) ? this._$AA.nextSibling.data = e : this.T(I.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var r;
    const { values: t, _$litType$: i } = e, o = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = K.createElement(Me(i.h, i.h[0]), this.options)), i);
    if (((r = this._$AH) == null ? void 0 : r._$AD) === o) this._$AH.p(t);
    else {
      const s = new Re(o, this), c = s.u(this.options);
      s.p(t), this.T(c), this._$AH = s;
    }
  }
  _$AC(e) {
    let t = we.get(e.strings);
    return t === void 0 && we.set(e.strings, t = new K(e)), t;
  }
  k(e) {
    ne(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let i, o = 0;
    for (const r of e) o === t.length ? t.push(i = new G(this.O(H()), this.O(H()), this, this.options)) : i = t[o], i._$AI(r), o++;
...
class W {
  ...
  _$AI(e, t = this, i, o) {
    ...
    let s = !1;
    if (r === void 0) e = S(this, e, t, 0), s = !B(e) || e !== this._$AH && e !== q, s && (this._$AH = e);
    else {
      const c = e;
      let a, l;
      for (e = r[0], a = 0; a < r.length - 1; a++) l = S(this, c[i + a], t, a), l === q && (l = this._$AH[a]), s || (s = !B(l) || l !== this._$AH[a]), l === f ? e = f : e !== f && (e += (l ?? "") + r[a + 1]), this._$AH[a] = l;
    }
    s && !o && this.j(e);
  }
  j(e) {
...
const L = J.litHtmlPolyfillSupport;
L == null || L(K, G), (J.litHtmlVersions ?? (J.litHtmlVersions = [])).push("3.3.1");
const Ze = (n, e, t) => {
  const i = (t == null ? void 0 : t.renderBefore) ?? e;
  let o = i._$litPart$;
  if (o === void 0) {
    const r = (t == null ? void 0 : t.renderBefore) ?? null;
    i._$litPart$ = o = new G(e.insertBefore(H(), r), r, void 0, t ?? {});
  }
  return o._$AI(n), o;
};
/**
...
var xe;
z._$litElement$ = !0, z.finalized = !0, (xe = E.litElementHydrateSupport) == null || xe.call(E, { LitElement: z });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ne = { attribute: !0, type: String, converter: Q, reflect: !1, hasChanged: oe }, Le = (n = Ne, e, t) => {
...
function w(n) {
  return (e, t) => typeof t == "object" ? Le(n, e, t) : ((i, o, r) => {
...
`, _e = Y`
  ...
  ${Xe}
`, $e = (n) => `swim-icon ${n.trim().split(" ").map((t) => {
  const [i, o] = t.split(":");
...
class et {
  ...
  get(e, t) {
    return this.lookup(e, t).map((i) => $e(i));
  }
  lookup(e, t) {
...
`, nt = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], st = ["S", "M", "T", "W", "T", "F", "S"];
function ee(n, e) {
...
function u(n) {
  ...
  for (let l = 1; l <= o; l++)
    s.push(X(new Date(t, i, l), i, e));
  const c = s.length % 7;
  if (c > 0) {
    const l = 7 - c;
    for (let h = 1; h <= l; h++)
      s.push(X(new Date(t, i + 1, h), i, e));
  }
  const a = [];
...
function Ae(n) {
  if (n instanceof Date) return k(n) ? n : null;
...
const ve = "swim-calendar", re = class re extends z {
    ...
    super(...arguments), this._value = null, this.disabled = !1, this._currentView = "date", this._focusDate = /* @__PURE__ */ new Date(), this._weeks = [], this._startYear = 0, this._currentDate = /* @__PURE__ */ new Date(), this._onDayKeyDown = (e) => {
      ...
      switch (e.code) {
        ...
        case "Home": {
          ...
          e.altKey ? i.setDate(1) : i.setDate(i.getDate() - i.getDay()), this._focusDate = i, this._weeks = u(this._focusDate), this.requestUpdate(), this.updateComplete.then(() => this.focusDay()), t = !0;
          break;
        }
        case "End": {
          const i = new Date(this._focusDate);
          e.altKey ? i.setMonth(i.getMonth() + 1, 0) : i.setDate(i.getDate() + (6 - i.getDay())), this._focusDate = i, this._weeks = u(this._focusDate), this.requestUpdate(), this.updateComplete.then(() => this.focusDay()), t = !0;
          break;
        }
        case "Enter":
          setTimeout(() => {
  ...
  _moveFocus(e, t) {
    ...
    this._focusDate = i, this._weeks = u(this._focusDate), this._focusDate.getFullYear() < this._startYear ? this._prevTwoDecades() : this._focusDate.getFullYear() > this._startYear + 20 && this._nextTwoDecades(), this.requestUpdate(), this.updateComplete.then(() => this.focusDay());
  }
};
re.styles = [ke, ot];
let m = re;
...
], m.prototype, "minDate", 2);
p([
  w({ attribute: "max-date" })
], m.prototype, "maxDate", 2);
p([
