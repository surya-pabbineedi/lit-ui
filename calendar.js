...
const qe = (n) => new Ce(typeof n == "string" ? n : n + "", void 0, ie), K = (n, ...e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ye, defineProperty: Fe, getOwnPropertyDescriptor: Ve, getOwnPropertyNames: Je, getOwnPropertySymbols: He, getPrototypeOf: Be } = Object, v = globalThis, le = v.trustedTypes, Ke = le ? le.emptyScript : "", N = v.reactiveElementPolyfillSupport, F = (n, e) => n, Q = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? Ke : null;
      break;
  ...
  return t;
} }, oe = (n, e) => !Ye(n, e), be = { attribute: !0, type: String, converter: Q, reflect: !1, useDefault: !1, hasChanged: oe };
...
let M = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(F("properties"))) {
      const t = this.properties, i = [...Je(t), ...He(t)];
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const V = globalThis, T = V.trustedTypes, he = T ? T.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, Ee = "$lit$", A = `lit$${Math.random().toFixed(9).slice(2)}$`, Ie = "?" + A, Ge = `<${Ie}>`, I = document, J = () => I.createComment(""), H = (n) => n === null || typeof n != "object" && typeof n != "function", ne = Array.isArray, Pe = (n) => ne(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", Z = `[ 	
\f\r]`, Y = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, fe = /-->/g, de = />/g, D = RegExp(`>|${Z}(?:([^\\s"'>=/]+)(${Z}*=${Z}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ue = /'/g, me = /"/g, Me = /^(?:script|style|textarea|title)$/i, Ue = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), d = Ue(1), q = Symbol.for("lit-noChange"), f = Symbol.for("lit-nothing"), we = /* @__PURE__ */ new WeakMap(), C = I.createTreeWalker(I, 129);
function ke(n, e) {
...
const Re = (n, e) => {
  ...
  for (let c = 0; c < t; c++) {
    const a = n[c];
    let l, h, b = -1, g = 0;
    for (; g < a.length && (s.lastIndex = g, h = s.exec(a), h !== null); ) g = s.lastIndex, s === Y ? h[1] === "!--" ? s = fe : h[1] !== void 0 ? s = de : h[2] !== void 0 ? (Me.test(h[2]) && (o = RegExp("</" + h[2], "g")), s = D) : h[3] !== void 0 && (s = D) : s === D ? h[0] === ">" ? (s = o ?? Y, b = -1) : h[1] === void 0 ? b = -2 : (b = s.lastIndex - h[2].length, l = h[1], s = h[3] === void 0 ? D : h[3] === '"' ? me : ue) : s === me || s === ue ? s = D : s === fe || s === de ? s = Y : (s = D, o = void 0);
    const y = s === D && n[c + 1].startsWith("/>") ? " " : "";
    r += s === Y ? a + Ge : b >= 0 ? (i.push(l), a.slice(0, b) + Ee + a.slice(b) + A + y) : a + A + (b === -2 ? c : y);
  }
    ...
    for (; (o = C.nextNode()) !== null && a.length < c; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const b of o.getAttributeNames()) if (b.endsWith(Ee)) {
          ...
          a.push({ type: 1, index: r, name: R[2], strings: y, ctor: R[1] === "." ? Qe : R[1] === "?" ? Te : R[1] === "@" ? We : W }), o.removeAttribute(b);
...
class Oe {
  ...
  u(e) {
    ...
    for (; a !== void 0; ) {
      if (s === a.index) {
        let l;
        a.type === 2 ? l = new G(r, r.nextSibling, this, e) : a.type === 1 ? l = new a.ctor(r, a.name, a.strings, this, e) : a.type === 6 && (l = new Ne(r, this, e)), this._$AV.push(l), a = i[++c];
      }
...
class G {
  ...
  _$AI(e, t = this) {
    e = S(this, e, t), H(e) ? e === f || e == null || e === "" ? (this._$AH !== f && this._$AR(), this._$AH = f) : e !== this._$AH && e !== q && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Pe(e) ? this.k(e) : this._(e);
  }
  O(e) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Le = { attribute: !0, type: String, converter: Q, reflect: !1, hasChanged: oe }, je = (n = Le, e, t) => {
...
@font-face {
  font-family: '${ot}';
  src: url('data:font/woff2;base64,${it}') format('woff2');
  font-weight: normal;
  font-style: normal;
  font-display: block;
}
`, document.head.appendChild(n), pe = !0;
}
var st = Object.defineProperty, U = (n, e, t, i) => {
  for (var o = void 0, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (o = s(e, t, o) || o);
  return o && st(e, t, o), o;
};
const ge = "swim-icon", se = class se extends z {
  constructor() {
    super(...arguments), this.fontIcon = "", this.alt = "", this.fontSet = "lit", this.iconClass = "", this._cssClasses = [], this._iconClassTokensOnHost = [];
  }
  connectedCallback() {
    super.connectedCallback(), nt(), this._updateFontIcon();
  }
  updated(e) {
...
customElements.get(ge) || customElements.define(ge, x);
const rt = K`
  :host {
    position: relative;
...
function m(n) {
  const e = /* @__PURE__ */ new Date(), t = n.getFullYear(), i = n.getMonth(), o = ye(t, i), r = new Date(t, i, 1).getDay(), s = [];
  if (r > 0) {
    const l = ye(t, i - 1);
    for (let h = r - 1; h >= 0; h--) {
...
var bt = Object.defineProperty, ht = Object.getOwnPropertyDescriptor, p = (n, e, t, i) => {
  for (var o = i > 1 ? void 0 : i ? ht(e, t) : e, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (o = (i ? s(e, t, o) : s(o)) || o);
  return i && o && bt(e, t, o), o;
};
const xe = "swim-calendar", re = class re extends z {
  constructor() {
  ...
  updated(e) {
    super.updated(e), e.has("value") && this._value && (this._focusDate = new Date(this._value), this._weeks = m(this._focusDate), this._startYear = Ae(this._focusDate.getFullYear()));
  }
  // ---------------------------------------------------------------------------
  // Public methods
  // ---------------------------------------------------------------------------
  ...
  _renderDateView() {
    ...
    return d`
      <div class="text-center">
        ...
        <div class="day-name-row">${at.map((t) => d`<div class="day-name text-center">${t}</div>`)}</div>
      ...
      <div class="text-center">
        ...
        <table class="months-container" role="grid">
          <tr class="months-row" role="row">
            ${ct.map((t, i) => {
      const o = this._isMonthActive(i), r = this._isCurrentMonth(i), s = this._focusDate.getMonth() === i && lt(this._focusDate, this._focusDate), c = this.disabled || this._isMonthDisabled(i), a = ["month"];
  ...
  // ---------------------------------------------------------------------------
  _init() {
    this._value && (this._focusDate = new Date(this._value)), this._weeks = m(this._focusDate), this._currentDate = /* @__PURE__ */ new Date(), this._startYear = Ae(this._focusDate.getFullYear()), this._validateView();
  }
  _validateView() {
    [
      "date",
