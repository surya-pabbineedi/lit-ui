 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: mt, defineProperty: bt, getOwnPropertyDescriptor: pt, getOwnPropertyNames: ft, getOwnPropertySymbols: gt, getPrototypeOf: wt } = Object, B = globalThis, Ye = B.trustedTypes, yt = Ye ? Ye.emptyScript : "", me = B.reactiveElementPolyfillSupport, X = (o, e) => o, le = { toAttribute(o, e) {
  switch (e) {
    case Boolean:
      o = o ? yt : null;
      break;
  ...
  return t;
} }, Me = (o, e) => !mt(o, e), Te = { attribute: !0, type: String, converter: le, reflect: !1, useDefault: !1, hasChanged: Me };
...
let G = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, t, i) {
    const { get: n, set: r } = pt(this.prototype, e) ?? { get() {
      return this[t];
    }, set(s) {
      this[t] = s;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(X("properties"))) {
      const t = this.properties, i = [...ft(t), ...gt(t)];
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const $ = globalThis, ce = $.trustedTypes, qe = ce ? ce.createPolicy("lit-html", { createHTML: (o) => o }) : void 0, it = "$lit$", H = `lit$${Math.random().toFixed(9).slice(2)}$`, ot = "?" + H, vt = `<${ot}>`, L = document, ee = () => L.createComment(""), te = (o) => o === null || typeof o != "object" && typeof o != "function", De = Array.isArray, _t = (o) => De(o) || typeof (o == null ? void 0 : o[Symbol.iterator]) == "function", be = `[ 	
\f\r]`, Z = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Fe = /-->/g, Ve = />/g, J = RegExp(`>|${be}(?:([^\\s"'>=/]+)(${be}*=${be}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Oe = /'/g, He = /"/g, nt = /^(?:script|style|textarea|title)$/i, xt = (o) => (e, ...t) => ({ _$litType$: o, strings: e, values: t }), f = xt(1), I = Symbol.for("lit-noChange"), h = Symbol.for("lit-nothing"), Be = /* @__PURE__ */ new WeakMap(), R = L.createTreeWalker(L, 129);
function st(o, e) {
...
const At = (o, e) => {
  ...
  let n, r = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", s = Z;
  for (let l = 0; l < t; l++) {
    const c = o[l];
    let d, v, w = -1, Y = 0;
    for (; Y < c.length && (s.lastIndex = Y, v = s.exec(c), v !== null); ) Y = s.lastIndex, s === Z ? v[1] === "!--" ? s = Fe : v[1] !== void 0 ? s = Ve : v[2] !== void 0 ? (nt.test(v[2]) && (n = RegExp("</" + v[2], "g")), s = J) : v[3] !== void 0 && (s = J) : s === J ? v[0] === ">" ? (s = n ?? Z, w = -1) : v[1] === void 0 ? w = -2 : (w = s.lastIndex - v[2].length, d = v[1], s = v[3] === void 0 ? J : v[3] === '"' ? He : Oe) : s === He || s === Oe ? s = J : s === Fe || s === Ve ? s = Z : (s = J, n = void 0);
    const O = s === J && o[l + 1].startsWith("/>") ? " " : "";
    r += s === Z ? c + vt : w >= 0 ? (i.push(d), c.slice(0, w) + it + c.slice(w) + H + O) : c + H + (w === -2 ? l : O);
  }
...
class ie {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let r = 0, s = 0;
    const l = e.length - 1, c = this.parts, [d, v] = At(e, t);
    ...
    for (; (n = R.nextNode()) !== null && c.length < l; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) for (const w of n.getAttributeNames()) if (w.endsWith(it)) {
          ...
          c.push({ type: 1, index: r, name: re[2], strings: O, ctor: re[1] === "." ? Dt : re[1] === "?" ? Ct : re[1] === "@" ? Et : he }), n.removeAttribute(w);
...
class Mt {
  ...
  u(e) {
    const { el: { content: t }, parts: i } = this._$AD, n = ((e == null ? void 0 : e.creationScope) ?? L).importNode(t, !0);
    R.currentNode = n;
...
class oe {
  ...
  _$AI(e, t = this) {
    e = N(this, e, t), te(e) ? e === h || e == null || e === "" ? (this._$AH !== h && this._$AR(), this._$AH = h) : e !== this._$AH && e !== I && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : _t(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== h && te(this._$AH) ? this._$AA.nextSibling.data = e : this.T(L.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var r;
    ...
    if (((r = this._$AH) == null ? void 0 : r._$AD) === n) this._$AH.p(t);
      ...
      const s = new Mt(n, this), l = s.u(this.options);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const It = { attribute: !0, type: String, converter: le, reflect: !1, hasChanged: Me }, St = (o = It, e, t) => {
...
function a(o) {
  return (e, t) => typeof t == "object" ? St(o, e, t) : ((i, n, r) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Yt = (o, e, t) => (t.configurable = !0, t.enumerable = !0, Reflect.decorate && typeof e != "object" && Object.defineProperty(o, e, t), t);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const K = { ATTRIBUTE: 1, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4 }, Tt = (o) => (...e) => ({ _$litDirective$: o, values: e });
class qt {
  constructor(e) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ft = (o) => o.strings === void 0, Vt = {}, Ot = (o, e = Vt) => o._$AH = e;
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
const Pe = Tt(class extends qt {
  constructor(o) {
    if (super(o), o.type !== K.PROPERTY && o.type !== K.ATTRIBUTE && o.type !== K.BOOLEAN_ATTRIBUTE) throw Error("The `live` directive is not allowed on child or event bindings");
    if (!Ft(o)) throw Error("`live` bindings can only contain a single expression");
  }
  render(o) {
    return o;
  }
  update(o, [e]) {
    ...
    if (o.type === K.PROPERTY) {
      if (e === t[i]) return I;
    } else if (o.type === K.BOOLEAN_ATTRIBUTE) {
      if (!!e === t.hasAttribute(i)) return I;
    } else if (o.type === K.ATTRIBUTE && t.getAttribute(i) === e + "") return I;
    return Ot(o), e;
  }
}), ne = V`
  :host {
...
`, document.head.appendChild(o), Je = !0;
}
var Gt = Object.defineProperty, se = (o, e, t, i) => {
...
const Re = "swim-icon", Ee = class Ee extends F {
  ...
  connectedCallback() {
    super.connectedCallback(), Kt(), this._updateFontIcon();
  }
  updated(e) {
...
var Wt = Object.defineProperty, Zt = Object.getOwnPropertyDescriptor, g = (o, e, t, i) => {
  for (var n = i > 1 ? void 0 : i ? Zt(e, t) : e, r = o.length - 1, s; r >= 0; r--)
...
de.styles = [ne, rt, Nt], de.formAssociated = !0;
let p = de;
g([
...
function k(o) {
  const e = /* @__PURE__ */ new Date(), t = o.getFullYear(), i = o.getMonth(), n = Le(t, i), r = new Date(t, i, 1).getDay(), s = [];
  if (r > 0) {
    const d = Le(t, i - 1);
    for (let v = r - 1; v >= 0; v--) {
...
const ei = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], ti = [
  ...
  "November",
  "December"
], ii = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], oi = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], Ge = {
  L: "MM/DD/YYYY",
  l: "M/D/YYYY",
  LL: "MMMM D, YYYY",
  ll: "MMM D, YYYY",
...
function Q(o, e, t) {
  ...
  const s = dt(o, i);
  return n.replace(ri, (c) => ai(c, s, o, i)).replace(/\x00(\d+)\x00/g, (c, d) => r[parseInt(d, 10)]);
}
function W(o) {
...
var di = Object.defineProperty, ui = Object.getOwnPropertyDescriptor, S = (o, e, t, i) => {
      ...
      <div class="text-center">
        ...
        <table class="months-container" role="grid">
          <tr class="months-row" role="row">
            ${jt.map((t, i) => {
      const n = this._isMonthActive(i), r = this._isCurrentMonth(i), s = this._focusDate.getMonth() === i && $t(this._focusDate, this._focusDate), l = this.disabled || this._isMonthDisabled(i), c = ["month"];
...
var j = /* @__PURE__ */ ((o) => (o.Regular = "regular", o.Medium = "medium", o.Large = "large", o))(j || {}), mi = Object.defineProperty, bi = Object.getOwnPropertyDescriptor, C = (o, e, t, i) => {
...
customElements.get(Xe) || customElements.define(Xe, x);
const pi = V`
  :host {
    position: relative;
    display: block;
...
`;
var fi = Object.defineProperty, gi = Object.getOwnPropertyDescriptor, m = (o, e, t, i) => {
  for (var n = i > 1 ? void 0 : i ? gi(e, t) : e, r = o.length - 1, s; r >= 0; r--)
    (s = o[r]) && (n = (i ? s(e, t, n) : s(n)) || n);
  return i && n && fi(e, t, n), n;
};
let wi = 0;
const $e = "swim-date-time", ue = class ue extends F {
  ...
  _getDialogHeaderText() {
    ...
    if (e === y.datetime) {
      const i = Q(this._dialogModel, "ddd, MMM D YYYY", t), n = Q(this._dialogModel, "h:mm a", t);
...
ue.styles = [ne, pi], ue.formAssociated = !0;
let u = ue;
m([
  Ce("swim-input")
...
export {
  ...
  u as SwimDateTime,
  Q as formatDate,
  xi as getEffectiveDisplayFormat,
