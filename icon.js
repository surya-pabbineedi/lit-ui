 ...
 */
const U = globalThis, T = U.ShadowRoot && (U.ShadyCSS === void 0 || U.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Z = Symbol(), X = /* @__PURE__ */ new WeakMap();
let ae = class {
  constructor(e, t, i) {
...
const he = (n) => new ae(typeof n == "string" ? n : n + "", void 0, Z), M = (n, ...e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: pe, defineProperty: ge, getOwnPropertyDescriptor: ue, getOwnPropertyNames: Ae, getOwnPropertySymbols: ye, getPrototypeOf: Ce } = Object, p = globalThis, $ = p.trustedTypes, xe = $ ? $.emptyScript : "", O = p.reactiveElementPolyfillSupport, q = (n, e) => n, D = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? xe : null;
      break;
  ...
  return t;
} }, N = (n, e) => !pe(n, e), ee = { attribute: !0, type: String, converter: D, reflect: !1, useDefault: !1, hasChanged: N };
...
let x = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(q("properties"))) {
      const t = this.properties, i = [...Ae(t), ...ye(t)];
  ...
  _$ET(e, t) {
    ...
    if (o !== void 0 && i.reflect === !0) {
      const s = (((r = i.converter) == null ? void 0 : r.toAttribute) !== void 0 ? i.converter : D).toAttribute(t, i.type);
  ...
  _$AK(e, t) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const l = i.getPropertyOptions(o), c = typeof l.converter == "function" ? { fromAttribute: l.converter } : ((r = l.converter) == null ? void 0 : r.fromAttribute) !== void 0 ? l.converter : D;
      this._$Em = o;
...
x.elementStyles = [], x.shadowRootOptions = { mode: "open" }, x[q("elementProperties")] = /* @__PURE__ */ new Map(), x[q("finalized")] = /* @__PURE__ */ new Map(), O == null || O({ ReactiveElement: x }), (p.reactiveElementVersions ?? (p.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const z = globalThis, P = z.trustedTypes, te = P ? P.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, be = "$lit$", w = `lit$${Math.random().toFixed(9).slice(2)}$`, fe = "?" + w, Ie = `<${fe}>`, C = document, J = () => C.createComment(""), H = (n) => n === null || typeof n != "object" && typeof n != "function", L = Array.isArray, Ee = (n) => L(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", F = `[ 	
\f\r]`, v = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ie = /-->/g, oe = />/g, u = RegExp(`>|${F}(?:([^\\s"'>=/]+)(${F}*=${F}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ne = /'/g, se = /"/g, me = /^(?:script|style|textarea|title)$/i, ve = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), R = ve(1), I = Symbol.for("lit-noChange"), f = Symbol.for("lit-nothing"), re = /* @__PURE__ */ new WeakMap(), A = C.createTreeWalker(C, 129);
function de(n, e) {
...
const qe = (n, e) => {
  ...
  for (let l = 0; l < t; l++) {
    const c = n[l];
    let b, m, a = -1, d = 0;
    for (; d < c.length && (s.lastIndex = d, m = s.exec(c), m !== null); ) d = s.lastIndex, s === v ? m[1] === "!--" ? s = ie : m[1] !== void 0 ? s = oe : m[2] !== void 0 ? (me.test(m[2]) && (o = RegExp("</" + m[2], "g")), s = u) : m[3] !== void 0 && (s = u) : s === u ? m[0] === ">" ? (s = o ?? v, a = -1) : m[1] === void 0 ? a = -2 : (a = s.lastIndex - m[2].length, b = m[1], s = m[3] === void 0 ? u : m[3] === '"' ? se : ne) : s === se || s === ne ? s = u : s === ie || s === oe ? s = v : (s = u, o = void 0);
    const h = s === u && n[l + 1].startsWith("/>") ? " " : "";
    r += s === v ? c + Ie : a >= 0 ? (i.push(b), c.slice(0, a) + be + c.slice(a) + w + h) : c + w + (a === -2 ? l : h);
  }
  return [de(n, r + (n[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), i];
};
class B {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let r = 0, s = 0;
    const l = e.length - 1, c = this.parts, [b, m] = qe(e, t);
    ...
    for (; (o = A.nextNode()) !== null && c.length < l; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const a of o.getAttributeNames()) if (a.endsWith(be)) {
          ...
          c.push({ type: 1, index: r, name: k[2], strings: h, ctor: k[1] === "." ? Se : k[1] === "?" ? Je : k[1] === "@" ? He : Q }), o.removeAttribute(a);
...
class ze {
  ...
  u(e) {
    ...
    for (; c !== void 0; ) {
      if (s === c.index) {
        let b;
        c.type === 2 ? b = new G(r, r.nextSibling, this, e) : c.type === 1 ? b = new c.ctor(r, c.name, c.strings, this, e) : c.type === 6 && (b = new Be(r, this, e)), this._$AV.push(b), c = i[++l];
      }
...
class G {
  ...
  _$AI(e, t = this) {
    e = E(this, e, t), H(e) ? e === f || e == null || e === "" ? (this._$AH !== f && this._$AR(), this._$AH = f) : e !== this._$AH && e !== I && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Ee(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    var r;
    const { values: t, _$litType$: i } = e, o = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = B.createElement(de(i.h, i.h[0]), this.options)), i);
    if (((r = this._$AH) == null ? void 0 : r._$AD) === o) this._$AH.p(t);
    else {
      const s = new ze(o, this), l = s.u(this.options);
...
Y == null || Y(B, G), (z.litHtmlVersions ?? (z.litHtmlVersions = [])).push("3.3.1");
const Me = (n, e, t) => {
...
var le;
S._$litElement$ = !0, S.finalized = !0, (le = y.litElementHydrateSupport) == null || le.call(y, { LitElement: S });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ge = { attribute: !0, type: String, converter: D, reflect: !1, hasChanged: N }, Ve = (n = Ge, e, t) => {
...
function V(n) {
  return (e, t) => typeof t == "object" ? Ve(n, e, t) : ((i, o, r) => {
...
const Oe = new Qe();
var Fe = Object.defineProperty, K = (n, e, t, i) => {
  for (var o = void 0, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (o = s(e, t, o) || o);
  return o && Fe(e, t, o), o;
};
const ce = "swim-icon", j = class j extends S {
  constructor() {
  ...
  _updateFontIcon() {
    ...
    this._cssClasses = Oe.get(e, this.fontSet);
  }
  render() {
    var r;
...
let g = j;
K([
  V({ type: String, attribute: "font-icon" })
], g.prototype, "fontIcon");
K([
  V({ type: String })
], g.prototype, "alt");
K([
  V({ type: String, attribute: "font-set" })
], g.prototype, "fontSet");
K([
  V({ type: String, attribute: "icon-class" })
], g.prototype, "iconClass");
K([
  Ke()
], g.prototype, "_cssClasses");
customElements.get(ce) || customElements.define(ce, g);
const Te = "ngx-icon";
export {
  Te as SWIM_ICON_FONT_FAMILY,
  g as SwimIcon
};
