 ...
 */
const R = globalThis, V = R.ShadowRoot && (R.ShadyCSS === void 0 || R.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, K = Symbol(), Q = /* @__PURE__ */ new WeakMap();
let ae = class {
  constructor(e, t, i) {
  ...
  get styleSheet() {
    ...
    if (V && e === void 0) {
      ...
      i && (e = Q.get(t)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), i && Q.set(t, e));
    }
    return e;
  }
  toString() {
...
}, X = V ? (n) => n : (n) => n instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: pe, defineProperty: ue, getOwnPropertyDescriptor: ge, getOwnPropertyNames: $e, getOwnPropertySymbols: _e, getPrototypeOf: ye } = Object, p = globalThis, Y = p.trustedTypes, ve = Y ? Y.emptyScript : "", D = p.reactiveElementPolyfillSupport, C = (n, e) => n, I = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? ve : null;
      break;
...
let v = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(C("properties"))) {
      const t = this.properties, i = [...$e(t), ..._e(t)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const o of i) t.unshift(X(o));
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const E = globalThis, L = E.trustedTypes, te = L ? L.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, be = "$lit$", w = `lit$${Math.random().toFixed(9).slice(2)}$`, fe = "?" + w, Ae = `<${fe}>`, y = document, P = () => y.createComment(""), z = (n) => n === null || typeof n != "object" && typeof n != "function", J = Array.isArray, xe = (n) => J(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", q = `[ 	
\f\r]`, S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ie = /-->/g, oe = />/g, g = RegExp(`>|${q}(?:([^\\s"'>=/]+)(${q}*=${q}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ne = /'/g, se = /"/g, me = /^(?:script|style|textarea|title)$/i, Se = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), N = Se(1), A = Symbol.for("lit-noChange"), f = Symbol.for("lit-nothing"), re = /* @__PURE__ */ new WeakMap(), $ = y.createTreeWalker(y, 129);
function he(n, e) {
...
class O {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    if (this.el = O.createElement(b, i), $.currentNode = this.el.content, t === 2 || t === 3) {
      const a = this.el.content.firstChild;
      a.replaceWith(...a.childNodes);
    }
    for (; (o = $.nextNode()) !== null && c.length < l; ) {
      if (o.nodeType === 1) {
        ...
        if (me.test(o.tagName)) {
          ...
          if (h > 0) {
            ...
            for (let d = 0; d < h; d++) o.append(a[d], P()), $.nextNode(), c.push({ type: 2, index: ++r });
            o.append(a[h], P());
          }
        }
...
class Ee {
  ...
  u(e) {
    ...
    $.currentNode = o;
    let r = $.nextNode(), s = 0, l = 0, c = i[0];
    for (; c !== void 0; ) {
      if (s === c.index) {
        let b;
        c.type === 2 ? b = new T(r, r.nextSibling, this, e) : c.type === 1 ? b = new c.ctor(r, c.name, c.strings, this, e) : c.type === 6 && (b = new Oe(r, this, e)), this._$AV.push(b), c = i[++l];
      }
      s !== (c == null ? void 0 : c.index) && (r = $.nextNode(), s++);
    }
...
class T {
  ...
  k(e) {
    ...
    const t = this._$AH;
    let i, o = 0;
    for (const r of e) o === t.length ? t.push(i = new T(this.O(P()), this.O(P()), this, this.options)) : i = t[o], i._$AI(r), o++;
...
F == null || F(O, T), (E.litHtmlVersions ?? (E.litHtmlVersions = [])).push("3.3.1");
const Te = (n, e, t) => {
  const i = (t == null ? void 0 : t.renderBefore) ?? e;
  let o = i._$litPart$;
  if (o === void 0) {
    const r = (t == null ? void 0 : t.renderBefore) ?? null;
    i._$litPart$ = o = new T(e.insertBefore(P(), r), r, void 0, t ?? {});
  }
  return o._$AI(n), o;
};
/**
...
var le;
k._$litElement$ = !0, k.finalized = !0, (le = _.litElementHydrateSupport) == null || le.call(_, { LitElement: k });
const W = _.litElementPolyfillSupport;
W == null || W({ LitElement: k });
(_.litElementVersions ?? (_.litElementVersions = [])).push("4.2.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ue = { attribute: !0, type: String, converter: I, reflect: !1, hasChanged: G }, Me = (n = Ue, e, t) => {
...
const Be = new je();
var De = Object.defineProperty, M = (n, e, t, i) => {
