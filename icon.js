 ...
 */
const k = globalThis, T = k.ShadowRoot && (k.ShadyCSS === void 0 || k.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Z = Symbol(), X = /* @__PURE__ */ new WeakMap();
let xe = class {
  constructor(e, n, t) {
    if (this._$cssResult$ = !0, t !== Z) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
  ...
  get styleSheet() {
    ...
    if (T && e === void 0) {
      ...
      t && (e = X.get(n)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), t && X.set(n, e));
    }
    return e;
  }
  toString() {
...
const he = (i) => new xe(typeof i == "string" ? i : i + "", void 0, Z), P = (i, ...e) => {
  ...
  if (T) i.adoptedStyleSheets = e.map((n) => n instanceof CSSStyleSheet ? n : n.styleSheet);
  else for (const n of e) {
    const t = document.createElement("style"), o = k.litNonce;
    o !== void 0 && t.setAttribute("nonce", o), t.textContent = n.cssText, i.appendChild(t);
  }
}, _ = T ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((e) => {
  let n = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ue, defineProperty: me, getOwnPropertyDescriptor: Ae, getOwnPropertyNames: ye, getOwnPropertySymbols: we, getPrototypeOf: Ce } = Object, p = globalThis, $ = p.trustedTypes, Ie = $ ? $.emptyScript : "", Q = p.reactiveElementPolyfillSupport, q = (i, e) => i, U = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Ie : null;
      break;
  ...
  return n;
} }, N = (i, e) => !ue(i, e), ee = { attribute: !0, type: String, converter: U, reflect: !1, useDefault: !1, hasChanged: N };
...
let C = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, n, t) {
    const { get: o, set: c } = Ae(this.prototype, e) ?? { get() {
      return this[n];
    }, set(r) {
      this[n] = r;
    } };
    return { get: o, set(r) {
      ...
      c == null || c.call(this, r), this.requestUpdate(e, s, t);
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(q("properties"))) {
      const n = this.properties, t = [...ye(n), ...we(n)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const o of t) n.unshift(_(o));
    } else e !== void 0 && n.push(_(e));
    return n;
  }
  static _$Eu(e, n) {
    const t = n.attribute;
  ...
  _$ET(e, n) {
    ...
    if (o !== void 0 && t.reflect === !0) {
      const r = (((c = t.converter) == null ? void 0 : c.toAttribute) !== void 0 ? t.converter : U).toAttribute(n, t.type);
  ...
  _$AK(e, n) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const s = t.getPropertyOptions(o), g = typeof s.converter == "function" ? { fromAttribute: s.converter } : ((c = s.converter) == null ? void 0 : c.fromAttribute) !== void 0 ? s.converter : U;
      this._$Em = o;
      const x = g.fromAttribute(n, s.type);
      this[o] = x ?? ((r = this._$Ej) == null ? void 0 : r.get(o)) ?? x, this._$Em = null;
    }
  }
  requestUpdate(e, n, t) {
    var o;
    if (e !== void 0) {
      ...
      if (t ?? (t = c.getPropertyOptions(e)), !((t.hasChanged ?? N)(r, n) || t.useDefault && t.reflect && r === ((o = this._$Ej) == null ? void 0 : o.get(e)) && !this.hasAttribute(c._$Eu(e, t)))) return;
      this.C(e, n, t);
    }
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (o.size > 0) for (const [c, r] of o) {
        const { wrapped: s } = r, g = this[c];
        s !== !0 || this._$AL.has(c) || g === void 0 || this.C(c, void 0, r, g);
      }
    }
    let e = !1;
    const n = this._$AL;
...
C.elementStyles = [], C.shadowRootOptions = { mode: "open" }, C[q("elementProperties")] = /* @__PURE__ */ new Map(), C[q("finalized")] = /* @__PURE__ */ new Map(), Q == null || Q({ ReactiveElement: C }), (p.reactiveElementVersions ?? (p.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const z = globalThis, D = z.trustedTypes, ne = D ? D.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, le = "$lit$", h = `lit$${Math.random().toFixed(9).slice(2)}$`, be = "?" + h, Ee = `<${be}>`, w = document, J = () => w.createComment(""), H = (i) => i === null || typeof i != "object" && typeof i != "function", L = Array.isArray, ve = (i) => L(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", F = `[ 	
\f\r]`, v = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, te = /-->/g, oe = />/g, m = RegExp(`>|${F}(?:([^\\s"'>=/]+)(${F}*=${F}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ie = /'/g, re = /"/g, fe = /^(?:script|style|textarea|title)$/i, qe = (i) => (e, ...n) => ({ _$litType$: i, strings: e, values: n }), R = qe(1), I = Symbol.for("lit-noChange"), l = Symbol.for("lit-nothing"), ce = /* @__PURE__ */ new WeakMap(), A = w.createTreeWalker(w, 129);
function de(i, e) {
  if (!L(i) || !i.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return ne !== void 0 ? ne.createHTML(e) : e;
}
const ze = (i, e) => {
  const n = i.length - 1, t = [];
  let o, c = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", r = v;
  for (let s = 0; s < n; s++) {
    const g = i[s];
    let x, b, a = -1, f = 0;
    for (; f < g.length && (r.lastIndex = f, b = r.exec(g), b !== null); ) f = r.lastIndex, r === v ? b[1] === "!--" ? r = te : b[1] !== void 0 ? r = oe : b[2] !== void 0 ? (fe.test(b[2]) && (o = RegExp("</" + b[2], "g")), r = m) : b[3] !== void 0 && (r = m) : r === m ? b[0] === ">" ? (r = o ?? v, a = -1) : b[1] === void 0 ? a = -2 : (a = r.lastIndex - b[2].length, x = b[1], r = b[3] === void 0 ? m : b[3] === '"' ? re : ie) : r === re || r === ie ? r = m : r === te || r === oe ? r = v : (r = m, o = void 0);
    const d = r === m && i[s + 1].startsWith("/>") ? " " : "";
    c += r === v ? g + Ee : a >= 0 ? (t.push(x), g.slice(0, a) + le + g.slice(a) + h + d) : g + h + (a === -2 ? s : d);
  }
  return [de(i, c + (i[n] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), t];
};
class B {
  constructor({ strings: e, _$litType$: n }, t) {
    ...
    this.parts = [];
    let c = 0, r = 0;
    const s = e.length - 1, g = this.parts, [x, b] = ze(e, n);
    if (this.el = B.createElement(x, t), A.currentNode = this.el.content, n === 2 || n === 3) {
      const a = this.el.content.firstChild;
      a.replaceWith(...a.childNodes);
    }
    for (; (o = A.nextNode()) !== null && g.length < s; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const a of o.getAttributeNames()) if (a.endsWith(le)) {
          const f = b[r++], d = o.getAttribute(a).split(h), K = /([.?@])?(.*)/.exec(f);
          g.push({ type: 1, index: c, name: K[2], strings: d, ctor: K[1] === "." ? Je : K[1] === "?" ? He : K[1] === "@" ? Be : O }), o.removeAttribute(a);
        } else a.startsWith(h) && (g.push({ type: 6, index: c }), o.removeAttribute(a));
        if (fe.test(o.tagName)) {
          const a = o.textContent.split(h), f = a.length - 1;
          if (f > 0) {
            o.textContent = D ? D.emptyScript : "";
            for (let d = 0; d < f; d++) o.append(a[d], J()), A.nextNode(), g.push({ type: 2, index: ++c });
            o.append(a[f], J());
          }
        }
      } else if (o.nodeType === 8) if (o.data === be) g.push({ type: 2, index: c });
      else {
        let a = -1;
        for (; (a = o.data.indexOf(h, a + 1)) !== -1; ) g.push({ type: 7, index: c }), a += h.length - 1;
      }
      c++;
    }
  }
...
function E(i, e, n = i, t) {
  var r, s;
  if (e === I) return e;
  let o = t !== void 0 ? (r = n._$Co) == null ? void 0 : r[t] : n._$Cl;
  const c = H(e) ? void 0 : e._$litDirective$;
  return (o == null ? void 0 : o.constructor) !== c && ((s = o == null ? void 0 : o._$AO) == null || s.call(o, !1), c === void 0 ? o = void 0 : (o = new c(i), o._$AT(i, n, t)), t !== void 0 ? (n._$Co ?? (n._$Co = []))[t] = o : n._$Cl = o), o !== void 0 && (e = E(i, o._$AS(i, e.values), o, t)), e;
}
class Se {
  constructor(e, n) {
  ...
  u(e) {
    const { el: { content: n }, parts: t } = this._$AD, o = ((e == null ? void 0 : e.creationScope) ?? w).importNode(n, !0);
    A.currentNode = o;
    let c = A.nextNode(), r = 0, s = 0, g = t[0];
    for (; g !== void 0; ) {
      if (r === g.index) {
        let x;
        g.type === 2 ? x = new M(c, c.nextSibling, this, e) : g.type === 1 ? x = new g.ctor(c, g.name, g.strings, this, e) : g.type === 6 && (x = new Me(c, this, e)), this._$AV.push(x), g = t[++s];
      }
      r !== (g == null ? void 0 : g.index) && (c = A.nextNode(), r++);
    }
...
class M {
  ...
  _$AI(e, n = this) {
    e = E(this, e, n), H(e) ? e === l || e == null || e === "" ? (this._$AH !== l && this._$AR(), this._$AH = l) : e !== this._$AH && e !== I && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : ve(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== l && H(this._$AH) ? this._$AA.nextSibling.data = e : this.T(w.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var c;
    const { values: n, _$litType$: t } = e, o = typeof t == "number" ? this._$AC(e) : (t.el === void 0 && (t.el = B.createElement(de(t.h, t.h[0]), this.options)), t);
    if (((c = this._$AH) == null ? void 0 : c._$AD) === o) this._$AH.p(n);
    else {
      const r = new Se(o, this), s = r.u(this.options);
      r.p(n), this.T(s), this._$AH = r;
    }
  }
  _$AC(e) {
    let n = ce.get(e.strings);
    return n === void 0 && ce.set(e.strings, n = new B(e)), n;
  }
  k(e) {
    L(this._$AH) || (this._$AH = [], this._$AR());
    const n = this._$AH;
    let t, o = 0;
    for (const c of e) o === n.length ? n.push(t = new M(this.O(J()), this.O(J()), this, this.options)) : t = n[o], t._$AI(c), o++;
...
class O {
  ...
  _$AI(e, n = this, t, o) {
    ...
    let r = !1;
    if (c === void 0) e = E(this, e, n, 0), r = !H(e) || e !== this._$AH && e !== I, r && (this._$AH = e);
    else {
      const s = e;
      let g, x;
      for (e = c[0], g = 0; g < c.length - 1; g++) x = E(this, s[t + g], n, g), x === I && (x = this._$AH[g]), r || (r = !H(x) || x !== this._$AH[g]), x === l ? e = l : e !== l && (e += (x ?? "") + c[g + 1]), this._$AH[g] = x;
    }
    r && !o && this.j(e);
  }
  j(e) {
...
Y == null || Y(B, M), (z.litHtmlVersions ?? (z.litHtmlVersions = [])).push("3.3.1");
const Ge = (i, e, n) => {
  const t = (n == null ? void 0 : n.renderBefore) ?? e;
  let o = t._$litPart$;
  if (o === void 0) {
    const c = (n == null ? void 0 : n.renderBefore) ?? null;
    t._$litPart$ = o = new M(e.insertBefore(J(), c), c, void 0, n ?? {});
  }
  return o._$AI(i), o;
};
/**
...
class S extends C {
  ...
  update(e) {
    const n = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = Ge(n, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var e;
...
var ae;
S._$litElement$ = !0, S.finalized = !0, (ae = y.litElementHydrateSupport) == null || ae.call(y, { LitElement: S });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ve = { attribute: !0, type: String, converter: U, reflect: !1, hasChanged: N }, Ke = (i = Ve, e, n) => {
  ...
  if (c === void 0 && globalThis.litPropertyMetadata.set(o, c = /* @__PURE__ */ new Map()), t === "setter" && ((i = Object.create(i)).wrapped = !0), c.set(n.name, i), t === "accessor") {
    ...
    return { set(s) {
      ...
      e.set.call(this, s), this.requestUpdate(r, g, i);
    }, init(s) {
      return s !== void 0 && this.C(r, void 0, i, s), s;
    } };
  }
  if (t === "setter") {
    const { name: r } = n;
    return function(s) {
      const g = this[r];
      e.call(this, s), this.requestUpdate(r, g, i);
    };
  }
  throw Error("Unsupported decorator location: " + t);
};
function G(i) {
  return (e, n) => typeof n == "object" ? Ke(i, e, n) : ((t, o, c) => {
...
`, De = P`
  ...
  ${Ue}
`, Pe = (i) => `ngx-icon ${i.trim().split(" ").map((n) => {
  const [t, o] = n.split(":");
...
class Oe {
  ...
  get(e, n) {
    return this.lookup(e, n).map((t) => Pe(t));
  }
  lookup(e, n) {
    const t = n ?? this._defaultFontSetClass;
    return (Array.isArray(e) ? e : [e]).reduce((o, c) => {
      const r = this._expandKeys(c, t).map((s) => {
        const g = this._iconMap.get(s);
        return g && g.length === 1 ? g[0] : s;
      }).join(" ");
...
const se = "swim-icon", j = class j extends S {
  ...
  _updateFontIcon() {
    ...
    this._cssClasses = Qe.get(e, this.fontSet);
  }
  render() {
    var c;
    ...
    return !e || e.length === 0 ? R`
      ...
      >
        ${e.map(
      (r, s) => R`<i part="icon icon-${s}" class="swim-icon__i swim-icon__i--${s} ${r}${o}"></i>`
    )}
      </span>
    `;
  }
