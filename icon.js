...
const be = (n) => new ae(typeof n == "string" ? n : n + "", void 0, Z), P = (n, ...e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: pe, defineProperty: ue, getOwnPropertyDescriptor: ge, getOwnPropertyNames: Ae, getOwnPropertySymbols: ye, getPrototypeOf: Ce } = Object, p = globalThis, $ = p.trustedTypes, xe = $ ? $.emptyScript : "", Q = p.reactiveElementPolyfillSupport, q = (n, e) => n, U = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? xe : null;
      break;
  ...
  return t;
} }, N = (n, e) => !pe(n, e), ee = { attribute: !0, type: String, converter: U, reflect: !1, useDefault: !1, hasChanged: N };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const z = globalThis, D = z.trustedTypes, te = D ? D.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, fe = "$lit$", w = `lit$${Math.random().toFixed(9).slice(2)}$`, me = "?" + w, Ie = `<${me}>`, C = document, J = () => C.createComment(""), H = (n) => n === null || typeof n != "object" && typeof n != "function", L = Array.isArray, Ee = (n) => L(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", F = `[ 	
\f\r]`, v = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ie = /-->/g, oe = />/g, g = RegExp(`>|${F}(?:([^\\s"'>=/]+)(${F}*=${F}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ne = /'/g, se = /"/g, de = /^(?:script|style|textarea|title)$/i, ve = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), R = ve(1), I = Symbol.for("lit-noChange"), f = Symbol.for("lit-nothing"), re = /* @__PURE__ */ new WeakMap(), A = C.createTreeWalker(C, 129);
function he(n, e) {
...
const qe = (n, e) => {
  ...
  for (let l = 0; l < t; l++) {
    ...
    r += s === v ? c + Ie : a >= 0 ? (i.push(b), c.slice(0, a) + fe + c.slice(a) + w + h) : c + w + (a === -2 ? l : h);
  }
    ...
    for (; (o = A.nextNode()) !== null && c.length < l; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const a of o.getAttributeNames()) if (a.endsWith(fe)) {
          ...
          c.push({ type: 1, index: r, name: K[2], strings: h, ctor: K[1] === "." ? Se : K[1] === "?" ? Je : K[1] === "@" ? He : O }), o.removeAttribute(a);
...
class ze {
  ...
  u(e) {
    ...
    for (; c !== void 0; ) {
      if (s === c.index) {
        let b;
        c.type === 2 ? b = new M(r, r.nextSibling, this, e) : c.type === 1 ? b = new c.ctor(r, c.name, c.strings, this, e) : c.type === 6 && (b = new Be(r, this, e)), this._$AV.push(b), c = i[++l];
      }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ge = { attribute: !0, type: String, converter: U, reflect: !1, hasChanged: N }, Ve = (n = Ge, e, t) => {
...
const Qe = new Oe();
var Fe = Object.defineProperty, V = (n, e, t, i) => {
