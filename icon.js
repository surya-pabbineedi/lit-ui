...
const we = (n) => new be(typeof n == "string" ? n : n + "", void 0, Z), P = (n, ...e) => {
...
}, _ = T ? (n) => n : (n) => n instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ue, defineProperty: ge, getOwnPropertyDescriptor: Ae, getOwnPropertyNames: ye, getOwnPropertySymbols: Ce, getPrototypeOf: xe } = Object, p = globalThis, $ = p.trustedTypes, Ie = $ ? $.emptyScript : "", Q = p.reactiveElementPolyfillSupport, q = (n, e) => n, U = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? Ie : null;
      break;
  ...
  return t;
} }, N = (n, e) => !ue(n, e), ee = { attribute: !0, type: String, converter: U, reflect: !1, useDefault: !1, hasChanged: N };
...
let x = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(q("properties"))) {
      const t = this.properties, i = [...ye(t), ...Ce(t)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const o of i) t.unshift(_(o));
  ...
  _$ET(e, t) {
    ...
    if (o !== void 0 && i.reflect === !0) {
      const s = (((r = i.converter) == null ? void 0 : r.toAttribute) !== void 0 ? i.converter : U).toAttribute(t, i.type);
  ...
  _$AK(e, t) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const l = i.getPropertyOptions(o), c = typeof l.converter == "function" ? { fromAttribute: l.converter } : ((r = l.converter) == null ? void 0 : r.fromAttribute) !== void 0 ? l.converter : U;
      this._$Em = o;
  ...
  requestUpdate(e, t, i) {
    ...
    if (e !== void 0) {
      ...
      if (i ?? (i = r.getPropertyOptions(e)), !((i.hasChanged ?? N)(s, t) || i.useDefault && i.reflect && s === ((o = this._$Ej) == null ? void 0 : o.get(e)) && !this.hasAttribute(r._$Eu(e, i)))) return;
      this.C(e, t, i);
    }
...
x.elementStyles = [], x.shadowRootOptions = { mode: "open" }, x[q("elementProperties")] = /* @__PURE__ */ new Map(), x[q("finalized")] = /* @__PURE__ */ new Map(), Q == null || Q({ ReactiveElement: x }), (p.reactiveElementVersions ?? (p.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const z = globalThis, D = z.trustedTypes, te = D ? D.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, fe = "$lit$", w = `lit$${Math.random().toFixed(9).slice(2)}$`, me = "?" + w, Ee = `<${me}>`, C = document, J = () => C.createComment(""), H = (n) => n === null || typeof n != "object" && typeof n != "function", L = Array.isArray, ve = (n) => L(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", F = `[ 	
\f\r]`, v = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ie = /-->/g, oe = />/g, g = RegExp(`>|${F}(?:([^\\s"'>=/]+)(${F}*=${F}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ne = /'/g, se = /"/g, de = /^(?:script|style|textarea|title)$/i, qe = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), R = qe(1), I = Symbol.for("lit-noChange"), f = Symbol.for("lit-nothing"), re = /* @__PURE__ */ new WeakMap(), A = C.createTreeWalker(C, 129);
function he(n, e) {
...
const ze = (n, e) => {
  ...
  for (let l = 0; l < t; l++) {
    const c = n[l];
    let b, m, a = -1, d = 0;
    for (; d < c.length && (s.lastIndex = d, m = s.exec(c), m !== null); ) d = s.lastIndex, s === v ? m[1] === "!--" ? s = ie : m[1] !== void 0 ? s = oe : m[2] !== void 0 ? (de.test(m[2]) && (o = RegExp("</" + m[2], "g")), s = g) : m[3] !== void 0 && (s = g) : s === g ? m[0] === ">" ? (s = o ?? v, a = -1) : m[1] === void 0 ? a = -2 : (a = s.lastIndex - m[2].length, b = m[1], s = m[3] === void 0 ? g : m[3] === '"' ? se : ne) : s === se || s === ne ? s = g : s === ie || s === oe ? s = v : (s = g, o = void 0);
    const h = s === g && n[l + 1].startsWith("/>") ? " " : "";
    r += s === v ? c + Ee : a >= 0 ? (i.push(b), c.slice(0, a) + fe + c.slice(a) + w + h) : c + w + (a === -2 ? l : h);
  }
...
class B {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let r = 0, s = 0;
    const l = e.length - 1, c = this.parts, [b, m] = ze(e, t);
    if (this.el = B.createElement(b, i), A.currentNode = this.el.content, t === 2 || t === 3) {
      const a = this.el.content.firstChild;
      a.replaceWith(...a.childNodes);
    }
    for (; (o = A.nextNode()) !== null && c.length < l; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const a of o.getAttributeNames()) if (a.endsWith(fe)) {
          const d = m[s++], h = o.getAttribute(a).split(w), K = /([.?@])?(.*)/.exec(d);
          c.push({ type: 1, index: r, name: K[2], strings: h, ctor: K[1] === "." ? Je : K[1] === "?" ? He : K[1] === "@" ? Be : O }), o.removeAttribute(a);
        } else a.startsWith(w) && (c.push({ type: 6, index: r }), o.removeAttribute(a));
        if (de.test(o.tagName)) {
          const a = o.textContent.split(w), d = a.length - 1;
          if (d > 0) {
            o.textContent = D ? D.emptyScript : "";
            for (let h = 0; h < d; h++) o.append(a[h], J()), A.nextNode(), c.push({ type: 2, index: ++r });
            o.append(a[d], J());
          }
        }
...
function E(n, e, t = n, i) {
  ...
  return (o == null ? void 0 : o.constructor) !== r && ((l = o == null ? void 0 : o._$AO) == null || l.call(o, !1), r === void 0 ? o = void 0 : (o = new r(n), o._$AT(n, t, i)), i !== void 0 ? (t._$Co ?? (t._$Co = []))[i] = o : t._$Cl = o), o !== void 0 && (e = E(n, o._$AS(n, e.values), o, i)), e;
}
class Se {
  constructor(e, t) {
  ...
  u(e) {
    const { el: { content: t }, parts: i } = this._$AD, o = ((e == null ? void 0 : e.creationScope) ?? C).importNode(t, !0);
    A.currentNode = o;
    let r = A.nextNode(), s = 0, l = 0, c = i[0];
    for (; c !== void 0; ) {
      if (s === c.index) {
        let b;
        c.type === 2 ? b = new M(r, r.nextSibling, this, e) : c.type === 1 ? b = new c.ctor(r, c.name, c.strings, this, e) : c.type === 6 && (b = new Me(r, this, e)), this._$AV.push(b), c = i[++l];
      }
...
class M {
  ...
  _$AI(e, t = this) {
    e = E(this, e, t), H(e) ? e === f || e == null || e === "" ? (this._$AH !== f && this._$AR(), this._$AH = f) : e !== this._$AH && e !== I && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : ve(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== f && H(this._$AH) ? this._$AA.nextSibling.data = e : this.T(C.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var r;
    const { values: t, _$litType$: i } = e, o = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = B.createElement(he(i.h, i.h[0]), this.options)), i);
    if (((r = this._$AH) == null ? void 0 : r._$AD) === o) this._$AH.p(t);
    else {
      const s = new Se(o, this), l = s.u(this.options);
  ...
  k(e) {
    ...
    const t = this._$AH;
    let i, o = 0;
    for (const r of e) o === t.length ? t.push(i = new M(this.O(J()), this.O(J()), this, this.options)) : i = t[o], i._$AI(r), o++;
...
class O {
  ...
  _$AI(e, t = this, i, o) {
    ...
    let s = !1;
    if (r === void 0) e = E(this, e, t, 0), s = !H(e) || e !== this._$AH && e !== I, s && (this._$AH = e);
    else {
      const l = e;
      let c, b;
      for (e = r[0], c = 0; c < r.length - 1; c++) b = E(this, l[i + c], t, c), b === I && (b = this._$AH[c]), s || (s = !H(b) || b !== this._$AH[c]), b === f ? e = f : e !== f && (e += (b ?? "") + r[c + 1]), this._$AH[c] = b;
    }
    s && !o && this.j(e);
  }
  j(e) {
...
const Ge = (n, e, t) => {
  ...
  if (o === void 0) {
    ...
    i._$litPart$ = o = new M(e.insertBefore(J(), r), r, void 0, t ?? {});
  }
  return o._$AI(n), o;
};
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ve = { attribute: !0, type: String, converter: U, reflect: !1, hasChanged: N }, Ke = (n = Ve, e, t) => {
...
function G(n) {
  return (e, t) => typeof t == "object" ? Ke(n, e, t) : ((i, o, r) => {
...
`, De = P`
  ...
  ${Ue}
`, Pe = (n) => `swim-icon ${n.trim().split(" ").map((t) => {
  const [i, o] = t.split(":");
...
class Oe {
  ...
  get(e, t) {
    return this.lookup(e, t).map((i) => Pe(i));
  }
  lookup(e, t) {
...
`, document.head.appendChild(n), ce = !0;
}
var Te = Object.defineProperty, V = (n, e, t, i) => {
  for (var o = void 0, r = n.length - 1, s; r >= 0; r--)
    (s = n[r]) && (o = s(e, t, o) || o);
  return o && Te(e, t, o), o;
};
const le = "swim-icon", j = class j extends S {
  constructor() {
  ...
  render() {
    ...
    return !e || e.length === 0 ? R`
      ...
      >
        ${e.map(
      (s, l) => R`<i part="icon icon-${l}" class="swim-icon__i swim-icon__i--${l} ${s}${o}"></i>`
    )}
      </span>
    `;
  }
...
customElements.get(le) || customElements.define(le, u);
export {
  u as SwimIcon
};
