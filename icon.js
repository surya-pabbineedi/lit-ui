 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: pe, defineProperty: ue, getOwnPropertyDescriptor: ge, getOwnPropertyNames: Ae, getOwnPropertySymbols: ye, getPrototypeOf: Ce } = Object, p = globalThis, $ = p.trustedTypes, xe = $ ? $.emptyScript : "", O = p.reactiveElementPolyfillSupport, q = (n, e) => n, D = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? xe : null;
      break;
...
const qe = (n, e) => {
  ...
  for (let l = 0; l < t; l++) {
    const c = n[l];
    let b, m, a = -1, d = 0;
    for (; d < c.length && (s.lastIndex = d, m = s.exec(c), m !== null); ) d = s.lastIndex, s === v ? m[1] === "!--" ? s = ie : m[1] !== void 0 ? s = oe : m[2] !== void 0 ? (me.test(m[2]) && (o = RegExp("</" + m[2], "g")), s = g) : m[3] !== void 0 && (s = g) : s === g ? m[0] === ">" ? (s = o ?? v, a = -1) : m[1] === void 0 ? a = -2 : (a = s.lastIndex - m[2].length, b = m[1], s = m[3] === void 0 ? g : m[3] === '"' ? se : ne) : s === se || s === ne ? s = g : s === ie || s === oe ? s = v : (s = g, o = void 0);
