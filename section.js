...
const He = (n) => new Ae(typeof n == "string" ? n : n + "", void 0, _), J = (n, ...e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Be, defineProperty: ke, getOwnPropertyDescriptor: Me, getOwnPropertyNames: Ge, getOwnPropertySymbols: Ve, getPrototypeOf: Ke } = Object, A = globalThis, re = A.trustedTypes, Re = re ? re.emptyScript : "", Y = A.reactiveElementPolyfillSupport, k = (n, e) => n, U = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? Re : null;
      break;
  ...
  return t;
} }, $ = (n, e) => !Be(n, e), ce = { attribute: !0, type: String, converter: U, reflect: !1, useDefault: !1, hasChanged: $ };
...
let q = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(k("properties"))) {
      const t = this.properties, i = [...Ge(t), ...Ve(t)];
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const M = globalThis, Q = M.trustedTypes, le = Q ? Q.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, Ce = "$lit$", y = `lit$${Math.random().toFixed(9).slice(2)}$`, ve = "?" + y, Pe = `<${ve}>`, z = document, G = () => z.createComment(""), V = (n) => n === null || typeof n != "object" && typeof n != "function", ee = Array.isArray, De = (n) => ee(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", W = `[ 	
\f\r]`, B = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ae = /-->/g, be = />/g, v = RegExp(`>|${W}(?:([^\\s"'>=/]+)(${W}*=${W}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), de = /'/g, fe = /"/g, xe = /^(?:script|style|textarea|title)$/i, Te = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), g = Te(1), S = Symbol.for("lit-noChange"), b = Symbol.for("lit-nothing"), he = /* @__PURE__ */ new WeakMap(), x = z.createTreeWalker(z, 129);
function Ee(n, e) {
...
const Oe = (n, e) => {
  ...
  for (let c = 0; c < t; c++) {
    ...
    s += r === B ? l + Pe : a >= 0 ? (i.push(d), l.slice(0, a) + Ce + l.slice(a) + y + u) : l + y + (a === -2 ? c : u);
  }
...
class K {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let s = 0, r = 0;
    const c = e.length - 1, l = this.parts, [d, f] = Oe(e, t);
    ...
    for (; (o = x.nextNode()) !== null && l.length < c; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const a of o.getAttributeNames()) if (a.endsWith(Ce)) {
          ...
          l.push({ type: 1, index: s, name: D[2], strings: u, ctor: D[1] === "." ? Qe : D[1] === "?" ? Fe : D[1] === "@" ? Ye : F }), o.removeAttribute(a);
...
class R {
  ...
  _$AI(e, t = this) {
    e = H(this, e, t), V(e) ? e === b || e == null || e === "" ? (this._$AH !== b && this._$AR(), this._$AH = b) : e !== this._$AH && e !== S && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : De(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    var s;
    const { values: t, _$litType$: i } = e, o = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = K.createElement(Ee(i.h, i.h[0]), this.options)), i);
...
class F {
  ...
  _$AI(e, t = this, i, o) {
    ...
    if (s === void 0) e = H(this, e, t, 0), r = !V(e) || e !== this._$AH && e !== S, r && (this._$AH = e);
      ...
      const c = e;
      let l, d;
      for (e = s[0], l = 0; l < s.length - 1; l++) d = H(this, c[i + l], t, l), d === S && (d = this._$AH[l]), r || (r = !V(d) || d !== this._$AH[l]), d === b ? e = b : e !== b && (e += (d ?? "") + s[l + 1]), this._$AH[l] = d;
    }
    r && !o && this.j(e);
  }
  j(e) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ze = { attribute: !0, type: String, converter: U, reflect: !1, hasChanged: $ }, Le = (n = Ze, e, t) => {
...
`, $e = [ze, _e];
var qe = /* @__PURE__ */ ((n) => (n.Legacy = "legacy", n.Outline = "outline", n.Light = "light", n.Minimal = "minimal", n))(qe || {}), O = /* @__PURE__ */ ((n) => (n.Left = "left", n.Right = "right", n.None = "none", n))(O || {});
function L(n) {
...
var lt = Object.defineProperty, P = (n, e, t, i) => {
  for (var o = void 0, s = n.length - 1, r; s >= 0; s--)
    (r = n[s]) && (o = r(e, t, o) || o);
  return o && lt(e, t, o), o;
};
const pe = "swim-icon", te = class te extends I {
  constructor() {
...
customElements.get(pe) || customElements.define(pe, C);
var at = Object.defineProperty, bt = Object.getOwnPropertyDescriptor, p = (n, e, t, i) => {
...
let we = 0;
const ge = "swim-section", ie = class ie extends I {
  constructor() {
    super(...arguments), this._id = `section-${++we}`, this._sectionCollapsed = !1, this._sectionCollapsible = !0, this._headerToggle = !1, this.sectionTitle = "", this.padding = "1.8em", this.appearance = qe.Legacy, this.togglePosition = O.Left, this._hasHeaderSlot = !1, this._headerSlotChangeBound = () => this._checkHeaderSlot();
  }
  get id() {
    return this._id;
  }
  set id(e) {
    this._id = e || `section-${++we}`;
  }
...
customElements.get(ge) || customElements.define(ge, h);
const ft = J`
  :host {
    display: contents;
  }
