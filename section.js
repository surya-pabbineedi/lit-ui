...
const Ae = (n) => new ye(typeof n == "string" ? n : n + "", void 0, _), J = (n, ...e) => {
...
class R {
  ...
  _$AI(e, t = this) {
    e = H(this, e, t), V(e) ? e === b || e == null || e === "" ? (this._$AH !== b && this._$AR(), this._$AH = b) : e !== this._$AH && e !== S && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Pe(e) ? this.k(e) : this._(e);
  }
  O(e) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ne = { attribute: !0, type: String, converter: U, reflect: !1, hasChanged: $ }, Ze = (n = Ne, e, t) => {
...
function m(n) {
  return (e, t) => typeof t == "object" ? Ze(n, e, t) : ((i, o, s) => {
...
const we = "swim-section", ie = class ie extends I {
  constructor() {
    super(...arguments), this._id = `section-${++pe}`, this._sectionCollapsed = !1, this._sectionCollapsible = !0, this._headerToggle = !1, this.sectionTitle = "", this.padding = "1.8em", this.appearance = qe.Legacy, this.togglePosition = O.Left, this._hasHeaderSlot = !1, this._headerSlotChangeBound = () => this._checkHeaderSlot();
  }
  get id() {
    return this._id;
  }
