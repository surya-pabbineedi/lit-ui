 ...
 */
const O = globalThis, X = O.ShadowRoot && (O.ShadyCSS === void 0 || O.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, _ = Symbol(), ie = /* @__PURE__ */ new WeakMap();
let Ae = class {
  constructor(e, n, t) {
    if (this._$cssResult$ = !0, t !== _) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
  ...
  get styleSheet() {
    ...
    if (X && e === void 0) {
      ...
      t && (e = ie.get(n)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), t && ie.set(n, e));
    }
    return e;
  }
  toString() {
...
const He = (i) => new Ae(typeof i == "string" ? i : i + "", void 0, _), J = (i, ...e) => {
  const n = i.length === 1 ? i[0] : e.reduce((t, o, r) => t + ((c) => {
  ...
  if (X) i.adoptedStyleSheets = e.map((n) => n instanceof CSSStyleSheet ? n : n.styleSheet);
  else for (const n of e) {
    const t = document.createElement("style"), o = O.litNonce;
    o !== void 0 && t.setAttribute("nonce", o), t.textContent = n.cssText, i.appendChild(t);
  }
}, re = X ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((e) => {
  let n = "";
  for (const t of e.cssRules) n += t.cssText;
  return He(n);
})(i) : i;
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Be, defineProperty: ke, getOwnPropertyDescriptor: Me, getOwnPropertyNames: Ge, getOwnPropertySymbols: Ve, getPrototypeOf: Ke } = Object, A = globalThis, ce = A.trustedTypes, Re = ce ? ce.emptyScript : "", Y = A.reactiveElementPolyfillSupport, k = (i, e) => i, U = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Re : null;
      break;
  ...
  return n;
} }, $ = (i, e) => !Be(i, e), se = { attribute: !0, type: String, converter: U, reflect: !1, useDefault: !1, hasChanged: $ };
...
let q = class extends HTMLElement {
  ...
  static createProperty(e, n = se) {
    if (n.state && (n.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(e) && ((n = Object.create(n)).wrapped = !0), this.elementProperties.set(e, n), !n.noAccessor) {
      const t = Symbol(), o = this.getPropertyDescriptor(e, t, n);
      o !== void 0 && ke(this.prototype, e, o);
    }
  }
  static getPropertyDescriptor(e, n, t) {
    const { get: o, set: r } = Me(this.prototype, e) ?? { get() {
      return this[n];
    }, set(c) {
      this[n] = c;
    } };
    return { get: o, set(c) {
      ...
      r == null || r.call(this, c), this.requestUpdate(e, s, t);
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(k("properties"))) {
      const n = this.properties, t = [...Ge(n), ...Ve(n)];
      for (const o of t) this.createProperty(o, n[o]);
    }
    const e = this[Symbol.metadata];
    if (e !== null) {
      const n = litPropertyMetadata.get(e);
      if (n !== void 0) for (const [t, o] of n) this.elementProperties.set(t, o);
    }
    this._$Eh = /* @__PURE__ */ new Map();
    for (const [n, t] of this.elementProperties) {
      const o = this._$Eu(n, t);
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const o of t) n.unshift(re(o));
    } else e !== void 0 && n.push(re(e));
    return n;
  }
  static _$Eu(e, n) {
    const t = n.attribute;
  ...
  _$E_() {
    ...
    for (const t of n.keys()) this.hasOwnProperty(t) && (e.set(t, this[t]), delete this[t]);
  ...
  connectedCallback() {
    ...
    this.renderRoot ?? (this.renderRoot = this.createRenderRoot()), this.enableUpdating(!0), (e = this._$EO) == null || e.forEach((n) => {
      var t;
      return (t = n.hostConnected) == null ? void 0 : t.call(n);
    });
  }
  enableUpdating(e) {
  }
  disconnectedCallback() {
    ...
    (e = this._$EO) == null || e.forEach((n) => {
      var t;
      return (t = n.hostDisconnected) == null ? void 0 : t.call(n);
    });
  }
  ...
  _$ET(e, n) {
    ...
    if (o !== void 0 && t.reflect === !0) {
      const c = (((r = t.converter) == null ? void 0 : r.toAttribute) !== void 0 ? t.converter : U).toAttribute(n, t.type);
  ...
  _$AK(e, n) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const s = t.getPropertyOptions(o), a = typeof s.converter == "function" ? { fromAttribute: s.converter } : ((r = s.converter) == null ? void 0 : r.fromAttribute) !== void 0 ? s.converter : U;
      this._$Em = o;
      const b = a.fromAttribute(n, s.type);
      this[o] = b ?? ((c = this._$Ej) == null ? void 0 : c.get(o)) ?? b, this._$Em = null;
    }
  }
  requestUpdate(e, n, t) {
    var o;
    if (e !== void 0) {
      ...
      if (t ?? (t = r.getPropertyOptions(e)), !((t.hasChanged ?? $)(c, n) || t.useDefault && t.reflect && c === ((o = this._$Ej) == null ? void 0 : o.get(e)) && !this.hasAttribute(r._$Eu(e, t)))) return;
      this.C(e, n, t);
    }
    this.isUpdatePending === !1 && (this._$ES = this._$EP());
  }
  C(e, n, { useDefault: t, reflect: o, wrapped: r }, c) {
    t && !(this._$Ej ?? (this._$Ej = /* @__PURE__ */ new Map())).has(e) && (this._$Ej.set(e, c ?? n ?? this[e]), r !== !0 || c !== void 0) || (this._$AL.has(e) || (this.hasUpdated || t || (n = void 0), this._$AL.set(e, n)), o === !0 && this._$Em !== e && (this._$Eq ?? (this._$Eq = /* @__PURE__ */ new Set())).add(e));
  }
  async _$EP() {
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (o.size > 0) for (const [r, c] of o) {
        const { wrapped: s } = c, a = this[r];
        s !== !0 || this._$AL.has(r) || a === void 0 || this.C(r, void 0, c, a);
      }
    }
    let e = !1;
    const n = this._$AL;
  ...
  _$AE(e) {
    ...
    (n = this._$EO) == null || n.forEach((t) => {
      var o;
      return (o = t.hostUpdated) == null ? void 0 : o.call(t);
...
q.elementStyles = [], q.shadowRootOptions = { mode: "open" }, q[k("elementProperties")] = /* @__PURE__ */ new Map(), q[k("finalized")] = /* @__PURE__ */ new Map(), Y == null || Y({ ReactiveElement: q }), (A.reactiveElementVersions ?? (A.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const M = globalThis, Q = M.trustedTypes, ae = Q ? Q.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, we = "$lit$", y = `lit$${Math.random().toFixed(9).slice(2)}$`, Ce = "?" + y, Pe = `<${Ce}>`, z = document, G = () => z.createComment(""), V = (i) => i === null || typeof i != "object" && typeof i != "function", ee = Array.isArray, De = (i) => ee(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", W = `[ 	
\f\r]`, B = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ge = /-->/g, le = />/g, C = RegExp(`>|${W}(?:([^\\s"'>=/]+)(${W}*=${W}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), be = /'/g, xe = /"/g, ve = /^(?:script|style|textarea|title)$/i, Oe = (i) => (e, ...n) => ({ _$litType$: i, strings: e, values: n }), u = Oe(1), S = Symbol.for("lit-noChange"), l = Symbol.for("lit-nothing"), de = /* @__PURE__ */ new WeakMap(), v = z.createTreeWalker(z, 129);
function Ee(i, e) {
  if (!ee(i) || !i.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return ae !== void 0 ? ae.createHTML(e) : e;
}
const Te = (i, e) => {
  const n = i.length - 1, t = [];
  let o, r = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", c = B;
  for (let s = 0; s < n; s++) {
    const a = i[s];
    let b, x, g = -1, p = 0;
    for (; p < a.length && (c.lastIndex = p, x = c.exec(a), x !== null); ) p = c.lastIndex, c === B ? x[1] === "!--" ? c = ge : x[1] !== void 0 ? c = le : x[2] !== void 0 ? (ve.test(x[2]) && (o = RegExp("</" + x[2], "g")), c = C) : x[3] !== void 0 && (c = C) : c === C ? x[0] === ">" ? (c = o ?? B, g = -1) : x[1] === void 0 ? g = -2 : (g = c.lastIndex - x[2].length, b = x[1], c = x[3] === void 0 ? C : x[3] === '"' ? xe : be) : c === xe || c === be ? c = C : c === ge || c === le ? c = B : (c = C, o = void 0);
    const m = c === C && i[s + 1].startsWith("/>") ? " " : "";
    r += c === B ? a + Pe : g >= 0 ? (t.push(b), a.slice(0, g) + we + a.slice(g) + y + m) : a + y + (g === -2 ? s : m);
  }
  return [Ee(i, r + (i[n] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), t];
};
class K {
  constructor({ strings: e, _$litType$: n }, t) {
    ...
    this.parts = [];
    let r = 0, c = 0;
    const s = e.length - 1, a = this.parts, [b, x] = Te(e, n);
    if (this.el = K.createElement(b, t), v.currentNode = this.el.content, n === 2 || n === 3) {
      const g = this.el.content.firstChild;
      g.replaceWith(...g.childNodes);
    }
    for (; (o = v.nextNode()) !== null && a.length < s; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const g of o.getAttributeNames()) if (g.endsWith(we)) {
          const p = x[c++], m = o.getAttribute(g).split(y), D = /([.?@])?(.*)/.exec(p);
          a.push({ type: 1, index: r, name: D[2], strings: m, ctor: D[1] === "." ? Qe : D[1] === "?" ? Fe : D[1] === "@" ? Ye : F }), o.removeAttribute(g);
        } else g.startsWith(y) && (a.push({ type: 6, index: r }), o.removeAttribute(g));
        if (ve.test(o.tagName)) {
          const g = o.textContent.split(y), p = g.length - 1;
          if (p > 0) {
            o.textContent = Q ? Q.emptyScript : "";
            for (let m = 0; m < p; m++) o.append(g[m], G()), v.nextNode(), a.push({ type: 2, index: ++r });
            o.append(g[p], G());
          }
        }
      } else if (o.nodeType === 8) if (o.data === Ce) a.push({ type: 2, index: r });
      else {
        let g = -1;
        for (; (g = o.data.indexOf(y, g + 1)) !== -1; ) a.push({ type: 7, index: r }), g += y.length - 1;
      }
      r++;
    }
  }
  static createElement(e, n) {
    const t = z.createElement("template");
    return t.innerHTML = e, t;
  }
}
function H(i, e, n = i, t) {
  var c, s;
  if (e === S) return e;
  let o = t !== void 0 ? (c = n._$Co) == null ? void 0 : c[t] : n._$Cl;
  const r = V(e) ? void 0 : e._$litDirective$;
  return (o == null ? void 0 : o.constructor) !== r && ((s = o == null ? void 0 : o._$AO) == null || s.call(o, !1), r === void 0 ? o = void 0 : (o = new r(i), o._$AT(i, n, t)), t !== void 0 ? (n._$Co ?? (n._$Co = []))[t] = o : n._$Cl = o), o !== void 0 && (e = H(i, o._$AS(i, e.values), o, t)), e;
}
class Ue {
  constructor(e, n) {
  ...
  u(e) {
    const { el: { content: n }, parts: t } = this._$AD, o = ((e == null ? void 0 : e.creationScope) ?? z).importNode(n, !0);
    v.currentNode = o;
    let r = v.nextNode(), c = 0, s = 0, a = t[0];
    for (; a !== void 0; ) {
      if (c === a.index) {
        let b;
        a.type === 2 ? b = new R(r, r.nextSibling, this, e) : a.type === 1 ? b = new a.ctor(r, a.name, a.strings, this, e) : a.type === 6 && (b = new We(r, this, e)), this._$AV.push(b), a = t[++s];
      }
      c !== (a == null ? void 0 : a.index) && (r = v.nextNode(), c++);
    }
    return v.currentNode = z, o;
  }
  p(e) {
    let n = 0;
    for (const t of this._$AV) t !== void 0 && (t.strings !== void 0 ? (t._$AI(e, t, n), n += t.strings.length - 2) : t._$AI(e[n])), n++;
  }
}
class R {
  get _$AU() {
  ...
  constructor(e, n, t, o) {
    this.type = 2, this._$AH = l, this._$AN = void 0, this._$AA = e, this._$AB = n, this._$AM = t, this.options = o, this._$Cv = (o == null ? void 0 : o.isConnected) ?? !0;
  }
  get parentNode() {
  ...
  _$AI(e, n = this) {
    e = H(this, e, n), V(e) ? e === l || e == null || e === "" ? (this._$AH !== l && this._$AR(), this._$AH = l) : e !== this._$AH && e !== S && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : De(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== l && V(this._$AH) ? this._$AA.nextSibling.data = e : this.T(z.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var r;
    const { values: n, _$litType$: t } = e, o = typeof t == "number" ? this._$AC(e) : (t.el === void 0 && (t.el = K.createElement(Ee(t.h, t.h[0]), this.options)), t);
    if (((r = this._$AH) == null ? void 0 : r._$AD) === o) this._$AH.p(n);
    else {
      const c = new Ue(o, this), s = c.u(this.options);
      c.p(n), this.T(s), this._$AH = c;
    }
  }
  _$AC(e) {
    let n = de.get(e.strings);
    return n === void 0 && de.set(e.strings, n = new K(e)), n;
  }
  k(e) {
    ee(this._$AH) || (this._$AH = [], this._$AR());
    const n = this._$AH;
    let t, o = 0;
    for (const r of e) o === n.length ? n.push(t = new R(this.O(G()), this.O(G()), this, this.options)) : t = n[o], t._$AI(r), o++;
    o < n.length && (this._$AR(t && t._$AB.nextSibling, o), n.length = o);
  }
  _$AR(e = this._$AA.nextSibling, n) {
    var t;
    for ((t = this._$AP) == null ? void 0 : t.call(this, !1, !0, n); e !== this._$AB; ) {
...
class F {
  ...
  constructor(e, n, t, o, r) {
    this.type = 1, this._$AH = l, this._$AN = void 0, this.element = e, this.name = n, this._$AM = o, this.options = r, t.length > 2 || t[0] !== "" || t[1] !== "" ? (this._$AH = Array(t.length - 1).fill(new String()), this.strings = t) : this._$AH = l;
  }
  _$AI(e, n = this, t, o) {
    const r = this.strings;
    let c = !1;
    if (r === void 0) e = H(this, e, n, 0), c = !V(e) || e !== this._$AH && e !== S, c && (this._$AH = e);
    else {
      const s = e;
      let a, b;
      for (e = r[0], a = 0; a < r.length - 1; a++) b = H(this, s[t + a], n, a), b === S && (b = this._$AH[a]), c || (c = !V(b) || b !== this._$AH[a]), b === l ? e = l : e !== l && (e += (b ?? "") + r[a + 1]), this._$AH[a] = b;
    }
    c && !o && this.j(e);
  }
  j(e) {
...
class Ye extends F {
  constructor(e, n, t, o, r) {
    super(e, n, t, o, r), this.type = 5;
  }
  _$AI(e, n = this) {
    if ((e = H(this, e, n, 0) ?? l) === S) return;
    const t = this._$AH, o = e === l && t !== l || e.capture !== t.capture || e.once !== t.once || e.passive !== t.passive, r = e !== l && (t === l || o);
...
class We {
  constructor(e, n, t) {
    this.element = e, this.type = 6, this._$AN = void 0, this._$AM = n, this.options = t;
  }
  get _$AU() {
    return this._$AM._$AU;
  }
...
const N = M.litHtmlPolyfillSupport;
N == null || N(K, R), (M.litHtmlVersions ?? (M.litHtmlVersions = [])).push("3.3.1");
const Ne = (i, e, n) => {
  const t = (n == null ? void 0 : n.renderBefore) ?? e;
  let o = t._$litPart$;
  if (o === void 0) {
    const r = (n == null ? void 0 : n.renderBefore) ?? null;
    t._$litPart$ = o = new R(e.insertBefore(G(), r), r, void 0, n ?? {});
  }
  return o._$AI(i), o;
};
/**
...
class I extends q {
  ...
  update(e) {
    const n = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = Ne(n, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var e;
...
var ye;
I._$litElement$ = !0, I.finalized = !0, (ye = E.litElementHydrateSupport) == null || ye.call(E, { LitElement: I });
const Z = E.litElementPolyfillSupport;
Z == null || Z({ LitElement: I });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ze = { attribute: !0, type: String, converter: U, reflect: !1, hasChanged: $ }, Le = (i = Ze, e, n) => {
  const { kind: t, metadata: o } = n;
  let r = globalThis.litPropertyMetadata.get(o);
  if (r === void 0 && globalThis.litPropertyMetadata.set(o, r = /* @__PURE__ */ new Map()), t === "setter" && ((i = Object.create(i)).wrapped = !0), r.set(n.name, i), t === "accessor") {
    const { name: c } = n;
    return { set(s) {
      const a = e.get.call(this);
      e.set.call(this, s), this.requestUpdate(c, a, i);
    }, init(s) {
      return s !== void 0 && this.C(c, void 0, i, s), s;
    } };
  }
  if (t === "setter") {
    const { name: c } = n;
    return function(s) {
      const a = this[c];
      e.call(this, s), this.requestUpdate(c, a, i);
    };
  }
  throw Error("Unsupported decorator location: " + t);
};
function f(i) {
  return (e, n) => typeof n == "object" ? Le(i, e, n) : ((t, o, r) => {
    const c = o.hasOwnProperty(r);
    return o.constructor.createProperty(r, t), c ? Object.getOwnPropertyDescriptor(o, r) : void 0;
  })(i, e, n);
}
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const je = (i, e, n) => (n.configurable = !0, n.enumerable = !0, Reflect.decorate && typeof e != "object" && Object.defineProperty(i, e, n), n);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
function Xe(i, e) {
  return (n, t, o) => {
    const r = (c) => {
      var s;
      return ((s = c.renderRoot) == null ? void 0 : s.querySelector(i)) ?? null;
    };
    return je(n, t, { get() {
      return r(this);
    } });
...
`, $e = [ze, _e];
var qe = /* @__PURE__ */ ((i) => (i.Legacy = "legacy", i.Outline = "outline", i.Light = "light", i.Minimal = "minimal", i))(qe || {}), T = /* @__PURE__ */ ((i) => (i.Left = "left", i.Right = "right", i.None = "none", i))(T || {});
function L(i) {
...
`, nn = J`
  ...
  ${en}
`, tn = (i) => `ngx-icon ${i.trim().split(" ").map((n) => {
  const [t, o] = n.split(":");
  return t.length ? `${t} ${t}-${o}` : o;
}).join(" ")}`;
class on {
  constructor() {
...
@font-face {
  font-family: '${sn}';
  src: url('data:font/woff2;base64,${cn}') format('woff2');
  font-weight: normal;
  font-style: normal;
  font-display: block;
}
`, document.head.appendChild(i), fe = !0;
}
var gn = Object.defineProperty, P = (i, e, n, t) => {
  for (var o = void 0, r = i.length - 1, c; r >= 0; r--)
    (c = i[r]) && (o = c(e, n, o) || o);
  return o && gn(e, n, o), o;
};
const he = "swim-icon", ne = class ne extends I {
  constructor() {
    super(...arguments), this.fontIcon = "", this.alt = "", this.fontSet = "ngx", this.iconClass = "", this._cssClasses = [], this._iconClassTokensOnHost = [];
  }
  connectedCallback() {
    super.connectedCallback(), an(), this._updateFontIcon();
  }
  updated(e) {
  ...
  _syncIconClassToHost() {
    var n;
    const e = (((n = this.iconClass) == null ? void 0 : n.trim()) ?? "").split(/\s+/).filter(Boolean);
    this._iconClassTokensOnHost.forEach((t) => this.classList.remove(t)), e.forEach((t) => this.classList.add(t)), this._iconClassTokensOnHost = e;
  }
  _parseFontIcon(e) {
  ...
  _updateFontIcon() {
    ...
    this._cssClasses = rn.get(e, this.fontSet);
  }
  render() {
    var r;
    const e = this._cssClasses, n = !!this.alt, t = ((r = this.iconClass) == null ? void 0 : r.trim()) ?? "", o = t ? ` ${t}` : "";
    return !e || e.length === 0 ? u`
        <span
          part="icon"
          class="${t}"
          role="${n ? "img" : "presentation"}"
          aria-label="${n ? this.alt : l}"
      ...
      >
        ${e.map(
      (c, s) => u`<i part="icon icon-${s}" class="swim-icon__i swim-icon__i--${s} ${c}${o}"></i>`
    )}
      </span>
    `;
  }
...
], w.prototype, "iconClass");
P([
  Ie()
], w.prototype, "_cssClasses");
customElements.get(he) || customElements.define(he, w);
var ln = Object.defineProperty, bn = Object.getOwnPropertyDescriptor, h = (i, e, n, t) => {
  for (var o = t > 1 ? void 0 : t ? bn(e, n) : e, r = i.length - 1, c; r >= 0; r--)
    (c = i[r]) && (o = (t ? c(e, n, o) : c(o)) || o);
  return t && o && ln(e, n, o), o;
};
const xn = {
  fromAttribute: (i) => i !== "false" && i !== "",
  toAttribute: (i) => i ? "true" : "false"
}, Se = {
  fromAttribute: (i) => i !== null && i !== "false",
  toAttribute: (i) => i ? "true" : "false"
};
let pe = 0;
const ue = "swim-section", te = class te extends I {
  constructor() {
    super(...arguments), this._id = `section-${++pe}`, this._sectionCollapsed = !1, this._sectionCollapsible = !0, this._headerToggle = !1, this.sectionTitle = "", this.padding = "1.8em", this.appearance = qe.Legacy, this.togglePosition = T.Left, this._hasHeaderSlot = !1, this._headerSlotChangeBound = () => this._checkHeaderSlot();
  }
  get id() {
    return this._id;
  }
  ...
  set sectionCollapsed(e) {
    const n = e != null ? L(e) : !1;
    this._sectionCollapsed !== n && (this._sectionCollapsed = n);
  }
  get sectionCollapsible() {
    return this._sectionCollapsible;
  }
  set sectionCollapsible(e) {
    const n = e != null ? L(e) : !0;
    this._sectionCollapsible !== n && (this._sectionCollapsible = n);
  }
  get headerToggle() {
  ...
  set headerToggle(e) {
    const n = e != null ? L(e) : !1;
    this._headerToggle !== n && (this._headerToggle = n);
  }
  get _contentId() {
  ...
  firstUpdated() {
    ...
    const e = ((t = (n = this.renderRoot) == null ? void 0 : n.querySelector) == null ? void 0 : t.call(n, 'slot[name="header"]')) ?? this._headerSlot;
  ...
  _checkHeaderSlot() {
    ...
    if (e) {
      const r = e.assignedNodes({ flatten: !0 }).some(
        (c) => {
          var s;
          return c.nodeType === Node.ELEMENT_NODE || c.nodeType === Node.TEXT_NODE && (((s = c.textContent) == null ? void 0 : s.trim()) ?? "").length > 0;
        }
      );
  ...
  _onToggle(e) {
    ...
    const n = !this.sectionCollapsed;
    this.sectionCollapsed = n, this.dispatchEvent(
  ...
  render() {
    var c;
    const e = this.sectionCollapsible, n = e && this.togglePosition !== T.None, t = this.togglePosition === T.Right, o = [
      "swim-section__header",
      ...
      t ? "swim-section__header--toggle-right" : ""
    ].filter(Boolean).join(" "), r = this._headerIsEmpty();
    return u`
      <div class="swim-section__inner">
        <header
          class="${o}${r ? " swim-section__header--empty" : ""}"
        ...
        >
          ${n && !r ? u`
                <button
                  ...
                  @keydown="${(s) => {
      (s.key === " " || s.key === "Enter") && (s.preventDefault(), this._onToggle(s));
    }}"
                >
                  <swim-icon
          ...
          <div class="swim-section__header-content">
            ${(c = this.sectionTitle) != null && c.trim() ? u`<h1 class="swim-section__header-title">${this.sectionTitle}</h1>` : l}
            <slot name="header"></slot>
          </div>
        </header>
        ${this.sectionCollapsed ? l : u`
              <div
                id="${this._contentId}"
...
h([
  f({ type: String, reflect: !0, attribute: "section-title" })
...
h([
  f({ type: String, reflect: !0, attribute: "toggle-position" })
...
customElements.get(ue) || customElements.define(ue, d);
const dn = J`
  :host {
    display: contents;
  }
`, me = "swim-section-header", oe = class oe extends I {
  render() {
    return u`<slot></slot>`;
  }
};
oe.styles = dn;
let j = oe;
customElements.get(me) || customElements.define(me, j);
export {
  qe as SectionAppearance,
  d as SwimSection,
  j as SwimSectionHeader,
  T as TogglePosition
};
