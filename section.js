 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Pe, defineProperty: ze, getOwnPropertyDescriptor: Oe, getOwnPropertyNames: He, getOwnPropertySymbols: Me, getPrototypeOf: Ue } = Object, y = globalThis, re = y.trustedTypes, Ne = re ? re.emptyScript : "", W = y.reactiveElementPolyfillSupport, O = (n, e) => n, B = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? Ne : null;
      break;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const H = globalThis, F = H.trustedTypes, le = F ? F.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, ye = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, $e = "?" + _, Re = `<${$e}>`, S = document, M = () => S.createComment(""), U = (n) => n === null || typeof n != "object" && typeof n != "function", ee = Array.isArray, Ie = (n) => ee(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", V = `[ 	
...
class R {
  ...
  _$AI(e, t = this) {
    e = T(this, e, t), U(e) ? e === b || e == null || e === "" ? (this._$AH !== b && this._$AR(), this._$AH = b) : e !== this._$AH && e !== k && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Ie(e) ? this.k(e) : this._(e);
  }
  O(e) {
