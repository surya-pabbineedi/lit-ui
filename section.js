...
const He = (i) => new ye(typeof i == "string" ? i : i + "", void 0, _), J = (i, ...e) => {
...
}, se = X ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Be, defineProperty: ke, getOwnPropertyDescriptor: Me, getOwnPropertyNames: Ge, getOwnPropertySymbols: Ve, getPrototypeOf: Ke } = Object, y = globalThis, re = y.trustedTypes, Re = re ? re.emptyScript : "", Y = y.reactiveElementPolyfillSupport, k = (i, e) => i, U = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Re : null;
      break;
  ...
  return t;
} }, $ = (i, e) => !Be(i, e), ce = { attribute: !0, type: String, converter: U, reflect: !1, useDefault: !1, hasChanged: $ };
...
let q = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(k("properties"))) {
      const t = this.properties, n = [...Ge(t), ...Ve(t)];
  ...
  _$ET(e, t) {
    ...
    if (o !== void 0 && n.reflect === !0) {
      const r = (((s = n.converter) == null ? void 0 : s.toAttribute) !== void 0 ? n.converter : U).toAttribute(t, n.type);
  ...
  _$AK(e, t) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const c = n.getPropertyOptions(o), a = typeof c.converter == "function" ? { fromAttribute: c.converter } : ((s = c.converter) == null ? void 0 : s.fromAttribute) !== void 0 ? c.converter : U;
      this._$Em = o;
      const b = a.fromAttribute(t, c.type);
  ...
  requestUpdate(e, t, n) {
    ...
    if (e !== void 0) {
      ...
      if (n ?? (n = s.getPropertyOptions(e)), !((n.hasChanged ?? $)(r, t) || n.useDefault && n.reflect && r === ((o = this._$Ej) == null ? void 0 : o.get(e)) && !this.hasAttribute(s._$Eu(e, n)))) return;
      this.C(e, t, n);
    }
...
q.elementStyles = [], q.shadowRootOptions = { mode: "open" }, q[k("elementProperties")] = /* @__PURE__ */ new Map(), q[k("finalized")] = /* @__PURE__ */ new Map(), Y == null || Y({ ReactiveElement: q }), (y.reactiveElementVersions ?? (y.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const M = globalThis, Q = M.trustedTypes, ae = Q ? Q.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, Ae = "$lit$", x = `lit$${Math.random().toFixed(9).slice(2)}$`, Ce = "?" + x, Pe = `<${Ce}>`, z = document, G = () => z.createComment(""), V = (i) => i === null || typeof i != "object" && typeof i != "function", ee = Array.isArray, De = (i) => ee(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", W = `[ 	
\f\r]`, B = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, le = /-->/g, ge = />/g, C = RegExp(`>|${W}(?:([^\\s"'>=/]+)(${W}*=${W}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), be = /'/g, de = /"/g, ve = /^(?:script|style|textarea|title)$/i, Oe = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), w = Oe(1), S = Symbol.for("lit-noChange"), g = Symbol.for("lit-nothing"), fe = /* @__PURE__ */ new WeakMap(), v = z.createTreeWalker(z, 129);
function Ee(i, e) {
...
const Te = (i, e) => {
  ...
  let o, s = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", r = B;
  for (let c = 0; c < t; c++) {
    const a = i[c];
    let b, d, l = -1, p = 0;
    for (; p < a.length && (r.lastIndex = p, d = r.exec(a), d !== null); ) p = r.lastIndex, r === B ? d[1] === "!--" ? r = le : d[1] !== void 0 ? r = ge : d[2] !== void 0 ? (ve.test(d[2]) && (o = RegExp("</" + d[2], "g")), r = C) : d[3] !== void 0 && (r = C) : r === C ? d[0] === ">" ? (r = o ?? B, l = -1) : d[1] === void 0 ? l = -2 : (l = r.lastIndex - d[2].length, b = d[1], r = d[3] === void 0 ? C : d[3] === '"' ? de : be) : r === de || r === be ? r = C : r === le || r === ge ? r = B : (r = C, o = void 0);
    const u = r === C && i[c + 1].startsWith("/>") ? " " : "";
    s += r === B ? a + Pe : l >= 0 ? (n.push(b), a.slice(0, l) + Ae + a.slice(l) + x + u) : a + x + (l === -2 ? c : u);
  }
  return [Ee(i, s + (i[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), n];
};
class K {
  constructor({ strings: e, _$litType$: t }, n) {
    ...
    this.parts = [];
    let s = 0, r = 0;
    const c = e.length - 1, a = this.parts, [b, d] = Te(e, t);
    if (this.el = K.createElement(b, n), v.currentNode = this.el.content, t === 2 || t === 3) {
      const l = this.el.content.firstChild;
      l.replaceWith(...l.childNodes);
    }
    for (; (o = v.nextNode()) !== null && a.length < c; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const l of o.getAttributeNames()) if (l.endsWith(Ae)) {
          const p = d[r++], u = o.getAttribute(l).split(x), D = /([.?@])?(.*)/.exec(p);
          a.push({ type: 1, index: s, name: D[2], strings: u, ctor: D[1] === "." ? Qe : D[1] === "?" ? Fe : D[1] === "@" ? Ye : F }), o.removeAttribute(l);
        } else l.startsWith(x) && (a.push({ type: 6, index: s }), o.removeAttribute(l));
        if (ve.test(o.tagName)) {
          const l = o.textContent.split(x), p = l.length - 1;
          if (p > 0) {
            o.textContent = Q ? Q.emptyScript : "";
            for (let u = 0; u < p; u++) o.append(l[u], G()), v.nextNode(), a.push({ type: 2, index: ++s });
            o.append(l[p], G());
          }
        }
      } else if (o.nodeType === 8) if (o.data === Ce) a.push({ type: 2, index: s });
      else {
        let l = -1;
...
function H(i, e, t = i, n) {
  var r, c;
  if (e === S) return e;
  let o = n !== void 0 ? (r = t._$Co) == null ? void 0 : r[n] : t._$Cl;
  const s = V(e) ? void 0 : e._$litDirective$;
  return (o == null ? void 0 : o.constructor) !== s && ((c = o == null ? void 0 : o._$AO) == null || c.call(o, !1), s === void 0 ? o = void 0 : (o = new s(i), o._$AT(i, t, n)), n !== void 0 ? (t._$Co ?? (t._$Co = []))[n] = o : t._$Cl = o), o !== void 0 && (e = H(i, o._$AS(i, e.values), o, n)), e;
}
class Ue {
  constructor(e, t) {
  ...
  u(e) {
    ...
    v.currentNode = o;
    let s = v.nextNode(), r = 0, c = 0, a = n[0];
    for (; a !== void 0; ) {
      if (r === a.index) {
        let b;
        a.type === 2 ? b = new R(s, s.nextSibling, this, e) : a.type === 1 ? b = new a.ctor(s, a.name, a.strings, this, e) : a.type === 6 && (b = new We(s, this, e)), this._$AV.push(b), a = n[++c];
      }
      r !== (a == null ? void 0 : a.index) && (s = v.nextNode(), r++);
    }
...
class R {
  ...
  constructor(e, t, n, o) {
    this.type = 2, this._$AH = g, this._$AN = void 0, this._$AA = e, this._$AB = t, this._$AM = n, this.options = o, this._$Cv = (o == null ? void 0 : o.isConnected) ?? !0;
  }
  get parentNode() {
  ...
  _$AI(e, t = this) {
    e = H(this, e, t), V(e) ? e === g || e == null || e === "" ? (this._$AH !== g && this._$AR(), this._$AH = g) : e !== this._$AH && e !== S && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : De(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== g && V(this._$AH) ? this._$AA.nextSibling.data = e : this.T(z.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var s;
    const { values: t, _$litType$: n } = e, o = typeof n == "number" ? this._$AC(e) : (n.el === void 0 && (n.el = K.createElement(Ee(n.h, n.h[0]), this.options)), n);
  ...
  k(e) {
    ...
    const t = this._$AH;
    let n, o = 0;
    for (const s of e) o === t.length ? t.push(n = new R(this.O(G()), this.O(G()), this, this.options)) : n = t[o], n._$AI(s), o++;
...
class F {
  ...
  constructor(e, t, n, o, s) {
    this.type = 1, this._$AH = g, this._$AN = void 0, this.element = e, this.name = t, this._$AM = o, this.options = s, n.length > 2 || n[0] !== "" || n[1] !== "" ? (this._$AH = Array(n.length - 1).fill(new String()), this.strings = n) : this._$AH = g;
  }
  _$AI(e, t = this, n, o) {
    const s = this.strings;
    let r = !1;
    if (s === void 0) e = H(this, e, t, 0), r = !V(e) || e !== this._$AH && e !== S, r && (this._$AH = e);
    else {
      const c = e;
      let a, b;
      for (e = s[0], a = 0; a < s.length - 1; a++) b = H(this, c[n + a], t, a), b === S && (b = this._$AH[a]), r || (r = !V(b) || b !== this._$AH[a]), b === g ? e = g : e !== g && (e += (b ?? "") + s[a + 1]), this._$AH[a] = b;
    }
    r && !o && this.j(e);
  }
  j(e) {
...
class Ye extends F {
  ...
  _$AI(e, t = this) {
    if ((e = H(this, e, t, 0) ?? g) === S) return;
    const n = this._$AH, o = e === g && n !== g || e.capture !== n.capture || e.once !== n.once || e.passive !== n.passive, s = e !== g && (n === g || o);
...
const Ne = (i, e, t) => {
  ...
  if (o === void 0) {
    ...
    n._$litPart$ = o = new R(e.insertBefore(G(), s), s, void 0, t ?? {});
  }
  return o._$AI(i), o;
};
/**
...
var xe;
I._$litElement$ = !0, I.finalized = !0, (xe = E.litElementHydrateSupport) == null || xe.call(E, { LitElement: I });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ze = { attribute: !0, type: String, converter: U, reflect: !1, hasChanged: $ }, Le = (i = Ze, e, t) => {
...
function h(i) {
  return (e, t) => typeof t == "object" ? Le(i, e, t) : ((n, o, s) => {
...
`, tt = J`
  ...
  ${et}
`, nt = (i) => `swim-icon ${i.trim().split(" ").map((t) => {
  const [n, o] = t.split(":");
...
class ot {
  ...
  get(e, t) {
    return this.lookup(e, t).map((n) => nt(n));
  }
  lookup(e, t) {
...
@font-face {
  font-family: '${rt}';
  src: url('data:font/woff2;base64,${st}') format('woff2');
  font-weight: normal;
  font-style: normal;
  font-display: block;
}
`, document.head.appendChild(i), he = !0;
}
var at = Object.defineProperty, P = (i, e, t, n) => {
  for (var o = void 0, s = i.length - 1, r; s >= 0; s--)
    (r = i[s]) && (o = r(e, t, o) || o);
  return o && at(e, t, o), o;
};
const me = "swim-icon", te = class te extends I {
  constructor() {
    super(...arguments), this.fontIcon = "", this.alt = "", this.fontSet = "ngx", this.iconClass = "", this._cssClasses = [], this._iconClassTokensOnHost = [];
  }
  connectedCallback() {
    super.connectedCallback(), ct(), this._updateFontIcon();
  }
  updated(e) {
  ...
  _updateFontIcon() {
    ...
    this._cssClasses = it.get(e, this.fontSet);
  }
  render() {
    var s;
    ...
    return !e || e.length === 0 ? w`
      ...
      >
        ${e.map(
      (r, c) => w`<i part="icon icon-${c}" class="swim-icon__i swim-icon__i--${c} ${r}${o}"></i>`
    )}
      </span>
    `;
  }
...
customElements.get(me) || customElements.define(me, A);
var lt = Object.defineProperty, gt = Object.getOwnPropertyDescriptor, m = (i, e, t, n) => {
  for (var o = n > 1 ? void 0 : n ? gt(e, t) : e, s = i.length - 1, r; s >= 0; s--)
...
let pe = 0;
const we = "swim-section", ne = class ne extends I {
  constructor() {
  ...
  firstUpdated() {
    ...
    const e = ((n = (t = this.renderRoot) == null ? void 0 : t.querySelector) == null ? void 0 : n.call(t, 'slot[name="header"]')) ?? this._headerSlot;
  ...
  render() {
    var r;
    const e = this.sectionCollapsible, t = e && this.togglePosition !== T.None, n = this.togglePosition === T.Right, o = [
      "swim-section__header",
      ...
      n ? "swim-section__header--toggle-right" : ""
    ...
    return w`
      ...
      (c.key === " " || c.key === "Enter") && (c.preventDefault(), this._onToggle(c));
          ...
          <div class="swim-section__header-content">
            ${(r = this.sectionTitle) != null && r.trim() ? w`<h1 class="swim-section__header-title">${this.sectionTitle}</h1>` : g}
            <slot name="header"></slot>
          </div>
        </header>
        ${this.sectionCollapsed ? g : w`
              <div
                id="${this._contentId}"
...
], f.prototype, "sectionCollapsed", 1);
m([
  h({
    reflect: !0,
...
], f.prototype, "sectionCollapsible", 1);
m([
  h({
    reflect: !0,
...
], f.prototype, "headerToggle", 1);
m([
  h({ type: String, reflect: !0, attribute: "section-title" })
], f.prototype, "sectionTitle", 2);
m([
  h({ type: String })
...
m([
  h({ type: String, reflect: !0, attribute: "toggle-position" })
], f.prototype, "togglePosition", 2);
m([
  Ie()
], f.prototype, "_hasHeaderSlot", 2);
m([
  Xe('slot[name="header"]')
], f.prototype, "_headerSlot", 2);
customElements.get(we) || customElements.define(we, f);
const dt = J`
  :host {
    display: contents;
  }
`, ue = "swim-section-header", oe = class oe extends I {
  render() {
    return w`<slot></slot>`;
  }
};
