 ...
 */
const T = globalThis, X = T.ShadowRoot && (T.ShadyCSS === void 0 || T.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, _ = Symbol(), ne = /* @__PURE__ */ new WeakMap();
let ye = class {
  constructor(e, t, i) {
...
const Se = (n) => new ye(typeof n == "string" ? n : n + "", void 0, _), q = (n, ...e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Je, defineProperty: Be, getOwnPropertyDescriptor: ke, getOwnPropertyNames: Me, getOwnPropertySymbols: Ge, getPrototypeOf: Ve } = Object, A = globalThis, re = A.trustedTypes, Ke = re ? re.emptyScript : "", Y = A.reactiveElementPolyfillSupport, k = (n, e) => n, U = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? Ke : null;
      break;
  ...
  return t;
} }, $ = (n, e) => !Je(n, e), ce = { attribute: !0, type: String, converter: U, reflect: !1, useDefault: !1, hasChanged: $ };
...
let S = class extends HTMLElement {
  ...
  _$ET(e, t) {
    ...
    if (o !== void 0 && i.reflect === !0) {
      const r = (((s = i.converter) == null ? void 0 : s.toAttribute) !== void 0 ? i.converter : U).toAttribute(t, i.type);
  ...
  _$AK(e, t) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const c = i.getPropertyOptions(o), l = typeof c.converter == "function" ? { fromAttribute: c.converter } : ((s = c.converter) == null ? void 0 : s.fromAttribute) !== void 0 ? c.converter : U;
      this._$Em = o;
  ...
  requestUpdate(e, t, i) {
    ...
    if (e !== void 0) {
      ...
      if (i ?? (i = s.getPropertyOptions(e)), !((i.hasChanged ?? $)(r, t) || i.useDefault && i.reflect && r === ((o = this._$Ej) == null ? void 0 : o.get(e)) && !this.hasAttribute(s._$Eu(e, i)))) return;
      this.C(e, t, i);
    }
...
S.elementStyles = [], S.shadowRootOptions = { mode: "open" }, S[k("elementProperties")] = /* @__PURE__ */ new Map(), S[k("finalized")] = /* @__PURE__ */ new Map(), Y == null || Y({ ReactiveElement: S }), (A.reactiveElementVersions ?? (A.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const M = globalThis, Q = M.trustedTypes, le = Q ? Q.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, Ae = "$lit$", y = `lit$${Math.random().toFixed(9).slice(2)}$`, Ce = "?" + y, Re = `<${Ce}>`, z = document, G = () => z.createComment(""), V = (n) => n === null || typeof n != "object" && typeof n != "function", ee = Array.isArray, Pe = (n) => ee(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", W = `[ 	
\f\r]`, B = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ae = /-->/g, be = />/g, v = RegExp(`>|${W}(?:([^\\s"'>=/]+)(${W}*=${W}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), de = /'/g, fe = /"/g, ve = /^(?:script|style|textarea|title)$/i, De = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), g = De(1), H = Symbol.for("lit-noChange"), b = Symbol.for("lit-nothing"), he = /* @__PURE__ */ new WeakMap(), x = z.createTreeWalker(z, 129);
function xe(n, e) {
...
const Te = (n, e) => {
  ...
  for (let c = 0; c < t; c++) {
    const l = n[c];
    let d, f, a = -1, w = 0;
    for (; w < l.length && (r.lastIndex = w, f = r.exec(l), f !== null); ) w = r.lastIndex, r === B ? f[1] === "!--" ? r = ae : f[1] !== void 0 ? r = be : f[2] !== void 0 ? (ve.test(f[2]) && (o = RegExp("</" + f[2], "g")), r = v) : f[3] !== void 0 && (r = v) : r === v ? f[0] === ">" ? (r = o ?? B, a = -1) : f[1] === void 0 ? a = -2 : (a = r.lastIndex - f[2].length, d = f[1], r = f[3] === void 0 ? v : f[3] === '"' ? fe : de) : r === fe || r === de ? r = v : r === ae || r === be ? r = B : (r = v, o = void 0);
    const u = r === v && n[c + 1].startsWith("/>") ? " " : "";
    s += r === B ? l + Re : a >= 0 ? (i.push(d), l.slice(0, a) + Ae + l.slice(a) + y + u) : l + y + (a === -2 ? c : u);
  }
...
class K {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    this.parts = [];
    let s = 0, r = 0;
    const c = e.length - 1, l = this.parts, [d, f] = Te(e, t);
    if (this.el = K.createElement(d, i), x.currentNode = this.el.content, t === 2 || t === 3) {
      const a = this.el.content.firstChild;
      a.replaceWith(...a.childNodes);
    }
    for (; (o = x.nextNode()) !== null && l.length < c; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const a of o.getAttributeNames()) if (a.endsWith(Ae)) {
        ...
        if (ve.test(o.tagName)) {
          ...
          if (w > 0) {
            ...
            for (let u = 0; u < w; u++) o.append(a[u], G()), x.nextNode(), l.push({ type: 2, index: ++s });
            o.append(a[w], G());
          }
        }
...
function J(n, e, t = n, i) {
  ...
  return (o == null ? void 0 : o.constructor) !== s && ((c = o == null ? void 0 : o._$AO) == null || c.call(o, !1), s === void 0 ? o = void 0 : (o = new s(n), o._$AT(n, t, i)), i !== void 0 ? (t._$Co ?? (t._$Co = []))[i] = o : t._$Cl = o), o !== void 0 && (e = J(n, o._$AS(n, e.values), o, i)), e;
}
class Oe {
  constructor(e, t) {
  ...
  u(e) {
    ...
    for (; l !== void 0; ) {
      if (r === l.index) {
        let d;
        l.type === 2 ? d = new R(s, s.nextSibling, this, e) : l.type === 1 ? d = new l.ctor(s, l.name, l.strings, this, e) : l.type === 6 && (d = new Ye(s, this, e)), this._$AV.push(d), l = i[++c];
      }
...
class R {
  ...
  _$AI(e, t = this) {
    e = J(this, e, t), V(e) ? e === b || e == null || e === "" ? (this._$AH !== b && this._$AR(), this._$AH = b) : e !== this._$AH && e !== H && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Pe(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    var s;
    const { values: t, _$litType$: i } = e, o = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = K.createElement(xe(i.h, i.h[0]), this.options)), i);
  ...
  _$AC(e) {
    ...
    return t === void 0 && he.set(e.strings, t = new K(e)), t;
  }
  k(e) {
...
class F {
  ...
  _$AI(e, t = this, i, o) {
    ...
    let r = !1;
    if (s === void 0) e = J(this, e, t, 0), r = !V(e) || e !== this._$AH && e !== H, r && (this._$AH = e);
    else {
      const c = e;
      let l, d;
      for (e = s[0], l = 0; l < s.length - 1; l++) d = J(this, c[i + l], t, l), d === H && (d = this._$AH[l]), r || (r = !V(d) || d !== this._$AH[l]), d === b ? e = b : e !== b && (e += (d ?? "") + s[l + 1]), this._$AH[l] = d;
    }
    r && !o && this.j(e);
  }
  j(e) {
...
Z == null || Z(K, R), (M.litHtmlVersions ?? (M.litHtmlVersions = [])).push("3.3.1");
const We = (n, e, t) => {
...
var ue;
I._$litElement$ = !0, I.finalized = !0, (ue = E.litElementHydrateSupport) == null || ue.call(E, { LitElement: I });
const N = E.litElementPolyfillSupport;
N == null || N({ LitElement: I });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ze = { attribute: !0, type: String, converter: U, reflect: !1, hasChanged: $ }, Ne = (n = Ze, e, t) => {
...
function m(n) {
  return (e, t) => typeof t == "object" ? Ne(n, e, t) : ((i, o, s) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Le = (n, e, t) => (t.configurable = !0, t.enumerable = !0, Reflect.decorate && typeof e != "object" && Object.defineProperty(n, e, t), t);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`, _e = [Ie, Xe];
var ze = /* @__PURE__ */ ((n) => (n.Legacy = "legacy", n.Outline = "outline", n.Light = "light", n.Minimal = "minimal", n))(ze || {}), O = /* @__PURE__ */ ((n) => (n.Left = "left", n.Right = "right", n.None = "none", n))(O || {});
function L(n) {
...
`, tt = q`
  ...
  ${et}
`, it = (n) => `swim-icon ${n.trim().split(" ").map((t) => {
  const [i, o] = t.split(":");
...
class ot {
  ...
  get(e, t) {
    return this.lookup(e, t).map((i) => it(i));
  }
  lookup(e, t) {
...
const nt = new ot();
var st = Object.defineProperty, P = (n, e, t, i) => {
...
const me = "swim-icon", te = class te extends I {
  ...
  _updateFontIcon() {
    ...
    this._cssClasses = nt.get(e, this.fontSet);
  }
  render() {
    var s;
...
let pe = 0;
const we = "swim-section", ie = class ie extends I {
  constructor() {
    super(...arguments), this._id = `section-${++pe}`, this._sectionCollapsed = !1, this._sectionCollapsible = !0, this._headerToggle = !1, this.sectionTitle = "", this.padding = "1.8em", this.appearance = ze.Legacy, this.togglePosition = O.Left, this._hasHeaderSlot = !1, this._headerSlotChangeBound = () => this._checkHeaderSlot();
  }
  get id() {
    return this._id;
  }
  ...
  render() {
    var r;
    const e = this.sectionCollapsible, t = e && this.togglePosition !== O.None, i = this.togglePosition === O.Right, o = [
      "swim-section__header",
...
`, ge = "swim-section-header", oe = class oe extends I {
  render() {
    return g`<slot></slot>`;
  }
};
oe.styles = at;
let j = oe;
customElements.get(ge) || customElements.define(ge, j);
export {
  ze as SectionAppearance,
  h as SwimSection,
